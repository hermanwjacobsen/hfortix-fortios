...
def test_request_method():
    ...
    # This is just a syntax/import test
    # Would need real credentials to actually run
    ...
    try:
        ...
        # Check method exists
        assert hasattr(fgt, "request"), "FortiOS.request() not found"
        print("✓ FortiOS.request() method exists")

        # Check it's callable
        assert callable(fgt.request), "FortiOS.request() not callable"
        ...
        print(
            "✓ FortiOS.request() has correct parameters: " "config, raw_json"
        )
        ...
        print('    "data": {"name": "test", "subnet": "10.0.0.1/32"}')
        print("  }")
