...
Configuration endpoint for emailfilter/block_allow_list.
...
.. code-block:: python
   ...
   fgt.api.cmdb.emailfilter.block_allow_list
...
.. code-block:: python
   ...
   # Delete item
   result = fgt.api.cmdb.emailfilter.block_allow_list.delete()
