...
Configuration endpoint for system/affinity_packet_redistribution.
...
.. code-block:: python
   ...
   fgt.api.cmdb.system.affinity_packet_redistribution
...
.. code-block:: python
   ...
   result = fgt.api.cmdb.system.affinity_packet_redistribution.put(
       ...
       rxqid='updated-value',
       round_robin='updated-value',
   )

   # Delete item
   result = fgt.api.cmdb.system.affinity_packet_redistribution.delete()
