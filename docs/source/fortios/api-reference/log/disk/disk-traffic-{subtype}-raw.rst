.. _disk_disk_traffic_{subtype}_raw:

Disk_Traffic_{Subtype}_Raw
==========================
...
.. code-block:: python
   ...
   fgt.api.log.disk.disk_traffic_{subtype}_raw
...
.. code-block:: python
   ...
   # Query logs
   response = fgt.api.log.disk.disk_traffic_{subtype}_raw.get()
