.. _disk_disk_{type}_archive-download:

Disk_{Type}_Archive Download
============================
...
.. code-block:: python
   ...
   fgt.api.log.disk.disk_{type}_archive-download
...
.. code-block:: python
   ...
   # Query logs
   response = fgt.api.log.disk.disk_{type}_archive-download.get()
