.. _forticloud_forticloud_event_{subtype}_raw:

Forticloud_Event_{Subtype}_Raw
==============================
...
.. code-block:: python
   ...
   fgt.api.log.forticloud.forticloud_event_{subtype}_raw
...
.. code-block:: python
   ...
   # Query logs
   response = fgt.api.log.forticloud.forticloud_event_{subtype}_raw.get()
