.. _forticloud_forticloud_traffic_{subtype}:

Forticloud_Traffic_{Subtype}
============================
...
.. code-block:: python
   ...
   fgt.api.log.forticloud.forticloud_traffic_{subtype}
...
.. code-block:: python
   ...
   # Query logs
   response = fgt.api.log.forticloud.forticloud_traffic_{subtype}.get()
