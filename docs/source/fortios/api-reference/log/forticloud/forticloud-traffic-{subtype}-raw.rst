.. _forticloud_forticloud_traffic_{subtype}_raw:

Forticloud_Traffic_{Subtype}_Raw
================================
...
.. code-block:: python
   ...
   fgt.api.log.forticloud.forticloud_traffic_{subtype}_raw
...
.. code-block:: python
   ...
   # Query logs
   response = fgt.api.log.forticloud.forticloud_traffic_{subtype}_raw.get()
