.. _forticloud_forticloud_{type}_raw:

Forticloud_{Type}_Raw
=====================
...
.. code-block:: python
   ...
   fgt.api.log.forticloud.forticloud_{type}_raw
...
.. code-block:: python
   ...
   # Query logs
   response = fgt.api.log.forticloud.forticloud_{type}_raw.get()
