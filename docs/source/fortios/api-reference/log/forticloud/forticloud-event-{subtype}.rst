.. _forticloud_forticloud_event_{subtype}:

Forticloud_Event_{Subtype}
==========================
...
.. code-block:: python
   ...
   fgt.api.log.forticloud.forticloud_event_{subtype}
...
.. code-block:: python
   ...
   # Query logs
   response = fgt.api.log.forticloud.forticloud_event_{subtype}.get()
