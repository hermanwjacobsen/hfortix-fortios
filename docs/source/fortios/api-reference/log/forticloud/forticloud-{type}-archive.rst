.. _forticloud_forticloud_{type}_archive:

Forticloud_{Type}_Archive
=========================
...
.. code-block:: python
   ...
   fgt.api.log.forticloud.forticloud_{type}_archive
...
.. code-block:: python
   ...
   # Query logs
   response = fgt.api.log.forticloud.forticloud_{type}_archive.get()
