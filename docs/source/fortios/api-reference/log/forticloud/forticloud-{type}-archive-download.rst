.. _forticloud_forticloud_{type}_archive-download:

Forticloud_{Type}_Archive Download
==================================
...
.. code-block:: python
   ...
   fgt.api.log.forticloud.forticloud_{type}_archive-download
...
.. code-block:: python
   ...
   # Query logs
   response = fgt.api.log.forticloud.forticloud_{type}_archive-download.get()
