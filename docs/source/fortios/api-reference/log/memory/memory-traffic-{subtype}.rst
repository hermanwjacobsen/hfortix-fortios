.. _memory_memory_traffic_{subtype}:

Memory_Traffic_{Subtype}
========================
...
.. code-block:: python
   ...
   fgt.api.log.memory.memory_traffic_{subtype}
...
.. code-block:: python
   ...
   # Query logs
   response = fgt.api.log.memory.memory_traffic_{subtype}.get()
