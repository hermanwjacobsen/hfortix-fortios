.. _memory_memory_event_{subtype}_raw:

Memory_Event_{Subtype}_Raw
==========================
...
.. code-block:: python
   ...
   fgt.api.log.memory.memory_event_{subtype}_raw
...
.. code-block:: python
   ...
   # Query logs
   response = fgt.api.log.memory.memory_event_{subtype}_raw.get()
