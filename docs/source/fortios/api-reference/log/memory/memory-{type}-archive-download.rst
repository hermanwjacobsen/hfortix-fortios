.. _memory_memory_{type}_archive-download:

Memory_{Type}_Archive Download
==============================
...
.. code-block:: python
   ...
   fgt.api.log.memory.memory_{type}_archive-download
...
.. code-block:: python
   ...
   # Query logs
   response = fgt.api.log.memory.memory_{type}_archive-download.get()
