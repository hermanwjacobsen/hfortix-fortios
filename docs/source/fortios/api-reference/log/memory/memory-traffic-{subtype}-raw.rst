.. _memory_memory_traffic_{subtype}_raw:

Memory_Traffic_{Subtype}_Raw
============================
...
.. code-block:: python
   ...
   fgt.api.log.memory.memory_traffic_{subtype}_raw
...
.. code-block:: python
   ...
   # Query logs
   response = fgt.api.log.memory.memory_traffic_{subtype}_raw.get()
