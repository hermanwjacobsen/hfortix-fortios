.. _fortianalyzer_fortianalyzer_{type}_raw:

Fortianalyzer_{Type}_Raw
========================
...
.. code-block:: python
   ...
   fgt.api.log.fortianalyzer.fortianalyzer_{type}_raw
...
.. code-block:: python
   ...
   # Query logs
   response = fgt.api.log.fortianalyzer.fortianalyzer_{type}_raw.get()
