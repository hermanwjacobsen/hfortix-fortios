.. _fortianalyzer_fortianalyzer_traffic_{subtype}_raw:

Fortianalyzer_Traffic_{Subtype}_Raw
===================================
...
.. code-block:: python
   ...
   fgt.api.log.fortianalyzer.fortianalyzer_traffic_{subtype}_raw
...
.. code-block:: python
   ...
   # Query logs
   response = fgt.api.log.fortianalyzer.fortianalyzer_traffic_{subtype}_raw.get()
