.. _fortianalyzer_fortianalyzer_{type}_archive-download:

Fortianalyzer_{Type}_Archive Download
=====================================
...
.. code-block:: python
   ...
   fgt.api.log.fortianalyzer.fortianalyzer_{type}_archive-download
...
.. code-block:: python
   ...
   # Query logs
   response = fgt.api.log.fortianalyzer.fortianalyzer_{type}_archive-download.get()
