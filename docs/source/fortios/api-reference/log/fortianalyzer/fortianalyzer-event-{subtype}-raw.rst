.. _fortianalyzer_fortianalyzer_event_{subtype}_raw:

Fortianalyzer_Event_{Subtype}_Raw
=================================
...
.. code-block:: python
   ...
   fgt.api.log.fortianalyzer.fortianalyzer_event_{subtype}_raw
...
.. code-block:: python
   ...
   # Query logs
   response = fgt.api.log.fortianalyzer.fortianalyzer_event_{subtype}_raw.get()
