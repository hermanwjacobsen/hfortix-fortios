.. _fortianalyzer_fortianalyzer_virus_archive:
...
.. code-block:: python
   ...
   fgt.api.log.fortianalyzer.fortianalyzer_virus_archive
...
.. code-block:: python
   ...
   # Query logs
   response = fgt.api.log.fortianalyzer.fortianalyzer_virus_archive.get()
