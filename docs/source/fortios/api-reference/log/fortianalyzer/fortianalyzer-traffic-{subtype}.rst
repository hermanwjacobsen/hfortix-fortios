.. _fortianalyzer_fortianalyzer_traffic_{subtype}:

Fortianalyzer_Traffic_{Subtype}
===============================
...
.. code-block:: python
   ...
   fgt.api.log.fortianalyzer.fortianalyzer_traffic_{subtype}
...
.. code-block:: python
   ...
   # Query logs
   response = fgt.api.log.fortianalyzer.fortianalyzer_traffic_{subtype}.get()
