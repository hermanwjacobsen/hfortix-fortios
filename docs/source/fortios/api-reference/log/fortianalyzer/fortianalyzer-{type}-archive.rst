.. _fortianalyzer_fortianalyzer_{type}_archive:

Fortianalyzer_{Type}_Archive
============================
...
.. code-block:: python
   ...
   fgt.api.log.fortianalyzer.fortianalyzer_{type}_archive
...
.. code-block:: python
   ...
   # Query logs
   response = fgt.api.log.fortianalyzer.fortianalyzer_{type}_archive.get()
