.. _fortianalyzer_fortianalyzer_event_{subtype}:

Fortianalyzer_Event_{Subtype}
=============================
...
.. code-block:: python
   ...
   fgt.api.log.fortianalyzer.fortianalyzer_event_{subtype}
...
.. code-block:: python
   ...
   # Query logs
   response = fgt.api.log.fortianalyzer.fortianalyzer_event_{subtype}.get()
