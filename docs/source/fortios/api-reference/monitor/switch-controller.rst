...
The ``monitor.switch-controller`` category provides real-time monitoring for:
...
.. code-block:: python
   ...
   fgt.api.monitor.switch-controller
...
.. code-block:: python
   ...
   # Get monitoring data
   data = fgt.api.monitor.switch-controller.{endpoint}.get()
