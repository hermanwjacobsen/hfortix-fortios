...
The ``monitor.endpoint-control`` category provides real-time monitoring for:
...
.. code-block:: python
   ...
   fgt.api.monitor.endpoint-control
...
.. code-block:: python
   ...
   # Get monitoring data
   data = fgt.api.monitor.endpoint-control.{endpoint}.get()
