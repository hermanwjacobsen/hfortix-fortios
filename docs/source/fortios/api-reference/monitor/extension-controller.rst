...
The ``monitor.extension-controller`` category provides real-time monitoring for:
...
.. code-block:: python
   ...
   fgt.api.monitor.extension-controller
...
.. code-block:: python
   ...
   # Get monitoring data
   data = fgt.api.monitor.extension-controller.{endpoint}.get()
