...
The ``monitor.extender-controller`` category provides real-time monitoring for:
...
.. code-block:: python
   ...
   fgt.api.monitor.extender-controller
...
.. code-block:: python
   ...
   # Get monitoring data
   data = fgt.api.monitor.extender-controller.{endpoint}.get()
