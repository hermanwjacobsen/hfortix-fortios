...
The ``monitor.vpn-certificate`` category provides real-time monitoring for:
...
.. code-block:: python
   ...
   fgt.api.monitor.vpn-certificate
...
.. code-block:: python
   ...
   # Get monitoring data
   data = fgt.api.monitor.vpn-certificate.{endpoint}.get()
