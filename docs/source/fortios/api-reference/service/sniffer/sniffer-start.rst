...
.. code-block:: python
   ...
   fgt.api.service.sniffer.sniffer_start
...
.. code-block:: python
   ...
   response = fgt.api.service.sniffer.sniffer_start.get()
...
.. code-block:: python
   ...
   # Execute service operation
   response = fgt.api.service.sniffer.sniffer_start.post(data={})
