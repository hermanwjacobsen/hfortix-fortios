...
.. code-block:: python
   ...
   fgt.api.service.sniffer.sniffer_stop
...
.. code-block:: python
   ...
   response = fgt.api.service.sniffer.sniffer_stop.get()
...
.. code-block:: python
   ...
   # Execute service operation
   response = fgt.api.service.sniffer.sniffer_stop.post(data={})
