...
.. code-block:: python
   ...
   fgt.api.service.sniffer.sniffer_delete
...
.. code-block:: python
   ...
   response = fgt.api.service.sniffer.sniffer_delete.get()
...
.. code-block:: python
   ...
   # Execute service operation
   response = fgt.api.service.sniffer.sniffer_delete.post(data={})
