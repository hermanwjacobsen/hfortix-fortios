...
.. code-block:: python
   ...
   fgt.api.service.sniffer.sniffer_meta
...
.. code-block:: python
   ...
   response = fgt.api.service.sniffer.sniffer_meta.get()
...
.. code-block:: python
   ...
   # Execute service operation
   response = fgt.api.service.sniffer.sniffer_meta.post(data={})
