.. _system_system_fabric-admin-lockout-exists-on-firmware-update:

System_Fabric Admin Lockout Exists On Firmware Update
=====================================================
...
.. code-block:: python
   ...
   fgt.api.service.system.system_fabric-admin-lockout-exists-on-firmware-update
...
.. code-block:: python
   ...
   response = fgt.api.service.system.system_fabric-admin-lockout-exists-on-firmware-update.get()
