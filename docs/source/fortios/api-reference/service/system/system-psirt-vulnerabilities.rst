.. _system_system_psirt-vulnerabilities:

System_Psirt Vulnerabilities
============================
...
.. code-block:: python
   ...
   fgt.api.service.system.system_psirt-vulnerabilities
...
.. code-block:: python
   ...
   response = fgt.api.service.system.system_psirt-vulnerabilities.get()
