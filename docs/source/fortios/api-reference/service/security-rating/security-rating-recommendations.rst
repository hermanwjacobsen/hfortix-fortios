.. _security-rating_security-rating_recommendations:

Security Rating_Recommendations
===============================
...
.. code-block:: python
   ...
   fgt.api.service.security-rating.security-rating_recommendations
...
.. code-block:: python
   ...
   response = fgt.api.service.security-rating.security-rating_recommendations.get()
