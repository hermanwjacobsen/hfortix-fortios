...
.. code-block:: python
   ...
   fgt.api.cmdb.casb.saas_application
...
.. code-block:: python
   ...
   item = fgt.api.cmdb.casb.saas_application.get(name='item-name')
   ...
   # Delete item
   result = fgt.api.cmdb.casb.saas_application.delete(name='item-name')
