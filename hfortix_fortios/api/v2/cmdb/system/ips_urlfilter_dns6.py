...
class IpsUrlfilterDns6(CRUDEndpoint, MetadataMixin):
    ...
    def move(
        ...
        reference_address6: str | None = None,
        **kwargs: Any,
    ) -> Union[FortiObject, Coroutine[Any, Any, FortiObject]]:
        """
        ...
        Args:
            ...
            position: Where to move the object:
                - "before": Move before reference object (requires reference_address6)
                - "after": Move after reference object (requires reference_address6)
            ...
            reference_address6: Identifier of reference object (required for before/after)
        ...
        # Handle before/after string positions
            ...
            if reference_address6 is None:
                raise ValueError(f"reference_address6 is required when position='{position}'")
            actual_position = position
        
        # Build params for move operation
        params = {
            "action": "move",
            actual_position: reference_address6,
            **kwargs,
        }
