        ...
        **kwargs: Any,
        ...
        Args:
            ...
            position: Where to move the object:
                - "before": Move before reference object (requires reference_serial)
                - "after": Move after reference object (requires reference_serial)
            ...
            reference_serial: Identifier of reference object (required for before/after)
            vdom: Virtual domain name
        ...
        # Handle before/after string positions
            ...
            if reference_serial is None:
                raise ValueError(f"reference_serial is required when position='{position}'")
            actual_position = position
        
        # Build params for move operation
        params = {
            "action": "move",
            actual_position: reference_serial,
            **kwargs,
        }
