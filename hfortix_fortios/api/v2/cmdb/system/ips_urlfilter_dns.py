        ...
        **kwargs: Any,
        ...
        Args:
            ...
            position: Where to move the object:
                - "before": Move before reference object (requires reference_address)
                - "after": Move after reference object (requires reference_address)
            ...
            reference_address: Identifier of reference object (required for before/after)
        ...
        # Handle before/after string positions
            ...
            if reference_address is None:
                raise ValueError(f"reference_address is required when position='{position}'")
            actual_position = position
        
        # Build params for move operation
        params = {
            "action": "move",
            actual_position: reference_address,
            **kwargs,
        }
