...
class Ddns(CRUDEndpoint, MetadataMixin):
    ...
    def move(
        ...
        reference_ddnsid: int | None = None,
        **kwargs: Any,
    ) -> Union[FortiObject, Coroutine[Any, Any, FortiObject]]:
        """
        ...
        Args:
            ...
            position: Where to move the object:
                - "before": Move before reference object (requires reference_ddnsid)
                - "after": Move after reference object (requires reference_ddnsid)
            ...
            reference_ddnsid: Identifier of reference object (required for before/after)
        ...
        # Handle before/after string positions
            ...
            if reference_ddnsid is None:
                raise ValueError(f"reference_ddnsid is required when position='{position}'")
            actual_position = position
        
        # Build params for move operation
        params = {
            "action": "move",
            actual_position: reference_ddnsid,
            **kwargs,
        }
