        ...
        **kwargs: Any,
        ...
        Args:
            ...
            position: Where to move the object:
                - "before": Move before reference object (requires reference_url)
                - "after": Move after reference object (requires reference_url)
            ...
            reference_url: Identifier of reference object (required for before/after)
            vdom: Virtual domain name
        ...
        # Handle before/after string positions
            ...
            if reference_url is None:
                raise ValueError(f"reference_url is required when position='{position}'")
            actual_position = position
        
        # Build params for move operation
        params = {
            "action": "move",
            actual_position: reference_url,
            **kwargs,
        }
