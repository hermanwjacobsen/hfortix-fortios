...
class TrafficClass(CRUDEndpoint, MetadataMixin):
    ...
    def move(
        ...
        reference_class_id: int | None = None,
        vdom: str | bool | None = None,
        **kwargs: Any,
    ) -> Union[FortiObject, Coroutine[Any, Any, FortiObject]]:
        """
        ...
        Args:
            ...
            position: Where to move the object:
                - "before": Move before reference object (requires reference_class_id)
                - "after": Move after reference object (requires reference_class_id)
            ...
            reference_class_id: Identifier of reference object (required for before/after)
            vdom: Virtual domain name
        ...
        # Handle before/after string positions
            ...
            if reference_class_id is None:
                raise ValueError(f"reference_class_id is required when position='{position}'")
            actual_position = position
        
        # Build params for move operation
        params = {
            "action": "move",
            actual_position: reference_class_id,
            **kwargs,
        }
