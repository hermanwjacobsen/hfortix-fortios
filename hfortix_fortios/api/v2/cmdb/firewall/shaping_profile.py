        ...
        **kwargs: Any,
        ...
        Args:
            ...
            position: Where to move the object:
                - "before": Move before reference object (requires reference_profile_name)
                - "after": Move after reference object (requires reference_profile_name)
            ...
            reference_profile_name: Identifier of reference object (required for before/after)
            vdom: Virtual domain name
        ...
        # Handle before/after string positions
            ...
            if reference_profile_name is None:
                raise ValueError(f"reference_profile_name is required when position='{position}'")
            actual_position = position
        
        # Build params for move operation
        params = {
            "action": "move",
            actual_position: reference_profile_name,
            **kwargs,
        }
