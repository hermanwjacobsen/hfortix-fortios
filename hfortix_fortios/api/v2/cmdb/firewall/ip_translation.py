...
class IpTranslation(CRUDEndpoint, MetadataMixin):
    ...
    def move(
        ...
        reference_transid: int | None = None,
        vdom: str | bool | None = None,
        **kwargs: Any,
    ) -> Union[FortiObject, Coroutine[Any, Any, FortiObject]]:
        """
        ...
        Args:
            ...
            position: Where to move the object:
                - "before": Move before reference object (requires reference_transid)
                - "after": Move after reference object (requires reference_transid)
            ...
            reference_transid: Identifier of reference object (required for before/after)
            vdom: Virtual domain name
        ...
        # Handle before/after string positions
            ...
            if reference_transid is None:
                raise ValueError(f"reference_transid is required when position='{position}'")
            actual_position = position
        
        # Build params for move operation
        params = {
            "action": "move",
            actual_position: reference_transid,
            **kwargs,
        }
