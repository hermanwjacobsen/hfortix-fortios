...
class Policy6(CRUDEndpoint, MetadataMixin):
    ...
    def move(
        ...
        reference_seq_num: int | None = None,
        vdom: str | bool | None = None,
        **kwargs: Any,
    ) -> Union[FortiObject, Coroutine[Any, Any, FortiObject]]:
        """
        ...
        Args:
            ...
            position: Where to move the object:
                - "before": Move before reference object (requires reference_seq_num)
                - "after": Move after reference object (requires reference_seq_num)
            ...
            reference_seq_num: Identifier of reference object (required for before/after)
            vdom: Virtual domain name
        ...
        # Handle before/after string positions
            ...
            if reference_seq_num is None:
                raise ValueError(f"reference_seq_num is required when position='{position}'")
            actual_position = position
        
        # Build params for move operation
        params = {
            "action": "move",
            actual_position: reference_seq_num,
            **kwargs,
        }
