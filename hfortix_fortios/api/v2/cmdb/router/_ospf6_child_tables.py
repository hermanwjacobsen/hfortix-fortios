"""
Child Table Helpers for cmdb.router.ospf6
...
class AreaHelper:
    """
    Helper for managing area child table in cmdb.router.ospf6.
    ...
    Example:
        >>> # Get all entries
        >>> entries = fgt.api.cmdb.router.ospf6.area.get()
        
        >>> # Get specific entry
        >>> entry = fgt.api.cmdb.router.ospf6.area.get(id="value")
        
        >>> # Add or update entry
        >>> result = fgt.api.cmdb.router.ospf6.area.set(
        ...     id="value",
        ...     # ... other fields
        ... )
        
        >>> # Delete entry
        >>> result = fgt.api.cmdb.router.ospf6.area.delete(id="value")
        
        >>> # Check if entry exists
        >>> exists = fgt.api.cmdb.router.ospf6.area.exists(id="value")
        
        >>> # Replace entire table
        >>> result = fgt.api.cmdb.router.ospf6.area.put([
        ...     {'id': "value1"},
        ...     {'id': "value2"},
        ... ])
    """
    ...
    def get(
        ...
        Example:
            >>> # Get all entries
            >>> all_entries = fgt.api.cmdb.router.ospf6.area.get()
    ...
    def exists(
        ...
        Example:
            >>> if fgt.api.cmdb.router.ospf6.area.exists(id="value"):
            ...     print("Entry exists")
        """
...
class Ospf6InterfaceHelper:
    """
    Helper for managing ospf6-interface child table in cmdb.router.ospf6.
    ...
    Example:
        >>> # Get all entries
        >>> entries = fgt.api.cmdb.router.ospf6.ospf6_interface.get()
        
        >>> # Get specific entry
        >>> entry = fgt.api.cmdb.router.ospf6.ospf6_interface.get(name="value")
        
        >>> # Add or update entry
        >>> result = fgt.api.cmdb.router.ospf6.ospf6_interface.set(
        ...     name="value",
        ...     # ... other fields
        ... )
        
        >>> # Delete entry
        >>> result = fgt.api.cmdb.router.ospf6.ospf6_interface.delete(name="value")
        
        >>> # Check if entry exists
        >>> exists = fgt.api.cmdb.router.ospf6.ospf6_interface.exists(name="value")
        
        >>> # Replace entire table
        >>> result = fgt.api.cmdb.router.ospf6.ospf6_interface.put([
        ...     {'name': "value1"},
        ...     {'name': "value2"},
        ... ])
    """
    ...
    def get(
        ...
        Example:
            >>> # Get all entries
            >>> all_entries = fgt.api.cmdb.router.ospf6.ospf6_interface.get()
    ...
    def exists(
        ...
        Example:
            >>> if fgt.api.cmdb.router.ospf6.ospf6_interface.exists(name="value"):
            ...     print("Entry exists")
        """
...
class RedistributeHelper:
    """
    Helper for managing redistribute child table in cmdb.router.ospf6.
    ...
    Example:
        >>> # Get all entries
        >>> entries = fgt.api.cmdb.router.ospf6.redistribute.get()
        
        >>> # Get specific entry
        >>> entry = fgt.api.cmdb.router.ospf6.redistribute.get(name="value")
        
        >>> # Add or update entry
        >>> result = fgt.api.cmdb.router.ospf6.redistribute.set(
        ...     name="value",
        ...     # ... other fields
        ... )
        
        >>> # Delete entry
        >>> result = fgt.api.cmdb.router.ospf6.redistribute.delete(name="value")
        
        >>> # Check if entry exists
        >>> exists = fgt.api.cmdb.router.ospf6.redistribute.exists(name="value")
        
        >>> # Replace entire table
        >>> result = fgt.api.cmdb.router.ospf6.redistribute.put([
        ...     {'name': "value1"},
        ...     {'name': "value2"},
        ... ])
    """
    ...
    def get(
        ...
        Example:
            >>> # Get all entries
            >>> all_entries = fgt.api.cmdb.router.ospf6.redistribute.get()
    ...
    def exists(
        ...
        Example:
            >>> if fgt.api.cmdb.router.ospf6.redistribute.exists(name="value"):
            ...     print("Entry exists")
        """
        entry = self.get(name=name)
        return entry is not None
...
class PassiveInterfaceHelper:
    """
    Helper for managing passive-interface child table in cmdb.router.ospf6.
    ...
    Example:
        >>> # Get all entries
        >>> entries = fgt.api.cmdb.router.ospf6.passive_interface.get()
        
        >>> # Get specific entry
        >>> entry = fgt.api.cmdb.router.ospf6.passive_interface.get(name="value")
        
        >>> # Add or update entry
        >>> result = fgt.api.cmdb.router.ospf6.passive_interface.set(
        ...     name="value",
        ...     # ... other fields
        ... )
        
        >>> # Delete entry
        >>> result = fgt.api.cmdb.router.ospf6.passive_interface.delete(name="value")
        
        >>> # Check if entry exists
        >>> exists = fgt.api.cmdb.router.ospf6.passive_interface.exists(name="value")
        
        >>> # Replace entire table
        >>> result = fgt.api.cmdb.router.ospf6.passive_interface.put([
        ...     {'name': "value1"},
        ...     {'name': "value2"},
        ... ])
    """
    ...
    def get(
        ...
        Example:
            >>> # Get all entries
            >>> all_entries = fgt.api.cmdb.router.ospf6.passive_interface.get()
    ...
    def exists(
        ...
        Example:
            >>> if fgt.api.cmdb.router.ospf6.passive_interface.exists(name="value"):
            ...     print("Entry exists")
        """
        entry = self.get(name=name)
        return entry is not None
...
class SummaryAddressHelper:
    """
    Helper for managing summary-address child table in cmdb.router.ospf6.
    ...
    Example:
        >>> # Get all entries
        >>> entries = fgt.api.cmdb.router.ospf6.summary_address.get()
        
        >>> # Get specific entry
        >>> entry = fgt.api.cmdb.router.ospf6.summary_address.get(id="value")
        
        >>> # Add or update entry
        >>> result = fgt.api.cmdb.router.ospf6.summary_address.set(
        ...     id="value",
        ...     # ... other fields
        ... )
        
        >>> # Delete entry
        >>> result = fgt.api.cmdb.router.ospf6.summary_address.delete(id="value")
        
        >>> # Check if entry exists
        >>> exists = fgt.api.cmdb.router.ospf6.summary_address.exists(id="value")
        
        >>> # Replace entire table
        >>> result = fgt.api.cmdb.router.ospf6.summary_address.put([
        ...     {'id': "value1"},
        ...     {'id': "value2"},
        ... ])
    """
    ...
    def get(
        ...
        Example:
            >>> # Get all entries
            >>> all_entries = fgt.api.cmdb.router.ospf6.summary_address.get()
    ...
    def exists(
        ...
        Example:
            >>> if fgt.api.cmdb.router.ospf6.summary_address.exists(id="value"):
            ...     print("Entry exists")
        """
        entry = self.get(id=id)
        return entry is not None
