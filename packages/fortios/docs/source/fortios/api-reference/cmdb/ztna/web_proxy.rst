...
Configuration endpoint for ztna/web_proxy.
...
.. code-block:: python
   ...
   item = fgt.api.cmdb.ztna.web_proxy.get(name='item-name')
   ...
   # Delete item
   result = fgt.api.cmdb.ztna.web_proxy.delete(name='item-name')
