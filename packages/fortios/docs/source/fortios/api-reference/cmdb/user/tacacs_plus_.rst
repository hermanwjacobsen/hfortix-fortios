...
Configuration endpoint for user/tacacs_plus_.
...
.. code-block:: python
   ...
   fgt.api.cmdb.user.tacacs_plus_
...
.. code-block:: python
   ...
   item = fgt.api.cmdb.user.tacacs_plus_.get(name='item-name')
   ...
   # Delete item
   result = fgt.api.cmdb.user.tacacs_plus_.delete(name='item-name')
