...
Generated from schema: /app/dev/classes/fortinet/packages/fortios/dev/schema/7.6.5/cmdb/firewall.interface-policy6.json
Category: cmdb
...
class TestAutoInterfacePolicy6Validators:
    ...
    def auto_test_validator_create_all_required(self):
        ...
        try:
            result = validators.validate_firewall_interface_policy6_post(config)
...
TEST_CATEGORY = "cmdb"
TEST_SCHEMA = "/app/dev/classes/fortinet/packages/fortios/dev/schema/7.6.5/cmdb/firewall.interface-policy6.json"
