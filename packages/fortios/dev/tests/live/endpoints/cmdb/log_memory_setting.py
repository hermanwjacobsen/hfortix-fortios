"""
CMDB Endpoint Tests: log.memory/setting
Tests memory settings configuration (VDOM scope).
...
def test_get():
    """Get and store original memory setting config"""
    global original_config
    
    print("\n1. Getting original memory setting config...")
    result = fgt.api.cmdb.log.memory.setting.get(vdom="test")
...
def test_put_change_status():
    ...
    result = fgt.api.cmdb.log.memory.setting.put(
    ...
    # Verify change
    verify = fgt.api.cmdb.log.memory.setting.get(vdom="test")
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("\n" + "="*50)
        print("All memory setting tests passed!")
        print("="*50)
