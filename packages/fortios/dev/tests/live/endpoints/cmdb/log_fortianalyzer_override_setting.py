"""
CMDB Endpoint Tests: log.fortianalyzer/override-setting
Tests FortiAnalyzer override settings configuration.
...
def test_get():
    """Get and store original FortiAnalyzer override setting config"""
    global original_config
    
    print("\n1. Getting original FortiAnalyzer override setting config...")
    result = fgt.api.cmdb.log.fortianalyzer.override_setting.get(vdom="test")
...
def test_put_disable():
    ...
    result = fgt.api.cmdb.log.fortianalyzer.override_setting.put(
        vdom="test",
    ...
    # Verify change
    verify = fgt.api.cmdb.log.fortianalyzer.override_setting.get(vdom="test")
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("\n" + "="*50)
        print("All FortiAnalyzer override setting tests passed!")
        print("="*50)
