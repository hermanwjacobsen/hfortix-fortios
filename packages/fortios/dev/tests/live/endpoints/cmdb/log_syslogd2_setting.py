"""
CMDB Endpoint Tests: log.syslogd2/setting
Tests syslogd2 settings configuration (Global scope).
...
def test_get():
    """Get and store original syslogd2 setting config"""
    global original_config
    
    print("\n1. Getting original syslogd2 setting config...")
    result = fgt.api.cmdb.log.syslogd2.setting.get()
...
def test_put_change_status():
    ...
    result = fgt.api.cmdb.log.syslogd2.setting.put(
    ...
    # Verify change
    verify = fgt.api.cmdb.log.syslogd2.setting.get()
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("\n" + "="*50)
        print("All syslogd2 setting tests passed!")
        print("="*50)
