"""
CMDB Endpoint Tests: log.null-device/setting
Tests null-device settings configuration (VDOM scope).
...
def test_get():
    """Get and store original null-device setting config"""
    global original_config
    
    print("\n1. Getting original null-device setting config...")
    result = fgt.api.cmdb.log.null_device.setting.get(vdom="test")
...
def test_put_change_status():
    ...
    result = fgt.api.cmdb.log.null_device.setting.put(
    ...
    # Verify change
    verify = fgt.api.cmdb.log.null_device.setting.get(vdom="test")
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("\n" + "="*50)
        print("All null-device setting tests passed!")
        print("="*50)
