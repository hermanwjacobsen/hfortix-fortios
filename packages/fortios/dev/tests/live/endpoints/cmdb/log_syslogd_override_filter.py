"""
CMDB Endpoint Tests: log.syslogd/override-filter
Tests syslogd override filter configuration (VDOM scope).
...
def test_get():
    """Get and store original syslogd override filter config"""
    global original_config
    
    print("\n1. Getting original syslogd override filter config...")
    result = fgt.api.cmdb.log.syslogd.override_filter.get(vdom="test")
...
def test_put_change_severity():
    ...
    result = fgt.api.cmdb.log.syslogd.override_filter.put(
    ...
    # Verify change
    verify = fgt.api.cmdb.log.syslogd.override_filter.get(vdom="test")
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("\n" + "="*50)
        print("All syslogd override filter tests passed!")
        print("="*50)
