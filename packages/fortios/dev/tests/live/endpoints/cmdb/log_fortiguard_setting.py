"""
CMDB Endpoint Tests: log.fortiguard/setting
Tests FortiCloud global settings configuration.
...
def test_get():
    """Get and store original FortiGuard setting config"""
    global original_config
    
    print("\n1. Getting original FortiGuard setting config...")
    result = fgt.api.cmdb.log.fortiguard.setting.get()
...
def test_put_change_status():
    ...
    result = fgt.api.cmdb.log.fortiguard.setting.put(
    ...
    # Verify change
    verify = fgt.api.cmdb.log.fortiguard.setting.get()
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("\n" + "="*50)
        print("All FortiGuard setting tests passed!")
        print("="*50)
