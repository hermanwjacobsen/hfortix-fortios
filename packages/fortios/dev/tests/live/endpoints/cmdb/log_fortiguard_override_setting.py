"""
CMDB Endpoint Tests: log.fortiguard/override-setting
Tests FortiCloud override settings configuration.
...
- Change status and priority settings
...
def test_get():
    """Get and store original FortiGuard override setting config"""
    global original_config
    
    print("\n1. Getting original FortiGuard override setting config...")
    result = fgt.api.cmdb.log.fortiguard.override_setting.get(vdom="test")
...
def test_put_change_status():
    ...
    result = fgt.api.cmdb.log.fortiguard.override_setting.put(
        vdom="test",
    ...
    # Verify change
    verify = fgt.api.cmdb.log.fortiguard.override_setting.get(vdom="test")
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("\n" + "="*50)
        print("All FortiGuard override setting tests passed!")
        print("="*50)
