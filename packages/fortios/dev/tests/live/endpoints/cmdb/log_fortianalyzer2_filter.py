"""
CMDB Endpoint Tests: log.fortianalyzer2/filter
Tests FortiAnalyzer2 filter configuration.
...
def test_get():
    """Get and store original FortiAnalyzer2 filter config"""
    global original_config
    
    print("\n1. Getting original FortiAnalyzer2 filter config...")
    result = fgt.api.cmdb.log.fortianalyzer2.filter.get()
...
def test_put_change_severity():
    ...
    result = fgt.api.cmdb.log.fortianalyzer2.filter.put(
    ...
    # Verify change
    verify = fgt.api.cmdb.log.fortianalyzer2.filter.get()
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("\n" + "="*50)
        print("All FortiAnalyzer2 filter tests passed!")
        print("="*50)
