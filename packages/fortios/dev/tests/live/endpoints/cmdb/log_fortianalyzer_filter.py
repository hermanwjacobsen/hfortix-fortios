"""
CMDB Endpoint Tests: log.fortianalyzer/filter
Tests FortiAnalyzer filter configuration.
...
def test_get():
    """Get and store original FortiAnalyzer filter config"""
    global original_config
    
    print("\n1. Getting original FortiAnalyzer filter config...")
    result = fgt.api.cmdb.log.fortianalyzer.filter.get()
...
def test_put_change_severity():
    ...
    result = fgt.api.cmdb.log.fortianalyzer.filter.put(
    ...
    # Verify change
    verify = fgt.api.cmdb.log.fortianalyzer.filter.get()
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("\n" + "="*50)
        print("All FortiAnalyzer filter tests passed!")
        print("="*50)
