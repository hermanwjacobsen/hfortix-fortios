"""
CMDB Endpoint Tests: log.syslogd/override-setting
Tests syslogd override settings configuration (VDOM scope).
...
def test_get():
    """Get and store original syslogd override setting config"""
    global original_config
    
    print("\n1. Getting original syslogd override setting config...")
    result = fgt.api.cmdb.log.syslogd.override_setting.get(vdom="test")
...
def test_put_change_status():
    ...
    result = fgt.api.cmdb.log.syslogd.override_setting.put(
    ...
    # Verify change
    verify = fgt.api.cmdb.log.syslogd.override_setting.get(vdom="test")
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("\n" + "="*50)
        print("All syslogd override setting tests passed!")
        print("="*50)
