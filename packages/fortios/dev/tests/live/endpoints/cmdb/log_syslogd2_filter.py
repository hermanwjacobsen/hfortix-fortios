"""
CMDB Endpoint Tests: log.syslogd2/filter
Tests syslogd2 filter configuration (Global scope).
...
def test_get():
    """Get and store original syslogd2 filter config"""
    global original_config
    
    print("\n1. Getting original syslogd2 filter config...")
    result = fgt.api.cmdb.log.syslogd2.filter.get()
...
def test_put_change_severity():
    ...
    result = fgt.api.cmdb.log.syslogd2.filter.put(
    ...
    # Verify change
    verify = fgt.api.cmdb.log.syslogd2.filter.get()
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("\n" + "="*50)
        print("All syslogd2 filter tests passed!")
        print("="*50)
