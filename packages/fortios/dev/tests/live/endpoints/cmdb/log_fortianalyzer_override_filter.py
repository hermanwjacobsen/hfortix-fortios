"""
CMDB Endpoint Tests: log.fortianalyzer/override-filter
Tests FortiAnalyzer override filter configuration.
...
def test_get():
    """Get and store original FortiAnalyzer override filter config"""
    global original_config
    
    print("\n1. Getting original FortiAnalyzer override filter config...")
    result = fgt.api.cmdb.log.fortianalyzer.override_filter.get(vdom="test")
...
def test_put_change_severity():
    ...
    result = fgt.api.cmdb.log.fortianalyzer.override_filter.put(
        vdom="test",
    ...
    # Verify change
    verify = fgt.api.cmdb.log.fortianalyzer.override_filter.get(vdom="test")
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("\n" + "="*50)
        print("All FortiAnalyzer override filter tests passed!")
        print("="*50)
