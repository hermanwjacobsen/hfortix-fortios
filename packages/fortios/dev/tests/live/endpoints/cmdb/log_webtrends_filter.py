"""
CMDB Endpoint Tests: log.webtrends/filter
Tests WebTrends filter configuration (Global scope).
...
def test_get():
    """Get and store original WebTrends filter config"""
    global original_config
    
    print("\n1. Getting original WebTrends filter config...")
...
def test_put_change_severity():
    ...
    result = fgt.api.cmdb.log.webtrends.filter.put(
    ...
    # Verify change
    verify = fgt.api.cmdb.log.webtrends.filter.get()
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("\n" + "="*50)
        print("All WebTrends filter tests passed!")
        print("="*50)
