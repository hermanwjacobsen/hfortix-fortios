"""
CMDB Endpoint Tests: log.syslogd2/override-filter
Tests syslogd2 override filter configuration (VDOM scope).
...
def test_get():
    """Get and store original syslogd2 override filter config"""
    global original_config
    
    print("\n1. Getting original syslogd2 override filter config...")
    result = fgt.api.cmdb.log.syslogd2.override_filter.get(vdom="test")
    ...
    print(f"✓ Original severity: {original_config['severity']}, voip: {original_config['voip']}")
...
def test_put_change_severity():
    ...
    result = fgt.api.cmdb.log.syslogd2.override_filter.put(
    ...
    # Verify change
    verify = fgt.api.cmdb.log.syslogd2.override_filter.get(vdom="test")
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("\n" + "="*50)
        print("All syslogd2 override filter tests passed!")
        print("="*50)
