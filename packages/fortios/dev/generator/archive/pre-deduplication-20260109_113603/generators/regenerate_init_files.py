...
def regenerate_category_init(category_dir: Path, base_dir: Path, skip_wrapper_subdirs: set | None = None):
...
if __name__ == "__main__":
    ...
    for api_type in api_types:
        ...
        for category_dir in sorted(category_dirs):
            wrapper_subdirs = regenerate_category_init(category_dir, base_dir) or set()
