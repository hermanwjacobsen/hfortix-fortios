...
class List:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        cache_key = f"service/sniffer/list"
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update existing sniffer/list object.
        ...
        Examples:
            ...
            >>> result = fgt.api.service.sniffer_list.put(
            ...
            ...     "field1": "new-value",
            ... }
            >>> result = fgt.api.service.sniffer_list.put(payload_dict=payload)
        ...
        endpoint = f"/sniffer/list/{name_value}"
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new sniffer/list object.
        ...
        Examples:
            ...
            >>> result = fgt.api.service.sniffer_list.post(payload_dict=payload)
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> result = fgt.api.service.sniffer_list.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.service.sniffer_list.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.service.sniffer_list.exists(name="old-object"):
            ...     fgt.api.service.sniffer_list.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update sniffer/list object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.service.sniffer_list.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.service.sniffer_list.set(payload_dict=obj_data)
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(List.help("name"))
        """
        from ._helpers.list import (
            get_schema_info,
            get_field_metadata,
        )
    ...
    def fields(detailed: bool = False) -> Union[list[str], dict[str, dict]]:
        ...
        Examples:
            ...
            >>> # Detailed info
            >>> fields = List.fields(detailed=True)
            >>> for name, meta in fields.items():
            ...     print(f"{name}: {meta['type']}")
        """
        from ._helpers.list import get_all_fields, get_field_metadata
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = List.field_info("name")
            >>> print(f"Type: {info['type']}")
            >>> if 'options' in info:
            ...     print(f"Options: {info['options']}")
        """
        from ._helpers.list import get_field_metadata
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = List.validate_field("name", "test")
            >>> if not is_valid:
            ...     print(f"Validation error: {error}")
        """
        from ._helpers.list import validate_field_value
    ...
    def required_fields() -> list[str]:
        ...
        """
        from ._helpers.list import REQUIRED_FIELDS
    ...
    def defaults() -> dict[str, Any]:
        ...
        """
        from ._helpers.list import FIELDS_WITH_DEFAULTS
    ...
    def schema() -> dict[str, Any]:
        ...
        """
        from ._helpers.list import get_schema_info
