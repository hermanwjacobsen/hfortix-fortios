...
class DownloadPayload(TypedDict, total=False):
    """
    Type hints for sniffer/download payload fields.
...
class DownloadResponse(TypedDict):
    """
    Type hints for sniffer/download API response fields.
...
class DownloadObject:
    """Typed FortiObject for sniffer/download with IDE autocomplete support.
