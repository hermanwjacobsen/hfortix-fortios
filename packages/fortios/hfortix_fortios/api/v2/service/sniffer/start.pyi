...
class StartPayload(TypedDict, total=False):
    """
    Type hints for sniffer/start payload fields.
...
class StartResponse(TypedDict):
    """
    Type hints for sniffer/start API response fields.
...
@final
class StartObject:
    """Typed FortiObject for sniffer/start with IDE autocomplete support.
