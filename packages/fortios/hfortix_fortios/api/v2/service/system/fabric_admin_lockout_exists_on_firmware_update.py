...
class FabricAdminLockoutExistsOnFirmwareUpdate:
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update existing system/fabric_admin_lockout_exists_on_firmware_update object.
        ...
        Examples:
            ...
            >>> result = fgt.api.service.system_fabric_admin_lockout_exists_on_firmware_update.put(
            ...
            ...     "field1": "new-value",
            ... }
            >>> result = fgt.api.service.system_fabric_admin_lockout_exists_on_firmware_update.put(payload_dict=payload)
        ...
        from ._helpers.fabric_admin_lockout_exists_on_firmware_update import DEPRECATED_FIELDS
        if DEPRECATED_FIELDS:
            from hfortix_core import check_deprecated_fields
            check_deprecated_fields(
                payload=payload_data,
                deprecated_fields=DEPRECATED_FIELDS,
                endpoint="service/system/fabric_admin_lockout_exists_on_firmware_update",
            )
        
        name_value = payload_data.get("name")
        if not name_value:
            raise ValueError("name is required for PUT")
        endpoint = f"/system/fabric-admin-lockout-exists-on-firmware-update/{name_value}"
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new system/fabric_admin_lockout_exists_on_firmware_update object.
        ...
        Examples:
            ...
            >>> payload = FabricAdminLockoutExistsOnFirmwareUpdate.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.service.system_fabric_admin_lockout_exists_on_firmware_update.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(FabricAdminLockoutExistsOnFirmwareUpdate.required_fields()) }}
            
            Use FabricAdminLockoutExistsOnFirmwareUpdate.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete system/fabric_admin_lockout_exists_on_firmware_update object.
        ...
        Examples:
            ...
            >>> result = fgt.api.service.system_fabric_admin_lockout_exists_on_firmware_update.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.service.system_fabric_admin_lockout_exists_on_firmware_update.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.service.system_fabric_admin_lockout_exists_on_firmware_update.exists(name="old-object"):
            ...     fgt.api.service.system_fabric_admin_lockout_exists_on_firmware_update.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update system/fabric_admin_lockout_exists_on_firmware_update object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.service.system_fabric_admin_lockout_exists_on_firmware_update.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.service.system_fabric_admin_lockout_exists_on_firmware_update.set(payload_dict=obj_data)
