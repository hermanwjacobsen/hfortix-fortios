...
class DataTypePayload(TypedDict, total=False):
    ...
    **Usage:**
    ...
    match_around: NotRequired[str]  # Dictionary to check whether it has a match around
    look_back: int  # Number of characters required to save for verification
    look_ahead: int  # Number of characters to obtain in advance for verification
    match_back: int  # Number of characters in front for match-around
    match_ahead: int  # Number of characters behind for match-around
...
class DataTypeObject:
    ...
    verify2: str
    # Dictionary to check whether it has a match around
    match_around: str
