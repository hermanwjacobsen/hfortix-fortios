...
class SettingsPayload(TypedDict, total=False):
    ...
    **Usage:**
    ...
    config_builder_timeout: NotRequired[int]  # Maximum time allowed for building a single DLP profile
...
class SettingsObject:
    ...
    db_mode: Literal["stop-adding", "remove-modified-then-oldest", "remove-oldest"]
    # Maximum percentage of available memory allocated to caching DLP fingerprints
    cache_mem_percent: int
