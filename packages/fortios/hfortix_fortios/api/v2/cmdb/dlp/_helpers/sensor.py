...
def validate_dlp_sensor_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_dlp_sensor_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_dlp_sensor_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for dlp/sensor.
...
def validate_dlp_sensor_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "name": True,  # Name of table containing the sensor.
        ...     "entries": True,  # DLP sensor entries.
        ... }
        ...
        >>> payload["match-type"] = "invalid-value"
        >>> is_valid, error = validate_dlp_sensor_post(payload)
...
def validate_dlp_sensor_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_dlp_sensor_put(payload)
    """
