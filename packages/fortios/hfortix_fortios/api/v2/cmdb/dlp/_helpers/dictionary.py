...
def validate_dlp_dictionary_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_dlp_dictionary_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_dlp_dictionary_get(name="test-item")
        >>> assert is_valid == True
...
def validate_dlp_dictionary_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "name": True,  # Name of table containing the dictionary.
        ...     "entries": True,  # DLP dictionary entries.
        ... }
...
def validate_dlp_dictionary_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_dlp_dictionary_put(payload)
    """
