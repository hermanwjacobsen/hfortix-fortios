...
REQUIRED_FIELDS = [
    "look-ahead",  # Number of characters to obtain in advance for verification (
    "look-back",  # Number of characters required to save for verification (1 -
    "match-ahead",  # Number of characters behind for match-around (1 - 4096, defa
    "match-back",  # Number of characters in front for match-around (1 - 4096, de
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for dlp_data-type.
