...
def validate_dlp_exact_data_match_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_dlp_exact_data_match_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_dlp_exact_data_match_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for dlp/exact_data_match.
...
def validate_dlp_exact_data_match_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "name": True,  # Name of table containing the exact-data-match temp
        ...     "data": True,  # External resource for exact data match.
        ... }
        >>> is_valid, error = validate_dlp_exact_data_match_post(payload)
        >>> assert is_valid == True
...
def validate_dlp_exact_data_match_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_dlp_exact_data_match_put(payload)
    """
