...
def validate_waf_profile_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_waf_profile_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_waf_profile_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for waf/profile.
...
def validate_waf_profile_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload["external"] = "invalid-value"
        >>> is_valid, error = validate_waf_profile_post(payload)
...
def validate_waf_profile_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_waf_profile_put(payload)
    """
