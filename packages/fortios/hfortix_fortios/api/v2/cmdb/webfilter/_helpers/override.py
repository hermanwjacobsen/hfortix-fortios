...
def validate_webfilter_override_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_webfilter_override_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by id
        >>> is_valid, error = validate_webfilter_override_get(id="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for webfilter/override.
...
def validate_webfilter_override_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "user": True,  # Name of the user which the override applies.
        ...     "user-group": True,  # Specify the user group for which the override appl
        ... }
...
def validate_webfilter_override_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_webfilter_override_put(payload)
    """
