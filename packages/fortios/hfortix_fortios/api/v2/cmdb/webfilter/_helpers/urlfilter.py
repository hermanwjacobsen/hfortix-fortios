...
def validate_webfilter_urlfilter_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_webfilter_urlfilter_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by id
        >>> is_valid, error = validate_webfilter_urlfilter_get(id="test-item")
        >>> assert is_valid == True
...
def validate_webfilter_urlfilter_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "name": True,  # Name of URL filter list.
        ...     "entries": True,  # URL filter entries.
        ... }
        ...
        >>> payload["one-arm-ips-urlfilter"] = "invalid-value"
        >>> is_valid, error = validate_webfilter_urlfilter_post(payload)
...
def validate_webfilter_urlfilter_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_webfilter_urlfilter_put(payload)
    """
