...
class IpsUrlfilterSetting6:
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new webfilter/ips_urlfilter_setting6 object.
        ...
        Examples:
            ...
            >>> payload = IpsUrlfilterSetting6.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.cmdb.webfilter_ips_urlfilter_setting6.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(IpsUrlfilterSetting6.required_fields()) }}
            
            Use IpsUrlfilterSetting6.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete webfilter/ips_urlfilter_setting6 object.
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.webfilter_ips_urlfilter_setting6.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.cmdb.webfilter_ips_urlfilter_setting6.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.cmdb.webfilter_ips_urlfilter_setting6.exists(name="old-object"):
            ...     fgt.api.cmdb.webfilter_ips_urlfilter_setting6.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update webfilter/ips_urlfilter_setting6 object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.cmdb.webfilter_ips_urlfilter_setting6.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.cmdb.webfilter_ips_urlfilter_setting6.set(payload_dict=obj_data)
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(IpsUrlfilterSetting6.help())
            
            >>> # Get field information
            >>> print(IpsUrlfilterSetting6.help("device"))
        """
        from ._helpers.ips_urlfilter_setting6 import (
            get_schema_info,
            get_field_metadata,
        )
    ...
    def fields(detailed: bool = False) -> Union[list[str], dict[str, dict]]:
        ...
        Examples:
            >>> # Simple list
            >>> fields = IpsUrlfilterSetting6.fields()
            >>> print(f"Available fields: {len(fields)}")
            
            >>> # Detailed info
            >>> fields = IpsUrlfilterSetting6.fields(detailed=True)
            >>> for name, meta in fields.items():
            ...     print(f"{name}: {meta['type']}")
        """
        from ._helpers.ips_urlfilter_setting6 import get_all_fields, get_field_metadata
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = IpsUrlfilterSetting6.field_info("device")
            >>> print(f"Type: {info['type']}")
            >>> if 'options' in info:
            ...     print(f"Options: {info['options']}")
        """
        from ._helpers.ips_urlfilter_setting6 import get_field_metadata
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = IpsUrlfilterSetting6.validate_field("device", "test")
            >>> if not is_valid:
            ...     print(f"Validation error: {error}")
        """
        from ._helpers.ips_urlfilter_setting6 import validate_field_value
    ...
    def required_fields() -> list[str]:
        ...
        Examples:
            >>> required = IpsUrlfilterSetting6.required_fields()
            >>> print(f"Required fields: {', '.join(required)}")
        """
        from ._helpers.ips_urlfilter_setting6 import REQUIRED_FIELDS
    ...
    def defaults() -> dict[str, Any]:
        ...
        Examples:
            >>> defaults = IpsUrlfilterSetting6.defaults()
            >>> print(f"Fields with defaults: {len(defaults)}")
            >>> # Use as starting point for payload
            >>> payload = defaults.copy()
            >>> payload['name'] = 'my-custom-name'
        """
        from ._helpers.ips_urlfilter_setting6 import FIELDS_WITH_DEFAULTS
    ...
    def schema() -> dict[str, Any]:
        ...
        Examples:
            >>> schema = IpsUrlfilterSetting6.schema()
            >>> print(f"Endpoint: {schema['endpoint']}")
            >>> print(f"Total fields: {schema['total_fields']}")
            >>> print(f"Primary key: {schema.get('mkey', 'N/A')}")
        """
        from ._helpers.ips_urlfilter_setting6 import get_schema_info
