"""
Validation helpers for sctp_filter/profile endpoint.
...
def validate_sctp_filter_profile_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_sctp_filter_profile_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_sctp_filter_profile_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for sctp_filter/profile.
...
def validate_sctp_filter_profile_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        ... }
        >>> is_valid, error = validate_sctp_filter_profile_post(payload)
        >>> assert is_valid == True
...
def validate_sctp_filter_profile_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_sctp_filter_profile_put(payload)
    """
