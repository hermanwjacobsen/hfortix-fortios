"""
Validation helpers for ips/global_setting endpoint.
...
def validate_ips_global_setting_get(
    attr: str | None = None,
    filters: dict[str, Any] | None = None,
    **params: Any,
) -> tuple[bool, str | None]:
    """
    Validate GET request parameters for ips/global_setting.
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_ips_global_setting_get()
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for ips/global_setting.
...
def validate_ips_global_setting_post(
    payload: dict,
    **params: Any,
) -> tuple[bool, str | None]:
    """
    Validate POST request to create new ips/global_setting object.
    ...
    Examples:
        ...
        >>> payload = {
        ... }
        >>> is_valid, error = validate_ips_global_setting_post(payload)
        >>> assert is_valid == True
        
        >>> # ✅ Valid - With enum field
        >>> payload = {
        ...     "fail-open": "enable",  # Valid enum value
        ... }
        >>> is_valid, error = validate_ips_global_setting_post(payload)
        >>> assert is_valid == True
        
        >>> # ❌ Invalid - Wrong enum value
        >>> payload["fail-open"] = "invalid-value"
        >>> is_valid, error = validate_ips_global_setting_post(payload)
...
def validate_ips_global_setting_put(
    payload: dict,
    **params: Any,
) -> tuple[bool, str | None]:
    """
    Validate PUT request to update ips/global_setting.
    ...
    Example:
        ...
        >>> is_valid, error = validate_ips_global_setting_put(payload)
    """
