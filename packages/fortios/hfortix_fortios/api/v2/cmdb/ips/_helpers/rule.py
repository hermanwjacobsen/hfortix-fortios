...
def validate_ips_rule_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_ips_rule_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_ips_rule_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for ips/rule.
...
def validate_ips_rule_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ... }
        >>> is_valid, error = validate_ips_rule_post(payload)
        >>> assert is_valid == True
...
def validate_ips_rule_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_ips_rule_put(payload)
    """
