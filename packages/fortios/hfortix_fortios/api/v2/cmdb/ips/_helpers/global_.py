...
def validate_ips_global__get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_ips_global__get()
...
def validate_ips_global__post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ... }
        >>> is_valid, error = validate_ips_global__post(payload)
        >>> assert is_valid == True
        
        >>> # ✅ Valid - With enum field
        >>> payload = {
        ...     "fail-open": "{'name': 'enable', 'help': 'Enable IPS fail open.', 'label': 'Enable', 'description': 'Enable IPS fail open'}",  # Valid enum value
        ... }
        >>> is_valid, error = validate_ips_global__post(payload)
        >>> assert is_valid == True
...
def validate_ips_global__put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_ips_global__put(payload)
    """
