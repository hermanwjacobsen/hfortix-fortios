...
def validate_ips_custom_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_ips_custom_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by tag
        >>> is_valid, error = validate_ips_custom_get(tag="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for ips/custom.
...
def validate_ips_custom_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ... }
        >>> is_valid, error = validate_ips_custom_post(payload)
        >>> assert is_valid == True
        
        >>> # ✅ Valid - With enum field
        >>> payload = {
        ...     "status": "{'name': 'disable', 'help': 'Disable status.', 'label': 'Disable', 'description': 'Disable status'}",  # Valid enum value
        ... }
        >>> is_valid, error = validate_ips_custom_post(payload)
        >>> assert is_valid == True
...
def validate_ips_custom_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_ips_custom_put(payload)
    """
