...
class Settings:
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new ips/settings object.
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.ips_settings.post(payload_dict=payload)
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.ips_settings.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.cmdb.ips_settings.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.cmdb.ips_settings.exists(name="old-object"):
            ...     fgt.api.cmdb.ips_settings.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update ips/settings object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.cmdb.ips_settings.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.cmdb.ips_settings.set(payload_dict=obj_data)
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(Settings.help("packet-log-history"))
        """
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = Settings.field_info("packet-log-history")
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = Settings.validate_field("packet-log-history", "test")
            >>> if not is_valid:
