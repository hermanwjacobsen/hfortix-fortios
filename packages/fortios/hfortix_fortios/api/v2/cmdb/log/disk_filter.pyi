...
class DiskFilterPayload(TypedDict, total=False):
    """
    Type hints for log/disk_filter payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: DiskFilterPayload = {
            "field": "value",  # <- autocomplete shows all fields
        }
    """
    severity: NotRequired[Literal["emergency", "alert", "critical", "error", "warning", "notification", "information", "debug"]]  # Log to disk every message above and including this severity 
...
class DiskFilter:
    ...
    def post(
        self,
        payload_dict: DiskFilterPayload | None = ...,
