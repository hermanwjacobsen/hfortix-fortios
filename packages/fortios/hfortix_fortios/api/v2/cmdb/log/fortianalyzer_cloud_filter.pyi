...
class FortianalyzerCloudFilterPayload(TypedDict, total=False):
    """
    Type hints for log/fortianalyzer_cloud_filter payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: FortianalyzerCloudFilterPayload = {
...
class FortianalyzerCloudFilter:
    ...
    Path: log/fortianalyzer_cloud_filter
    Category: cmdb
    """
    ...
    def post(
        self,
        payload_dict: FortianalyzerCloudFilterPayload | None = ...,
