...
class GuiDisplayObject:
    ...
    # Enable/disable resolving IP addresses to hostname in log messages on the GUI usi
    resolve_hosts: Literal["enable", "disable"]
    # Resolve unknown applications on the GUI using Fortinet's remote application data
    resolve_apps: Literal["enable", "disable"]
