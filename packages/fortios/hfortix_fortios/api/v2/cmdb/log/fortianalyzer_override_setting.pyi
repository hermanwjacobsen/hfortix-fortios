...
class FortianalyzerOverrideSettingPayload(TypedDict, total=False):
    """
    Type hints for log/fortianalyzer_override_setting payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: FortianalyzerOverrideSettingPayload = {
...
class FortianalyzerOverrideSetting:
    ...
    Path: log/fortianalyzer_override_setting
    Category: cmdb
    """
    ...
    def post(
        self,
        payload_dict: FortianalyzerOverrideSettingPayload | None = ...,
