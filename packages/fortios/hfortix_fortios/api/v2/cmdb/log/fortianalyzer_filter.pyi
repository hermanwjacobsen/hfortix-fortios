...
class FortianalyzerFilterPayload(TypedDict, total=False):
    """
    Type hints for log/fortianalyzer_filter payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: FortianalyzerFilterPayload = {
...
class FortianalyzerFilter:
    ...
    def post(
        self,
        payload_dict: FortianalyzerFilterPayload | None = ...,
