...
class Fortianalyzer3OverrideFilterPayload(TypedDict, total=False):
    """
    Type hints for log/fortianalyzer3_override_filter payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: Fortianalyzer3OverrideFilterPayload = {
...
class Fortianalyzer3OverrideFilter:
    ...
    Path: log/fortianalyzer3_override_filter
    Category: cmdb
    """
    ...
    def post(
        self,
        payload_dict: Fortianalyzer3OverrideFilterPayload | None = ...,
