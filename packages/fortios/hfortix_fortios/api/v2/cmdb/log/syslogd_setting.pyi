...
class SyslogdSettingPayload(TypedDict, total=False):
    """
    Type hints for log/syslogd_setting payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: SyslogdSettingPayload = {
...
class SyslogdSetting:
    ...
    def post(
        self,
        payload_dict: SyslogdSettingPayload | None = ...,
