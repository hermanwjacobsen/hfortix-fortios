...
class Fortianalyzer3FilterPayload(TypedDict, total=False):
    """
    Type hints for log/fortianalyzer3_filter payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: Fortianalyzer3FilterPayload = {
...
class Fortianalyzer3Filter:
    ...
    Path: log/fortianalyzer3_filter
    Category: cmdb
    """
    ...
    def post(
        self,
        payload_dict: Fortianalyzer3FilterPayload | None = ...,
