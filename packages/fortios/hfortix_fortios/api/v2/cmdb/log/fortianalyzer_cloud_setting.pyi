...
class FortianalyzerCloudSettingPayload(TypedDict, total=False):
    """
    Type hints for log/fortianalyzer_cloud_setting payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: FortianalyzerCloudSettingPayload = {
...
class FortianalyzerCloudSetting:
    ...
    Path: log/fortianalyzer_cloud_setting
    Category: cmdb
    """
    ...
    def post(
        self,
        payload_dict: FortianalyzerCloudSettingPayload | None = ...,
