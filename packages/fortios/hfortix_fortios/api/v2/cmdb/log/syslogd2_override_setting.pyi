...
class Syslogd2OverrideSettingPayload(TypedDict, total=False):
    """
    Type hints for log/syslogd2_override_setting payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: Syslogd2OverrideSettingPayload = {
...
class Syslogd2OverrideSetting:
    ...
    Path: log/syslogd2_override_setting
    Category: cmdb
    """
    ...
    def post(
        self,
        payload_dict: Syslogd2OverrideSettingPayload | None = ...,
