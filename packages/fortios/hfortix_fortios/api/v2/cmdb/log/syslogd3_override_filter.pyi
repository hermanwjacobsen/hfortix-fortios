...
class Syslogd3OverrideFilterPayload(TypedDict, total=False):
    """
    Type hints for log/syslogd3_override_filter payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: Syslogd3OverrideFilterPayload = {
...
class Syslogd3OverrideFilter:
    ...
    Path: log/syslogd3_override_filter
    Category: cmdb
    """
    ...
    def post(
        self,
        payload_dict: Syslogd3OverrideFilterPayload | None = ...,
