...
class Syslogd4OverrideFilterPayload(TypedDict, total=False):
    """
    Type hints for log/syslogd4_override_filter payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: Syslogd4OverrideFilterPayload = {
...
class Syslogd4OverrideFilter:
    ...
    Path: log/syslogd4_override_filter
    Category: cmdb
    """
    ...
    def post(
        self,
        payload_dict: Syslogd4OverrideFilterPayload | None = ...,
