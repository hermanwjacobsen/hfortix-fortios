...
class FortiguardOverrideFilterPayload(TypedDict, total=False):
    """
    Type hints for log/fortiguard_override_filter payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: FortiguardOverrideFilterPayload = {
...
class FortiguardOverrideFilter:
    ...
    Path: log/fortiguard_override_filter
    Category: cmdb
    """
    ...
    def post(
        self,
        payload_dict: FortiguardOverrideFilterPayload | None = ...,
