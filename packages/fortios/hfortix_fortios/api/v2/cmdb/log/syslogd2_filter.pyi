...
class Syslogd2FilterPayload(TypedDict, total=False):
    """
    Type hints for log/syslogd2_filter payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: Syslogd2FilterPayload = {
...
class Syslogd2Filter:
    ...
    def post(
        self,
        payload_dict: Syslogd2FilterPayload | None = ...,
