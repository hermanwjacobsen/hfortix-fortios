...
class FortianalyzerCloudOverrideFilterPayload(TypedDict, total=False):
    """
    Type hints for log/fortianalyzer_cloud_override_filter payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: FortianalyzerCloudOverrideFilterPayload = {
...
class FortianalyzerCloudOverrideFilter:
    ...
    Path: log/fortianalyzer_cloud_override_filter
    Category: cmdb
    """
    ...
    def post(
        self,
        payload_dict: FortianalyzerCloudOverrideFilterPayload | None = ...,
