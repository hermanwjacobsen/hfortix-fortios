...
class Fortianalyzer2OverrideSettingPayload(TypedDict, total=False):
    """
    Type hints for log/fortianalyzer2_override_setting payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: Fortianalyzer2OverrideSettingPayload = {
...
class Fortianalyzer2OverrideSetting:
    ...
    Path: log/fortianalyzer2_override_setting
    Category: cmdb
    """
    ...
    def post(
        self,
        payload_dict: Fortianalyzer2OverrideSettingPayload | None = ...,
