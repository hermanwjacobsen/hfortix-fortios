...
class MemoryFilterPayload(TypedDict, total=False):
    """
    Type hints for log/memory_filter payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: MemoryFilterPayload = {
...
class MemoryFilter:
    ...
    def post(
        self,
        payload_dict: MemoryFilterPayload | None = ...,
