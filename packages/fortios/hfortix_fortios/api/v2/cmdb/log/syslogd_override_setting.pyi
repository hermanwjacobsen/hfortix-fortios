...
class SyslogdOverrideSettingPayload(TypedDict, total=False):
    """
    Type hints for log/syslogd_override_setting payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: SyslogdOverrideSettingPayload = {
...
class SyslogdOverrideSetting:
    ...
    Path: log/syslogd_override_setting
    Category: cmdb
    """
    ...
    def post(
        self,
        payload_dict: SyslogdOverrideSettingPayload | None = ...,
