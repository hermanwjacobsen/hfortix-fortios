...
class NullDeviceFilterPayload(TypedDict, total=False):
    """
    Type hints for log/null_device_filter payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: NullDeviceFilterPayload = {
...
class NullDeviceFilter:
    ...
    def post(
        self,
        payload_dict: NullDeviceFilterPayload | None = ...,
