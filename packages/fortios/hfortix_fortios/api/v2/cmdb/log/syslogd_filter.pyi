...
class SyslogdFilterPayload(TypedDict, total=False):
    """
    Type hints for log/syslogd_filter payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: SyslogdFilterPayload = {
...
class SyslogdFilter:
    ...
    def post(
        self,
        payload_dict: SyslogdFilterPayload | None = ...,
