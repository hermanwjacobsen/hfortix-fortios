...
class WebtrendsFilterPayload(TypedDict, total=False):
    """
    Type hints for log/webtrends_filter payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: WebtrendsFilterPayload = {
...
class WebtrendsFilter:
    ...
    def post(
        self,
        payload_dict: WebtrendsFilterPayload | None = ...,
