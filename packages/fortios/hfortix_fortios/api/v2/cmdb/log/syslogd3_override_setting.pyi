...
class Syslogd3OverrideSettingPayload(TypedDict, total=False):
    """
    Type hints for log/syslogd3_override_setting payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: Syslogd3OverrideSettingPayload = {
...
class Syslogd3OverrideSetting:
    ...
    Path: log/syslogd3_override_setting
    Category: cmdb
    """
    ...
    def post(
        self,
        payload_dict: Syslogd3OverrideSettingPayload | None = ...,
