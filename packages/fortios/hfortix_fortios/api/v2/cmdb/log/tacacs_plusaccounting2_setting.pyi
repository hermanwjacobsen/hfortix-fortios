...
class TacacsPlusaccounting2SettingPayload(TypedDict, total=False):
    """
    Type hints for log/tacacs_plusaccounting2_setting payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: TacacsPlusaccounting2SettingPayload = {
...
class TacacsPlusaccounting2Setting:
    ...
    Path: log/tacacs_plusaccounting2_setting
    Category: cmdb
    """
    ...
    def post(
        self,
        payload_dict: TacacsPlusaccounting2SettingPayload | None = ...,
