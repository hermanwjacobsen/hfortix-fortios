...
class TacacsPlusaccounting3SettingPayload(TypedDict, total=False):
    """
    Type hints for log/tacacs_plusaccounting3_setting payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: TacacsPlusaccounting3SettingPayload = {
...
class TacacsPlusaccounting3Setting:
    ...
    Path: log/tacacs_plusaccounting3_setting
    Category: cmdb
    """
    ...
    def post(
        self,
        payload_dict: TacacsPlusaccounting3SettingPayload | None = ...,
