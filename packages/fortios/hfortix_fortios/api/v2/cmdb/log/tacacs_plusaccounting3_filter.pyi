...
class TacacsPlusaccounting3FilterPayload(TypedDict, total=False):
    """
    Type hints for log/tacacs_plusaccounting3_filter payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: TacacsPlusaccounting3FilterPayload = {
...
class TacacsPlusaccounting3Filter:
    ...
    Path: log/tacacs_plusaccounting3_filter
    Category: cmdb
    """
    ...
    def post(
        self,
        payload_dict: TacacsPlusaccounting3FilterPayload | None = ...,
