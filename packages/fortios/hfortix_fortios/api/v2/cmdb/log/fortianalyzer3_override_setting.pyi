...
class Fortianalyzer3OverrideSettingPayload(TypedDict, total=False):
    """
    Type hints for log/fortianalyzer3_override_setting payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: Fortianalyzer3OverrideSettingPayload = {
...
class Fortianalyzer3OverrideSetting:
    ...
    Path: log/fortianalyzer3_override_setting
    Category: cmdb
    """
    ...
    def post(
        self,
        payload_dict: Fortianalyzer3OverrideSettingPayload | None = ...,
