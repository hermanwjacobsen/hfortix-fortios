...
class Syslogd2OverrideFilterPayload(TypedDict, total=False):
    """
    Type hints for log/syslogd2_override_filter payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: Syslogd2OverrideFilterPayload = {
...
class Syslogd2OverrideFilter:
    ...
    Path: log/syslogd2_override_filter
    Category: cmdb
    """
    ...
    def post(
        self,
        payload_dict: Syslogd2OverrideFilterPayload | None = ...,
