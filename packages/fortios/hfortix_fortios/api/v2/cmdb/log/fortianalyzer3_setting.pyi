...
class Fortianalyzer3SettingPayload(TypedDict, total=False):
    """
    Type hints for log/fortianalyzer3_setting payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: Fortianalyzer3SettingPayload = {
...
class Fortianalyzer3Setting:
    ...
    Path: log/fortianalyzer3_setting
    Category: cmdb
    """
    ...
    def post(
        self,
        payload_dict: Fortianalyzer3SettingPayload | None = ...,
