...
class DiskSettingPayload(TypedDict, total=False):
    """
    Type hints for log/disk_setting payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: DiskSettingPayload = {
...
class DiskSetting:
    ...
    def post(
        self,
        payload_dict: DiskSettingPayload | None = ...,
