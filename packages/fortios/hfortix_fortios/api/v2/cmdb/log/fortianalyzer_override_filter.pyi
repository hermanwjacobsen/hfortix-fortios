...
class FortianalyzerOverrideFilterPayload(TypedDict, total=False):
    """
    Type hints for log/fortianalyzer_override_filter payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: FortianalyzerOverrideFilterPayload = {
...
class FortianalyzerOverrideFilter:
    ...
    Path: log/fortianalyzer_override_filter
    Category: cmdb
    """
    ...
    def post(
        self,
        payload_dict: FortianalyzerOverrideFilterPayload | None = ...,
