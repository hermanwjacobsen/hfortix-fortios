...
class FortianalyzerSettingPayload(TypedDict, total=False):
    """
    Type hints for log/fortianalyzer_setting payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: FortianalyzerSettingPayload = {
...
class FortianalyzerSetting:
    ...
    Path: log/fortianalyzer_setting
    Category: cmdb
    """
    ...
    def post(
        self,
        payload_dict: FortianalyzerSettingPayload | None = ...,
