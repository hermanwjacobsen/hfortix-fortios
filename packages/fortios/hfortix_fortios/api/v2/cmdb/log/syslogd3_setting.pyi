...
class Syslogd3SettingPayload(TypedDict, total=False):
    """
    Type hints for log/syslogd3_setting payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: Syslogd3SettingPayload = {
...
class Syslogd3Setting:
    ...
    def post(
        self,
        payload_dict: Syslogd3SettingPayload | None = ...,
