...
class FortiguardFilterPayload(TypedDict, total=False):
    """
    Type hints for log/fortiguard_filter payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: FortiguardFilterPayload = {
...
class FortiguardFilter:
    ...
    def post(
        self,
        payload_dict: FortiguardFilterPayload | None = ...,
