...
def validate_log_memory_global_setting_get(
    ...
    **params: Any,
    ...
    """
    Validate GET request parameters for log/memory_global_setting.
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_log_memory_global_setting_get()
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for log/memory_global_setting.
...
def validate_log_memory_global_setting_post(
    ...
    **params: Any,
    ...
    """
    Validate POST request to create new log/memory_global_setting object.
    ...
    Examples:
        ...
        >>> payload = {
        ... }
        >>> is_valid, error = validate_log_memory_global_setting_post(payload)
        >>> assert is_valid == True
...
def validate_log_memory_global_setting_put(
    ...
    **params: Any,
    ...
    """
    Validate PUT request to update log/memory_global_setting.
    ...
    Example:
        ...
        >>> is_valid, error = validate_log_memory_global_setting_put(payload)
    """
...
SCHEMA_INFO = {
    "endpoint": "log/memory_global_setting",
    "category": "cmdb",
