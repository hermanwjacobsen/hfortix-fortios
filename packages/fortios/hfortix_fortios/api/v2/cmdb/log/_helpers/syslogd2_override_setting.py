...
def validate_log_syslogd2_override_setting_get(
    ...
    **params: Any,
    ...
    """
    Validate GET request parameters for log/syslogd2_override_setting.
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_log_syslogd2_override_setting_get()
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for log/syslogd2_override_setting.
...
def validate_log_syslogd2_override_setting_post(
    ...
    **params: Any,
    ...
    """
    Validate POST request to create new log/syslogd2_override_setting object.
...
def validate_log_syslogd2_override_setting_put(
    ...
    **params: Any,
    ...
    """
    Validate PUT request to update log/syslogd2_override_setting.
    ...
    Example:
        ...
        >>> is_valid, error = validate_log_syslogd2_override_setting_put(payload)
    """
...
SCHEMA_INFO = {
    "endpoint": "log/syslogd2_override_setting",
    "category": "cmdb",
