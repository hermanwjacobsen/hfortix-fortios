...
def validate_log_syslogd3_override_setting_get(
    ...
    **params: Any,
    ...
    """
    Validate GET request parameters for log/syslogd3_override_setting.
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for log/syslogd3_override_setting.
...
def validate_log_syslogd3_override_setting_post(
    ...
    **params: Any,
    ...
    """
    Validate POST request to create new log/syslogd3_override_setting object.
...
def validate_log_syslogd3_override_setting_put(
    ...
    **params: Any,
    ...
    """
    Validate PUT request to update log/syslogd3_override_setting.
...
SCHEMA_INFO = {
    "endpoint": "log/syslogd3_override_setting",
    "category": "cmdb",
