...
def validate_log_fortiguard_filter_get(
    ...
    **params: Any,
    ...
    """
    Validate GET request parameters for log/fortiguard_filter.
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_log_fortiguard_filter_get()
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for log/fortiguard_filter.
...
def validate_log_fortiguard_filter_post(
    ...
    **params: Any,
    ...
    """
    Validate POST request to create new log/fortiguard_filter object.
    ...
    Examples:
        ...
        >>> payload = {
        ... }
        >>> is_valid, error = validate_log_fortiguard_filter_post(payload)
        >>> assert is_valid == True
...
def validate_log_fortiguard_filter_put(
    ...
    **params: Any,
    ...
    """
    Validate PUT request to update log/fortiguard_filter.
    ...
    Example:
        ...
        >>> is_valid, error = validate_log_fortiguard_filter_put(payload)
    """
...
SCHEMA_INFO = {
    "endpoint": "log/fortiguard_filter",
    "category": "cmdb",
