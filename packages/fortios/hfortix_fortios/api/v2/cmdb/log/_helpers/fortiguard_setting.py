...
def validate_log_fortiguard_setting_get(
    ...
    **params: Any,
    ...
    """
    Validate GET request parameters for log/fortiguard_setting.
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_log_fortiguard_setting_get()
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for log/fortiguard_setting.
...
def validate_log_fortiguard_setting_post(
    ...
    **params: Any,
    ...
    """
    Validate POST request to create new log/fortiguard_setting object.
...
def validate_log_fortiguard_setting_put(
    ...
    **params: Any,
    ...
    """
    Validate PUT request to update log/fortiguard_setting.
    ...
    Example:
        ...
        >>> is_valid, error = validate_log_fortiguard_setting_put(payload)
    """
...
SCHEMA_INFO = {
    "endpoint": "log/fortiguard_setting",
    "category": "cmdb",
