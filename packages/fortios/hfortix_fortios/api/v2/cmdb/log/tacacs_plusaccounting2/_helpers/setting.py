"""
Validation helpers for log/tacacs_plusaccounting2/setting endpoint.
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for log/tacacs_plusaccounting2/setting.
...
def validate_log_tacacs_plusaccounting2_setting_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "server": True,
        ...     "status": "{'name': 'enable', 'help': 'Enable TACACS+ accounting.', 'label': 'Enable', 'description': 'Enable TACACS+ accounting'}",  # Valid enum value
        ... }
        >>> is_valid, error = validate_log_tacacs_plusaccounting2_setting_post(payload)
        >>> assert is_valid == True
