...
class Fortianalyzer2OverrideFilterPayload(TypedDict, total=False):
    """
    Type hints for log/fortianalyzer2_override_filter payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: Fortianalyzer2OverrideFilterPayload = {
            "field": "value",  # <- autocomplete shows all fields
        }
    """
    severity: NotRequired[Literal["emergency", "alert", "critical", "error", "warning", "notification", "information", "debug"]]  # Log every message above and including this severity level.
...
class Fortianalyzer2OverrideFilter:
    ...
    Path: log/fortianalyzer2_override_filter
    Category: cmdb
    """
    ...
    def post(
        self,
        payload_dict: Fortianalyzer2OverrideFilterPayload | None = ...,
