...
class Syslogd3FilterPayload(TypedDict, total=False):
    """
    Type hints for log/syslogd3_filter payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: Syslogd3FilterPayload = {
...
class Syslogd3Filter:
    ...
    def post(
        self,
        payload_dict: Syslogd3FilterPayload | None = ...,
