...
class TacacsPlusaccountingFilterPayload(TypedDict, total=False):
    """
    Type hints for log/tacacs_plusaccounting_filter payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: TacacsPlusaccountingFilterPayload = {
...
class TacacsPlusaccountingFilter:
    ...
    Path: log/tacacs_plusaccounting_filter
    Category: cmdb
    """
    ...
    def post(
        self,
        payload_dict: TacacsPlusaccountingFilterPayload | None = ...,
