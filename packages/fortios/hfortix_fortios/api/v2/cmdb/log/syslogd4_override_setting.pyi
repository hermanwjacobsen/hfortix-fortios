...
class Syslogd4OverrideSettingPayload(TypedDict, total=False):
    """
    Type hints for log/syslogd4_override_setting payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: Syslogd4OverrideSettingPayload = {
...
class Syslogd4OverrideSetting:
    ...
    Path: log/syslogd4_override_setting
    Category: cmdb
    """
    ...
    def post(
        self,
        payload_dict: Syslogd4OverrideSettingPayload | None = ...,
