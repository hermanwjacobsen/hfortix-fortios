...
class Syslogd2SettingPayload(TypedDict, total=False):
    """
    Type hints for log/syslogd2_setting payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: Syslogd2SettingPayload = {
...
class Syslogd2Setting:
    ...
    def post(
        self,
        payload_dict: Syslogd2SettingPayload | None = ...,
