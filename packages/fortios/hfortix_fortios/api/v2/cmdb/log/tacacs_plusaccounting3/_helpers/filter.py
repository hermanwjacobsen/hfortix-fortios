"""
Validation helpers for log/tacacs_plusaccounting3/filter endpoint.
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for log/tacacs_plusaccounting3/filter.
...
def validate_log_tacacs_plusaccounting3_filter_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "login-audit": "{'name': 'enable', 'help': 'Enable TACACS+ accounting for login events audit.', 'label': 'Enable', 'description': 'Enable TACACS+ accounting for login events audit'}",  # Valid enum value
        ... }
        >>> is_valid, error = validate_log_tacacs_plusaccounting3_filter_post(payload)
        >>> assert is_valid == True
