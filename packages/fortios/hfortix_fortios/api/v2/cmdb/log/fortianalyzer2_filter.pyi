...
class Fortianalyzer2FilterPayload(TypedDict, total=False):
    """
    Type hints for log/fortianalyzer2_filter payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: Fortianalyzer2FilterPayload = {
...
class Fortianalyzer2Filter:
    ...
    Path: log/fortianalyzer2_filter
    Category: cmdb
    """
    ...
    def post(
        self,
        payload_dict: Fortianalyzer2FilterPayload | None = ...,
