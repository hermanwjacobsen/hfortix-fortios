...
class FmwpPayload(TypedDict, total=False):
    ...
    **Usage:**
    ...
    status: NotRequired[Literal["disable", "enable"]]  # Print all FMWP rules information.
...
class FmwpObject:
    ...
    # Rule name.
    name: str
    # Print all FMWP rules information.
    status: Literal["disable", "enable"]
    ...
    date: int
    # Meta data.
    metadata: list[FmwpMetadataObject]  # Table field - list of typed objects
