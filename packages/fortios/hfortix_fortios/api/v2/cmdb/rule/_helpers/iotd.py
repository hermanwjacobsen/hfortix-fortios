...
def validate_rule_iotd_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_rule_iotd_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_rule_iotd_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for rule/iotd.
...
def validate_rule_iotd_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ... }
        >>> is_valid, error = validate_rule_iotd_post(payload)
        >>> assert is_valid == True
...
def validate_rule_iotd_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_rule_iotd_put(payload)
    """
