...
def validate_rule_fmwp_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_rule_fmwp_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_rule_fmwp_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for rule/fmwp.
...
def validate_rule_fmwp_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_rule_fmwp_put(payload)
    """
