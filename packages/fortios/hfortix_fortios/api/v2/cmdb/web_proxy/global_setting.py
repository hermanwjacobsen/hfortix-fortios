"""
FortiOS CMDB - Web_proxy global_setting

Configuration endpoint for managing cmdb web_proxy/global_setting objects.

API Endpoints:
    GET    /cmdb/web_proxy/global_setting
    POST   /cmdb/web_proxy/global_setting
    PUT    /cmdb/web_proxy/global_setting/{identifier}
    DELETE /cmdb/web_proxy/global_setting/{identifier}
...
Example Usage:
    ...
    >>>
    >>> # List all items
    >>> items = fgt.api.cmdb.web_proxy_global_setting.get()
...
class GlobalSetting:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        """
        Retrieve web_proxy/global_setting configuration.
        ...
        Examples:
            >>> # Get all web_proxy/global_setting objects
            >>> result = fgt.api.cmdb.web_proxy_global_setting.get()
            ...
            >>> schema = fgt.api.cmdb.web_proxy_global_setting.get(action="schema")

        See Also:
            - post(): Create new web_proxy/global_setting object
            - put(): Update existing web_proxy/global_setting object
            - delete(): Remove web_proxy/global_setting object
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update existing web_proxy/global_setting object.
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.web_proxy_global_setting.put(
            ...
            ...     "field1": "new-value",
            ... }
            >>> result = fgt.api.cmdb.web_proxy_global_setting.put(payload_dict=payload)
        ...
        if DEPRECATED_FIELDS:
            ...
            check_deprecated_fields(
                ...
                endpoint="cmdb/web_proxy/global_setting",
            )
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new web_proxy/global_setting object.
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.web_proxy_global_setting.post(
            ...     name="example",
            ...
            >>> result = fgt.api.cmdb.web_proxy_global_setting.post(payload_dict=payload)
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete web_proxy/global_setting object.
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.web_proxy_global_setting.delete(name="object-to-delete")
    ...
    def exists(
        ...
        """
        Check if web_proxy/global_setting object exists.
        ...
        Examples:
            ...
            >>> if fgt.api.cmdb.web_proxy_global_setting.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.cmdb.web_proxy_global_setting.exists(name="old-object"):
            ...     fgt.api.cmdb.web_proxy_global_setting.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update web_proxy/global_setting object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.cmdb.web_proxy_global_setting.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.cmdb.web_proxy_global_setting.set(payload_dict=obj_data)
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(GlobalSetting.help("ssl-cert"))
        """
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = GlobalSetting.field_info("ssl-cert")
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = GlobalSetting.validate_field("ssl-cert", "test")
            >>> if not is_valid:
