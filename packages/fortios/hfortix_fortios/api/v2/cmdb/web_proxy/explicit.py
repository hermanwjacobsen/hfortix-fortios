...
class Explicit:
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new web_proxy/explicit object.
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.web_proxy_explicit.post(payload_dict=payload)
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete web_proxy/explicit object.
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.web_proxy_explicit.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.cmdb.web_proxy_explicit.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.cmdb.web_proxy_explicit.exists(name="old-object"):
            ...     fgt.api.cmdb.web_proxy_explicit.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update web_proxy/explicit object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.cmdb.web_proxy_explicit.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.cmdb.web_proxy_explicit.set(payload_dict=obj_data)
