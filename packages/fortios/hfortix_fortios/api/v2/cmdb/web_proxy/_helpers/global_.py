"""
Validation helpers for web_proxy/global_ endpoint.
...
def validate_web_proxy_global__get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_web_proxy_global__get()
...
def validate_web_proxy_global__post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ... }
        >>> is_valid, error = validate_web_proxy_global__post(payload)
        >>> assert is_valid == True
        
        >>> # ✅ Valid - With enum field
        >>> payload = {
        ...     "fast-policy-match": "{'name': 'enable', 'help': 'Enable setting.', 'label': 'Enable', 'description': 'Enable setting'}",  # Valid enum value
        ... }
        >>> is_valid, error = validate_web_proxy_global__post(payload)
        >>> assert is_valid == True
...
def validate_web_proxy_global__put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_web_proxy_global__put(payload)
    """
