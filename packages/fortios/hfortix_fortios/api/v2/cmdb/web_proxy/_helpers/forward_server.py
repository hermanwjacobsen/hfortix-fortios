"""
Validation helpers for web_proxy/forward_server endpoint.
...
def validate_web_proxy_forward_server_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_web_proxy_forward_server_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_web_proxy_forward_server_get(name="test-item")
        >>> assert is_valid == True
...
def validate_web_proxy_forward_server_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_web_proxy_forward_server_put(payload)
    """
