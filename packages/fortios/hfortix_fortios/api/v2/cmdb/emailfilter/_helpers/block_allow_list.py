...
def validate_emailfilter_block_allow_list_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_emailfilter_block_allow_list_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by id
        >>> is_valid, error = validate_emailfilter_block_allow_list_get(id="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for emailfilter/block_allow_list.
...
def validate_emailfilter_block_allow_list_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "name": True,  # Name of table.
        ...     "entries": True,  # Anti-spam block/allow entries.
        ... }
        >>> is_valid, error = validate_emailfilter_block_allow_list_post(payload)
        >>> assert is_valid == True
...
def validate_emailfilter_block_allow_list_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_emailfilter_block_allow_list_put(payload)
    """
