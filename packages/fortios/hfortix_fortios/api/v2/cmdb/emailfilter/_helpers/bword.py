...
def validate_emailfilter_bword_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_emailfilter_bword_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by id
        >>> is_valid, error = validate_emailfilter_bword_get(id="test-item")
        >>> assert is_valid == True
...
def validate_emailfilter_bword_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        ... }
        >>> is_valid, error = validate_emailfilter_bword_post(payload)
        >>> assert is_valid == True
...
def validate_emailfilter_bword_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_emailfilter_bword_put(payload)
    """
