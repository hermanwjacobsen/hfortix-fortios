"""
Validation helpers for file_filter/profile endpoint.
...
def validate_file_filter_profile_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_file_filter_profile_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_file_filter_profile_get(name="test-item")
        >>> assert is_valid == True
...
def validate_file_filter_profile_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_file_filter_profile_put(payload)
    """
