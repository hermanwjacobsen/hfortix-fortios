...
class ProfileRulesItem(TypedDict):
    ...
    comment: str  # Comment. | MaxLen: 255
    protocol: Literal["http", "ftp", "smtp", "imap", "pop3", "mapi", "cifs", "ssh"]  # Protocols to apply rule to. | Default: http ftp smtp imap pop3 mapi c
...
class ProfileRulesObject:
    ...
    # Comment. | MaxLen: 255
    comment: str
    # Protocols to apply rule to. | Default: http ftp smtp imap pop3 mapi c
