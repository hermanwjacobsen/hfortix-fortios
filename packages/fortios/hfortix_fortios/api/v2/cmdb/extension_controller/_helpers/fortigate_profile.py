"""
Validation helpers for extension_controller/fortigate_profile endpoint.
...
def validate_extension_controller_fortigate_profile_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_extension_controller_fortigate_profile_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_extension_controller_fortigate_profile_get(name="test-item")
        >>> assert is_valid == True
...
def validate_extension_controller_fortigate_profile_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "lan-extension": True,  # FortiGate connector LAN extension configuration.
        ... }
        ...
        >>> payload["extension"] = "invalid-value"
        >>> is_valid, error = validate_extension_controller_fortigate_profile_post(payload)
...
def validate_extension_controller_fortigate_profile_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_extension_controller_fortigate_profile_put(payload)
    """
