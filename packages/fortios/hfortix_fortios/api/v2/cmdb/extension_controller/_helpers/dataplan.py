"""
Validation helpers for extension_controller/dataplan endpoint.
...
def validate_extension_controller_dataplan_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_extension_controller_dataplan_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_extension_controller_dataplan_get(name="test-item")
        >>> assert is_valid == True
...
def validate_extension_controller_dataplan_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "slot": True,  # SIM slot configuration.
        ...     "iccid": True,  # ICCID configuration.
        ... }
        ...
        >>> payload["modem-id"] = "invalid-value"
        >>> is_valid, error = validate_extension_controller_dataplan_post(payload)
...
def validate_extension_controller_dataplan_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_extension_controller_dataplan_put(payload)
    """
