...
def validate_extension_controller_fortigate_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_extension_controller_fortigate_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_extension_controller_fortigate_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for extension_controller/fortigate.
...
def validate_extension_controller_fortigate_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "name": True,  # FortiGate entry name.
        ...     "id": True,  # FortiGate serial number.
        ... }
...
def validate_extension_controller_fortigate_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_extension_controller_fortigate_put(payload)
    """
