...
class ProfilePayload(TypedDict, total=False):
    ...
    **Usage:**
    ...
    severity: NotRequired[Literal["info", "low", "medium", "high", "critical"]]  # Relative severity of the signature
...
class ProfileObject:
    ...
    exemption: list[ProfileExemptionObject]  # Table field - list of typed objects
