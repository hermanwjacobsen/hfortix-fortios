...
class GlobalPayload(TypedDict, total=False):
    ...
    **Usage:**
    ...
    """
    mac_aging_interval: NotRequired[int]  # Time after which an inactive MAC is aged out
    ...
    dhcp_snoop_client_db_exp: NotRequired[int]  # Expiry time for DHCP snooping server database entries
    dhcp_snoop_db_per_port_learn_limit: NotRequired[int]  # Per Interface dhcp-server entries learn limit
    ...
    bounce_quarantined_link: NotRequired[Literal["disable", "enable"]]  # Enable/disable bouncing
...
class GlobalResponse(TypedDict):
    ...
    disable_discovery: list[dict[str, Any]]
...
class GlobalObject:
    ...
    disable_discovery: list[GlobalDisablediscoveryObject]  # Table field - list of typed objects
    ...
    custom_command: list[GlobalCustomcommandObject]  # Table field - list of typed objects
    ...
    switch_on_deauth: Literal["no-op", "factory-reset"]
    # Time period in minutes to hold firewall authenticated MAC users
    firewall_auth_user_hold_period: int
