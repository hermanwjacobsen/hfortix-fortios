...
class FlowTracking:
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new switch_controller/flow_tracking object.
        ...
        Examples:
            ...
            >>> payload = FlowTracking.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.cmdb.switch_controller_flow_tracking.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(FlowTracking.required_fields()) }}
            
            Use FlowTracking.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete switch_controller/flow_tracking object.
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.switch_controller_flow_tracking.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.cmdb.switch_controller_flow_tracking.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.cmdb.switch_controller_flow_tracking.exists(name="old-object"):
            ...     fgt.api.cmdb.switch_controller_flow_tracking.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update switch_controller/flow_tracking object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.cmdb.switch_controller_flow_tracking.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.cmdb.switch_controller_flow_tracking.set(payload_dict=obj_data)
