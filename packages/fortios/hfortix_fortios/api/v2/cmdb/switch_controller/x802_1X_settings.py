...
class X8021xSettings:
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new switch_controller/x802_1X_settings object.
        ...
        Examples:
            ...
            >>> payload = X8021xSettings.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.cmdb.switch_controller_x802_1X_settings.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(X8021xSettings.required_fields()) }}
            
            Use X8021xSettings.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete switch_controller/x802_1X_settings object.
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.switch_controller_x802_1X_settings.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.cmdb.switch_controller_x802_1X_settings.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.cmdb.switch_controller_x802_1X_settings.exists(name="old-object"):
            ...     fgt.api.cmdb.switch_controller_x802_1X_settings.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update switch_controller/x802_1X_settings object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.cmdb.switch_controller_x802_1X_settings.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.cmdb.switch_controller_x802_1X_settings.set(payload_dict=obj_data)
