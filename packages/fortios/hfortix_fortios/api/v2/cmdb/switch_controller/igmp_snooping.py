...
class IgmpSnooping:
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new switch_controller/igmp_snooping object.
        ...
        Examples:
            ...
            >>> payload = IgmpSnooping.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.cmdb.switch_controller_igmp_snooping.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(IgmpSnooping.required_fields()) }}
            
            Use IgmpSnooping.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete switch_controller/igmp_snooping object.
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.switch_controller_igmp_snooping.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.cmdb.switch_controller_igmp_snooping.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.cmdb.switch_controller_igmp_snooping.exists(name="old-object"):
            ...     fgt.api.cmdb.switch_controller_igmp_snooping.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update switch_controller/igmp_snooping object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.cmdb.switch_controller_igmp_snooping.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.cmdb.switch_controller_igmp_snooping.set(payload_dict=obj_data)
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(IgmpSnooping.help())
            
            >>> # Get field information
            >>> print(IgmpSnooping.help("aging-time"))
        """
        from ._helpers.igmp_snooping import (
            get_schema_info,
            get_field_metadata,
        )
    ...
    def fields(detailed: bool = False) -> Union[list[str], dict[str, dict]]:
        ...
        Examples:
            >>> # Simple list
            >>> fields = IgmpSnooping.fields()
            >>> print(f"Available fields: {len(fields)}")
            
            >>> # Detailed info
            >>> fields = IgmpSnooping.fields(detailed=True)
            >>> for name, meta in fields.items():
            ...     print(f"{name}: {meta['type']}")
        """
        from ._helpers.igmp_snooping import get_all_fields, get_field_metadata
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = IgmpSnooping.field_info("aging-time")
            >>> print(f"Type: {info['type']}")
            >>> if 'options' in info:
            ...     print(f"Options: {info['options']}")
        """
        from ._helpers.igmp_snooping import get_field_metadata
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = IgmpSnooping.validate_field("aging-time", "test")
            >>> if not is_valid:
            ...     print(f"Validation error: {error}")
        """
        from ._helpers.igmp_snooping import validate_field_value
    ...
    def required_fields() -> list[str]:
        ...
        Examples:
            >>> required = IgmpSnooping.required_fields()
            >>> print(f"Required fields: {', '.join(required)}")
        """
        from ._helpers.igmp_snooping import REQUIRED_FIELDS
    ...
    def defaults() -> dict[str, Any]:
        ...
        Examples:
            >>> defaults = IgmpSnooping.defaults()
            >>> print(f"Fields with defaults: {len(defaults)}")
            >>> # Use as starting point for payload
            >>> payload = defaults.copy()
            >>> payload['name'] = 'my-custom-name'
        """
        from ._helpers.igmp_snooping import FIELDS_WITH_DEFAULTS
    ...
    def schema() -> dict[str, Any]:
        ...
        Examples:
            >>> schema = IgmpSnooping.schema()
            >>> print(f"Endpoint: {schema['endpoint']}")
            >>> print(f"Total fields: {schema['total_fields']}")
            >>> print(f"Primary key: {schema.get('mkey', 'N/A')}")
        """
        from ._helpers.igmp_snooping import get_schema_info
