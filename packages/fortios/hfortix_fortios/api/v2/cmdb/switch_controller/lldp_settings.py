...
class LldpSettings:
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new switch_controller/lldp_settings object.
        ...
        Examples:
            ...
            >>> payload = LldpSettings.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.cmdb.switch_controller_lldp_settings.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(LldpSettings.required_fields()) }}
            
            Use LldpSettings.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete switch_controller/lldp_settings object.
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.switch_controller_lldp_settings.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.cmdb.switch_controller_lldp_settings.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.cmdb.switch_controller_lldp_settings.exists(name="old-object"):
            ...     fgt.api.cmdb.switch_controller_lldp_settings.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update switch_controller/lldp_settings object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.cmdb.switch_controller_lldp_settings.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.cmdb.switch_controller_lldp_settings.set(payload_dict=obj_data)
