...
class LldpSettingsPayload(TypedDict, total=False):
    ...
    **Usage:**
    ...
    """
    tx_hold: NotRequired[int]  # Number of tx-intervals before local LLDP data expires
    tx_interval: NotRequired[int]  # Frequency of LLDP PDU transmission from FortiSwitch
