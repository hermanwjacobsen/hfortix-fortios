...
class TrafficSniffer:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> schema = fgt.api.cmdb.switch_controller_traffic_sniffer.get(action="schema")
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new switch_controller/traffic_sniffer object.
        ...
        Examples:
            ...
            >>> payload = TrafficSniffer.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.cmdb.switch_controller_traffic_sniffer.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(TrafficSniffer.required_fields()) }}
            
            Use TrafficSniffer.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete switch_controller/traffic_sniffer object.
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.switch_controller_traffic_sniffer.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.cmdb.switch_controller_traffic_sniffer.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.cmdb.switch_controller_traffic_sniffer.exists(name="old-object"):
            ...     fgt.api.cmdb.switch_controller_traffic_sniffer.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update switch_controller/traffic_sniffer object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.cmdb.switch_controller_traffic_sniffer.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.cmdb.switch_controller_traffic_sniffer.set(payload_dict=obj_data)
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(TrafficSniffer.help())
            
            >>> # Get field information
            >>> print(TrafficSniffer.help("mode"))
        """
        from ._helpers.traffic_sniffer import (
            get_schema_info,
            get_field_metadata,
        )
    ...
    def fields(detailed: bool = False) -> Union[list[str], dict[str, dict]]:
        ...
        Examples:
            >>> # Simple list
            >>> fields = TrafficSniffer.fields()
            >>> print(f"Available fields: {len(fields)}")
            
            >>> # Detailed info
            >>> fields = TrafficSniffer.fields(detailed=True)
            >>> for name, meta in fields.items():
            ...     print(f"{name}: {meta['type']}")
        """
        from ._helpers.traffic_sniffer import get_all_fields, get_field_metadata
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = TrafficSniffer.field_info("mode")
            >>> print(f"Type: {info['type']}")
            >>> if 'options' in info:
            ...     print(f"Options: {info['options']}")
        """
        from ._helpers.traffic_sniffer import get_field_metadata
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = TrafficSniffer.validate_field("mode", "test")
            >>> if not is_valid:
            ...     print(f"Validation error: {error}")
        """
        from ._helpers.traffic_sniffer import validate_field_value
    ...
    def required_fields() -> list[str]:
        ...
        Examples:
            >>> required = TrafficSniffer.required_fields()
            >>> print(f"Required fields: {', '.join(required)}")
        """
        from ._helpers.traffic_sniffer import REQUIRED_FIELDS
    ...
    def defaults() -> dict[str, Any]:
        ...
        Examples:
            >>> defaults = TrafficSniffer.defaults()
            >>> print(f"Fields with defaults: {len(defaults)}")
            >>> # Use as starting point for payload
            >>> payload = defaults.copy()
            >>> payload['name'] = 'my-custom-name'
        """
        from ._helpers.traffic_sniffer import FIELDS_WITH_DEFAULTS
    ...
    def schema() -> dict[str, Any]:
        ...
        Examples:
            >>> schema = TrafficSniffer.schema()
            >>> print(f"Endpoint: {schema['endpoint']}")
            >>> print(f"Total fields: {schema['total_fields']}")
            >>> print(f"Primary key: {schema.get('mkey', 'N/A')}")
        """
        from ._helpers.traffic_sniffer import get_schema_info
