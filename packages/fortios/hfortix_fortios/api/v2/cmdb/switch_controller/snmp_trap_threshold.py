...
class SnmpTrapThreshold:
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new switch_controller/snmp_trap_threshold object.
        ...
        Examples:
            ...
            >>> payload = SnmpTrapThreshold.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.cmdb.switch_controller_snmp_trap_threshold.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(SnmpTrapThreshold.required_fields()) }}
            
            Use SnmpTrapThreshold.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete switch_controller/snmp_trap_threshold object.
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.switch_controller_snmp_trap_threshold.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.cmdb.switch_controller_snmp_trap_threshold.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.cmdb.switch_controller_snmp_trap_threshold.exists(name="old-object"):
            ...     fgt.api.cmdb.switch_controller_snmp_trap_threshold.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update switch_controller/snmp_trap_threshold object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.cmdb.switch_controller_snmp_trap_threshold.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.cmdb.switch_controller_snmp_trap_threshold.set(payload_dict=obj_data)
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(SnmpTrapThreshold.help())
            
            >>> # Get field information
            >>> print(SnmpTrapThreshold.help("trap-high-cpu-threshold"))
        """
        from ._helpers.snmp_trap_threshold import (
            get_schema_info,
            get_field_metadata,
        )
    ...
    def fields(detailed: bool = False) -> Union[list[str], dict[str, dict]]:
        ...
        Examples:
            >>> # Simple list
            >>> fields = SnmpTrapThreshold.fields()
            >>> print(f"Available fields: {len(fields)}")
            
            >>> # Detailed info
            >>> fields = SnmpTrapThreshold.fields(detailed=True)
            >>> for name, meta in fields.items():
            ...     print(f"{name}: {meta['type']}")
        """
        from ._helpers.snmp_trap_threshold import get_all_fields, get_field_metadata
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = SnmpTrapThreshold.field_info("trap-high-cpu-threshold")
            >>> print(f"Type: {info['type']}")
            >>> if 'options' in info:
            ...     print(f"Options: {info['options']}")
        """
        from ._helpers.snmp_trap_threshold import get_field_metadata
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = SnmpTrapThreshold.validate_field("trap-high-cpu-threshold", "test")
            >>> if not is_valid:
            ...     print(f"Validation error: {error}")
        """
        from ._helpers.snmp_trap_threshold import validate_field_value
    ...
    def required_fields() -> list[str]:
        ...
        Examples:
            >>> required = SnmpTrapThreshold.required_fields()
            >>> print(f"Required fields: {', '.join(required)}")
        """
        from ._helpers.snmp_trap_threshold import REQUIRED_FIELDS
    ...
    def defaults() -> dict[str, Any]:
        ...
        Examples:
            >>> defaults = SnmpTrapThreshold.defaults()
            >>> print(f"Fields with defaults: {len(defaults)}")
            >>> # Use as starting point for payload
            >>> payload = defaults.copy()
            >>> payload['name'] = 'my-custom-name'
        """
        from ._helpers.snmp_trap_threshold import FIELDS_WITH_DEFAULTS
    ...
    def schema() -> dict[str, Any]:
        ...
        Examples:
            >>> schema = SnmpTrapThreshold.schema()
            >>> print(f"Endpoint: {schema['endpoint']}")
            >>> print(f"Total fields: {schema['total_fields']}")
            >>> print(f"Primary key: {schema.get('mkey', 'N/A')}")
        """
        from ._helpers.snmp_trap_threshold import get_schema_info
