...
class SecurityPolicy8021xPayload(TypedDict, total=False):
    """
    Type hints for switch-controller/security_policy_802_1X payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: SecurityPolicy8021xPayload = {
...
class SecurityPolicy8021x:
    ...
    Path: switch-controller/security_policy_802_1X
    Category: cmdb
    Primary Key: name
    """
    ...
    def post(
        self,
        payload_dict: SecurityPolicy8021xPayload | None = ...,
        name: str | None = ...,
