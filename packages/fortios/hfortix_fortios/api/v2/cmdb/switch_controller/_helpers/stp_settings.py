"""
Validation helpers for switch_controller/stp_settings endpoint.
...
def validate_switch_controller_stp_settings_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_switch_controller_stp_settings_get()
...
def validate_switch_controller_stp_settings_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ... }
        >>> is_valid, error = validate_switch_controller_stp_settings_post(payload)
        >>> assert is_valid == True
...
def validate_switch_controller_stp_settings_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_switch_controller_stp_settings_put(payload)
    """
