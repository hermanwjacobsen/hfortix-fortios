"""
Validation helpers for switch_controller/switch_profile endpoint.
...
def validate_switch_controller_switch_profile_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_switch_controller_switch_profile_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_switch_controller_switch_profile_get(name="test-item")
        >>> assert is_valid == True
...
def validate_switch_controller_switch_profile_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload["login-passwd-override"] = "invalid-value"
        >>> is_valid, error = validate_switch_controller_switch_profile_post(payload)
...
def validate_switch_controller_switch_profile_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_switch_controller_switch_profile_put(payload)
    """
