"""
Validation helpers for switch_controller/dynamic_port_policy endpoint.
...
def validate_switch_controller_dynamic_port_policy_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_switch_controller_dynamic_port_policy_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_switch_controller_dynamic_port_policy_get(name="test-item")
        >>> assert is_valid == True
...
def validate_switch_controller_dynamic_port_policy_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "fortilink": True,  # FortiLink interface for which this Dynamic port po
        ... }
        >>> is_valid, error = validate_switch_controller_dynamic_port_policy_post(payload)
        >>> assert is_valid == True
...
def validate_switch_controller_dynamic_port_policy_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_switch_controller_dynamic_port_policy_put(payload)
    """
