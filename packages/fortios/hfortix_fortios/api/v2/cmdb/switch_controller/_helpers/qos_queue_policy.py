...
def validate_switch_controller_qos_queue_policy_get(
    ...
    **params: Any,
    ...
    """
    Validate GET request parameters for switch-controller/qos_queue_policy.
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_switch_controller_qos_queue_policy_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_switch_controller_qos_queue_policy_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for switch-controller/qos_queue_policy.
...
def validate_switch_controller_qos_queue_policy_post(
    ...
    **params: Any,
    ...
    """
    Validate POST request to create new switch-controller/qos_queue_policy object.
    ...
    Examples:
        ...
        >>> payload["schedule"] = "invalid-value"
        >>> is_valid, error = validate_switch_controller_qos_queue_policy_post(payload)
...
def validate_switch_controller_qos_queue_policy_put(
    ...
    **params: Any,
    ...
    """
    Validate PUT request to update switch-controller/qos_queue_policy.
    ...
    Example:
        ...
        >>> is_valid, error = validate_switch_controller_qos_queue_policy_put(payload)
    """
...
SCHEMA_INFO = {
    "endpoint": "switch-controller/qos_queue_policy",
    "category": "cmdb",
