"""
Validation helpers for switch_controller/storm_control_policy endpoint.
...
def validate_switch_controller_storm_control_policy_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_switch_controller_storm_control_policy_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_switch_controller_storm_control_policy_get(name="test-item")
        >>> assert is_valid == True
...
def validate_switch_controller_storm_control_policy_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "name": True,  # Storm control policy name.
        ... }
        ...
        >>> payload["storm-control-mode"] = "invalid-value"
        >>> is_valid, error = validate_switch_controller_storm_control_policy_post(payload)
...
def validate_switch_controller_storm_control_policy_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_switch_controller_storm_control_policy_put(payload)
    """
