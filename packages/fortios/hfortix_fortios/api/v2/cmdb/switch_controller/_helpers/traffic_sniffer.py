"""
Validation helpers for switch_controller/traffic_sniffer endpoint.
...
def validate_switch_controller_traffic_sniffer_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_switch_controller_traffic_sniffer_get()
...
def validate_switch_controller_traffic_sniffer_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_switch_controller_traffic_sniffer_put(payload)
    """
