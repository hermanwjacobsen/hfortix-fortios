...
def validate_switch_controller_ptp_profile_get(
    ...
    **params: Any,
    ...
    """
    Validate GET request parameters for switch-controller/ptp_profile.
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_switch_controller_ptp_profile_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_switch_controller_ptp_profile_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for switch-controller/ptp_profile.
...
def validate_switch_controller_ptp_profile_post(
    ...
    **params: Any,
    ...
    """
    Validate POST request to create new switch-controller/ptp_profile object.
...
def validate_switch_controller_ptp_profile_put(
    ...
    **params: Any,
    ...
    """
    Validate PUT request to update switch-controller/ptp_profile.
    ...
    Example:
        ...
        >>> is_valid, error = validate_switch_controller_ptp_profile_put(payload)
    """
...
SCHEMA_INFO = {
    "endpoint": "switch-controller/ptp_profile",
    "category": "cmdb",
