"""
Validation helpers for switch_controller/x802_1x_settings endpoint.
...
def validate_switch_controller_x802_1x_settings_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_switch_controller_x802_1x_settings_get()
...
def validate_switch_controller_x802_1x_settings_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ... }
        >>> is_valid, error = validate_switch_controller_x802_1x_settings_post(payload)
        >>> assert is_valid == True
        
        >>> # ✅ Valid - With enum field
        >>> payload = {
        ...     "link-down-auth": "{'name': 'set-unauth', 'help': 'Interface set to unauth when down. Reauthentication is needed.', 'label': 'Set Unauth', 'description': 'Interface set to unauth when down'}",  # Valid enum value
        ... }
        >>> is_valid, error = validate_switch_controller_x802_1x_settings_post(payload)
        >>> assert is_valid == True
        
        >>> # ❌ Invalid - Wrong enum value
        >>> payload["link-down-auth"] = "invalid-value"
        >>> is_valid, error = validate_switch_controller_x802_1x_settings_post(payload)
...
def validate_switch_controller_x802_1x_settings_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_switch_controller_x802_1x_settings_put(payload)
    """
