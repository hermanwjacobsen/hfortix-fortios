"""
Validation helpers for switch_controller/global_ endpoint.
...
def validate_switch_controller_global__get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_switch_controller_global__get()
...
def validate_switch_controller_global__post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ... }
        >>> is_valid, error = validate_switch_controller_global__post(payload)
        >>> assert is_valid == True
        
        >>> # ✅ Valid - With enum field
        >>> payload = {
        ...     "https-image-push": "{'name': 'enable', 'help': 'Enable image push to FortiSwitch using HTTPS.', 'label': 'Enable', 'description': 'Enable image push to FortiSwitch using HTTPS'}",  # Valid enum value
        ... }
        >>> is_valid, error = validate_switch_controller_global__post(payload)
        >>> assert is_valid == True
...
def validate_switch_controller_global__put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_switch_controller_global__put(payload)
    """
