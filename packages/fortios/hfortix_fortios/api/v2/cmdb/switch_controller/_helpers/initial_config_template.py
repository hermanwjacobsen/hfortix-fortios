...
def validate_switch_controller_initial_config_template_get(
    ...
    **params: Any,
    ...
    """
    Validate GET request parameters for switch-controller/initial_config_template.
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_switch_controller_initial_config_template_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_switch_controller_initial_config_template_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for switch-controller/initial_config_template.
...
def validate_switch_controller_initial_config_template_post(
    ...
    **params: Any,
    ...
    """
    Validate POST request to create new switch-controller/initial_config_template object.
    ...
    Examples:
        ...
        >>> payload = {
        ...     "name": True,  # Initial config template name.
        ... }
        ...
        >>> payload["allowaccess"] = "invalid-value"
        >>> is_valid, error = validate_switch_controller_initial_config_template_post(payload)
...
def validate_switch_controller_initial_config_template_put(
    ...
    **params: Any,
    ...
    """
    Validate PUT request to update switch-controller/initial_config_template.
    ...
    Example:
        ...
        >>> is_valid, error = validate_switch_controller_initial_config_template_put(payload)
    """
...
SCHEMA_INFO = {
    "endpoint": "switch-controller/initial_config_template",
    "category": "cmdb",
