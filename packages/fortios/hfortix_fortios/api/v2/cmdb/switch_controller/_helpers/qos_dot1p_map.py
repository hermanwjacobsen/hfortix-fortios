...
def validate_switch_controller_qos_dot1p_map_get(
    ...
    **params: Any,
    ...
    """
    Validate GET request parameters for switch-controller/qos_dot1p_map.
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for switch-controller/qos_dot1p_map.
...
def validate_switch_controller_qos_dot1p_map_post(
    ...
    **params: Any,
    ...
    """
    Validate POST request to create new switch-controller/qos_dot1p_map object.
...
def validate_switch_controller_qos_dot1p_map_put(
    ...
    **params: Any,
    ...
    """
    Validate PUT request to update switch-controller/qos_dot1p_map.
...
SCHEMA_INFO = {
    "endpoint": "switch-controller/qos_dot1p_map",
    "category": "cmdb",
