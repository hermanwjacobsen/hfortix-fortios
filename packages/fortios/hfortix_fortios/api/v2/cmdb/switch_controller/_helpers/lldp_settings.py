"""
Validation helpers for switch_controller/lldp_settings endpoint.
...
def validate_switch_controller_lldp_settings_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_switch_controller_lldp_settings_get()
...
def validate_switch_controller_lldp_settings_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload["management-interface"] = "invalid-value"
        >>> is_valid, error = validate_switch_controller_lldp_settings_post(payload)
...
def validate_switch_controller_lldp_settings_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_switch_controller_lldp_settings_put(payload)
    """
