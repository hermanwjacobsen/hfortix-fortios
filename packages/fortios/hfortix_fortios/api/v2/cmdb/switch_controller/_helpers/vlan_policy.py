"""
Validation helpers for switch_controller/vlan_policy endpoint.
...
def validate_switch_controller_vlan_policy_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_switch_controller_vlan_policy_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_switch_controller_vlan_policy_get(name="test-item")
        >>> assert is_valid == True
...
def validate_switch_controller_vlan_policy_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "fortilink": True,  # FortiLink interface for which this VLAN policy bel
        ... }
        ...
        >>> payload["allowed-vlans-all"] = "invalid-value"
        >>> is_valid, error = validate_switch_controller_vlan_policy_post(payload)
...
def validate_switch_controller_vlan_policy_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_switch_controller_vlan_policy_put(payload)
    """
