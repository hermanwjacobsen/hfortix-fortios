"""
Validation helpers for switch_controller/security_policy/x802_1x endpoint.
...
def validate_switch_controller_security_policy_x802_1x_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_switch_controller_security_policy_x802_1x_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_switch_controller_security_policy_x802_1x_get(name="test-item")
        >>> assert is_valid == True
...
def validate_switch_controller_security_policy_x802_1x_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        ... }
        >>> is_valid, error = validate_switch_controller_security_policy_x802_1x_post(payload)
        >>> assert is_valid == True
        
        >>> # ✅ Valid - With enum field
        >>> payload = {
        ...     "user-group": True,
        ...     "security-mode": "{'name': '802.1X', 'help': '802.1X port based authentication.', 'label': '802.1X'}",  # Valid enum value
        ... }
        >>> is_valid, error = validate_switch_controller_security_policy_x802_1x_post(payload)
        >>> assert is_valid == True
...
def validate_switch_controller_security_policy_x802_1x_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_switch_controller_security_policy_x802_1x_put(payload)
    """
