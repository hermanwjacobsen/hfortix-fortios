"""
FortiOS CMDB - Switch Controller qos_dot1p_map

Configuration endpoint for managing cmdb switch-controller/qos_dot1p_map objects.
...
class QosDot1pMap:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        """
        Retrieve switch-controller/qos_dot1p_map configuration.
        ...
        Examples:
            >>> # Get all switch-controller/qos_dot1p_map objects
            >>> result = fgt.api.cmdb.switch_controller_qos_dot1p_map.get()
            >>> print(f"Found {len(result['results'])} objects")
            
            >>> # Get specific switch-controller/qos_dot1p_map by name
        ...
        See Also:
            - post(): Create new switch-controller/qos_dot1p_map object
            - put(): Update existing switch-controller/qos_dot1p_map object
            - delete(): Remove switch-controller/qos_dot1p_map object
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update existing switch-controller/qos_dot1p_map object.
        ...
        from ._helpers.qos_dot1p_map import DEPRECATED_FIELDS
        if DEPRECATED_FIELDS:
            from hfortix_core import check_deprecated_fields
            check_deprecated_fields(
                payload=payload_data,
                deprecated_fields=DEPRECATED_FIELDS,
                endpoint="cmdb/switch-controller/qos_dot1p_map",
            )
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new switch-controller/qos_dot1p_map object.
        ...
        Examples:
            ...
            >>> payload = QosDot1pMap.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.cmdb.switch_controller_qos_dot1p_map.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(QosDot1pMap.required_fields()) }}
            
            Use QosDot1pMap.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete switch-controller/qos_dot1p_map object.
    ...
    def exists(
        ...
        """
        Check if switch-controller/qos_dot1p_map object exists.
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update switch-controller/qos_dot1p_map object (intelligent operation).
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(QosDot1pMap.help())
            
            >>> # Get field information
            >>> print(QosDot1pMap.help("name"))
        """
        from ._helpers.qos_dot1p_map import (
            get_schema_info,
            get_field_metadata,
        )
    ...
    def fields(detailed: bool = False) -> Union[list[str], dict[str, dict]]:
        ...
        Examples:
            >>> # Simple list
            >>> fields = QosDot1pMap.fields()
            >>> print(f"Available fields: {len(fields)}")
            
            >>> # Detailed info
            >>> fields = QosDot1pMap.fields(detailed=True)
            >>> for name, meta in fields.items():
            ...     print(f"{name}: {meta['type']}")
        """
        from ._helpers.qos_dot1p_map import get_all_fields, get_field_metadata
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = QosDot1pMap.field_info("name")
            >>> print(f"Type: {info['type']}")
            >>> if 'options' in info:
            ...     print(f"Options: {info['options']}")
        """
        from ._helpers.qos_dot1p_map import get_field_metadata
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = QosDot1pMap.validate_field("name", "test")
            >>> if not is_valid:
            ...     print(f"Validation error: {error}")
        """
        from ._helpers.qos_dot1p_map import validate_field_value
    ...
    def required_fields() -> list[str]:
        ...
        Examples:
            >>> required = QosDot1pMap.required_fields()
            >>> print(f"Required fields: {', '.join(required)}")
        """
        from ._helpers.qos_dot1p_map import REQUIRED_FIELDS
    ...
    def defaults() -> dict[str, Any]:
        ...
        Examples:
            >>> defaults = QosDot1pMap.defaults()
            >>> print(f"Fields with defaults: {len(defaults)}")
            >>> # Use as starting point for payload
            >>> payload = defaults.copy()
            >>> payload['name'] = 'my-custom-name'
        """
        from ._helpers.qos_dot1p_map import FIELDS_WITH_DEFAULTS
    ...
    def schema() -> dict[str, Any]:
        ...
        Examples:
            >>> schema = QosDot1pMap.schema()
            >>> print(f"Endpoint: {schema['endpoint']}")
            >>> print(f"Total fields: {schema['total_fields']}")
            >>> print(f"Primary key: {schema.get('mkey', 'N/A')}")
        """
        from ._helpers.qos_dot1p_map import get_schema_info
