...
class WtpProfilePayload(TypedDict, total=False):
    ...
    **Usage:**
    ...
    apcfg_mesh: NotRequired[Literal["enable", "disable"]]  # Enable/disable AP local mesh configuration
    ...
    max_clients: NotRequired[int]  # Maximum number of stations (STAs) supported by the WTP
    ...
    ap_handoff: NotRequired[Literal["enable", "disable"]]  # Enable/disable AP handoff of clients to other APs
    ...
    console_login: NotRequired[Literal["enable", "disable"]]  # Enable/disable FortiAP console login access
    ...
    wan_port_auth_macsec: NotRequired[Literal["enable", "disable"]]  # Enable/disable WAN port 802.1x supplicant MACsec policy
    apcfg_auto_cert: NotRequired[Literal["enable", "disable"]]  # Enable/disable AP local auto cert configuration
    ...
    apcfg_auto_cert_est_server: NotRequired[str]  # Address and port for EST server
    ...
    apcfg_auto_cert_est_subject: NotRequired[str]  # Subject e.g. "CN=User,DC=example,DC=COM"
    apcfg_auto_cert_est_subject_alt_name: NotRequired[str]  # Subject alternative name
    ...
    apcfg_auto_cert_scep_ec_name: NotRequired[Literal["secp256r1", "secp384r1", "secp521r1"]]  # Elliptic curve name: secp256r1, secp384r1 and secp521r1.
    apcfg_auto_cert_scep_sub_fully_dn: NotRequired[str]  # Full DN of the subject
    ...
    apcfg_auto_cert_scep_subject_alt_name: NotRequired[str]  # Subject alternative name
...
class WtpProfileResponse(TypedDict):
    ...
    led_schedules: list[dict[str, Any]]
    ...
    deny_mac_list: list[dict[str, Any]]
...
class WtpProfileObject:
    ...
    led_schedules: list[WtpProfileLedschedulesObject]  # Table field - list of typed objects
    ...
    max_clients: int
    # Minimum received signal strength indicator (RSSI) value for handoff
    handoff_rssi: int
    ...
    deny_mac_list: list[WtpProfileDenymaclistObject]  # Table field - list of typed objects
    # Country in which this WTP, FortiAP, or AP will operate
    ap_country: Literal["--", "AF", "AL", "DZ", "AS", "AO", "AR", "AM", "AU", "AT", "AZ", "BS", "BH", "BD", "BB", "BY", "BE", "BZ", "BJ", "BM", "BT", "BO", "BA", "BW", "BR", "BN", "BG", "BF", "KH", "CM", "KY", "CF", "TD", "CL", "CN", "CX", "CO", "CG", "CD", "CR", "HR", "CY", "CZ", "DK", "DJ", "DM", "DO", "EC", "EG", "SV", "ET", "EE", "GF", "PF", "FO", "FJ", "FI", "FR", "GA", "GE", "GM", "DE", "GH", "GI", "GR", "GL", "GD", "GP", "GU", "GT", "GY", "HT", "HN", "HK", "HU", "IS", "IN", "ID", "IQ", "IE", "IM", "IL", "IT", "CI", "JM", "JO", "KZ", "KE", "KR", "KW", "LA", "LV", "LB", "LS", "LR", "LY", "LI", "LT", "LU", "MO", "MK", "MG", "MW", "MY", "MV", "ML", "MT", "MH", "MQ", "MR", "MU", "YT", "MX", "FM", "MD", "MC", "MN", "MA", "MZ", "MM", "NA", "NP", "NL", "AN", "AW", "NZ", "NI", "NE", "NG", "NO", "MP", "OM", "PK", "PW", "PA", "PG", "PY", "PE", "PH", "PL", "PT", "PR", "QA", "RE", "RO", "RU", "RW", "BL", "KN", "LC", "MF", "PM", "VC", "SA", "SN", "RS", "ME", "SL", "SG", "SK", "SI", "SO", "ZA", "ES", "LK", "SR", "SZ", "SE", "CH", "TW", "TZ", "TH", "TL", "TG", "TT", "TN", "TR", "TM", "AE", "TC", "UG", "UA", "GB", "US", "PS", "UY", "UZ", "VU", "VE", "VN", "VI", "WF", "YE", "ZM", "ZW", "JP", "CA"]
    ...
    split_tunneling_acl: list[WtpProfileSplittunnelingaclObject]  # Table field - list of typed objects
