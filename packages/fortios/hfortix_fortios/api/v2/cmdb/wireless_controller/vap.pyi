...
class VapPayload(TypedDict, total=False):
    ...
    **Usage:**
    ...
    mesh_backhaul: NotRequired[Literal["enable", "disable"]]  # Enable/disable using this VAP as a WiFi mesh backhaul
    ...
    security: NotRequired[Literal["open", "wep64", "wep128", "wpa-personal", "wpa-enterprise", "wpa-only-personal", "wpa-only-enterprise", "wpa2-only-personal", "wpa2-only-enterprise", "wpa3-enterprise", "wpa3-only-enterprise", "wpa3-enterprise-transition", "wpa3-sae", "wpa3-sae-transition", "owe", "osen"]]  # Security mode for the wireless interface
    pmf: NotRequired[Literal["disable", "enable", "optional"]]  # Protected Management Frames (PMF) support
    ...
    okc: NotRequired[Literal["disable", "enable"]]  # Enable/disable Opportunistic Key Caching (OKC)
    mbo: NotRequired[Literal["disable", "enable"]]  # Enable/disable Multiband Operation (default = disable).
    gas_comeback_delay: NotRequired[int]  # GAS comeback delay
    gas_fragmentation_limit: NotRequired[int]  # GAS fragmentation limit (512 - 4096, default = 1024).
    mbo_cell_data_conn_pref: NotRequired[Literal["excluded", "prefer-not", "prefer-use"]]  # MBO cell data connection preference
    x80211k: NotRequired[Literal["disable", "enable"]]  # Enable/disable 802.11k assisted roaming (default = enable).
    x80211v: NotRequired[Literal["disable", "enable"]]  # Enable/disable 802.11v assisted roaming (default = enable).
    neighbor_report_dual_band: NotRequired[Literal["disable", "enable"]]  # Enable/disable dual-band neighbor report (default = disable)
    fast_bss_transition: NotRequired[Literal["disable", "enable"]]  # Enable/disable 802.11r Fast BSS Transition (FT)
    ...
    eapol_key_retries: NotRequired[Literal["disable", "enable"]]  # Enable/disable retransmission of EAPOL-Key frames
    ...
    called_station_id_type: NotRequired[Literal["mac", "ip", "apname"]]  # The format type of RADIUS attribute Called-Station-Id
    mac_auth_bypass: NotRequired[Literal["enable", "disable"]]  # Enable/disable MAC authentication bypass.
    radius_mac_auth: NotRequired[Literal["enable", "disable"]]  # Enable/disable RADIUS-based MAC authentication of clients
    ...
    radius_mac_mpsk_timeout: NotRequired[int]  # RADIUS MAC MPSK cache timeout interval
    ...
    encrypt: NotRequired[Literal["TKIP", "AES", "TKIP-AES"]]  # Encryption protocol to use
    ...
    sae_h2e_only: NotRequired[Literal["enable", "disable"]]  # Use hash-to-element-only mechanism for PWE derivation
    sae_hnp_only: NotRequired[Literal["enable", "disable"]]  # Use hunting-and-pecking-only mechanism for PWE derivation
    ...
    domain_name_stripping: NotRequired[Literal["disable", "enable"]]  # Enable/disable stripping domain name from identity
    mlo: NotRequired[Literal["disable", "enable"]]  # Enable/disable WiFi7 Multi-Link-Operation
    ...
    local_standalone_dns_ip: NotRequired[list[dict[str, Any]]]  # IPv4 addresses for the local standalone DNS.
    ...
    portal_message_override_group: NotRequired[str]  # Replacement message group for this VAP
    ...
    port_macauth: NotRequired[Literal["disable", "radius", "address-group"]]  # Enable/disable LAN port MAC authentication
    port_macauth_timeout: NotRequired[int]  # LAN port MAC authentication idle timeout value
    ...
    probe_resp_suppression: NotRequired[Literal["enable", "disable"]]  # Enable/disable probe response suppression
    probe_resp_threshold: NotRequired[str]  # Minimum signal level/threshold in dBm required for the AP re
    radio_sensitivity: NotRequired[Literal["enable", "disable"]]  # Enable/disable software radio sensitivity
    quarantine: NotRequired[Literal["enable", "disable"]]  # Enable/disable station quarantine (default = disable).
    ...
    dhcp_option43_insertion: NotRequired[Literal["enable", "disable"]]  # Enable/disable insertion of DHCP option 43
    dhcp_option82_insertion: NotRequired[Literal["enable", "disable"]]  # Enable/disable DHCP option 82 insert (default = disable).
    dhcp_option82_circuit_id_insertion: NotRequired[Literal["style-1", "style-2", "style-3", "disable"]]  # Enable/disable DHCP option 82 circuit-id insert
    dhcp_option82_remote_id_insertion: NotRequired[Literal["style-1", "disable"]]  # Enable/disable DHCP option 82 remote-id insert
    ...
    eap_reauth_intv: NotRequired[int]  # EAP re-authentication interval
    ...
    osen: NotRequired[Literal["enable", "disable"]]  # Enable/disable OSEN as part of key management
    application_detection_engine: NotRequired[Literal["enable", "disable"]]  # Enable/disable application detection engine
    application_dscp_marking: NotRequired[Literal["enable", "disable"]]  # Enable/disable application attribute based DSCP marking
    ...
    l3_roaming_mode: NotRequired[Literal["direct", "indirect"]]  # Select the way that layer 3 roaming traffic is passed
...
class VapResponse(TypedDict):
    ...
    radius_mac_auth_usergroups: list[dict[str, Any]]
    ...
    selected_usergroups: list[dict[str, Any]]
...
class VapObject:
    ...
    # Virtual AP name.
    name: str
    # Enable/disable pre-authentication, where supported by clients (default = enable)
    pre_auth: Literal["enable", "disable"]
    ...
    max_clients: int
    # Maximum number of clients that can connect simultaneously to the VAP per AP radi
    max_clients_ap: int
    # IEEE 802.11 service set identifier (SSID) for the wireless interface. Users who
    ssid: str
    ...
    pmf_assoc_comeback_timeout: int
    # Protected Management Frames (PMF) SA query retry timeout interval
    pmf_sa_query_retry_timeout: int
    # Enable/disable beacon protection support (default = disable).
    beacon_protection: Literal["disable", "enable"]
    ...
    mbo_cell_data_conn_pref: Literal["excluded", "prefer-not", "prefer-use"]
    # Enable/disable 802.11k assisted roaming (default = enable).
    x80211k: Literal["disable", "enable"]
    # Enable/disable 802.11v assisted roaming (default = enable).
    x80211v: Literal["disable", "enable"]
    ...
    radius_mac_auth_block_interval: int
    # Enable/disable RADIUS-based MAC authentication of clients for MPSK authenticatio
    radius_mac_mpsk_auth: Literal["enable", "disable"]
    # RADIUS MAC MPSK cache timeout interval
    radius_mac_mpsk_timeout: int
    # Selective user groups that are permitted for RADIUS mac authentication.
    radius_mac_auth_usergroups: list[VapRadiusmacauthusergroupsObject]  # Table field - list of typed objects
    ...
    sae_hnp_only: Literal["enable", "disable"]
    # Enable/disable WPA3 SAE-PK (default = disable).
    sae_pk: Literal["enable", "disable"]
    ...
    local_standalone_dns_ip: list[dict[str, Any]]  # Multi-value field
    ...
    usergroup: list[VapUsergroupObject]  # Table field - list of typed objects
    ...
    portal_message_overrides: str
    # Captive portal functionality. Configure how the captive portal authenticates use
    portal_type: Literal["auth", "auth+disclaimer", "disclaimer", "email-collect", "cmcc", "cmcc-macauth", "auth-mac", "external-auth", "external-macauth"]
    # Selective user groups that are permitted to authenticate.
    selected_usergroups: list[VapSelectedusergroupsObject]  # Table field - list of typed objects
    ...
    intra_vap_privacy: Literal["enable", "disable"]
    # Firewall schedules for enabling this VAP on the FortiAP. This VAP will be enable
    schedule: list[VapScheduleObject]  # Table field - list of typed objects
    ...
    dynamic_vlan: Literal["enable", "disable"]
    # Enable/disable RADIUS accounting for captive portal firewall authentication sess
    captive_portal_fw_accounting: Literal["enable", "disable"]
    # Local-bridging captive portal ac-name.
    captive_portal_ac_name: str
    # Hard timeout - AP will always clear the session after timeout regardless of traf
    captive_portal_auth_timeout: int
    ...
    dhcp_address_enforcement: Literal["enable", "disable"]
    # Optional suppression of broadcast messages. For example, you can keep DHCP messa
    broadcast_suppression: Literal["dhcp-up", "dhcp-down", "dhcp-starvation", "dhcp-ucast", "arp-known", "arp-unknown", "arp-reply", "arp-poison", "arp-proxy", "netbios-ns", "netbios-ds", "ipv6", "all-other-mc", "all-other-bc"]
    # Optional rules of IPv6 packets. For example, you can keep RA, RS and so on off o
    ipv6_rules: Literal["drop-icmp6ra", "drop-icmp6rs", "drop-llmnr6", "drop-icmp6mld2", "drop-dhcp6s", "drop-dhcp6c", "ndp-proxy", "drop-ns-dad", "drop-ns-nondad"]
    # Disable multicast enhancement when this many clients are receiving multicast tra
    me_disable_thresh: int
    # Enable/disable Multi-user MIMO (default = enable).
    mu_mimo: Literal["enable", "disable"]
    # Enable/disable probe response suppression (to ignore weak signals)
    probe_resp_suppression: Literal["enable", "disable"]
    # Minimum signal level/threshold in dBm required for the AP response to probe requ
    probe_resp_threshold: str
    # Enable/disable software radio sensitivity (to ignore weak signals)
    radio_sensitivity: Literal["enable", "disable"]
    # Enable/disable station quarantine (default = disable).
    quarantine: Literal["enable", "disable"]
    # Minimum signal level/threshold in dBm required for the AP response to receive a
    radio_5g_threshold: str
    # Minimum signal level/threshold in dBm required for the AP response to receive a
    radio_2g_threshold: str
    # Table for mapping VLAN name to VLAN ID.
    vlan_name: list[VapVlannameObject]  # Table field - list of typed objects
    # Enable/disable VLAN pooling, to allow grouping of multiple wireless controller V
    vlan_pooling: Literal["wtp-group", "round-robin", "hash", "disable"]
    # VLAN pool.
    vlan_pool: list[VapVlanpoolObject]  # Table field - list of typed objects
    ...
    ptk_rekey: Literal["enable", "disable"]
    # PTK rekey interval (600 - 864000 sec, default = 86400).
    ptk_rekey_intv: int
    # Enable/disable GTK rekey for WPA security.
    gtk_rekey: Literal["enable", "disable"]
    # GTK rekey interval (600 - 864000 sec, default = 86400).
    gtk_rekey_intv: int
    ...
    rates_11ax_mcs_map: str
    # Comma separated list of max nss that supports EHT-MCS 0-9, 10-11, 12-13 for 20MH
    rates_11be_mcs_map: str
    # Comma separated list of max nss that supports EHT-MCS 0-9, 10-11, 12-13 for 160M
    rates_11be_mcs_map_160: str
    # Comma separated list of max nss that supports EHT-MCS 0-9, 10-11, 12-13 for 320M
    rates_11be_mcs_map_320: str
    # UTM profile name.
    utm_profile: str
    ...
    address_group: str
    # Configure MAC address filtering policy for MAC addresses that are in the address
    address_group_policy: Literal["disable", "allow", "deny"]
    # Enable/disable sticky client remove to maintain good signal level clients in SSI
    sticky_client_remove: Literal["enable", "disable"]
    ...
    # Time interval for client to voluntarily leave AP before forcing a disassociation
    bstm_load_balancing_disassoc_timer: int
    # Enable/disable forcing of disassociation after the BSTM request timer has been r
    bstm_disassociation_imminent: Literal["enable", "disable"]
