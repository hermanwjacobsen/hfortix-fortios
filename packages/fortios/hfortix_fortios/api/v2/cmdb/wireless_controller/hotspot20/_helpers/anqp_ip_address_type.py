"""
Validation helpers for wireless_controller/hotspot20/anqp_ip_address_type endpoint.
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for wireless_controller/hotspot20/anqp_ip_address_type.
