...
class QosMapResponse(TypedDict):
    ...
    """
    name: str
    dscp_except: list[dict[str, Any]]
    dscp_range: list[dict[str, Any]]
...
class QosMapObject:
    ...
    dscp_except: list[QosMapDscpexceptObject]  # Table field - list of typed objects
    # Differentiated Services Code Point (DSCP) ranges.
    dscp_range: list[QosMapDscprangeObject]  # Table field - list of typed objects
