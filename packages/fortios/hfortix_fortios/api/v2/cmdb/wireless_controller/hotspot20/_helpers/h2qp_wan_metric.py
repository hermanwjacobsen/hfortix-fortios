"""
Validation helpers for wireless_controller/hotspot20/h2qp_wan_metric endpoint.
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for wireless_controller/hotspot20/h2qp_wan_metric.
