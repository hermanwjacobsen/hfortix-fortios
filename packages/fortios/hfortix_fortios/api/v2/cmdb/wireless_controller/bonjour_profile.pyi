...
class BonjourProfilePayload(TypedDict, total=False):
    ...
    **Usage:**
    ...
    micro_location: NotRequired[Literal["enable", "disable"]]  # Enable/disable Micro location for Bonjour profile
...
class BonjourProfileObject:
    ...
    micro_location: Literal["enable", "disable"]
    # Bonjour policy list.
    policy_list: list[BonjourProfilePolicylistObject]  # Table field - list of typed objects
