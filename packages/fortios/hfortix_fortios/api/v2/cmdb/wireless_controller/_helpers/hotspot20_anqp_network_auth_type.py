...
def validate_wireless_controller_hotspot20_anqp_network_auth_type_get(
    ...
    **params: Any,
    ...
    """
    Validate GET request parameters for wireless-controller/hotspot20_anqp_network_auth_type.
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_wireless_controller_hotspot20_anqp_network_auth_type_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_wireless_controller_hotspot20_anqp_network_auth_type_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for wireless-controller/hotspot20_anqp_network_auth_type.
...
def validate_wireless_controller_hotspot20_anqp_network_auth_type_post(
    ...
    **params: Any,
    ...
    """
    Validate POST request to create new wireless-controller/hotspot20_anqp_network_auth_type object.
...
def validate_wireless_controller_hotspot20_anqp_network_auth_type_put(
    ...
    **params: Any,
    ...
    """
    Validate PUT request to update wireless-controller/hotspot20_anqp_network_auth_type.
    ...
    Example:
        ...
        >>> is_valid, error = validate_wireless_controller_hotspot20_anqp_network_auth_type_put(payload)
    """
...
SCHEMA_INFO = {
    "endpoint": "wireless-controller/hotspot20_anqp_network_auth_type",
    "category": "cmdb",
