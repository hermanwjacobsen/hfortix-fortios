"""
Validation helpers for wireless_controller/snmp endpoint.
...
def validate_wireless_controller_snmp_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_wireless_controller_snmp_get()
...
def validate_wireless_controller_snmp_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ... }
        >>> is_valid, error = validate_wireless_controller_snmp_post(payload)
        >>> assert is_valid == True
...
def validate_wireless_controller_snmp_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_wireless_controller_snmp_put(payload)
    """
