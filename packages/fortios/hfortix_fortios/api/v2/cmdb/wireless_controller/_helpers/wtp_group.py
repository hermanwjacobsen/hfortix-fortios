"""
Validation helpers for wireless_controller/wtp_group endpoint.
...
def validate_wireless_controller_wtp_group_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_wireless_controller_wtp_group_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_wireless_controller_wtp_group_get(name="test-item")
        >>> assert is_valid == True
...
def validate_wireless_controller_wtp_group_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload["platform-type"] = "invalid-value"
        >>> is_valid, error = validate_wireless_controller_wtp_group_post(payload)
...
def validate_wireless_controller_wtp_group_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_wireless_controller_wtp_group_put(payload)
    """
