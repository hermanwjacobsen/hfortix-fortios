"""
Validation helpers for wireless_controller/global_setting endpoint.
...
def validate_wireless_controller_global_setting_get(
    attr: str | None = None,
    filters: dict[str, Any] | None = None,
    **params: Any,
) -> tuple[bool, str | None]:
    """
    Validate GET request parameters for wireless_controller/global_setting.
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_wireless_controller_global_setting_get()
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for wireless_controller/global_setting.
...
def validate_wireless_controller_global_setting_post(
    payload: dict,
    **params: Any,
) -> tuple[bool, str | None]:
    """
    Validate POST request to create new wireless_controller/global_setting object.
    ...
    Examples:
        ...
        >>> payload = {
        ... }
        >>> is_valid, error = validate_wireless_controller_global_setting_post(payload)
        >>> assert is_valid == True
        
        >>> # ✅ Valid - With enum field
        >>> payload = {
        ...     "image-download": "enable",  # Valid enum value
        ... }
        >>> is_valid, error = validate_wireless_controller_global_setting_post(payload)
        >>> assert is_valid == True
...
def validate_wireless_controller_global_setting_put(
    payload: dict,
    **params: Any,
) -> tuple[bool, str | None]:
    """
    Validate PUT request to update wireless_controller/global_setting.
    ...
    Example:
        ...
        >>> is_valid, error = validate_wireless_controller_global_setting_put(payload)
    """
