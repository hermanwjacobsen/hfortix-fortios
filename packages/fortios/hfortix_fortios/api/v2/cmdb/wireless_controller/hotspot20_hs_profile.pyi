...
class Hotspot20HsProfilePayload(TypedDict, total=False):
    """
    Type hints for wireless-controller/hotspot20_hs_profile payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: Hotspot20HsProfilePayload = {
...
class Hotspot20HsProfile:
    ...
    Path: wireless-controller/hotspot20_hs_profile
    Category: cmdb
    Primary Key: name
    """
    ...
    def post(
        self,
        payload_dict: Hotspot20HsProfilePayload | None = ...,
        name: str | None = ...,
        release: int | None = ...,
