...
def validate_certificate_remote_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_certificate_remote_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_certificate_remote_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for certificate/remote.
...
def validate_certificate_remote_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        ...     "name": True,  # Name.
        ... }
        >>> is_valid, error = validate_certificate_remote_post(payload)
        >>> assert is_valid == True
...
def validate_certificate_remote_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_certificate_remote_put(payload)
    """
