...
def validate_certificate_crl_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_certificate_crl_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_certificate_crl_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for certificate/crl.
...
def validate_certificate_crl_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        ...     "name": True,  # Name.
        ... }
        >>> is_valid, error = validate_certificate_crl_post(payload)
        >>> assert is_valid == True
...
def validate_certificate_crl_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_certificate_crl_put(payload)
    """
