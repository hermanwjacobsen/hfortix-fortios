...
def validate_certificate_ca_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_certificate_ca_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_certificate_ca_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for certificate/ca.
...
def validate_certificate_ca_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_certificate_ca_put(payload)
    """
