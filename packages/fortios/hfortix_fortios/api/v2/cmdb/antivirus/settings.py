...
class Settings:
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new antivirus/settings object.
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.antivirus_settings.post(payload_dict=payload)
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete antivirus/settings object.
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.antivirus_settings.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.cmdb.antivirus_settings.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.cmdb.antivirus_settings.exists(name="old-object"):
            ...     fgt.api.cmdb.antivirus_settings.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update antivirus/settings object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.cmdb.antivirus_settings.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.cmdb.antivirus_settings.set(payload_dict=obj_data)
