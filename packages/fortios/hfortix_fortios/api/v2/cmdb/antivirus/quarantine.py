...
class Quarantine:
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new antivirus/quarantine object.
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.antivirus_quarantine.post(payload_dict=payload)
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete antivirus/quarantine object.
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.antivirus_quarantine.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.cmdb.antivirus_quarantine.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.cmdb.antivirus_quarantine.exists(name="old-object"):
            ...     fgt.api.cmdb.antivirus_quarantine.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update antivirus/quarantine object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.cmdb.antivirus_quarantine.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.cmdb.antivirus_quarantine.set(payload_dict=obj_data)
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(Quarantine.help("agelimit"))
        """
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = Quarantine.field_info("agelimit")
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = Quarantine.validate_field("agelimit", "test")
            >>> if not is_valid:
