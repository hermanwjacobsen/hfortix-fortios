...
class ReplacemsgSpamPayload(TypedDict, total=False):
    """
    Type hints for system/replacemsg_spam payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: ReplacemsgSpamPayload = {
...
class ReplacemsgSpam:
    ...
    def post(
        self,
        payload_dict: ReplacemsgSpamPayload | None = ...,
        msg_type: str | None = ...,
        buffer: str | None = ...,
