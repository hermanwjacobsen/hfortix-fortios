...
class ReplacemsgSslvpnPayload(TypedDict, total=False):
    """
    Type hints for system/replacemsg_sslvpn payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: ReplacemsgSslvpnPayload = {
...
class ReplacemsgSslvpn:
    ...
    def post(
        self,
        payload_dict: ReplacemsgSslvpnPayload | None = ...,
        msg_type: str | None = ...,
        buffer: str | None = ...,
