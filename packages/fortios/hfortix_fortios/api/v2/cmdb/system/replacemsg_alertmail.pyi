...
class ReplacemsgAlertmailPayload(TypedDict, total=False):
    """
    Type hints for system/replacemsg_alertmail payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: ReplacemsgAlertmailPayload = {
...
class ReplacemsgAlertmail:
    ...
    Path: system/replacemsg_alertmail
    Category: cmdb
    ...
    def post(
        self,
        payload_dict: ReplacemsgAlertmailPayload | None = ...,
        msg_type: str | None = ...,
        buffer: str | None = ...,
