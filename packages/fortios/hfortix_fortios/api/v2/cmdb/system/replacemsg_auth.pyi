...
class ReplacemsgAuthPayload(TypedDict, total=False):
    """
    Type hints for system/replacemsg_auth payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: ReplacemsgAuthPayload = {
...
class ReplacemsgAuth:
    ...
    def post(
        self,
        payload_dict: ReplacemsgAuthPayload | None = ...,
        msg_type: str | None = ...,
        buffer: str | None = ...,
