...
class SshConfig:
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new system/ssh_config object.
        ...
        Examples:
            ...
            >>> payload = SshConfig.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.cmdb.system_ssh_config.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(SshConfig.required_fields()) }}
            
            Use SshConfig.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete system/ssh_config object.
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.system_ssh_config.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.cmdb.system_ssh_config.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.cmdb.system_ssh_config.exists(name="old-object"):
            ...     fgt.api.cmdb.system_ssh_config.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update system/ssh_config object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.cmdb.system_ssh_config.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.cmdb.system_ssh_config.set(payload_dict=obj_data)
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(SshConfig.help())
            
            >>> # Get field information
            >>> print(SshConfig.help("ssh-kex-algo"))
        """
        from ._helpers.ssh_config import (
            get_schema_info,
            get_field_metadata,
        )
    ...
    def fields(detailed: bool = False) -> Union[list[str], dict[str, dict]]:
        ...
        Examples:
            >>> # Simple list
            >>> fields = SshConfig.fields()
            >>> print(f"Available fields: {len(fields)}")
            
            >>> # Detailed info
            >>> fields = SshConfig.fields(detailed=True)
            >>> for name, meta in fields.items():
            ...     print(f"{name}: {meta['type']}")
        """
        from ._helpers.ssh_config import get_all_fields, get_field_metadata
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = SshConfig.field_info("ssh-kex-algo")
            >>> print(f"Type: {info['type']}")
            >>> if 'options' in info:
            ...     print(f"Options: {info['options']}")
        """
        from ._helpers.ssh_config import get_field_metadata
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = SshConfig.validate_field("ssh-kex-algo", "test")
            >>> if not is_valid:
            ...     print(f"Validation error: {error}")
        """
        from ._helpers.ssh_config import validate_field_value
    ...
    def required_fields() -> list[str]:
        ...
        Examples:
            >>> required = SshConfig.required_fields()
            >>> print(f"Required fields: {', '.join(required)}")
        """
        from ._helpers.ssh_config import REQUIRED_FIELDS
    ...
    def defaults() -> dict[str, Any]:
        ...
        Examples:
            >>> defaults = SshConfig.defaults()
            >>> print(f"Fields with defaults: {len(defaults)}")
            >>> # Use as starting point for payload
            >>> payload = defaults.copy()
            >>> payload['name'] = 'my-custom-name'
        """
        from ._helpers.ssh_config import FIELDS_WITH_DEFAULTS
    ...
    def schema() -> dict[str, Any]:
        ...
        """
        from ._helpers.ssh_config import get_schema_info
