...
class ReplacemsgAdminPayload(TypedDict, total=False):
    """
    Type hints for system/replacemsg_admin payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: ReplacemsgAdminPayload = {
...
class ReplacemsgAdmin:
    ...
    def post(
        self,
        payload_dict: ReplacemsgAdminPayload | None = ...,
        msg_type: str | None = ...,
        buffer: str | None = ...,
