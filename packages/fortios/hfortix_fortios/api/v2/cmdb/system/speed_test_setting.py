...
class SpeedTestSetting:
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new system/speed_test_setting object.
        ...
        Examples:
            ...
            >>> payload = SpeedTestSetting.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.cmdb.system_speed_test_setting.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(SpeedTestSetting.required_fields()) }}
            
            Use SpeedTestSetting.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete system/speed_test_setting object.
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.system_speed_test_setting.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.cmdb.system_speed_test_setting.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.cmdb.system_speed_test_setting.exists(name="old-object"):
            ...     fgt.api.cmdb.system_speed_test_setting.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update system/speed_test_setting object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.cmdb.system_speed_test_setting.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.cmdb.system_speed_test_setting.set(payload_dict=obj_data)
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(SpeedTestSetting.help())
            
            >>> # Get field information
            >>> print(SpeedTestSetting.help("latency-threshold"))
        """
        from ._helpers.speed_test_setting import (
            get_schema_info,
            get_field_metadata,
        )
    ...
    def fields(detailed: bool = False) -> Union[list[str], dict[str, dict]]:
        ...
        Examples:
            >>> # Simple list
            >>> fields = SpeedTestSetting.fields()
            >>> print(f"Available fields: {len(fields)}")
            
            >>> # Detailed info
            >>> fields = SpeedTestSetting.fields(detailed=True)
            >>> for name, meta in fields.items():
            ...     print(f"{name}: {meta['type']}")
        """
        from ._helpers.speed_test_setting import get_all_fields, get_field_metadata
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = SpeedTestSetting.field_info("latency-threshold")
            >>> print(f"Type: {info['type']}")
            >>> if 'options' in info:
            ...     print(f"Options: {info['options']}")
        """
        from ._helpers.speed_test_setting import get_field_metadata
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = SpeedTestSetting.validate_field("latency-threshold", "test")
            >>> if not is_valid:
            ...     print(f"Validation error: {error}")
        """
        from ._helpers.speed_test_setting import validate_field_value
    ...
    def required_fields() -> list[str]:
        ...
        Examples:
            >>> required = SpeedTestSetting.required_fields()
            >>> print(f"Required fields: {', '.join(required)}")
        """
        from ._helpers.speed_test_setting import REQUIRED_FIELDS
    ...
    def defaults() -> dict[str, Any]:
        ...
        Examples:
            >>> defaults = SpeedTestSetting.defaults()
            >>> print(f"Fields with defaults: {len(defaults)}")
            >>> # Use as starting point for payload
            >>> payload = defaults.copy()
            >>> payload['name'] = 'my-custom-name'
        """
        from ._helpers.speed_test_setting import FIELDS_WITH_DEFAULTS
    ...
    def schema() -> dict[str, Any]:
        ...
        Examples:
            >>> schema = SpeedTestSetting.schema()
            >>> print(f"Endpoint: {schema['endpoint']}")
            >>> print(f"Total fields: {schema['total_fields']}")
            >>> print(f"Primary key: {schema.get('mkey', 'N/A')}")
        """
        from ._helpers.speed_test_setting import get_schema_info
