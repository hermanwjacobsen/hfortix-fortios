...
class ReplacemsgMailPayload(TypedDict, total=False):
    """
    Type hints for system/replacemsg_mail payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: ReplacemsgMailPayload = {
...
class ReplacemsgMail:
    ...
    def post(
        self,
        payload_dict: ReplacemsgMailPayload | None = ...,
        msg_type: str | None = ...,
        buffer: str | None = ...,
