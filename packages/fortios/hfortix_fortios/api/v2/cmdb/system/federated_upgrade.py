...
class FederatedUpgrade:
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new system/federated_upgrade object.
        ...
        Examples:
            ...
            >>> payload = FederatedUpgrade.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.cmdb.system_federated_upgrade.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(FederatedUpgrade.required_fields()) }}
            
            Use FederatedUpgrade.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete system/federated_upgrade object.
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.system_federated_upgrade.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.cmdb.system_federated_upgrade.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.cmdb.system_federated_upgrade.exists(name="old-object"):
            ...     fgt.api.cmdb.system_federated_upgrade.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update system/federated_upgrade object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.cmdb.system_federated_upgrade.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.cmdb.system_federated_upgrade.set(payload_dict=obj_data)
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(FederatedUpgrade.help())
            
            >>> # Get field information
            >>> print(FederatedUpgrade.help("status"))
        """
        from ._helpers.federated_upgrade import (
            get_schema_info,
            get_field_metadata,
        )
    ...
    def fields(detailed: bool = False) -> Union[list[str], dict[str, dict]]:
        ...
        Examples:
            >>> # Simple list
            >>> fields = FederatedUpgrade.fields()
            >>> print(f"Available fields: {len(fields)}")
            
            >>> # Detailed info
            >>> fields = FederatedUpgrade.fields(detailed=True)
            >>> for name, meta in fields.items():
            ...     print(f"{name}: {meta['type']}")
        """
        from ._helpers.federated_upgrade import get_all_fields, get_field_metadata
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = FederatedUpgrade.field_info("status")
            >>> print(f"Type: {info['type']}")
            >>> if 'options' in info:
            ...     print(f"Options: {info['options']}")
        """
        from ._helpers.federated_upgrade import get_field_metadata
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = FederatedUpgrade.validate_field("status", "test")
            >>> if not is_valid:
            ...     print(f"Validation error: {error}")
        """
        from ._helpers.federated_upgrade import validate_field_value
    ...
    def required_fields() -> list[str]:
        ...
        Examples:
            >>> required = FederatedUpgrade.required_fields()
            >>> print(f"Required fields: {', '.join(required)}")
        """
        from ._helpers.federated_upgrade import REQUIRED_FIELDS
    ...
    def defaults() -> dict[str, Any]:
        ...
        Examples:
            >>> defaults = FederatedUpgrade.defaults()
            >>> print(f"Fields with defaults: {len(defaults)}")
            >>> # Use as starting point for payload
            >>> payload = defaults.copy()
            >>> payload['name'] = 'my-custom-name'
        """
        from ._helpers.federated_upgrade import FIELDS_WITH_DEFAULTS
    ...
    def schema() -> dict[str, Any]:
        ...
        Examples:
            >>> schema = FederatedUpgrade.schema()
            >>> print(f"Endpoint: {schema['endpoint']}")
            >>> print(f"Total fields: {schema['total_fields']}")
            >>> print(f"Primary key: {schema.get('mkey', 'N/A')}")
        """
        from ._helpers.federated_upgrade import get_schema_info
