...
class Interface:
    ...
    def post(
        ...
        ip: str | None = ...,
        allowaccess: Literal["ping", "https", "ssh", "snmp", "http", "telnet", "fgfm", "radius-acct", "probe-response", "fabric", "ftm", "speed-test", "scim"] | None = ...,
        gwdetect: Literal["enable", "disable"] | None = ...,
        ping_serv_status: int | None = ...,
        detectserver: str | None = ...,
        detectprotocol: Literal["ping", "tcp-echo", "udp-echo"] | None = ...,
        ha_priority: int | None = ...,
        fail_detect: Literal["enable", "disable"] | None = ...,
        fail_detect_option: Literal["detectserver", "link-down"] | None = ...,
        ...
        dns_server_protocol: Literal["cleartext", "dot", "doh"] | None = ...,
        ...
        exclude_signatures: Literal["iot", "ot"] | None = ...,
        ...
        dhcp_snooping_server_list: list[dict[str, Any]] | None = ...,
