...
class LldpNetworkPolicyPayload(TypedDict, total=False):
    """
    Type hints for system/lldp_network_policy payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: LldpNetworkPolicyPayload = {
...
class LldpNetworkPolicy:
    ...
    Path: system/lldp_network_policy
    Category: cmdb
    Primary Key: name
    """
    ...
    def post(
        self,
        payload_dict: LldpNetworkPolicyPayload | None = ...,
        name: str | None = ...,
        comment: str | None = ...,
        voice: str | None = ...,
