...
class ReplacemsgAutomationPayload(TypedDict, total=False):
    """
    Type hints for system/replacemsg_automation payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: ReplacemsgAutomationPayload = {
...
class ReplacemsgAutomation:
    ...
    Path: system/replacemsg_automation
    Category: cmdb
    ...
    def post(
        self,
        payload_dict: ReplacemsgAutomationPayload | None = ...,
        msg_type: str | None = ...,
        buffer: str | None = ...,
