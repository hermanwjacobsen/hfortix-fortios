...
class ZoneObject:
    ...
    tagging: list[ZoneTaggingObject]  # Table field - list of typed objects
    # Description.
    description: str
    # Allow or deny traffic routing between different interfaces in the same zone
    intrazone: Literal["allow", "deny"]
    # Add interfaces to this zone. Interfaces must not be assigned to another zone or
    interface: list[ZoneInterfaceObject]  # Table field - list of typed objects
