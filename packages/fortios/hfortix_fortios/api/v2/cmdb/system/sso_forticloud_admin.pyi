...
class SsoForticloudAdminObject:
    ...
    name: str
    # FortiCloud SSO admin user access profile. Permission is set to read-only without
    accprofile: str
    # Virtual domain(s) that the administrator can access.
    vdom: list[SsoForticloudAdminVdomObject]  # Table field - list of typed objects
