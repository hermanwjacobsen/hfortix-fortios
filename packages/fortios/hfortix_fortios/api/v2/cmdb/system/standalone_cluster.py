...
class StandaloneCluster:
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new system/standalone_cluster object.
        ...
        Examples:
            ...
            >>> payload = StandaloneCluster.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.cmdb.system_standalone_cluster.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(StandaloneCluster.required_fields()) }}
            
            Use StandaloneCluster.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete system/standalone_cluster object.
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.system_standalone_cluster.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.cmdb.system_standalone_cluster.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.cmdb.system_standalone_cluster.exists(name="old-object"):
            ...     fgt.api.cmdb.system_standalone_cluster.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update system/standalone_cluster object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.cmdb.system_standalone_cluster.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.cmdb.system_standalone_cluster.set(payload_dict=obj_data)
