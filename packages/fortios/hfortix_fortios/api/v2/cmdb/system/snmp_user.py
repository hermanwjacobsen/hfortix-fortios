"""
FortiOS CMDB - System snmp_user

Configuration endpoint for managing cmdb system/snmp_user objects.
...
class SnmpUser:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        """
        Retrieve system/snmp_user configuration.
        ...
        Examples:
            >>> # Get all system/snmp_user objects
            >>> result = fgt.api.cmdb.system_snmp_user.get()
            >>> print(f"Found {len(result['results'])} objects")
            
            >>> # Get specific system/snmp_user by name
            ...
            >>> schema = fgt.api.cmdb.system_snmp_user.get(action="schema")

        See Also:
            - post(): Create new system/snmp_user object
            - put(): Update existing system/snmp_user object
            - delete(): Remove system/snmp_user object
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update existing system/snmp_user object.
        ...
        if DEPRECATED_FIELDS:
            ...
            check_deprecated_fields(
                ...
                endpoint="cmdb/system/snmp_user",
            )
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new system/snmp_user object.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete system/snmp_user object.
    ...
    def exists(
        ...
        """
        Check if system/snmp_user object exists.
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update system/snmp_user object (intelligent operation).
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(SnmpUser.help("name"))
        """
        from ._helpers.snmp_user import (
            get_schema_info,
            get_field_metadata,
        )
    ...
    def fields(detailed: bool = False) -> Union[list[str], dict[str, dict]]:
        ...
        Examples:
            >>> # Simple list
            >>> fields = SnmpUser.fields()
            >>> print(f"Available fields: {len(fields)}")
            
            >>> # Detailed info
            >>> fields = SnmpUser.fields(detailed=True)
            >>> for name, meta in fields.items():
            ...     print(f"{name}: {meta['type']}")
        """
        from ._helpers.snmp_user import get_all_fields, get_field_metadata
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = SnmpUser.field_info("name")
            >>> print(f"Type: {info['type']}")
            >>> if 'options' in info:
            ...     print(f"Options: {info['options']}")
        """
        from ._helpers.snmp_user import get_field_metadata
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = SnmpUser.validate_field("name", "test")
            >>> if not is_valid:
            ...     print(f"Validation error: {error}")
        """
        from ._helpers.snmp_user import validate_field_value
    ...
    def required_fields() -> list[str]:
        ...
        Examples:
            >>> required = SnmpUser.required_fields()
            >>> print(f"Required fields: {', '.join(required)}")
        """
        from ._helpers.snmp_user import REQUIRED_FIELDS
    ...
    def defaults() -> dict[str, Any]:
        ...
        Examples:
            >>> defaults = SnmpUser.defaults()
            >>> print(f"Fields with defaults: {len(defaults)}")
            >>> # Use as starting point for payload
            >>> payload = defaults.copy()
            >>> payload['name'] = 'my-custom-name'
        """
        from ._helpers.snmp_user import FIELDS_WITH_DEFAULTS
    ...
    def schema() -> dict[str, Any]:
        ...
        Examples:
            >>> schema = SnmpUser.schema()
            >>> print(f"Endpoint: {schema['endpoint']}")
            >>> print(f"Total fields: {schema['total_fields']}")
            >>> print(f"Primary key: {schema.get('mkey', 'N/A')}")
        """
        from ._helpers.snmp_user import get_schema_info
