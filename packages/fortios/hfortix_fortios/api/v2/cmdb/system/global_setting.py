"""
FortiOS CMDB - System global_setting

Configuration endpoint for managing cmdb system/global_setting objects.

API Endpoints:
    GET    /cmdb/system/global_setting
    POST   /cmdb/system/global_setting
    PUT    /cmdb/system/global_setting/{identifier}
    DELETE /cmdb/system/global_setting/{identifier}
...
Example Usage:
    ...
    >>>
    >>> # List all items
    >>> items = fgt.api.cmdb.system_global_setting.get()
...
class GlobalSetting:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        """
        Retrieve system/global_setting configuration.
        ...
        Examples:
            >>> # Get all system/global_setting objects
            >>> result = fgt.api.cmdb.system_global_setting.get()
            ...
            >>> schema = fgt.api.cmdb.system_global_setting.get(action="schema")

        See Also:
            - post(): Create new system/global_setting object
            - put(): Update existing system/global_setting object
            - delete(): Remove system/global_setting object
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update existing system/global_setting object.
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.system_global_setting.put(
            ...
            ...     "field1": "new-value",
            ... }
            >>> result = fgt.api.cmdb.system_global_setting.put(payload_dict=payload)
        ...
        if DEPRECATED_FIELDS:
            ...
            check_deprecated_fields(
                ...
                endpoint="cmdb/system/global_setting",
            )
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new system/global_setting object.
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.system_global_setting.post(
            ...     name="example",
            ...
            >>> result = fgt.api.cmdb.system_global_setting.post(payload_dict=payload)
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete system/global_setting object.
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.system_global_setting.delete(name="object-to-delete")
    ...
    def exists(
        ...
        """
        Check if system/global_setting object exists.
        ...
        Examples:
            ...
            >>> if fgt.api.cmdb.system_global_setting.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.cmdb.system_global_setting.exists(name="old-object"):
            ...     fgt.api.cmdb.system_global_setting.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update system/global_setting object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.cmdb.system_global_setting.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.cmdb.system_global_setting.set(payload_dict=obj_data)
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(GlobalSetting.help("language"))
        """
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = GlobalSetting.field_info("language")
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = GlobalSetting.validate_field("language", "test")
            >>> if not is_valid:
