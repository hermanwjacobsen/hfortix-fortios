...
class GeoipOverrideIp6rangeObject:
    ...
    start_ip: str
    # Ending IP address, inclusive, of the address range
    end_ip: str
...
class GeoipOverrideObject:
    ...
    ip_range: list[GeoipOverrideIprangeObject]  # Table field - list of typed objects
    # Table of IPv6 ranges assigned to country.
    ip6_range: list[GeoipOverrideIp6rangeObject]  # Table field - list of typed objects
