"""
FortiOS CMDB - System snmp_community

Configuration endpoint for managing cmdb system/snmp_community objects.
...
class SnmpCommunity:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        """
        Retrieve system/snmp_community configuration.
        ...
        Examples:
            >>> # Get all system/snmp_community objects
            >>> result = fgt.api.cmdb.system_snmp_community.get()
            >>> print(f"Found {len(result['results'])} objects")
            
            >>> # Get specific system/snmp_community by id
            ...
            >>> schema = fgt.api.cmdb.system_snmp_community.get(action="schema")

        See Also:
            - post(): Create new system/snmp_community object
            - put(): Update existing system/snmp_community object
            - delete(): Remove system/snmp_community object
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update existing system/snmp_community object.
        ...
        if DEPRECATED_FIELDS:
            ...
            check_deprecated_fields(
                ...
                endpoint="cmdb/system/snmp_community",
            )
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new system/snmp_community object.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete system/snmp_community object.
    ...
    def exists(
        ...
        """
        Check if system/snmp_community object exists.
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update system/snmp_community object (intelligent operation).
