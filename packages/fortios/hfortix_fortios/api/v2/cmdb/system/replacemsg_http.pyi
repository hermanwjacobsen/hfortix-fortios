...
class ReplacemsgHttpPayload(TypedDict, total=False):
    """
    Type hints for system/replacemsg_http payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: ReplacemsgHttpPayload = {
...
class ReplacemsgHttp:
    ...
    def post(
        self,
        payload_dict: ReplacemsgHttpPayload | None = ...,
        msg_type: str | None = ...,
        buffer: str | None = ...,
