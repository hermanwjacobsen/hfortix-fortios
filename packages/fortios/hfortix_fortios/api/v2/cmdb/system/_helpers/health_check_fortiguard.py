...
def validate_system_health_check_fortiguard_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_system_health_check_fortiguard_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_system_health_check_fortiguard_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for system/health_check_fortiguard.
...
def validate_system_health_check_fortiguard_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "name": True,  # Status check or predefined health-check targets na
        ...     "server": True,  # Status check or predefined health-check domain nam
        ... }
...
def validate_system_health_check_fortiguard_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_system_health_check_fortiguard_put(payload)
    """
