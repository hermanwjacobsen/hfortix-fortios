...
def validate_system_ipsec_aggregate_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_system_ipsec_aggregate_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_system_ipsec_aggregate_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for system/ipsec_aggregate.
...
def validate_system_ipsec_aggregate_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "member": True,  # Member tunnels of the aggregate.
        ... }
        ...
        >>> payload["algorithm"] = "invalid-value"
        >>> is_valid, error = validate_system_ipsec_aggregate_post(payload)
...
def validate_system_ipsec_aggregate_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_system_ipsec_aggregate_put(payload)
    """
