...
def validate_system_ipip_tunnel_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_system_ipip_tunnel_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_system_ipip_tunnel_get(name="test-item")
        >>> assert is_valid == True
...
def validate_system_ipip_tunnel_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "interface": True,  # Interface name that is associated with the incomin
        ... }
...
def validate_system_ipip_tunnel_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_system_ipip_tunnel_put(payload)
    """
