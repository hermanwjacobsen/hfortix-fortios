...
def validate_system_vdom_exception_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_system_vdom_exception_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by id
        >>> is_valid, error = validate_system_vdom_exception_get(id="test-item")
        >>> assert is_valid == True
...
def validate_system_vdom_exception_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "object": True,  # Name of the configuration object that can be confi
        ... }
...
def validate_system_vdom_exception_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_system_vdom_exception_put(payload)
    """
