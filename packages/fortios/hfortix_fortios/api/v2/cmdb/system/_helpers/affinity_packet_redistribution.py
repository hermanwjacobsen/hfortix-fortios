...
def validate_system_affinity_packet_redistribution_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_system_affinity_packet_redistribution_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by id
        >>> is_valid, error = validate_system_affinity_packet_redistribution_get(id="test-item")
        >>> assert is_valid == True
...
def validate_system_affinity_packet_redistribution_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "interface": True,  # Physical interface name on which to perform packet
        ... }
        ...
        >>> payload["round-robin"] = "invalid-value"
        >>> is_valid, error = validate_system_affinity_packet_redistribution_post(payload)
...
def validate_system_affinity_packet_redistribution_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_system_affinity_packet_redistribution_put(payload)
    """
