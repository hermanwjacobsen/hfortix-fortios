...
def validate_system_api_user_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_system_api_user_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_system_api_user_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for system/api_user.
...
def validate_system_api_user_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "accprofile": True,  # Admin user access profile.
        ...     "peer-group": True,  # Peer group name.
        ... }
        ...
        >>> payload["peer-auth"] = "invalid-value"
        >>> is_valid, error = validate_system_api_user_post(payload)
...
def validate_system_api_user_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_system_api_user_put(payload)
    """
