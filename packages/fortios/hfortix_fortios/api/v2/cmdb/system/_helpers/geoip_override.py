...
def validate_system_geoip_override_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_system_geoip_override_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_system_geoip_override_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for system/geoip_override.
...
def validate_system_geoip_override_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        ... }
        >>> is_valid, error = validate_system_geoip_override_post(payload)
        >>> assert is_valid == True
...
def validate_system_geoip_override_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_system_geoip_override_put(payload)
    """
