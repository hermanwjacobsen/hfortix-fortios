...
def validate_system_network_visibility_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_system_network_visibility_get()
...
def validate_system_network_visibility_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload["destination-visibility"] = "invalid-value"
        >>> is_valid, error = validate_system_network_visibility_post(payload)
...
def validate_system_network_visibility_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_system_network_visibility_put(payload)
    """
