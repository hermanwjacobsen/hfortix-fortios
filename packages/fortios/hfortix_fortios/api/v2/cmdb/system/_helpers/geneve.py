...
REQUIRED_FIELDS = [
    ...
    "ip-version",  # IP version to use for the GENEVE interface and so for commun
    "name",  # GENEVE device or interface name. Must be an unique interface
    "remote-ip",  # IPv4 address of the GENEVE interface on the device at the re
    "remote-ip6",  # IPv6 IP address of the GENEVE interface on the device at the
    "type",  # GENEVE type.
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for system_geneve.
