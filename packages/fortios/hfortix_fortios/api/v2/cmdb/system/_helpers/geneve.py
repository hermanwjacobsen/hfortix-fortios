...
def validate_system_geneve_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_system_geneve_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_system_geneve_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for system/geneve.
...
def validate_system_geneve_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "interface": True,  # Outgoing interface for GENEVE encapsulated traffic
        ... }
...
def validate_system_geneve_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_system_geneve_put(payload)
    """
