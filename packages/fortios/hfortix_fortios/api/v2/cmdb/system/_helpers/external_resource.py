...
def validate_system_external_resource_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_system_external_resource_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_system_external_resource_get(name="test-item")
        >>> assert is_valid == True
...
def validate_system_external_resource_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "name": True,  # External resource name.
        ...     "resource": True,  # URL of external resource.
        ... }
...
def validate_system_external_resource_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_system_external_resource_put(payload)
    """
