...
def validate_system_dedicated_mgmt_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_system_dedicated_mgmt_get()
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for system/dedicated_mgmt.
...
def validate_system_dedicated_mgmt_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_system_dedicated_mgmt_put(payload)
    """
