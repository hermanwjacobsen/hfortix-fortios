...
def validate_system_lldp_network_policy_get(
    ...
    **params: Any,
    ...
    """
    Validate GET request parameters for system/lldp_network_policy.
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for system/lldp_network_policy.
...
def validate_system_lldp_network_policy_post(
    ...
    **params: Any,
    ...
    """
    Validate POST request to create new system/lldp_network_policy object.
...
def validate_system_lldp_network_policy_put(
    ...
    **params: Any,
    ...
    """
    Validate PUT request to update system/lldp_network_policy.
...
SCHEMA_INFO = {
    "endpoint": "system/lldp_network_policy",
    "category": "cmdb",
