...
REQUIRED_FIELDS = [
    ...
    "name",  # Zone name.
    "ttl",  # Default time-to-live value for the entries of this DNS zone
    "type",  # Zone type (primary to manage entries directly, secondary to
    "view",  # Zone view (public to serve public clients, shadow to serve i
]
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for system_dns-database.
