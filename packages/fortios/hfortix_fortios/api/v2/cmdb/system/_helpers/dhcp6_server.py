...
def validate_system_dhcp6_server_get(
    ...
    **params: Any,
    ...
    """
    Validate GET request parameters for system/dhcp6_server.
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for system/dhcp6_server.
...
def validate_system_dhcp6_server_post(
    ...
    **params: Any,
    ...
    """
    Validate POST request to create new system/dhcp6_server object.
...
def validate_system_dhcp6_server_put(
    ...
    **params: Any,
    ...
    """
    Validate PUT request to update system/dhcp6_server.
