...
REQUIRED_FIELDS = [
    "delegated-prefix-iaid",  # IAID of obtained delegated-prefix from the upstream interfac
    "id",  # ID.
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for system_dhcp6_server.
