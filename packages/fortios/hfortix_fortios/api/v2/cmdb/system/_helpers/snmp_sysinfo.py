...
def validate_system_snmp_sysinfo_get(
    ...
    **params: Any,
    ...
    """
    Validate GET request parameters for system/snmp_sysinfo.
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for system/snmp_sysinfo.
...
def validate_system_snmp_sysinfo_post(
    ...
    **params: Any,
    ...
    """
    Validate POST request to create new system/snmp_sysinfo object.
...
def validate_system_snmp_sysinfo_put(
    ...
    **params: Any,
    ...
    """
    Validate PUT request to update system/snmp_sysinfo.
