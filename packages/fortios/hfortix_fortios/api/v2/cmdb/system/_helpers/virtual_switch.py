...
def validate_system_virtual_switch_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_system_virtual_switch_get()
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for system/virtual_switch.
...
def validate_system_virtual_switch_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ... }
        >>> is_valid, error = validate_system_virtual_switch_post(payload)
        >>> assert is_valid == True
...
def validate_system_virtual_switch_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_system_virtual_switch_put(payload)
    """
