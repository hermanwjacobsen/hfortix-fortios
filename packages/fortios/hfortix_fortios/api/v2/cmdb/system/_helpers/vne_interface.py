...
def validate_system_vne_interface_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_system_vne_interface_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_system_vne_interface_get(name="test-item")
        >>> assert is_valid == True
...
def validate_system_vne_interface_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        ...     "bmr-hostname": True,  # BMR hostname.
        ... }
        ...
        >>> payload["auto-asic-offload"] = "invalid-value"
        >>> is_valid, error = validate_system_vne_interface_post(payload)
...
def validate_system_vne_interface_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_system_vne_interface_put(payload)
    """
