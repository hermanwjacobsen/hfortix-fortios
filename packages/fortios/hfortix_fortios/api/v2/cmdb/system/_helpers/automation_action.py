...
REQUIRED_FIELDS = [
    ...
    "forticare-email",  # Enable/disable use of your FortiCare email address as the em
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for system_automation-action.
