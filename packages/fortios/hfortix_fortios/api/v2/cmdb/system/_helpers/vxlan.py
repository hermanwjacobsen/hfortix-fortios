...
def validate_system_vxlan_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_system_vxlan_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_system_vxlan_get(name="test-item")
        >>> assert is_valid == True
...
def validate_system_vxlan_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "interface": True,  # Outgoing interface for VXLAN encapsulated traffic.
        ...     "remote-ip6": True,  # IPv6 IP address of the VXLAN interface on the devi
        ... }
...
def validate_system_vxlan_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_system_vxlan_put(payload)
    """
