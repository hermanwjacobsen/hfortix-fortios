...
def validate_system_affinity_interrupt_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_system_affinity_interrupt_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by id
        >>> is_valid, error = validate_system_affinity_interrupt_get(id="test-item")
        >>> assert is_valid == True
...
def validate_system_affinity_interrupt_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "interrupt": True,  # Interrupt name.
        ...     "affinity-cpumask": True,  # Affinity setting (64-bit hexadecimal value in the 
        ... }
        >>> is_valid, error = validate_system_affinity_interrupt_post(payload)
        >>> assert is_valid == True
...
def validate_system_affinity_interrupt_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_system_affinity_interrupt_put(payload)
    """
