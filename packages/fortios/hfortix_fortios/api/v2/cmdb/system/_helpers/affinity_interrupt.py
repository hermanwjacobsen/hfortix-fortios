...
REQUIRED_FIELDS = [
    "affinity-cpumask",  # Affinity setting (64-bit hexadecimal value in the format of
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for system_affinity-interrupt.
