...
class TosBasedPriorityPayload(TypedDict, total=False):
    ...
    **Usage:**
    ...
    tos: NotRequired[int]  # Value of the ToS byte in the IP datagram header
    priority: NotRequired[Literal["low", "medium", "high"]]  # ToS based priority level to low, medium or high
