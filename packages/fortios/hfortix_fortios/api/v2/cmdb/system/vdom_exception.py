    ...
    def put(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            id: Index (1 - 4096).
            object_: Name of the configuration object that can be configured independently for all VDOMs.
