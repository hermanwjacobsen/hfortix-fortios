...
class ReplacemsgTrafficQuotaPayload(TypedDict, total=False):
    """
    Type hints for system/replacemsg_traffic_quota payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: ReplacemsgTrafficQuotaPayload = {
...
class ReplacemsgTrafficQuota:
    ...
    Path: system/replacemsg_traffic_quota
    Category: cmdb
    ...
    def post(
        self,
        payload_dict: ReplacemsgTrafficQuotaPayload | None = ...,
        msg_type: str | None = ...,
        buffer: str | None = ...,
