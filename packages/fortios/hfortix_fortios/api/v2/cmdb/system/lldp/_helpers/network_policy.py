"""
Validation helpers for system/lldp/network_policy endpoint.
...
NESTED_SCHEMAS = {
    "voice": {
        "status": {
            ...
            "default": "disable",
            "options": [{"help": "Disable advertising this LLDP network policy.", "label": "Disable", "name": "disable"}, {"help": "Enable advertising this LLDP network policy.", "label": "Enable", "name": "enable"}],
        },
        "tag": {
            "type": "option",
            "help": "Advertise tagged or untagged traffic.",
            "default": "none",
            "options": [{"help": "Advertise that untagged frames should be used.", "label": "None", "name": "none"}, {"help": "Advertise that 802.1Q (VLAN) tagging should be used.", "label": "Dot1Q", "name": "dot1q"}, {"help": "Advertise that 802.1P priority tagging (VLAN 0) should be used.", "label": "Dot1P", "name": "dot1p"}],
        },
        "vlan": {
            "type": "integer",
...
def validate_system_lldp_network_policy_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_system_lldp_network_policy_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_system_lldp_network_policy_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for system/lldp/network_policy.
...
def validate_system_lldp_network_policy_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "name": True,  # LLDP network policy name.
        ... }
        >>> is_valid, error = validate_system_lldp_network_policy_post(payload)
        >>> assert is_valid == True
...
def validate_system_lldp_network_policy_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_system_lldp_network_policy_put(payload)
    """
