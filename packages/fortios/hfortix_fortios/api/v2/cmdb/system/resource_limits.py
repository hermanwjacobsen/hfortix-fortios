...
class ResourceLimits:
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new system/resource_limits object.
        ...
        Examples:
            ...
            >>> payload = ResourceLimits.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.cmdb.system_resource_limits.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(ResourceLimits.required_fields()) }}
            
            Use ResourceLimits.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete system/resource_limits object.
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.system_resource_limits.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.cmdb.system_resource_limits.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.cmdb.system_resource_limits.exists(name="old-object"):
            ...     fgt.api.cmdb.system_resource_limits.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update system/resource_limits object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.cmdb.system_resource_limits.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.cmdb.system_resource_limits.set(payload_dict=obj_data)
