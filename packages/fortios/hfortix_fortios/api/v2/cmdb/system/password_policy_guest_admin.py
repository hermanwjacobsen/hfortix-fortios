...
class PasswordPolicyGuestAdmin:
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new system/password_policy_guest_admin object.
        ...
        Examples:
            ...
            >>> payload = PasswordPolicyGuestAdmin.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.cmdb.system_password_policy_guest_admin.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(PasswordPolicyGuestAdmin.required_fields()) }}
            
            Use PasswordPolicyGuestAdmin.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete system/password_policy_guest_admin object.
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.system_password_policy_guest_admin.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.cmdb.system_password_policy_guest_admin.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.cmdb.system_password_policy_guest_admin.exists(name="old-object"):
            ...     fgt.api.cmdb.system_password_policy_guest_admin.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update system/password_policy_guest_admin object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.cmdb.system_password_policy_guest_admin.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.cmdb.system_password_policy_guest_admin.set(payload_dict=obj_data)
