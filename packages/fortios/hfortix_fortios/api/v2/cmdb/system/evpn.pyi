...
class EvpnResponse(TypedDict):
    ...
    id: int
    rd: str
    import_rt: list[dict[str, Any]]
    export_rt: list[dict[str, Any]]
...
class EvpnObject:
    ...
    import_rt: list[EvpnImportrtObject]  # Table field - list of typed objects
    # List of export route targets.
    export_rt: list[EvpnExportrtObject]  # Table field - list of typed objects
