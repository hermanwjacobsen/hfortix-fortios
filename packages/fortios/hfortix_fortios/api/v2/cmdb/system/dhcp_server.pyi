...
class DhcpServerPayload(TypedDict, total=False):
    """
    Type hints for system/dhcp_server payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: DhcpServerPayload = {
...
class DhcpServer:
    ...
    def post(
        self,
        payload_dict: DhcpServerPayload | None = ...,
        id: int | None = ...,
