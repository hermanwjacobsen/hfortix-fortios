"""
FortiOS CMDB - System replacemsg_nac_quar

Configuration endpoint for managing cmdb system/replacemsg_nac_quar objects.
...
class ReplacemsgNacQuar:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        """
        Retrieve system/replacemsg_nac_quar configuration.
        ...
        Examples:
            >>> # Get all system/replacemsg_nac_quar objects
            >>> result = fgt.api.cmdb.system_replacemsg_nac_quar.get()
            >>> print(f"Found {len(result['results'])} objects")
            
            >>> # Get specific system/replacemsg_nac_quar by msg-type
        ...
        See Also:
            - post(): Create new system/replacemsg_nac_quar object
            - put(): Update existing system/replacemsg_nac_quar object
            - delete(): Remove system/replacemsg_nac_quar object
            - exists(): Check if object exists
        """
        # Check cache for readonly reference data (24hr TTL)
        cache_key = f"cmdb/system/replacemsg_nac_quar"
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update existing system/replacemsg_nac_quar object.
        ...
        from ._helpers.replacemsg_nac_quar import DEPRECATED_FIELDS
        if DEPRECATED_FIELDS:
            from hfortix_core import check_deprecated_fields
            check_deprecated_fields(
                payload=payload_data,
                deprecated_fields=DEPRECATED_FIELDS,
                endpoint="cmdb/system/replacemsg_nac_quar",
            )
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new system/replacemsg_nac_quar object.
        ...
        Examples:
            ...
            >>> payload = ReplacemsgNacQuar.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.cmdb.system_replacemsg_nac_quar.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(ReplacemsgNacQuar.required_fields()) }}
            
            Use ReplacemsgNacQuar.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete system/replacemsg_nac_quar object.
    ...
    def exists(
        ...
        """
        Check if system/replacemsg_nac_quar object exists.
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update system/replacemsg_nac_quar object (intelligent operation).
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(ReplacemsgNacQuar.help())
            
            >>> # Get field information
            >>> print(ReplacemsgNacQuar.help("msg-type"))
        """
        from ._helpers.replacemsg_nac_quar import (
            get_schema_info,
            get_field_metadata,
        )
    ...
    def fields(detailed: bool = False) -> Union[list[str], dict[str, dict]]:
        ...
        Examples:
            >>> # Simple list
            >>> fields = ReplacemsgNacQuar.fields()
            >>> print(f"Available fields: {len(fields)}")
            
            >>> # Detailed info
            >>> fields = ReplacemsgNacQuar.fields(detailed=True)
            >>> for name, meta in fields.items():
            ...     print(f"{name}: {meta['type']}")
        """
        from ._helpers.replacemsg_nac_quar import get_all_fields, get_field_metadata
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = ReplacemsgNacQuar.field_info("msg-type")
            >>> print(f"Type: {info['type']}")
            >>> if 'options' in info:
            ...     print(f"Options: {info['options']}")
        """
        from ._helpers.replacemsg_nac_quar import get_field_metadata
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = ReplacemsgNacQuar.validate_field("msg-type", "test")
            >>> if not is_valid:
            ...     print(f"Validation error: {error}")
        """
        from ._helpers.replacemsg_nac_quar import validate_field_value
    ...
    def required_fields() -> list[str]:
        ...
        Examples:
            >>> required = ReplacemsgNacQuar.required_fields()
            >>> print(f"Required fields: {', '.join(required)}")
        """
        from ._helpers.replacemsg_nac_quar import REQUIRED_FIELDS
    ...
    def defaults() -> dict[str, Any]:
        ...
        Examples:
            >>> defaults = ReplacemsgNacQuar.defaults()
            >>> print(f"Fields with defaults: {len(defaults)}")
            >>> # Use as starting point for payload
            >>> payload = defaults.copy()
            >>> payload['name'] = 'my-custom-name'
        """
        from ._helpers.replacemsg_nac_quar import FIELDS_WITH_DEFAULTS
    ...
    def schema() -> dict[str, Any]:
        ...
        Examples:
            >>> schema = ReplacemsgNacQuar.schema()
            >>> print(f"Endpoint: {schema['endpoint']}")
            >>> print(f"Total fields: {schema['total_fields']}")
            >>> print(f"Primary key: {schema.get('mkey', 'N/A')}")
        """
        from ._helpers.replacemsg_nac_quar import get_schema_info
