...
class ReplacemsgFortiguardWfPayload(TypedDict, total=False):
    """
    Type hints for system/replacemsg_fortiguard_wf payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: ReplacemsgFortiguardWfPayload = {
...
class ReplacemsgFortiguardWf:
    ...
    Path: system/replacemsg_fortiguard_wf
    Category: cmdb
    ...
    def post(
        self,
        payload_dict: ReplacemsgFortiguardWfPayload | None = ...,
        msg_type: str | None = ...,
        buffer: str | None = ...,
