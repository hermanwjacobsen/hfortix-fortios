...
def validate_firewall_addrgrp6_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_firewall_addrgrp6_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_firewall_addrgrp6_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for firewall/addrgrp6.
...
def validate_firewall_addrgrp6_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "name": True,  # IPv6 address group name.
        ...     "exclude-member": True,  # Address6 exclusion member.
        ... }
...
def validate_firewall_addrgrp6_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_firewall_addrgrp6_put(payload)
    """
