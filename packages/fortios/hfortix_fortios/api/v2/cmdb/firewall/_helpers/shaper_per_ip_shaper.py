...
def validate_firewall_shaper_per_ip_shaper_get(
    ...
    **params: Any,
    ...
    """
    Validate GET request parameters for firewall/shaper_per_ip_shaper.
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_firewall_shaper_per_ip_shaper_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_firewall_shaper_per_ip_shaper_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for firewall/shaper_per_ip_shaper.
...
def validate_firewall_shaper_per_ip_shaper_post(
    ...
    **params: Any,
    ...
    """
    Validate POST request to create new firewall/shaper_per_ip_shaper object.
...
def validate_firewall_shaper_per_ip_shaper_put(
    ...
    **params: Any,
    ...
    """
    Validate PUT request to update firewall/shaper_per_ip_shaper.
    ...
    Example:
        ...
        >>> is_valid, error = validate_firewall_shaper_per_ip_shaper_put(payload)
    """
...
SCHEMA_INFO = {
    "endpoint": "firewall/shaper_per_ip_shaper",
    "category": "cmdb",
