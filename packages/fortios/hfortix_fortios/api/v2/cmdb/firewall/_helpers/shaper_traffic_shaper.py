...
def validate_firewall_shaper_traffic_shaper_get(
    ...
    **params: Any,
    ...
    """
    Validate GET request parameters for firewall/shaper_traffic_shaper.
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for firewall/shaper_traffic_shaper.
...
def validate_firewall_shaper_traffic_shaper_post(
    ...
    **params: Any,
    ...
    """
    Validate POST request to create new firewall/shaper_traffic_shaper object.
...
def validate_firewall_shaper_traffic_shaper_put(
    ...
    **params: Any,
    ...
    """
    Validate PUT request to update firewall/shaper_traffic_shaper.
...
SCHEMA_INFO = {
    "endpoint": "firewall/shaper_traffic_shaper",
    "category": "cmdb",
