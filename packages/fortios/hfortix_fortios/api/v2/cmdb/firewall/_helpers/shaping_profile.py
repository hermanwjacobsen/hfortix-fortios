...
def validate_firewall_shaping_profile_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_firewall_shaping_profile_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by profile-name
        >>> is_valid, error = validate_firewall_shaping_profile_get(profile_name="test-item")
        >>> assert is_valid == True
...
def validate_firewall_shaping_profile_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "profile-name": True,  # Shaping profile name.
        ... }
...
def validate_firewall_shaping_profile_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_firewall_shaping_profile_put(payload)
    """
