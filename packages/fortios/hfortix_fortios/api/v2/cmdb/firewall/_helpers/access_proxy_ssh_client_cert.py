...
def validate_firewall_access_proxy_ssh_client_cert_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_firewall_access_proxy_ssh_client_cert_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_firewall_access_proxy_ssh_client_cert_get(name="test-item")
        >>> assert is_valid == True
...
def validate_firewall_access_proxy_ssh_client_cert_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "auth-ca": True,  # Name of the SSH server public key authentication C
        ... }
        ...
        >>> payload["source-address"] = "invalid-value"
        >>> is_valid, error = validate_firewall_access_proxy_ssh_client_cert_post(payload)
...
def validate_firewall_access_proxy_ssh_client_cert_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_firewall_access_proxy_ssh_client_cert_put(payload)
    """
