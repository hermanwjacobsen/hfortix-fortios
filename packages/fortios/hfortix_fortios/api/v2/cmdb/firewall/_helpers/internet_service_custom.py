...
def validate_firewall_internet_service_custom_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_firewall_internet_service_custom_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_firewall_internet_service_custom_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for firewall/internet_service_custom.
...
def validate_firewall_internet_service_custom_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ... }
        >>> is_valid, error = validate_firewall_internet_service_custom_post(payload)
        >>> assert is_valid == True
...
def validate_firewall_internet_service_custom_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_firewall_internet_service_custom_put(payload)
    """
