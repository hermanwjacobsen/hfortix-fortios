...
REQUIRED_FIELDS = [
    "extintf",  # Interface connected to the source network that receives the
    "extip",  # IP address or address range on the external interface that y
    ...
    "ipv6-mappedip",  # Range of mapped IPv6 addresses. Specify the start IPv6 addre
    "mappedip",  # IP address or address range on the destination network to wh
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for firewall_vip.
