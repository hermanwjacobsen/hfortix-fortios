...
def validate_firewall_schedule_recurring_get(
    ...
    **params: Any,
    ...
    """
    Validate GET request parameters for firewall/schedule_recurring.
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_firewall_schedule_recurring_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_firewall_schedule_recurring_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for firewall/schedule_recurring.
...
def validate_firewall_schedule_recurring_post(
    ...
    **params: Any,
    ...
    """
    Validate POST request to create new firewall/schedule_recurring object.
    ...
    Examples:
        ...
        >>> payload = {
        ...     "name": True,  # Recurring schedule name.
        ...     "start": True,  # Time of day to start the schedule, format hh:mm.
        ... }
...
def validate_firewall_schedule_recurring_put(
    ...
    **params: Any,
    ...
    """
    Validate PUT request to update firewall/schedule_recurring.
    ...
    Example:
        ...
        >>> is_valid, error = validate_firewall_schedule_recurring_put(payload)
    """
...
SCHEMA_INFO = {
    "endpoint": "firewall/schedule_recurring",
    "category": "cmdb",
