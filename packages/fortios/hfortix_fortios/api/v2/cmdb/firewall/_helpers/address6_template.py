...
NESTED_SCHEMAS = {
    "subnet-segment": {
        ...
        "exclusive": {
            ...
            "required": True,
            "default": "disable",
            "options": [{"help": "Enable exclusive value.", "label": "Enable", "name": "enable"}, {"help": "Disable exclusive value.", "label": "Disable", "name": "disable"}],
        },
        "values": {
            "type": "string",
...
def validate_firewall_address6_template_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_firewall_address6_template_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_firewall_address6_template_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for firewall/address6_template.
...
def validate_firewall_address6_template_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "name": True,  # IPv6 address template name.
        ... }
        >>> is_valid, error = validate_firewall_address6_template_post(payload)
        >>> assert is_valid == True
...
def validate_firewall_address6_template_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_firewall_address6_template_put(payload)
    """
