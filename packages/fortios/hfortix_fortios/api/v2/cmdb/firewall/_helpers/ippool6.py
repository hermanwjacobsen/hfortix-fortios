...
def validate_firewall_ippool6_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_firewall_ippool6_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_firewall_ippool6_get(name="test-item")
        >>> assert is_valid == True
...
def validate_firewall_ippool6_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_firewall_ippool6_put(payload)
    """
