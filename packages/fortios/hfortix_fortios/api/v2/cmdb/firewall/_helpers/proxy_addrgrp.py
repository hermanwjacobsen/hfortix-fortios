...
def validate_firewall_proxy_addrgrp_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_firewall_proxy_addrgrp_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_firewall_proxy_addrgrp_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for firewall/proxy_addrgrp.
...
def validate_firewall_proxy_addrgrp_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "member": True,  # Members of address group.
        ... }
...
def validate_firewall_proxy_addrgrp_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_firewall_proxy_addrgrp_put(payload)
    """
