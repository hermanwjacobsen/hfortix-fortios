...
def validate_firewall_address6_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_firewall_address6_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_firewall_address6_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for firewall/address6.
...
def validate_firewall_address6_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "template": True,  # IPv6 address template.
...
def validate_firewall_address6_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_firewall_address6_put(payload)
    """
