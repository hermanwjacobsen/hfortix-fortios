...
def validate_firewall_service_custom_get(
    ...
    **params: Any,
    ...
    """
    Validate GET request parameters for firewall/service_custom.
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for firewall/service_custom.
...
def validate_firewall_service_custom_post(
    ...
    **params: Any,
    ...
    """
    Validate POST request to create new firewall/service_custom object.
...
def validate_firewall_service_custom_put(
    ...
    **params: Any,
    ...
    """
    Validate PUT request to update firewall/service_custom.
...
SCHEMA_INFO = {
    "endpoint": "firewall/service_custom",
    "category": "cmdb",
