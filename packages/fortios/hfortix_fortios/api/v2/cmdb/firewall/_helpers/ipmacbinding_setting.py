...
def validate_firewall_ipmacbinding_setting_get(
    ...
    **params: Any,
    ...
    """
    Validate GET request parameters for firewall/ipmacbinding_setting.
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_firewall_ipmacbinding_setting_get()
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for firewall/ipmacbinding_setting.
...
def validate_firewall_ipmacbinding_setting_post(
    ...
    **params: Any,
    ...
    """
    Validate POST request to create new firewall/ipmacbinding_setting object.
    ...
    Examples:
        ...
        >>> payload["bindthroughfw"] = "invalid-value"
        >>> is_valid, error = validate_firewall_ipmacbinding_setting_post(payload)
...
def validate_firewall_ipmacbinding_setting_put(
    ...
    **params: Any,
    ...
    """
    Validate PUT request to update firewall/ipmacbinding_setting.
    ...
    Example:
        ...
        >>> is_valid, error = validate_firewall_ipmacbinding_setting_put(payload)
    """
...
SCHEMA_INFO = {
    "endpoint": "firewall/ipmacbinding_setting",
    "category": "cmdb",
