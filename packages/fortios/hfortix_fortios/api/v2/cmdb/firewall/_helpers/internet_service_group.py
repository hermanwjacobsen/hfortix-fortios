...
def validate_firewall_internet_service_group_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_firewall_internet_service_group_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_firewall_internet_service_group_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for firewall/internet_service_group.
...
def validate_firewall_internet_service_group_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload["direction"] = "invalid-value"
        >>> is_valid, error = validate_firewall_internet_service_group_post(payload)
...
def validate_firewall_internet_service_group_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_firewall_internet_service_group_put(payload)
    """
