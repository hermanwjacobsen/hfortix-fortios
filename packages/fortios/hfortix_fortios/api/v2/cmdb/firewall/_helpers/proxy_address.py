...
def validate_firewall_proxy_address_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_firewall_proxy_address_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_firewall_proxy_address_get(name="test-item")
        >>> assert is_valid == True
...
def validate_firewall_proxy_address_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "host": True,  # Address object for the host.
        ...     "application": True,  # SaaS application.
        ... }
...
def validate_firewall_proxy_address_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_firewall_proxy_address_put(payload)
    """
