...
def validate_firewall_service_group_get(
    ...
    **params: Any,
    ...
    """
    Validate GET request parameters for firewall/service_group.
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_firewall_service_group_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_firewall_service_group_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for firewall/service_group.
...
def validate_firewall_service_group_post(
    ...
    **params: Any,
    ...
    """
    Validate POST request to create new firewall/service_group object.
    ...
    Examples:
        ...
        >>> payload = {
        ...     "name": True,  # Service group name.
        ... }
        >>> is_valid, error = validate_firewall_service_group_post(payload)
        >>> assert is_valid == True
...
def validate_firewall_service_group_put(
    ...
    **params: Any,
    ...
    """
    Validate PUT request to update firewall/service_group.
    ...
    Example:
        ...
        >>> is_valid, error = validate_firewall_service_group_put(payload)
    """
...
SCHEMA_INFO = {
    "endpoint": "firewall/service_group",
    "category": "cmdb",
