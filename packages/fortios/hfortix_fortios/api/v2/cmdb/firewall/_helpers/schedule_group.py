...
def validate_firewall_schedule_group_get(
    ...
    **params: Any,
    ...
    """
    Validate GET request parameters for firewall/schedule_group.
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_firewall_schedule_group_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_firewall_schedule_group_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for firewall/schedule_group.
...
def validate_firewall_schedule_group_post(
    ...
    **params: Any,
    ...
    """
    Validate POST request to create new firewall/schedule_group object.
    ...
    Examples:
        ...
        >>> payload = {
        ...     "name": True,  # Schedule group name.
        ...     "member": True,  # Schedules added to the schedule group.
        ... }
        >>> is_valid, error = validate_firewall_schedule_group_post(payload)
        >>> assert is_valid == True
        ...
        >>> payload["fabric-object"] = "invalid-value"
        >>> is_valid, error = validate_firewall_schedule_group_post(payload)
...
def validate_firewall_schedule_group_put(
    ...
    **params: Any,
    ...
    """
    Validate PUT request to update firewall/schedule_group.
    ...
    Example:
        ...
        >>> is_valid, error = validate_firewall_schedule_group_put(payload)
    """
...
SCHEMA_INFO = {
    "endpoint": "firewall/schedule_group",
    "category": "cmdb",
