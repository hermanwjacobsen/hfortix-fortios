...
def validate_firewall_ldb_monitor_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_firewall_ldb_monitor_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_firewall_ldb_monitor_get(name="test-item")
        >>> assert is_valid == True
...
def validate_firewall_ldb_monitor_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "type": True,  # Select the Monitor type used by the health check m
        ... }
...
def validate_firewall_ldb_monitor_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_firewall_ldb_monitor_put(payload)
    """
