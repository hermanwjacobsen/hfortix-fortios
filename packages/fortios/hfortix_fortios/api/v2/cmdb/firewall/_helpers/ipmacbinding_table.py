...
def validate_firewall_ipmacbinding_table_get(
    ...
    **params: Any,
    ...
    """
    Validate GET request parameters for firewall/ipmacbinding_table.
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_firewall_ipmacbinding_table_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by seq-num
        >>> is_valid, error = validate_firewall_ipmacbinding_table_get(seq_num="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for firewall/ipmacbinding_table.
...
def validate_firewall_ipmacbinding_table_post(
    ...
    **params: Any,
    ...
    """
    Validate POST request to create new firewall/ipmacbinding_table object.
...
def validate_firewall_ipmacbinding_table_put(
    ...
    **params: Any,
    ...
    """
    Validate PUT request to update firewall/ipmacbinding_table.
    ...
    Example:
        ...
        >>> is_valid, error = validate_firewall_ipmacbinding_table_put(payload)
    """
...
SCHEMA_INFO = {
    "endpoint": "firewall/ipmacbinding_table",
    "category": "cmdb",
