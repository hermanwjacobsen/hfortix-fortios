...
def validate_firewall_ssl_setting_get(
    ...
    **params: Any,
    ...
    """
    Validate GET request parameters for firewall/ssl_setting.
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for firewall/ssl_setting.
...
def validate_firewall_ssl_setting_post(
    ...
    **params: Any,
    ...
    """
    Validate POST request to create new firewall/ssl_setting object.
...
def validate_firewall_ssl_setting_put(
    ...
    **params: Any,
    ...
    """
    Validate PUT request to update firewall/ssl_setting.
