...
REQUIRED_FIELDS = [
    ...
    "dstaddr",  # Address object to limit traffic monitoring to network traffi
    ...
    "srcaddr",  # Address object to limit traffic monitoring to network traffi
]
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for firewall_interface-policy.
