...
def validate_firewall_interface_policy_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_firewall_interface_policy_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by policyid
        >>> is_valid, error = validate_firewall_interface_policy_get(policyid="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for firewall/interface_policy.
...
def validate_firewall_interface_policy_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        ...     "srcaddr": True,  # Address object to limit traffic monitoring to netw
        ... }
        >>> is_valid, error = validate_firewall_interface_policy_post(payload)
        >>> assert is_valid == True
...
def validate_firewall_interface_policy_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_firewall_interface_policy_put(payload)
    """
