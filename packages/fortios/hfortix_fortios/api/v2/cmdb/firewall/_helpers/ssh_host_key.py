...
def validate_firewall_ssh_host_key_get(
    ...
    **params: Any,
    ...
    """
    Validate GET request parameters for firewall/ssh_host_key.
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_firewall_ssh_host_key_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_firewall_ssh_host_key_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for firewall/ssh_host_key.
...
def validate_firewall_ssh_host_key_post(
    ...
    **params: Any,
    ...
    """
    Validate POST request to create new firewall/ssh_host_key object.
...
def validate_firewall_ssh_host_key_put(
    ...
    **params: Any,
    ...
    """
    Validate PUT request to update firewall/ssh_host_key.
    ...
    Example:
        ...
        >>> is_valid, error = validate_firewall_ssh_host_key_put(payload)
    """
...
SCHEMA_INFO = {
    "endpoint": "firewall/ssh_host_key",
    "category": "cmdb",
