...
def validate_firewall_access_proxy_virtual_host_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_firewall_access_proxy_virtual_host_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_firewall_access_proxy_virtual_host_get(name="test-item")
        >>> assert is_valid == True
...
def validate_firewall_access_proxy_virtual_host_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "ssl-certificate": True,  # SSL certificates for this host.
        ...     "host": True,  # The host name.
        ... }
        ...
        >>> payload["host-type"] = "invalid-value"
        >>> is_valid, error = validate_firewall_access_proxy_virtual_host_post(payload)
...
def validate_firewall_access_proxy_virtual_host_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_firewall_access_proxy_virtual_host_put(payload)
    """
