...
def validate_firewall_schedule_onetime_get(
    ...
    **params: Any,
    ...
    """
    Validate GET request parameters for firewall/schedule_onetime.
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_firewall_schedule_onetime_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_firewall_schedule_onetime_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for firewall/schedule_onetime.
...
def validate_firewall_schedule_onetime_post(
    ...
    **params: Any,
    ...
    """
    Validate POST request to create new firewall/schedule_onetime object.
    ...
    Examples:
        ...
        >>> payload = {
        ...     "name": True,  # Onetime schedule name.
        ...     "start": True,  # Schedule start date and time, format hh:mm yyyy/mm
        ... }
...
def validate_firewall_schedule_onetime_put(
    ...
    **params: Any,
    ...
    """
    Validate PUT request to update firewall/schedule_onetime.
    ...
    Example:
        ...
        >>> is_valid, error = validate_firewall_schedule_onetime_put(payload)
    """
...
SCHEMA_INFO = {
    "endpoint": "firewall/schedule_onetime",
    "category": "cmdb",
