...
def validate_firewall_DoS_policy_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_firewall_DoS_policy_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by policyid
        >>> is_valid, error = validate_firewall_DoS_policy_get(policyid="test-item")
        >>> assert is_valid == True
...
def validate_firewall_DoS_policy_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "interface": True,  # Incoming interface name from available interfaces.
        ...     "srcaddr": True,  # Source address name from available addresses.
        ... }
        >>> is_valid, error = validate_firewall_DoS_policy_post(payload)
        >>> assert is_valid == True
...
def validate_firewall_DoS_policy_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_firewall_DoS_policy_put(payload)
    """
