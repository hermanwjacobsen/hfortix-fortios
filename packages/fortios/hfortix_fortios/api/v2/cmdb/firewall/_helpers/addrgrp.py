...
def validate_firewall_addrgrp_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_firewall_addrgrp_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_firewall_addrgrp_get(name="test-item")
        >>> assert is_valid == True
...
def validate_firewall_addrgrp_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "name": True,  # Address group name.
        ...     "exclude-member": True,  # Address exclusion member.
        ... }
...
def validate_firewall_addrgrp_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_firewall_addrgrp_put(payload)
    """
