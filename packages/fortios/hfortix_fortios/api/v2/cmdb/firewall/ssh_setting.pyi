...
class SshSettingPayload(TypedDict, total=False):
    """
    Type hints for firewall/ssh_setting payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: SshSettingPayload = {
...
class SshSetting:
    ...
    def post(
        self,
        payload_dict: SshSettingPayload | None = ...,
        caname: str | None = ...,
