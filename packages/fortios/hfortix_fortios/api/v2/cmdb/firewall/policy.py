...
class Policy:
    ...
    def put(
        ...
        scim_users: str | list | None = None,
        scim_groups: str | list | None = None,
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = Policy.field_info("policyid")
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = Policy.validate_field("policyid", "test")
            >>> if not is_valid:
