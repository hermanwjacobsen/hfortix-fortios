...
class VendorMacSummary:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> schema = fgt.api.cmdb.firewall_vendor_mac_summary.get(action="schema")
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new firewall/vendor_mac_summary object.
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.firewall_vendor_mac_summary.post(
            ...     name="example",
            ...
            >>> payload = VendorMacSummary.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.cmdb.firewall_vendor_mac_summary.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(VendorMacSummary.required_fields()) }}
            
            Use VendorMacSummary.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete firewall/vendor_mac_summary object.
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.firewall_vendor_mac_summary.delete(name="object-to-delete")
    ...
    def exists(
        ...
        """
        Check if firewall/vendor_mac_summary object exists.
        ...
        Examples:
            ...
            >>> if fgt.api.cmdb.firewall_vendor_mac_summary.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.cmdb.firewall_vendor_mac_summary.exists(name="old-object"):
            ...     fgt.api.cmdb.firewall_vendor_mac_summary.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update firewall/vendor_mac_summary object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.cmdb.firewall_vendor_mac_summary.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.cmdb.firewall_vendor_mac_summary.set(payload_dict=obj_data)
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(VendorMacSummary.help())
            
            >>> # Get field information
            >>> print(VendorMacSummary.help("name"))
        """
        from ._helpers.vendor_mac_summary import (
            get_schema_info,
            get_field_metadata,
        )
    ...
    def fields(detailed: bool = False) -> Union[list[str], dict[str, dict]]:
        ...
        Examples:
            >>> # Simple list
            >>> fields = VendorMacSummary.fields()
            >>> print(f"Available fields: {len(fields)}")
            
            >>> # Detailed info
            >>> fields = VendorMacSummary.fields(detailed=True)
            >>> for name, meta in fields.items():
            ...     print(f"{name}: {meta['type']}")
        """
        from ._helpers.vendor_mac_summary import get_all_fields, get_field_metadata
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = VendorMacSummary.field_info("name")
            >>> print(f"Type: {info['type']}")
            >>> if 'options' in info:
            ...     print(f"Options: {info['options']}")
        """
        from ._helpers.vendor_mac_summary import get_field_metadata
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = VendorMacSummary.validate_field("name", "test")
            >>> if not is_valid:
            ...     print(f"Validation error: {error}")
        """
        from ._helpers.vendor_mac_summary import validate_field_value
    ...
    def required_fields() -> list[str]:
        ...
        Examples:
            >>> required = VendorMacSummary.required_fields()
            >>> print(f"Required fields: {', '.join(required)}")
        """
        from ._helpers.vendor_mac_summary import REQUIRED_FIELDS
    ...
    def defaults() -> dict[str, Any]:
        ...
        Examples:
            >>> defaults = VendorMacSummary.defaults()
            >>> print(f"Fields with defaults: {len(defaults)}")
            >>> # Use as starting point for payload
            >>> payload = defaults.copy()
            >>> payload['name'] = 'my-custom-name'
        """
        from ._helpers.vendor_mac_summary import FIELDS_WITH_DEFAULTS
    ...
    def schema() -> dict[str, Any]:
        ...
        Examples:
            >>> schema = VendorMacSummary.schema()
            >>> print(f"Endpoint: {schema['endpoint']}")
            >>> print(f"Total fields: {schema['total_fields']}")
            >>> print(f"Primary key: {schema.get('mkey', 'N/A')}")
        """
        from ._helpers.vendor_mac_summary import get_schema_info
