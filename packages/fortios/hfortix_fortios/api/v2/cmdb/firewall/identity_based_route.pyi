...
class IdentityBasedRouteRuleObject:
    ...
    device: str
    # Select one or more group(s) from available groups that are allowed to use this r
    groups: str
...
class IdentityBasedRouteObject:
    ...
    comments: str
    # Rule.
    rule: list[IdentityBasedRouteRuleObject]  # Table field - list of typed objects
