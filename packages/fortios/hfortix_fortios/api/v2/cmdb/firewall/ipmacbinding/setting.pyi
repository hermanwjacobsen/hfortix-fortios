...
class SettingObject:
    ...
    # Enable/disable use of IP/MAC binding to filter packets that would normally go th
    bindthroughfw: Literal["enable", "disable"]
    # Enable/disable use of IP/MAC binding to filter packets that would normally go to
    bindtofw: Literal["enable", "disable"]
