"""
FortiOS CMDB - Firewall ipmacbinding_table

Configuration endpoint for managing cmdb firewall/ipmacbinding_table objects.
...
class IpmacbindingTable:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        """
        Retrieve firewall/ipmacbinding_table configuration.
        ...
        Examples:
            >>> # Get all firewall/ipmacbinding_table objects
            >>> result = fgt.api.cmdb.firewall_ipmacbinding_table.get()
            >>> print(f"Found {len(result['results'])} objects")
            
            >>> # Get specific firewall/ipmacbinding_table by seq-num
        ...
        See Also:
            - post(): Create new firewall/ipmacbinding_table object
            - put(): Update existing firewall/ipmacbinding_table object
            - delete(): Remove firewall/ipmacbinding_table object
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update existing firewall/ipmacbinding_table object.
        ...
        from ._helpers.ipmacbinding_table import DEPRECATED_FIELDS
        if DEPRECATED_FIELDS:
            from hfortix_core import check_deprecated_fields
            check_deprecated_fields(
                payload=payload_data,
                deprecated_fields=DEPRECATED_FIELDS,
                endpoint="cmdb/firewall/ipmacbinding_table",
            )
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new firewall/ipmacbinding_table object.
        ...
        Examples:
            ...
            >>> payload = IpmacbindingTable.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.cmdb.firewall_ipmacbinding_table.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(IpmacbindingTable.required_fields()) }}
            
            Use IpmacbindingTable.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete firewall/ipmacbinding_table object.
    ...
    def exists(
        ...
        """
        Check if firewall/ipmacbinding_table object exists.
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update firewall/ipmacbinding_table object (intelligent operation).
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(IpmacbindingTable.help())
            
            >>> # Get field information
            >>> print(IpmacbindingTable.help("seq-num"))
        """
        from ._helpers.ipmacbinding_table import (
            get_schema_info,
            get_field_metadata,
        )
    ...
    def fields(detailed: bool = False) -> Union[list[str], dict[str, dict]]:
        ...
        Examples:
            >>> # Simple list
            >>> fields = IpmacbindingTable.fields()
            >>> print(f"Available fields: {len(fields)}")
            
            >>> # Detailed info
            >>> fields = IpmacbindingTable.fields(detailed=True)
            >>> for name, meta in fields.items():
            ...     print(f"{name}: {meta['type']}")
        """
        from ._helpers.ipmacbinding_table import get_all_fields, get_field_metadata
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = IpmacbindingTable.field_info("seq-num")
            >>> print(f"Type: {info['type']}")
            >>> if 'options' in info:
            ...     print(f"Options: {info['options']}")
        """
        from ._helpers.ipmacbinding_table import get_field_metadata
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = IpmacbindingTable.validate_field("seq-num", "test")
            >>> if not is_valid:
            ...     print(f"Validation error: {error}")
        """
        from ._helpers.ipmacbinding_table import validate_field_value
    ...
    def required_fields() -> list[str]:
        ...
        Examples:
            >>> required = IpmacbindingTable.required_fields()
            >>> print(f"Required fields: {', '.join(required)}")
        """
        from ._helpers.ipmacbinding_table import REQUIRED_FIELDS
    ...
    def defaults() -> dict[str, Any]:
        ...
        Examples:
            >>> defaults = IpmacbindingTable.defaults()
            >>> print(f"Fields with defaults: {len(defaults)}")
            >>> # Use as starting point for payload
            >>> payload = defaults.copy()
            >>> payload['name'] = 'my-custom-name'
        """
        from ._helpers.ipmacbinding_table import FIELDS_WITH_DEFAULTS
    ...
    def schema() -> dict[str, Any]:
        ...
        Examples:
            >>> schema = IpmacbindingTable.schema()
            >>> print(f"Endpoint: {schema['endpoint']}")
            >>> print(f"Total fields: {schema['total_fields']}")
            >>> print(f"Primary key: {schema.get('mkey', 'N/A')}")
        """
        from ._helpers.ipmacbinding_table import get_schema_info
