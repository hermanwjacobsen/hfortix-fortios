...
class DosPolicyObject:
    ...
    srcaddr: list[DosPolicySrcaddrObject]  # Table field - list of typed objects
    # Destination address name from available addresses.
    dstaddr: list[DosPolicyDstaddrObject]  # Table field - list of typed objects
    # Service object from available options.
    service: list[DosPolicyServiceObject]  # Table field - list of typed objects
    # Anomaly name.
    anomaly: list[DosPolicyAnomalyObject]  # Table field - list of typed objects
