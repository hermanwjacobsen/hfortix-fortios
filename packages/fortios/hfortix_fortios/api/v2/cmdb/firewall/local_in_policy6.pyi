...
class LocalInPolicy6Payload(TypedDict, total=False):
    ...
    **Usage:**
    ...
    action: NotRequired[Literal["accept", "deny"]]  # Action performed on traffic matching the policy
    ...
    virtual_patch: NotRequired[Literal["enable", "disable"]]  # Enable/disable the virtual patching feature.
...
class LocalInPolicy6Object:
    ...
    intf: list[LocalInPolicy6IntfObject]  # Table field - list of typed objects
    # Source address object from available options.
    srcaddr: list[LocalInPolicy6SrcaddrObject]  # Table field - list of typed objects
    # When enabled srcaddr specifies what the source address must NOT be.
    srcaddr_negate: Literal["enable", "disable"]
    # Destination address object from available options.
    dstaddr: list[LocalInPolicy6DstaddrObject]  # Table field - list of typed objects
    # Enable/disable use of IPv6 Internet Services in source for this local-in policy.
    internet_service6_src: Literal["enable", "disable"]
    # IPv6 Internet Service source name.
    internet_service6_src_name: list[LocalInPolicy6Internetservice6srcnameObject]  # Table field - list of typed objects
    # Internet Service6 source group name.
    internet_service6_src_group: list[LocalInPolicy6Internetservice6srcgroupObject]  # Table field - list of typed objects
    # Custom IPv6 Internet Service source name.
    internet_service6_src_custom: list[LocalInPolicy6Internetservice6srccustomObject]  # Table field - list of typed objects
    # Custom Internet Service6 source group name.
    internet_service6_src_custom_group: list[LocalInPolicy6Internetservice6srccustomgroupObject]  # Table field - list of typed objects
    # FortiGuard IPv6 Internet Service source name.
    internet_service6_src_fortiguard: list[LocalInPolicy6Internetservice6srcfortiguardObject]  # Table field - list of typed objects
    ...
    service: list[LocalInPolicy6ServiceObject]  # Table field - list of typed objects
