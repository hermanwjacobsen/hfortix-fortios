...
class ProfilePayload(TypedDict, total=False):
    ...
    **Usage:**
    ...
    icap_block_log: NotRequired[Literal["disable", "enable"]]  # Enable/disable UTM log when infection found
...
class ProfileResponse(TypedDict):
    ...
    timeout: int
    icap_headers: list[dict[str, Any]]
    respmod_forward_rules: list[dict[str, Any]]
...
class ProfileObject:
    ...
    icap_headers: list[ProfileIcapheadersObject]  # Table field - list of typed objects
    # ICAP response mode forward rules.
    respmod_forward_rules: list[ProfileRespmodforwardrulesObject]  # Table field - list of typed objects
