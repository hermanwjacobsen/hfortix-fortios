...
class Profile:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> schema = fgt.api.cmdb.icap_profile.get(action="schema")
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(Profile.help("replacemsg-group"))
        """
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = Profile.field_info("replacemsg-group")
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = Profile.validate_field("replacemsg-group", "test")
            >>> if not is_valid:
