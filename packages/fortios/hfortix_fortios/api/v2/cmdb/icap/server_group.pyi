...
class ServerGroupObject:
    ...
    # Configure an ICAP server group consisting one or multiple forward servers. Suppo
    name: str
    # Load balance method.
    ldb_method: Literal["weighted", "least-session", "active-passive"]
    # Add ICAP servers to a list to form a server group. Optionally assign weights to
    server_list: list[ServerGroupServerlistObject]  # Table field - list of typed objects
