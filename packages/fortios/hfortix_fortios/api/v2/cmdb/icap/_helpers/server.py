...
def validate_icap_server_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_icap_server_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_icap_server_get(name="test-item")
        >>> assert is_valid == True
...
def validate_icap_server_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "healthcheck-service": True,  # ICAP Service name to use for health checks.
        ... }
...
def validate_icap_server_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_icap_server_put(payload)
    """
