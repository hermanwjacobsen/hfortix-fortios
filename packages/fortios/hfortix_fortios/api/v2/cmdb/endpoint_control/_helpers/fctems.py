"""
Validation helpers for endpoint_control/fctems endpoint.
...
def validate_endpoint_control_fctems_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_endpoint_control_fctems_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by ems-id
        >>> is_valid, error = validate_endpoint_control_fctems_get(ems_id="test-item")
        >>> assert is_valid == True
...
def validate_endpoint_control_fctems_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_endpoint_control_fctems_put(payload)
    """
