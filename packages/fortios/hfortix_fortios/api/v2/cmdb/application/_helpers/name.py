...
def validate_application_name_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_application_name_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_application_name_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for application/name.
...
def validate_application_name_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ... }
        >>> is_valid, error = validate_application_name_post(payload)
        >>> assert is_valid == True
...
def validate_application_name_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_application_name_put(payload)
    """
