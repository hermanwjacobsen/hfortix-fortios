...
def validate_user_tacacs_plus_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_user_tacacs_plus_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_user_tacacs_plus_get(name="test-item")
        >>> assert is_valid == True
...
def validate_user_tacacs_plus_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "server": True,  # Primary TACACS+ server CN domain name or IP addres
        ...
        >>> payload["authen-type"] = "invalid-value"
        >>> is_valid, error = validate_user_tacacs_plus_post(payload)
...
def validate_user_tacacs_plus_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_user_tacacs_plus_put(payload)
    """
