...
def validate_user_pop3_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_user_pop3_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_user_pop3_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for user/pop3.
...
def validate_user_pop3_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "server": True,  # Server domain name or IP address.
        ... }
...
def validate_user_pop3_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_user_pop3_put(payload)
    """
