...
def validate_user_krb_keytab_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_user_krb_keytab_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_user_krb_keytab_get(name="test-item")
        >>> assert is_valid == True
...
def validate_user_krb_keytab_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "principal": True,  # Kerberos service principal. For example, HTTP/myfg
        ...     "keytab": True,  # Base64 coded keytab file containing a pre-shared k
        ... }
        ...
        >>> payload["pac-data"] = "invalid-value"
        >>> is_valid, error = validate_user_krb_keytab_post(payload)
...
def validate_user_krb_keytab_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_user_krb_keytab_put(payload)
    """
