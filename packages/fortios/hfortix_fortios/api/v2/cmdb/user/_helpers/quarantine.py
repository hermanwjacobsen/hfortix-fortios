...
def validate_user_quarantine_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_user_quarantine_get()
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for user/quarantine.
...
def validate_user_quarantine_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload["quarantine"] = "invalid-value"
        >>> is_valid, error = validate_user_quarantine_post(payload)
...
def validate_user_quarantine_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_user_quarantine_put(payload)
    """
