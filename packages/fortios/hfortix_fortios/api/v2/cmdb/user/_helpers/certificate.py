...
def validate_user_certificate_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_user_certificate_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_user_certificate_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for user/certificate.
...
def validate_user_certificate_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "common-name": True,  # Certificate common name.
        ...     "issuer": True,  # CA certificate used for client certificate verific
        ... }
...
def validate_user_certificate_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_user_certificate_put(payload)
    """
