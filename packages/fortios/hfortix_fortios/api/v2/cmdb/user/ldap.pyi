...
class LdapPayload(TypedDict, total=False):
    ...
    **Usage:**
    ...
    server_identity_check: NotRequired[Literal["enable", "disable"]]  # Enable/disable LDAP server identity check
    ...
    port: NotRequired[int]  # Port to be used for communication with the LDAP server
...
class LdapObject:
    ...
    status_ttl: int
    # Enable/disable LDAP server identity check
    server_identity_check: Literal["enable", "disable"]
