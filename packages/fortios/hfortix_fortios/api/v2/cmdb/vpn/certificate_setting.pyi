...
class CertificateSettingPayload(TypedDict, total=False):
    """
    Type hints for vpn/certificate_setting payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: CertificateSettingPayload = {
...
class CertificateSetting:
    ...
    def post(
        self,
        payload_dict: CertificateSettingPayload | None = ...,
