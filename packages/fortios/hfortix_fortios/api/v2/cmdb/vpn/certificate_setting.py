"""
FortiOS CMDB - Vpn certificate_setting

Configuration endpoint for managing cmdb vpn/certificate_setting objects.

API Endpoints:
    GET    /cmdb/vpn/certificate_setting
    POST   /cmdb/vpn/certificate_setting
    PUT    /cmdb/vpn/certificate_setting/{identifier}
    DELETE /cmdb/vpn/certificate_setting/{identifier}
...
class CertificateSetting:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        """
        Retrieve vpn/certificate_setting configuration.
        ...
        Examples:
            >>> # Get all vpn/certificate_setting objects
        ...
        See Also:
            - post(): Create new vpn/certificate_setting object
            - put(): Update existing vpn/certificate_setting object
            - delete(): Remove vpn/certificate_setting object
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update existing vpn/certificate_setting object.
        ...
        from ._helpers.certificate_setting import DEPRECATED_FIELDS
        if DEPRECATED_FIELDS:
            from hfortix_core import check_deprecated_fields
            check_deprecated_fields(
                payload=payload_data,
                deprecated_fields=DEPRECATED_FIELDS,
                endpoint="cmdb/vpn/certificate_setting",
            )
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new vpn/certificate_setting object.
        ...
        Examples:
            ...
            >>> payload = CertificateSetting.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.cmdb.vpn_certificate_setting.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(CertificateSetting.required_fields()) }}
            
            Use CertificateSetting.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete vpn/certificate_setting object.
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.vpn_certificate_setting.delete(name="object-to-delete")
    ...
    def exists(
        ...
        """
        Check if vpn/certificate_setting object exists.
        ...
        Examples:
            ...
            >>> if fgt.api.cmdb.vpn_certificate_setting.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.cmdb.vpn_certificate_setting.exists(name="old-object"):
            ...     fgt.api.cmdb.vpn_certificate_setting.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update vpn/certificate_setting object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.cmdb.vpn_certificate_setting.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.cmdb.vpn_certificate_setting.set(payload_dict=obj_data)
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(CertificateSetting.help())
            
            >>> # Get field information
            >>> print(CertificateSetting.help("ocsp-status"))
        """
        from ._helpers.certificate_setting import (
            get_schema_info,
            get_field_metadata,
        )
    ...
    def fields(detailed: bool = False) -> Union[list[str], dict[str, dict]]:
        ...
        Examples:
            >>> # Simple list
            >>> fields = CertificateSetting.fields()
            >>> print(f"Available fields: {len(fields)}")
            
            >>> # Detailed info
            >>> fields = CertificateSetting.fields(detailed=True)
            >>> for name, meta in fields.items():
            ...     print(f"{name}: {meta['type']}")
        """
        from ._helpers.certificate_setting import get_all_fields, get_field_metadata
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = CertificateSetting.field_info("ocsp-status")
            >>> print(f"Type: {info['type']}")
            >>> if 'options' in info:
            ...     print(f"Options: {info['options']}")
        """
        from ._helpers.certificate_setting import get_field_metadata
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = CertificateSetting.validate_field("ocsp-status", "test")
            >>> if not is_valid:
            ...     print(f"Validation error: {error}")
        """
        from ._helpers.certificate_setting import validate_field_value
    ...
    def required_fields() -> list[str]:
        ...
        Examples:
            >>> required = CertificateSetting.required_fields()
            >>> print(f"Required fields: {', '.join(required)}")
        """
        from ._helpers.certificate_setting import REQUIRED_FIELDS
    ...
    def defaults() -> dict[str, Any]:
        ...
        Examples:
            >>> defaults = CertificateSetting.defaults()
            >>> print(f"Fields with defaults: {len(defaults)}")
            >>> # Use as starting point for payload
            >>> payload = defaults.copy()
            >>> payload['name'] = 'my-custom-name'
        """
        from ._helpers.certificate_setting import FIELDS_WITH_DEFAULTS
    ...
    def schema() -> dict[str, Any]:
        ...
        Examples:
            >>> schema = CertificateSetting.schema()
            >>> print(f"Endpoint: {schema['endpoint']}")
            >>> print(f"Total fields: {schema['total_fields']}")
            >>> print(f"Primary key: {schema.get('mkey', 'N/A')}")
        """
        from ._helpers.certificate_setting import get_schema_info
