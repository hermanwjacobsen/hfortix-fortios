...
class KmipServerPayload(TypedDict, total=False):
    ...
    **Usage:**
    ...
    server_identity_check: NotRequired[Literal["enable", "disable"]]  # Enable/disable KMIP server identity check
...
class KmipServerObject:
    ...
    name: str
    # KMIP server list.
    server_list: list[KmipServerServerlistObject]  # Table field - list of typed objects
    ...
    ssl_min_proto_version: Literal["default", "SSLv3", "TLSv1", "TLSv1-1", "TLSv1-2", "TLSv1-3"]
    # Enable/disable KMIP server identity check
    server_identity_check: Literal["enable", "disable"]
