...
class CertificateLocalPayload(TypedDict, total=False):
    """
    Type hints for vpn/certificate_local payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: CertificateLocalPayload = {
...
class CertificateLocal:
    ...
    def post(
        self,
        payload_dict: CertificateLocalPayload | None = ...,
        name: str | None = ...,
        password: str | None = ...,
        comments: str | None = ...,
