"""
FortiOS CMDB - Vpn ipsec_phase1_interface

Configuration endpoint for managing cmdb vpn/ipsec_phase1_interface objects.
...
class IpsecPhase1Interface:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        """
        Retrieve vpn/ipsec_phase1_interface configuration.
        ...
        Examples:
            >>> # Get all vpn/ipsec_phase1_interface objects
            >>> result = fgt.api.cmdb.vpn_ipsec_phase1_interface.get()
            >>> print(f"Found {len(result['results'])} objects")
            
            >>> # Get specific vpn/ipsec_phase1_interface by name
        ...
        See Also:
            - post(): Create new vpn/ipsec_phase1_interface object
            - put(): Update existing vpn/ipsec_phase1_interface object
            - delete(): Remove vpn/ipsec_phase1_interface object
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update existing vpn/ipsec_phase1_interface object.
        ...
        from ._helpers.ipsec_phase1_interface import DEPRECATED_FIELDS
        if DEPRECATED_FIELDS:
            from hfortix_core import check_deprecated_fields
            check_deprecated_fields(
                payload=payload_data,
                deprecated_fields=DEPRECATED_FIELDS,
                endpoint="cmdb/vpn/ipsec_phase1_interface",
            )
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new vpn/ipsec_phase1_interface object.
        ...
        Examples:
            ...
            >>> payload = IpsecPhase1Interface.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.cmdb.vpn_ipsec_phase1_interface.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(IpsecPhase1Interface.required_fields()) }}
            
            Use IpsecPhase1Interface.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete vpn/ipsec_phase1_interface object.
    ...
    def exists(
        ...
        """
        Check if vpn/ipsec_phase1_interface object exists.
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update vpn/ipsec_phase1_interface object (intelligent operation).
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(IpsecPhase1Interface.help())
            
            >>> # Get field information
            >>> print(IpsecPhase1Interface.help("name"))
        """
        from ._helpers.ipsec_phase1_interface import (
            get_schema_info,
            get_field_metadata,
        )
    ...
    def fields(detailed: bool = False) -> Union[list[str], dict[str, dict]]:
        ...
        Examples:
            >>> # Simple list
            >>> fields = IpsecPhase1Interface.fields()
            >>> print(f"Available fields: {len(fields)}")
            
            >>> # Detailed info
            >>> fields = IpsecPhase1Interface.fields(detailed=True)
            >>> for name, meta in fields.items():
            ...     print(f"{name}: {meta['type']}")
        """
        from ._helpers.ipsec_phase1_interface import get_all_fields, get_field_metadata
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = IpsecPhase1Interface.field_info("name")
            >>> print(f"Type: {info['type']}")
            >>> if 'options' in info:
            ...     print(f"Options: {info['options']}")
        """
        from ._helpers.ipsec_phase1_interface import get_field_metadata
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = IpsecPhase1Interface.validate_field("name", "test")
            >>> if not is_valid:
            ...     print(f"Validation error: {error}")
        """
        from ._helpers.ipsec_phase1_interface import validate_field_value
    ...
    def required_fields() -> list[str]:
        ...
        Examples:
            >>> required = IpsecPhase1Interface.required_fields()
            >>> print(f"Required fields: {', '.join(required)}")
        """
        from ._helpers.ipsec_phase1_interface import REQUIRED_FIELDS
    ...
    def defaults() -> dict[str, Any]:
        ...
        Examples:
            >>> defaults = IpsecPhase1Interface.defaults()
            >>> print(f"Fields with defaults: {len(defaults)}")
            >>> # Use as starting point for payload
            >>> payload = defaults.copy()
            >>> payload['name'] = 'my-custom-name'
        """
        from ._helpers.ipsec_phase1_interface import FIELDS_WITH_DEFAULTS
    ...
    def schema() -> dict[str, Any]:
        ...
        Examples:
            >>> schema = IpsecPhase1Interface.schema()
            >>> print(f"Endpoint: {schema['endpoint']}")
            >>> print(f"Total fields: {schema['total_fields']}")
            >>> print(f"Primary key: {schema.get('mkey', 'N/A')}")
        """
        from ._helpers.ipsec_phase1_interface import get_schema_info
