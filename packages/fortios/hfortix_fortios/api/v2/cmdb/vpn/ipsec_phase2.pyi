...
class IpsecPhase2Payload(TypedDict, total=False):
    """
    Type hints for vpn/ipsec_phase2 payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: IpsecPhase2Payload = {
...
class IpsecPhase2:
    ...
    def post(
        self,
        payload_dict: IpsecPhase2Payload | None = ...,
        name: str | None = ...,
        phase1name: str | None = ...,
