...
def validate_vpn_ipsec_manualkey_get(
    ...
    **params: Any,
    ...
    """
    Validate GET request parameters for vpn/ipsec_manualkey.
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_vpn_ipsec_manualkey_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_vpn_ipsec_manualkey_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for vpn/ipsec_manualkey.
...
def validate_vpn_ipsec_manualkey_post(
    ...
    **params: Any,
    ...
    """
    Validate POST request to create new vpn/ipsec_manualkey object.
    ...
    Examples:
        ...
        ...     "authkey": True,  # Hexadecimal authentication key in 16-digit (8-byte
        ... }
        ...
        >>> payload["authentication"] = "invalid-value"
        >>> is_valid, error = validate_vpn_ipsec_manualkey_post(payload)
...
def validate_vpn_ipsec_manualkey_put(
    ...
    **params: Any,
    ...
    """
    Validate PUT request to update vpn/ipsec_manualkey.
    ...
    Example:
        ...
        >>> is_valid, error = validate_vpn_ipsec_manualkey_put(payload)
    """
