...
def validate_vpn_certificate_hsm_local_get(
    ...
    **params: Any,
    ...
    """
    Validate GET request parameters for vpn/certificate_hsm_local.
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_vpn_certificate_hsm_local_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_vpn_certificate_hsm_local_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for vpn/certificate_hsm_local.
...
def validate_vpn_certificate_hsm_local_post(
    ...
    **params: Any,
    ...
    """
    Validate POST request to create new vpn/certificate_hsm_local object.
...
def validate_vpn_certificate_hsm_local_put(
    ...
    **params: Any,
    ...
    """
    Validate PUT request to update vpn/certificate_hsm_local.
    ...
    Example:
        ...
        >>> is_valid, error = validate_vpn_certificate_hsm_local_put(payload)
    """
...
SCHEMA_INFO = {
    "endpoint": "vpn/certificate_hsm_local",
    "category": "cmdb",
