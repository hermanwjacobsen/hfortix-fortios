...
def validate_vpn_ipsec_concentrator_get(
    ...
    **params: Any,
    ...
    """
    Validate GET request parameters for vpn/ipsec_concentrator.
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_vpn_ipsec_concentrator_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by id
        >>> is_valid, error = validate_vpn_ipsec_concentrator_get(id="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for vpn/ipsec_concentrator.
...
def validate_vpn_ipsec_concentrator_post(
    ...
    **params: Any,
    ...
    """
    Validate POST request to create new vpn/ipsec_concentrator object.
    ...
    Examples:
        ...
        >>> payload["src-check"] = "invalid-value"
        >>> is_valid, error = validate_vpn_ipsec_concentrator_post(payload)
...
def validate_vpn_ipsec_concentrator_put(
    ...
    **params: Any,
    ...
    """
    Validate PUT request to update vpn/ipsec_concentrator.
    ...
    Example:
        ...
        >>> is_valid, error = validate_vpn_ipsec_concentrator_put(payload)
    """
...
SCHEMA_INFO = {
    "endpoint": "vpn/ipsec_concentrator",
    "category": "cmdb",
