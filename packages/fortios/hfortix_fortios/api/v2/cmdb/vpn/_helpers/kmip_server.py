...
def validate_vpn_kmip_server_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_vpn_kmip_server_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_vpn_kmip_server_get(name="test-item")
        >>> assert is_valid == True
...
def validate_vpn_kmip_server_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "server-list": True,  # KMIP server list.
        ...     "username": True,  # User name to use for connectivity to the KMIP serv
        ... }
        ...
        >>> payload["ssl-min-proto-version"] = "invalid-value"
        >>> is_valid, error = validate_vpn_kmip_server_post(payload)
...
def validate_vpn_kmip_server_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_vpn_kmip_server_put(payload)
    """
