...
def validate_vpn_certificate_ca_get(
    ...
    **params: Any,
    ...
    """
    Validate GET request parameters for vpn/certificate_ca.
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_vpn_certificate_ca_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_vpn_certificate_ca_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for vpn/certificate_ca.
...
def validate_vpn_certificate_ca_post(
    ...
    **params: Any,
    ...
    """
    Validate POST request to create new vpn/certificate_ca object.
    ...
    Examples:
        ...
        >>> payload = {
        ...     "name": True,  # Name.
        ...     "ca": True,  # CA certificate as a PEM file.
        ... }
        >>> is_valid, error = validate_vpn_certificate_ca_post(payload)
        >>> assert is_valid == True
...
def validate_vpn_certificate_ca_put(
    ...
    **params: Any,
    ...
    """
    Validate PUT request to update vpn/certificate_ca.
    ...
    Example:
        ...
        >>> is_valid, error = validate_vpn_certificate_ca_put(payload)
    """
