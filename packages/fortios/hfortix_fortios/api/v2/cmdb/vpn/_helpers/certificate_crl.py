...
def validate_vpn_certificate_crl_get(
    ...
    **params: Any,
    ...
    """
    Validate GET request parameters for vpn/certificate_crl.
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_vpn_certificate_crl_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_vpn_certificate_crl_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for vpn/certificate_crl.
...
def validate_vpn_certificate_crl_post(
    ...
    **params: Any,
    ...
    """
    Validate POST request to create new vpn/certificate_crl object.
    ...
    Examples:
        ...
        ...     "name": True,  # Name.
        ... }
        >>> is_valid, error = validate_vpn_certificate_crl_post(payload)
        >>> assert is_valid == True
...
def validate_vpn_certificate_crl_put(
    ...
    **params: Any,
    ...
    """
    Validate PUT request to update vpn/certificate_crl.
    ...
    Example:
        ...
        >>> is_valid, error = validate_vpn_certificate_crl_put(payload)
    """
