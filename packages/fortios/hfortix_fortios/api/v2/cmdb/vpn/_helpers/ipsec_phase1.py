...
def validate_vpn_ipsec_phase1_get(
    ...
    **params: Any,
    ...
    """
    Validate GET request parameters for vpn/ipsec_phase1.
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for vpn/ipsec_phase1.
...
def validate_vpn_ipsec_phase1_post(
    ...
    **params: Any,
    ...
    """
    Validate POST request to create new vpn/ipsec_phase1 object.
...
def validate_vpn_ipsec_phase1_put(
    ...
    **params: Any,
    ...
    """
    Validate PUT request to update vpn/ipsec_phase1.
