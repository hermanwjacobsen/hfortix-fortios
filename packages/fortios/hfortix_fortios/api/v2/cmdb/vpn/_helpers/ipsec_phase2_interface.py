...
def validate_vpn_ipsec_phase2_interface_get(
    ...
    **params: Any,
    ...
    """
    Validate GET request parameters for vpn/ipsec_phase2_interface.
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_vpn_ipsec_phase2_interface_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_vpn_ipsec_phase2_interface_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for vpn/ipsec_phase2_interface.
...
def validate_vpn_ipsec_phase2_interface_post(
    ...
    **params: Any,
    ...
    """
    Validate POST request to create new vpn/ipsec_phase2_interface object.
...
def validate_vpn_ipsec_phase2_interface_put(
    ...
    **params: Any,
    ...
    """
    Validate PUT request to update vpn/ipsec_phase2_interface.
    ...
    Example:
        ...
        >>> is_valid, error = validate_vpn_ipsec_phase2_interface_put(payload)
    """
...
SCHEMA_INFO = {
    "endpoint": "vpn/ipsec_phase2_interface",
    "category": "cmdb",
