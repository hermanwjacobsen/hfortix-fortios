...
REQUIRED_FIELDS = [
    "acme-ca-url",  # The URL for the ACME CA server (Let's Encrypt is the default
    "acme-domain",  # A valid domain that resolves to this FortiGate unit.
    "acme-email",  # Contact email address that is required by some CAs like Lets
    "name",  # Name.
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for vpn_certificate_local.
