...
def validate_vpn_certificate_setting_get(
    ...
    **params: Any,
    ...
    """
    Validate GET request parameters for vpn/certificate_setting.
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for vpn/certificate_setting.
...
def validate_vpn_certificate_setting_post(
    ...
    **params: Any,
    ...
    """
    Validate POST request to create new vpn/certificate_setting object.
...
def validate_vpn_certificate_setting_put(
    ...
    **params: Any,
    ...
    """
    Validate PUT request to update vpn/certificate_setting.
...
SCHEMA_INFO = {
    "endpoint": "vpn/certificate_setting",
    "category": "cmdb",
