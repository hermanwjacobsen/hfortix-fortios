...
class IpsecPhase1InterfacePayload(TypedDict, total=False):
    """
    Type hints for vpn/ipsec_phase1_interface payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: IpsecPhase1InterfacePayload = {
...
class IpsecPhase1Interface:
    ...
    Path: vpn/ipsec_phase1_interface
    Category: cmdb
    Primary Key: name
    """
    ...
    def post(
        self,
        payload_dict: IpsecPhase1InterfacePayload | None = ...,
        name: str | None = ...,
