...
class Phase1InterfacePayload(TypedDict, total=False):
    ...
    **Usage:**
    ...
    monitor: list[dict[str, Any]]  # IPsec interface as backup for primary interface.
...
class Phase1InterfaceCertificateItem(TypedDict):
...
class Phase1InterfaceMonitorItem(TypedDict):
...
class Phase1InterfaceInternaldomainlistItem(TypedDict):
...
class Phase1InterfaceDnssuffixsearchItem(TypedDict):
...
class Phase1InterfaceIpv4excluderangeItem(TypedDict):
...
class Phase1InterfaceIpv6excluderangeItem(TypedDict):
...
class Phase1InterfaceBackupgatewayItem(TypedDict):
...
class Phase1InterfaceRemotegwztnatagsItem(TypedDict):
...
class Phase1InterfaceDictMode:
    """Phase1Interface endpoint for dict response mode (default for this client).
    
    By default returns Phase1InterfaceResponse (TypedDict).
    Can be overridden per-call with response_mode="object" to return Phase1InterfaceObject.
    """
...
class Phase1InterfaceObjectMode:
    """Phase1Interface endpoint for object response mode (default for this client).
    
    By default returns Phase1InterfaceObject (FortiObject).
    Can be overridden per-call with response_mode="dict" to return Phase1InterfaceResponse (TypedDict).
    """
...
__all__ = [
    "Phase1Interface",
    "Phase1InterfaceDictMode",
    "Phase1InterfaceObjectMode",
