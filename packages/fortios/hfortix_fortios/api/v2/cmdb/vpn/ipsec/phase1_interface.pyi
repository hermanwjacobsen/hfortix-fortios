...
class Phase1InterfacePayload(TypedDict, total=False):
    ...
    **Usage:**
    ...
    psksecret_remote: str  # Pre-shared secret for remote side PSK authentication
    ...
    auto_discovery_offer_interval: NotRequired[int]  # Interval between shortcut offer messages in seconds
    ...
    digital_signature_auth: NotRequired[Literal["enable", "disable"]]  # Enable/disable IKEv2 Digital Signature Authentication
    ...
    fec_redundant: NotRequired[int]  # Number of redundant Forward Error Correction packets
...
class Phase1InterfaceResponse(TypedDict):
    ...
    internal_domain_list: list[dict[str, Any]]
    dns_suffix_search: list[dict[str, Any]]
    ipv4_wins_server1: str
    ipv4_wins_server2: str
    ipv4_exclude_range: list[dict[str, Any]]
    ...
    ipv6_exclude_range: list[dict[str, Any]]
    ...
    backup_gateway: list[dict[str, Any]]
    ...
    remote_gw_ztna_tags: list[dict[str, Any]]
...
class Phase1InterfaceObject:
    ...
    certificate: list[Phase1InterfaceCertificateObject]  # Table field - list of typed objects
    ...
    default_gw: str
    # Priority for default gateway route. A higher priority number signifies a less pr
    default_gw_priority: int
    ...
    peergrp: str
    # IPsec interface as backup for primary interface.
    monitor: list[Phase1InterfaceMonitorObject]  # Table field - list of typed objects
    # Minimum number of links to become degraded before activating this interface.  Ze
    monitor_min: int
    ...
    peer_egress_shaping: Literal["enable", "disable"]
    # Configure outbound bandwidth to use for peer egress shaping in kbps
    peer_egress_shaping_value: int
    ...
    internal_domain_list: list[Phase1InterfaceInternaldomainlistObject]  # Table field - list of typed objects
    # One or more DNS domain name suffixes in quotes separated by spaces.
    dns_suffix_search: list[Phase1InterfaceDnssuffixsearchObject]  # Table field - list of typed objects
    # WINS server 1.
    ipv4_wins_server1: str
    # WINS server 2.
    ipv4_wins_server2: str
    # Configuration Method IPv4 exclude ranges.
    ipv4_exclude_range: list[Phase1InterfaceIpv4excluderangeObject]  # Table field - list of typed objects
    ...
    ipv6_exclude_range: list[Phase1InterfaceIpv6excluderangeObject]  # Table field - list of typed objects
    ...
    backup_gateway: list[Phase1InterfaceBackupgatewayObject]  # Table field - list of typed objects
    # Phase1 proposal.
    proposal: Literal["des-md5", "des-sha1", "des-sha256", "des-sha384", "des-sha512", "3des-md5", "3des-sha1", "3des-sha256", "3des-sha384", "3des-sha512", "aes128-md5", "aes128-sha1", "aes128-sha256", "aes128-sha384", "aes128-sha512", "aes128gcm-prfsha1", "aes128gcm-prfsha256", "aes128gcm-prfsha384", "aes128gcm-prfsha512", "aes192-md5", "aes192-sha1", "aes192-sha256", "aes192-sha384", "aes192-sha512", "aes256-md5", "aes256-sha1", "aes256-sha256", "aes256-sha384", "aes256-sha512", "aes256gcm-prfsha1", "aes256gcm-prfsha256", "aes256gcm-prfsha384", "aes256gcm-prfsha512", "chacha20poly1305-prfsha1", "chacha20poly1305-prfsha256", "chacha20poly1305-prfsha384", "chacha20poly1305-prfsha512", "aria128-md5", "aria128-sha1", "aria128-sha256", "aria128-sha384", "aria128-sha512", "aria192-md5", "aria192-sha1", "aria192-sha256", "aria192-sha384", "aria192-sha512", "aria256-md5", "aria256-sha1", "aria256-sha256", "aria256-sha384", "aria256-sha512", "seed-md5", "seed-sha1", "seed-sha256", "seed-sha384", "seed-sha512"]
    ...
    auto_discovery_forwarder: Literal["enable", "disable"]
    # Enable/disable use of pre-shared secrets for authentication of auto-discovery tu
    auto_discovery_psk: Literal["enable", "disable"]
    ...
    remote_gw_ztna_tags: list[Phase1InterfaceRemotegwztnatagsObject]  # Table field - list of typed objects
