...
class IpsecPhase2InterfacePayload(TypedDict, total=False):
    """
    Type hints for vpn/ipsec_phase2_interface payload fields.
    
    Use this for IDE autocomplete when building payload dicts:
        payload: IpsecPhase2InterfacePayload = {
...
class IpsecPhase2Interface:
    ...
    Path: vpn/ipsec_phase2_interface
    Category: cmdb
    Primary Key: name
    """
    ...
    def post(
        self,
        payload_dict: IpsecPhase2InterfacePayload | None = ...,
        name: str | None = ...,
        phase1name: str | None = ...,
