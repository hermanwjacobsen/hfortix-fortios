...
class Explicit:
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new ftp_proxy/explicit object.
        ...
        Examples:
            ...
            >>> payload = Explicit.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.cmdb.ftp_proxy_explicit.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(Explicit.required_fields()) }}
            
            Use Explicit.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete ftp_proxy/explicit object.
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.ftp_proxy_explicit.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.cmdb.ftp_proxy_explicit.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.cmdb.ftp_proxy_explicit.exists(name="old-object"):
            ...     fgt.api.cmdb.ftp_proxy_explicit.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update ftp_proxy/explicit object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.cmdb.ftp_proxy_explicit.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.cmdb.ftp_proxy_explicit.set(payload_dict=obj_data)
