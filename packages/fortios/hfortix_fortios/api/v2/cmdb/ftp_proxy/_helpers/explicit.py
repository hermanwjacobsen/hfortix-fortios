"""
Validation helpers for ftp_proxy/explicit endpoint.
...
def validate_ftp_proxy_explicit_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_ftp_proxy_explicit_get()
...
def validate_ftp_proxy_explicit_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_ftp_proxy_explicit_put(payload)
    """
