...
def validate_ztna_traffic_forward_proxy_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_ztna_traffic_forward_proxy_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_ztna_traffic_forward_proxy_get(name="test-item")
        >>> assert is_valid == True
...
def validate_ztna_traffic_forward_proxy_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_ztna_traffic_forward_proxy_put(payload)
    """
