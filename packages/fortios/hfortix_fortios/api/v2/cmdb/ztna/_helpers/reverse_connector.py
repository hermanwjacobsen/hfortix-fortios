...
def validate_ztna_reverse_connector_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_ztna_reverse_connector_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_ztna_reverse_connector_get(name="test-item")
        >>> assert is_valid == True
...
def validate_ztna_reverse_connector_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "address": True,  # Connector service edge adress(IP or FQDN).
        ... }
...
def validate_ztna_reverse_connector_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_ztna_reverse_connector_put(payload)
    """
