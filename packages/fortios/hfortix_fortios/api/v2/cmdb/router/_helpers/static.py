...
def validate_router_static_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_router_static_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by seq-num
        >>> is_valid, error = validate_router_static_get(seq_num="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for router/static.
...
def validate_router_static_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        ... }
        >>> is_valid, error = validate_router_static_post(payload)
        >>> assert is_valid == True
...
def validate_router_static_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_router_static_put(payload)
    """
