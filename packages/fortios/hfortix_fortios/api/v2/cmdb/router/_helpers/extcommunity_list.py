...
NESTED_SCHEMAS = {
    "rule": {
        ...
        "type": {
            ...
            "required": True,
            "default": "rt",
            "options": [{"help": "Route Target.", "label": "Rt", "name": "rt"}, {"help": "Site of Origin.", "label": "Soo", "name": "soo"}],
        },
        "match": {
            "type": "string",
...
def validate_router_extcommunity_list_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_router_extcommunity_list_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_router_extcommunity_list_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for router/extcommunity_list.
...
def validate_router_extcommunity_list_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "name": True,  # Extended community list name.
        ... }
        >>> is_valid, error = validate_router_extcommunity_list_post(payload)
        >>> assert is_valid == True
        
        >>> # ✅ Valid - With enum field
        >>> payload = {
        ...     "name": True,
        ...     "type": "{'name': 'standard', 'help': 'Standard extended community list type.', 'label': 'Standard', 'description': 'Standard extended community list type'}",  # Valid enum value
        ... }
        >>> is_valid, error = validate_router_extcommunity_list_post(payload)
        >>> assert is_valid == True
...
def validate_router_extcommunity_list_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_router_extcommunity_list_put(payload)
    """
