...
def validate_router_policy_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_router_policy_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by seq-num
        >>> is_valid, error = validate_router_policy_get(seq_num="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for router/policy.
...
def validate_router_policy_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_router_policy_put(payload)
    """
