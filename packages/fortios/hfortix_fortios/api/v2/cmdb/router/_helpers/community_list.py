...
def validate_router_community_list_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_router_community_list_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_router_community_list_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for router/community_list.
...
def validate_router_community_list_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_router_community_list_put(payload)
    """
