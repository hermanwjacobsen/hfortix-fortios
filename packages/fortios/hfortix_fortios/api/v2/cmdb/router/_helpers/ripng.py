...
def validate_router_ripng_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_router_ripng_get()
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for router/ripng.
...
def validate_router_ripng_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload["default-information-originate"] = "invalid-value"
        >>> is_valid, error = validate_router_ripng_post(payload)
...
def validate_router_ripng_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_router_ripng_put(payload)
    """
