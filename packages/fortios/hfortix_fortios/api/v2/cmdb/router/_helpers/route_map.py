...
def validate_router_route_map_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_router_route_map_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_router_route_map_get(name="test-item")
        >>> assert is_valid == True
...
def validate_router_route_map_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        ...     "name": True,  # Name.
        ... }
        >>> is_valid, error = validate_router_route_map_post(payload)
        >>> assert is_valid == True
...
def validate_router_route_map_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_router_route_map_put(payload)
    """
