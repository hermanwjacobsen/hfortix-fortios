...
def validate_casb_user_activity_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_casb_user_activity_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_casb_user_activity_get(name="test-item")
        >>> assert is_valid == True
...
def validate_casb_user_activity_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "application": True,  # CASB SaaS application name.
        ... }
...
def validate_casb_user_activity_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_casb_user_activity_put(payload)
    """
