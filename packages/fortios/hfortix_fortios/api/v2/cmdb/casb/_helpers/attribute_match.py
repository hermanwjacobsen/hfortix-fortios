...
def validate_casb_attribute_match_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_casb_attribute_match_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_casb_attribute_match_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for casb/attribute_match.
...
def validate_casb_attribute_match_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ...     "application": True,  # CASB attribute application name.
        ... }
        ...
        >>> payload["match-strategy"] = "invalid-value"
        >>> is_valid, error = validate_casb_attribute_match_post(payload)
...
def validate_casb_attribute_match_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_casb_attribute_match_put(payload)
    """
