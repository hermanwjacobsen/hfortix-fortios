...
def validate_casb_saas_application_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_casb_saas_application_get()
        >>> assert is_valid == True
        
        >>> # Valid - Get specific item by name
        >>> is_valid, error = validate_casb_saas_application_get(name="test-item")
        >>> assert is_valid == True
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for casb/saas_application.
...
def validate_casb_saas_application_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_casb_saas_application_put(payload)
    """
