...
class UserActivityObject:
    ...
    match: list[UserActivityMatchObject]  # Table field - list of typed objects
    # CASB control options.
    control_options: list[UserActivityControloptionsObject]  # Table field - list of typed objects
