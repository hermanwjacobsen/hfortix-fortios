...
class RateBased:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        cache_key = f"monitor/ips/rate_based"
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update existing ips/rate_based object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.ips_rate_based.put(
            ...
            ...     "field1": "new-value",
            ... }
            >>> result = fgt.api.monitor.ips_rate_based.put(payload_dict=payload)
        ...
        from ._helpers.rate_based import DEPRECATED_FIELDS
        if DEPRECATED_FIELDS:
            from hfortix_core import check_deprecated_fields
            check_deprecated_fields(
                payload=payload_data,
                deprecated_fields=DEPRECATED_FIELDS,
                endpoint="monitor/ips/rate_based",
            )
        
        name_value = payload_data.get("name")
        if not name_value:
            raise ValueError("name is required for PUT")
        endpoint = f"/ips/rate-based/{name_value}"
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new ips/rate_based object.
        ...
        Examples:
            ...
            >>> payload = RateBased.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.monitor.ips_rate_based.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(RateBased.required_fields()) }}
            
            Use RateBased.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.ips_rate_based.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.monitor.ips_rate_based.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.monitor.ips_rate_based.exists(name="old-object"):
            ...     fgt.api.monitor.ips_rate_based.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update ips/rate_based object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.monitor.ips_rate_based.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.monitor.ips_rate_based.set(payload_dict=obj_data)
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(RateBased.help())
            
            >>> # Get field information
            >>> print(RateBased.help("name"))
        """
        from ._helpers.rate_based import (
            get_schema_info,
            get_field_metadata,
        )
    ...
    def fields(detailed: bool = False) -> Union[list[str], dict[str, dict]]:
        ...
        Examples:
            >>> # Simple list
            >>> fields = RateBased.fields()
            >>> print(f"Available fields: {len(fields)}")
            
            >>> # Detailed info
            >>> fields = RateBased.fields(detailed=True)
            >>> for name, meta in fields.items():
            ...     print(f"{name}: {meta['type']}")
        """
        from ._helpers.rate_based import get_all_fields, get_field_metadata
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = RateBased.field_info("name")
            >>> print(f"Type: {info['type']}")
            >>> if 'options' in info:
            ...     print(f"Options: {info['options']}")
        """
        from ._helpers.rate_based import get_field_metadata
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = RateBased.validate_field("name", "test")
            >>> if not is_valid:
            ...     print(f"Validation error: {error}")
        """
        from ._helpers.rate_based import validate_field_value
    ...
    def required_fields() -> list[str]:
        ...
        Examples:
            >>> required = RateBased.required_fields()
            >>> print(f"Required fields: {', '.join(required)}")
        """
        from ._helpers.rate_based import REQUIRED_FIELDS
    ...
    def defaults() -> dict[str, Any]:
        ...
        Examples:
            >>> defaults = RateBased.defaults()
            >>> print(f"Fields with defaults: {len(defaults)}")
            >>> # Use as starting point for payload
            >>> payload = defaults.copy()
            >>> payload['name'] = 'my-custom-name'
        """
        from ._helpers.rate_based import FIELDS_WITH_DEFAULTS
    ...
    def schema() -> dict[str, Any]:
        ...
        Examples:
            >>> schema = RateBased.schema()
            >>> print(f"Endpoint: {schema['endpoint']}")
            >>> print(f"Total fields: {schema['total_fields']}")
            >>> print(f"Primary key: {schema.get('mkey', 'N/A')}")
        """
        from ._helpers.rate_based import get_schema_info
