...
class DownloadPayload(TypedDict, total=False):
    """
    Type hints for log/av_archive/download payload fields.
...
class DownloadResponse(TypedDict):
    """
    Type hints for log/av_archive/download API response fields.
...
class DownloadObject:
    """Typed FortiObject for log/av_archive/download with IDE autocomplete support.
