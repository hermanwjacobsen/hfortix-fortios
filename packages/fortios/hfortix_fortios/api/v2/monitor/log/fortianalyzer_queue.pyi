...
class FortianalyzerQueueResponse(TypedDict):
    """
    Type hints for log/fortianalyzer_queue API response fields.
...
@final
class FortianalyzerQueueObject:
    """Typed FortiObject for log/fortianalyzer_queue with IDE autocomplete support.
    ...
    def to_dict(self) -> FortianalyzerQueuePayload: ...
    def keys(self) -> Any: ...
...
class FortianalyzerQueue:
    ...
    def get(
        ...
        action: str | None = ...,
        vdom: str | bool | None = ...,
    ) -> FortianalyzerQueueObject | dict[str, Any]: ...
