...
class FortianalyzerPayload(TypedDict, total=False):
    """
    Type hints for log/fortianalyzer payload fields.
    
    Return FortiAnalyzer/FortiManager log status.
    
    **Usage:**
        payload: FortianalyzerPayload = {
...
class FortianalyzerResponse(TypedDict):
    """
    Type hints for log/fortianalyzer API response fields.
...
class FortianalyzerObject:
    """Typed FortiObject for log/fortianalyzer with IDE autocomplete support.
    ...
    def to_dict(self) -> FortianalyzerPayload: ...
    def keys(self) -> Any: ...
...
class Fortianalyzer:
    ...
    def get(
        ...
        action: str | None = ...,
        vdom: str | bool | None = ...,
    ) -> FortianalyzerObject | dict[str, Any]: ...
