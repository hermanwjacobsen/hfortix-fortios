...
class LocalReportList:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        cache_key = f"monitor/log/local_report_list"
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update existing log/local_report_list object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.log_local_report_list.put(
            ...
            ...     "field1": "new-value",
            ... }
            >>> result = fgt.api.monitor.log_local_report_list.put(payload_dict=payload)
        ...
        from ._helpers.local_report_list import DEPRECATED_FIELDS
        if DEPRECATED_FIELDS:
            from hfortix_core import check_deprecated_fields
            check_deprecated_fields(
                payload=payload_data,
                deprecated_fields=DEPRECATED_FIELDS,
                endpoint="monitor/log/local_report_list",
            )
        
        name_value = payload_data.get("name")
        if not name_value:
            raise ValueError("name is required for PUT")
        endpoint = f"/log/local-report-list/{name_value}"
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new log/local_report_list object.
        ...
        Examples:
            ...
            >>> payload = LocalReportList.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.monitor.log_local_report_list.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(LocalReportList.required_fields()) }}
            
            Use LocalReportList.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete log/local_report_list object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.log_local_report_list.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.monitor.log_local_report_list.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.monitor.log_local_report_list.exists(name="old-object"):
            ...     fgt.api.monitor.log_local_report_list.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update log/local_report_list object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.monitor.log_local_report_list.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.monitor.log_local_report_list.set(payload_dict=obj_data)
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(LocalReportList.help())
            
            >>> # Get field information
            >>> print(LocalReportList.help("name"))
        """
        from ._helpers.local_report_list import (
            get_schema_info,
            get_field_metadata,
        )
    ...
    def fields(detailed: bool = False) -> Union[list[str], dict[str, dict]]:
        ...
        Examples:
            >>> # Simple list
            >>> fields = LocalReportList.fields()
            >>> print(f"Available fields: {len(fields)}")
            
            >>> # Detailed info
            >>> fields = LocalReportList.fields(detailed=True)
            >>> for name, meta in fields.items():
            ...     print(f"{name}: {meta['type']}")
        """
        from ._helpers.local_report_list import get_all_fields, get_field_metadata
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = LocalReportList.field_info("name")
            >>> print(f"Type: {info['type']}")
            >>> if 'options' in info:
            ...     print(f"Options: {info['options']}")
        """
        from ._helpers.local_report_list import get_field_metadata
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = LocalReportList.validate_field("name", "test")
            >>> if not is_valid:
            ...     print(f"Validation error: {error}")
        """
        from ._helpers.local_report_list import validate_field_value
    ...
    def required_fields() -> list[str]:
        ...
        Examples:
            >>> required = LocalReportList.required_fields()
            >>> print(f"Required fields: {', '.join(required)}")
        """
        from ._helpers.local_report_list import REQUIRED_FIELDS
    ...
    def defaults() -> dict[str, Any]:
        ...
        Examples:
            >>> defaults = LocalReportList.defaults()
            >>> print(f"Fields with defaults: {len(defaults)}")
            >>> # Use as starting point for payload
            >>> payload = defaults.copy()
            >>> payload['name'] = 'my-custom-name'
        """
        from ._helpers.local_report_list import FIELDS_WITH_DEFAULTS
    ...
    def schema() -> dict[str, Any]:
        ...
        Examples:
            >>> schema = LocalReportList.schema()
            >>> print(f"Endpoint: {schema['endpoint']}")
            >>> print(f"Total fields: {schema['total_fields']}")
            >>> print(f"Primary key: {schema.get('mkey', 'N/A')}")
        """
        from ._helpers.local_report_list import get_schema_info
