...
class StatePayload(TypedDict, total=False):
    """
    Type hints for log/device/state payload fields.
...
class StateResponse(TypedDict):
    """
    Type hints for log/device/state API response fields.
...
@final
class StateObject:
    """Typed FortiObject for log/device/state with IDE autocomplete support.
