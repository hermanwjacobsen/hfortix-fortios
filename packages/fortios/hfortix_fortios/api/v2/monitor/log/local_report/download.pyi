...
class DownloadPayload(TypedDict, total=False):
    """
    Type hints for log/local_report/download payload fields.
...
class DownloadResponse(TypedDict):
    """
    Type hints for log/local_report/download API response fields.
...
class DownloadObject:
    """Typed FortiObject for log/local_report/download with IDE autocomplete support.
