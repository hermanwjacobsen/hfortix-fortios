...
class HistoricDailyRemoteLogsResponse(TypedDict):
    """
    Type hints for log/historic_daily_remote_logs API response fields.
...
@final
class HistoricDailyRemoteLogsObject:
    """Typed FortiObject for log/historic_daily_remote_logs with IDE autocomplete support.
    ...
    def to_dict(self) -> HistoricDailyRemoteLogsPayload: ...
    def keys(self) -> Any: ...
...
class HistoricDailyRemoteLogs:
    ...
    def get(
        ...
        action: str | None = ...,
        vdom: str | bool | None = ...,
    ) -> HistoricDailyRemoteLogsObject | dict[str, Any]: ...
