...
class DownloadPayload(TypedDict, total=False):
    """
    Type hints for log/policy_archive/download payload fields.
...
class DownloadResponse(TypedDict):
    """
    Type hints for log/policy_archive/download API response fields.
...
class DownloadObject:
    """Typed FortiObject for log/policy_archive/download with IDE autocomplete support.
