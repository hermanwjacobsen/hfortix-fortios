...
class Reset:
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update existing webcache/stats/reset object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.webcache_stats_reset.put(
            ...
            ...     "field1": "new-value",
            ... }
            >>> result = fgt.api.monitor.webcache_stats_reset.put(payload_dict=payload)
        ...
        endpoint = f"/webcache/stats/reset/{name_value}"
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete webcache/stats/reset object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.webcache_stats_reset.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.monitor.webcache_stats_reset.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.monitor.webcache_stats_reset.exists(name="old-object"):
            ...     fgt.api.monitor.webcache_stats_reset.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update webcache/stats/reset object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.monitor.webcache_stats_reset.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.monitor.webcache_stats_reset.set(payload_dict=obj_data)
