...
class StatusPayload(TypedDict, total=False):
    """
    Type hints for endpoint_control/ems/status payload fields.
...
class StatusResponse(TypedDict):
    """
    Type hints for endpoint_control/ems/status API response fields.
...
@final
class StatusObject:
    """Typed FortiObject for endpoint_control/ems/status with IDE autocomplete support.
