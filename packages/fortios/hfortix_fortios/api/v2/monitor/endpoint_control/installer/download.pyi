...
class DownloadPayload(TypedDict, total=False):
    """
    Type hints for endpoint_control/installer/download payload fields.
...
class DownloadResponse(TypedDict):
    """
    Type hints for endpoint_control/installer/download API response fields.
...
class DownloadObject:
    """Typed FortiObject for endpoint_control/installer/download with IDE autocomplete support.
