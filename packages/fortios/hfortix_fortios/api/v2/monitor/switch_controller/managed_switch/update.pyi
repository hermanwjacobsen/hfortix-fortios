...
class UpdatePayload(TypedDict, total=False):
    """
    Type hints for switch_controller/managed_switch/update payload fields.
...
class UpdateResponse(TypedDict):
    """
    Type hints for switch_controller/managed_switch/update API response fields.
...
@final
class UpdateObject:
    """Typed FortiObject for switch_controller/managed_switch/update with IDE autocomplete support.
