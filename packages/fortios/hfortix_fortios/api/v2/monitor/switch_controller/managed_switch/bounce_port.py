...
class BouncePort:
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update existing switch_controller/managed_switch/bounce_port object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.switch_controller_managed_switch_bounce_port.put(
            ...
            ...     "field1": "new-value",
            ... }
            >>> result = fgt.api.monitor.switch_controller_managed_switch_bounce_port.put(payload_dict=payload)
        ...
        endpoint = f"/switch-controller/managed-switch/bounce-port/{name_value}"
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete switch_controller/managed_switch/bounce_port object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.switch_controller_managed_switch_bounce_port.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.monitor.switch_controller_managed_switch_bounce_port.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.monitor.switch_controller_managed_switch_bounce_port.exists(name="old-object"):
            ...     fgt.api.monitor.switch_controller_managed_switch_bounce_port.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update switch_controller/managed_switch/bounce_port object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.monitor.switch_controller_managed_switch_bounce_port.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.monitor.switch_controller_managed_switch_bounce_port.set(payload_dict=obj_data)
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(BouncePort.help())
            
            >>> # Get field information
            >>> print(BouncePort.help("name"))
        """
        from ._helpers.bounce_port import (
            get_schema_info,
            get_field_metadata,
        )
    ...
    def fields(detailed: bool = False) -> Union[list[str], dict[str, dict]]:
        ...
        Examples:
            >>> # Simple list
            >>> fields = BouncePort.fields()
            >>> print(f"Available fields: {len(fields)}")
            
            >>> # Detailed info
            >>> fields = BouncePort.fields(detailed=True)
            >>> for name, meta in fields.items():
            ...     print(f"{name}: {meta['type']}")
        """
        from ._helpers.bounce_port import get_all_fields, get_field_metadata
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = BouncePort.field_info("name")
            >>> print(f"Type: {info['type']}")
            >>> if 'options' in info:
            ...     print(f"Options: {info['options']}")
        """
        from ._helpers.bounce_port import get_field_metadata
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = BouncePort.validate_field("name", "test")
            >>> if not is_valid:
            ...     print(f"Validation error: {error}")
        """
        from ._helpers.bounce_port import validate_field_value
    ...
    def required_fields() -> list[str]:
        ...
        Examples:
            >>> required = BouncePort.required_fields()
            >>> print(f"Required fields: {', '.join(required)}")
        """
        from ._helpers.bounce_port import REQUIRED_FIELDS
    ...
    def defaults() -> dict[str, Any]:
        ...
        Examples:
            >>> defaults = BouncePort.defaults()
            >>> print(f"Fields with defaults: {len(defaults)}")
            >>> # Use as starting point for payload
            >>> payload = defaults.copy()
            >>> payload['name'] = 'my-custom-name'
        """
        from ._helpers.bounce_port import FIELDS_WITH_DEFAULTS
    ...
    def schema() -> dict[str, Any]:
        ...
        Examples:
            >>> schema = BouncePort.schema()
            >>> print(f"Endpoint: {schema['endpoint']}")
            >>> print(f"Total fields: {schema['total_fields']}")
            >>> print(f"Primary key: {schema.get('mkey', 'N/A')}")
        """
        from ._helpers.bounce_port import get_schema_info
