...
class HealthStatus:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Monitor endpoint for switch-controller/managed-switch/health-status
        ...
        cache_key = f"monitor/switch_controller/managed_switch/health_status"
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update existing switch_controller/managed_switch/health_status object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.switch_controller_managed_switch_health_status.put(
            ...
            ...     "field1": "new-value",
            ... }
            >>> result = fgt.api.monitor.switch_controller_managed_switch_health_status.put(payload_dict=payload)
        ...
        from ._helpers.health_status import DEPRECATED_FIELDS
        if DEPRECATED_FIELDS:
            from hfortix_core import check_deprecated_fields
            check_deprecated_fields(
                payload=payload_data,
                deprecated_fields=DEPRECATED_FIELDS,
                endpoint="monitor/switch_controller/managed_switch/health_status",
            )
        
        name_value = payload_data.get("name")
        if not name_value:
            raise ValueError("name is required for PUT")
        endpoint = f"/switch-controller/managed-switch/health-status/{name_value}"
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new switch_controller/managed_switch/health_status object.
        ...
        Examples:
            ...
            >>> payload = HealthStatus.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.monitor.switch_controller_managed_switch_health_status.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(HealthStatus.required_fields()) }}
            
            Use HealthStatus.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete switch_controller/managed_switch/health_status object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.switch_controller_managed_switch_health_status.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.monitor.switch_controller_managed_switch_health_status.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.monitor.switch_controller_managed_switch_health_status.exists(name="old-object"):
            ...     fgt.api.monitor.switch_controller_managed_switch_health_status.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update switch_controller/managed_switch/health_status object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.monitor.switch_controller_managed_switch_health_status.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.monitor.switch_controller_managed_switch_health_status.set(payload_dict=obj_data)
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(HealthStatus.help())
            
            >>> # Get field information
            >>> print(HealthStatus.help("name"))
        """
        from ._helpers.health_status import (
            get_schema_info,
            get_field_metadata,
        )
    ...
    def fields(detailed: bool = False) -> Union[list[str], dict[str, dict]]:
        ...
        Examples:
            >>> # Simple list
            >>> fields = HealthStatus.fields()
            >>> print(f"Available fields: {len(fields)}")
            
            >>> # Detailed info
            >>> fields = HealthStatus.fields(detailed=True)
            >>> for name, meta in fields.items():
            ...     print(f"{name}: {meta['type']}")
        """
        from ._helpers.health_status import get_all_fields, get_field_metadata
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = HealthStatus.field_info("name")
            >>> print(f"Type: {info['type']}")
            >>> if 'options' in info:
            ...     print(f"Options: {info['options']}")
        """
        from ._helpers.health_status import get_field_metadata
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = HealthStatus.validate_field("name", "test")
            >>> if not is_valid:
            ...     print(f"Validation error: {error}")
        """
        from ._helpers.health_status import validate_field_value
    ...
    def required_fields() -> list[str]:
        ...
        Examples:
            >>> required = HealthStatus.required_fields()
            >>> print(f"Required fields: {', '.join(required)}")
        """
        from ._helpers.health_status import REQUIRED_FIELDS
    ...
    def defaults() -> dict[str, Any]:
        ...
        Examples:
            >>> defaults = HealthStatus.defaults()
            >>> print(f"Fields with defaults: {len(defaults)}")
            >>> # Use as starting point for payload
            >>> payload = defaults.copy()
            >>> payload['name'] = 'my-custom-name'
        """
        from ._helpers.health_status import FIELDS_WITH_DEFAULTS
    ...
    def schema() -> dict[str, Any]:
        ...
        Examples:
            >>> schema = HealthStatus.schema()
            >>> print(f"Endpoint: {schema['endpoint']}")
            >>> print(f"Total fields: {schema['total_fields']}")
            >>> print(f"Primary key: {schema.get('mkey', 'N/A')}")
        """
        from ._helpers.health_status import get_schema_info
