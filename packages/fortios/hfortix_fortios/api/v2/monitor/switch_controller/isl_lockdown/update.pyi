...
class UpdatePayload(TypedDict, total=False):
    """
    Type hints for switch_controller/isl_lockdown/update payload fields.
...
class UpdateResponse(TypedDict):
    """
    Type hints for switch_controller/isl_lockdown/update API response fields.
...
@final
class UpdateObject:
    """Typed FortiObject for switch_controller/isl_lockdown/update with IDE autocomplete support.
