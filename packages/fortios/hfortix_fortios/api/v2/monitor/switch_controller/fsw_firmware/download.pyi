...
class DownloadPayload(TypedDict, total=False):
    """
    Type hints for switch_controller/fsw_firmware/download payload fields.
...
class DownloadResponse(TypedDict):
    """
    Type hints for switch_controller/fsw_firmware/download API response fields.
...
class DownloadObject:
    """Typed FortiObject for switch_controller/fsw_firmware/download with IDE autocomplete support.
