...
class Neighbors:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Monitor endpoint for router/bgp/neighbors
        ...
        cache_key = f"monitor/router/bgp/neighbors"
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update existing router/bgp/neighbors object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.router_bgp_neighbors.put(
            ...
            ...     "field1": "new-value",
            ... }
            >>> result = fgt.api.monitor.router_bgp_neighbors.put(payload_dict=payload)
        ...
        endpoint = f"/router/bgp/neighbors/{name_value}"
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new router/bgp/neighbors object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.router_bgp_neighbors.post(payload_dict=payload)
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete router/bgp/neighbors object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.router_bgp_neighbors.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.monitor.router_bgp_neighbors.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.monitor.router_bgp_neighbors.exists(name="old-object"):
            ...     fgt.api.monitor.router_bgp_neighbors.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update router/bgp/neighbors object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.monitor.router_bgp_neighbors.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.monitor.router_bgp_neighbors.set(payload_dict=obj_data)
