...
class Paths:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Monitor endpoint for router/bgp/paths
        ...
        cache_key = f"monitor/router/bgp/paths"
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update existing router/bgp/paths object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.router_bgp_paths.put(
            ...
            ...     "field1": "new-value",
            ... }
            >>> result = fgt.api.monitor.router_bgp_paths.put(payload_dict=payload)
        ...
        from ._helpers.paths import DEPRECATED_FIELDS
        ...
        endpoint = f"/router/bgp/paths/{name_value}"
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new router/bgp/paths object.
        ...
        Examples:
            ...
            >>> payload = Paths.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.monitor.router_bgp_paths.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(Paths.required_fields()) }}
            
            Use Paths.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete router/bgp/paths object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.router_bgp_paths.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.monitor.router_bgp_paths.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.monitor.router_bgp_paths.exists(name="old-object"):
            ...     fgt.api.monitor.router_bgp_paths.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update router/bgp/paths object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.monitor.router_bgp_paths.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.monitor.router_bgp_paths.set(payload_dict=obj_data)
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(Paths.help("name"))
        """
        from ._helpers.paths import (
            get_schema_info,
            get_field_metadata,
        )
    ...
    def fields(detailed: bool = False) -> Union[list[str], dict[str, dict]]:
        ...
        Examples:
            ...
            >>> # Detailed info
            >>> fields = Paths.fields(detailed=True)
            >>> for name, meta in fields.items():
            ...     print(f"{name}: {meta['type']}")
        """
        from ._helpers.paths import get_all_fields, get_field_metadata
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = Paths.field_info("name")
            >>> print(f"Type: {info['type']}")
            >>> if 'options' in info:
            ...     print(f"Options: {info['options']}")
        """
        from ._helpers.paths import get_field_metadata
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = Paths.validate_field("name", "test")
            >>> if not is_valid:
            ...     print(f"Validation error: {error}")
        """
        from ._helpers.paths import validate_field_value
    ...
    def required_fields() -> list[str]:
        ...
        Examples:
            >>> required = Paths.required_fields()
            >>> print(f"Required fields: {', '.join(required)}")
        """
        from ._helpers.paths import REQUIRED_FIELDS
    ...
    def defaults() -> dict[str, Any]:
        ...
        """
        from ._helpers.paths import FIELDS_WITH_DEFAULTS
    ...
    def schema() -> dict[str, Any]:
        ...
        """
        from ._helpers.paths import get_schema_info
