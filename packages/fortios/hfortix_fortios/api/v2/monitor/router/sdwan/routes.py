...
class Routes:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Monitor endpoint for router/sdwan/routes
        ...
        cache_key = f"monitor/router/sdwan/routes"
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update existing router/sdwan/routes object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.router_sdwan_routes.put(
            ...
            ...     "field1": "new-value",
            ... }
            >>> result = fgt.api.monitor.router_sdwan_routes.put(payload_dict=payload)
        ...
        from ._helpers.routes import DEPRECATED_FIELDS
        ...
        endpoint = f"/router/sdwan/routes/{name_value}"
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new router/sdwan/routes object.
        ...
        Examples:
            ...
            >>> payload = Routes.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.monitor.router_sdwan_routes.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(Routes.required_fields()) }}
            
            Use Routes.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete router/sdwan/routes object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.router_sdwan_routes.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.monitor.router_sdwan_routes.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.monitor.router_sdwan_routes.exists(name="old-object"):
            ...     fgt.api.monitor.router_sdwan_routes.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update router/sdwan/routes object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.monitor.router_sdwan_routes.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.monitor.router_sdwan_routes.set(payload_dict=obj_data)
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(Routes.help("name"))
        """
        from ._helpers.routes import (
            get_schema_info,
            get_field_metadata,
        )
    ...
    def fields(detailed: bool = False) -> Union[list[str], dict[str, dict]]:
        ...
        Examples:
            ...
            >>> # Detailed info
            >>> fields = Routes.fields(detailed=True)
            >>> for name, meta in fields.items():
            ...     print(f"{name}: {meta['type']}")
        """
        from ._helpers.routes import get_all_fields, get_field_metadata
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = Routes.field_info("name")
            >>> print(f"Type: {info['type']}")
            >>> if 'options' in info:
            ...     print(f"Options: {info['options']}")
        """
        from ._helpers.routes import get_field_metadata
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = Routes.validate_field("name", "test")
            >>> if not is_valid:
            ...     print(f"Validation error: {error}")
        """
        from ._helpers.routes import validate_field_value
    ...
    def required_fields() -> list[str]:
        ...
        Examples:
            >>> required = Routes.required_fields()
            >>> print(f"Required fields: {', '.join(required)}")
        """
        from ._helpers.routes import REQUIRED_FIELDS
    ...
    def defaults() -> dict[str, Any]:
        ...
        """
        from ._helpers.routes import FIELDS_WITH_DEFAULTS
    ...
    def schema() -> dict[str, Any]:
        ...
        """
        from ._helpers.routes import get_schema_info
