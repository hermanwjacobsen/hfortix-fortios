...
class Ipv4Payload(TypedDict, total=False):
    """
    Type hints for router/ipv4 payload fields.
...
class Ipv4Response(TypedDict):
    """
    Type hints for router/ipv4 API response fields.
...
@final
class Ipv4Object:
    """Typed FortiObject for router/ipv4 with IDE autocomplete support.
