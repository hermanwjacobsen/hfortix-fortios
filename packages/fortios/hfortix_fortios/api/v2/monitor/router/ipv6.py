...
class Ipv6:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        cache_key = f"monitor/router/ipv6"
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update existing router/ipv6 object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.router_ipv6.put(
            ...
            ...     "field1": "new-value",
            ... }
            >>> result = fgt.api.monitor.router_ipv6.put(payload_dict=payload)
        ...
        from ._helpers.ipv6 import DEPRECATED_FIELDS
        ...
        endpoint = f"/router/ipv6/{name_value}"
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> payload = Ipv6.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.monitor.router_ipv6.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(Ipv6.required_fields()) }}
            
            Use Ipv6.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.router_ipv6.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.monitor.router_ipv6.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.monitor.router_ipv6.exists(name="old-object"):
            ...     fgt.api.monitor.router_ipv6.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update router/ipv6 object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.monitor.router_ipv6.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.monitor.router_ipv6.set(payload_dict=obj_data)
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(Ipv6.help("name"))
        """
        from ._helpers.ipv6 import (
            get_schema_info,
            get_field_metadata,
        )
    ...
    def fields(detailed: bool = False) -> Union[list[str], dict[str, dict]]:
        ...
        Examples:
            ...
            >>> # Detailed info
            >>> fields = Ipv6.fields(detailed=True)
            >>> for name, meta in fields.items():
            ...     print(f"{name}: {meta['type']}")
        """
        from ._helpers.ipv6 import get_all_fields, get_field_metadata
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = Ipv6.field_info("name")
            >>> print(f"Type: {info['type']}")
            >>> if 'options' in info:
            ...     print(f"Options: {info['options']}")
        """
        from ._helpers.ipv6 import get_field_metadata
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = Ipv6.validate_field("name", "test")
            >>> if not is_valid:
            ...     print(f"Validation error: {error}")
        """
        from ._helpers.ipv6 import validate_field_value
    ...
    def required_fields() -> list[str]:
        ...
        Examples:
            >>> required = Ipv6.required_fields()
            >>> print(f"Required fields: {', '.join(required)}")
        """
        from ._helpers.ipv6 import REQUIRED_FIELDS
    ...
    def defaults() -> dict[str, Any]:
        ...
        Examples:
            >>> defaults = Ipv6.defaults()
            >>> print(f"Fields with defaults: {len(defaults)}")
            >>> # Use as starting point for payload
            >>> payload = defaults.copy()
            >>> payload['name'] = 'my-custom-name'
        """
        from ._helpers.ipv6 import FIELDS_WITH_DEFAULTS
    ...
    def schema() -> dict[str, Any]:
        ...
        """
        from ._helpers.ipv6 import get_schema_info
