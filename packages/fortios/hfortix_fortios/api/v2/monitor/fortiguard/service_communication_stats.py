...
class ServiceCommunicationStats:
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update existing fortiguard/service_communication_stats object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.fortiguard_service_communication_stats.put(
            ...
            ...     "field1": "new-value",
            ... }
            >>> result = fgt.api.monitor.fortiguard_service_communication_stats.put(payload_dict=payload)
        ...
        from ._helpers.service_communication_stats import DEPRECATED_FIELDS
        if DEPRECATED_FIELDS:
            from hfortix_core import check_deprecated_fields
            check_deprecated_fields(
                payload=payload_data,
                deprecated_fields=DEPRECATED_FIELDS,
                endpoint="monitor/fortiguard/service_communication_stats",
            )
        
        name_value = payload_data.get("name")
        if not name_value:
            raise ValueError("name is required for PUT")
        endpoint = f"/fortiguard/service-communication-stats/{name_value}"
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new fortiguard/service_communication_stats object.
        ...
        Examples:
            ...
            >>> payload = ServiceCommunicationStats.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.monitor.fortiguard_service_communication_stats.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(ServiceCommunicationStats.required_fields()) }}
            
            Use ServiceCommunicationStats.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete fortiguard/service_communication_stats object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.fortiguard_service_communication_stats.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.monitor.fortiguard_service_communication_stats.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.monitor.fortiguard_service_communication_stats.exists(name="old-object"):
            ...     fgt.api.monitor.fortiguard_service_communication_stats.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update fortiguard/service_communication_stats object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.monitor.fortiguard_service_communication_stats.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.monitor.fortiguard_service_communication_stats.set(payload_dict=obj_data)
