...
class ServiceCommunicationStatsPayload(TypedDict, total=False):
    """
    Type hints for fortiguard/service_communication_stats payload fields.
    
    Retrieve historical statistics for communication with FortiGuard services.
    
    **Usage:**
        payload: ServiceCommunicationStatsPayload = {
...
class ServiceCommunicationStatsResponse(TypedDict):
    """
    Type hints for fortiguard/service_communication_stats API response fields.
...
@final
class ServiceCommunicationStatsObject:
    """Typed FortiObject for fortiguard/service_communication_stats with IDE autocomplete support.
    ...
    def to_dict(self) -> ServiceCommunicationStatsPayload: ...
    def keys(self) -> Any: ...
...
class ServiceCommunicationStats:
    ...
    def get(
        ...
        action: str | None = ...,
        vdom: str | bool | None = ...,
    ) -> ServiceCommunicationStatsObject | dict[str, Any]: ...
