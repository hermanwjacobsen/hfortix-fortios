...
class HistoryPayload(TypedDict, total=False):
    """
    Type hints for wanopt/history payload fields.
...
class HistoryResponse(TypedDict):
    """
    Type hints for wanopt/history API response fields.
...
@final
class HistoryObject:
    """Typed FortiObject for wanopt/history with IDE autocomplete support.
    ...
    def to_dict(self) -> HistoryPayload: ...
    def keys(self) -> Any: ...
