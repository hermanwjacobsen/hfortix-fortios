...
class WebcachePayload(TypedDict, total=False):
    """
    Type hints for wanopt/webcache payload fields.
...
class WebcacheResponse(TypedDict):
    """
    Type hints for wanopt/webcache API response fields.
...
@final
class WebcacheObject:
    """Typed FortiObject for wanopt/webcache with IDE autocomplete support.
    ...
    def to_dict(self) -> WebcachePayload: ...
    def keys(self) -> Any: ...
