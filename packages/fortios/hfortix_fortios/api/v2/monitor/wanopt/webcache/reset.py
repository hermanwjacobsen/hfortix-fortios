...
class Reset:
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update existing wanopt/webcache/reset object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.wanopt_webcache_reset.put(
            ...
            ...     "field1": "new-value",
            ... }
            >>> result = fgt.api.monitor.wanopt_webcache_reset.put(payload_dict=payload)
        ...
        endpoint = f"/wanopt/webcache/reset/{name_value}"
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete wanopt/webcache/reset object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.wanopt_webcache_reset.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.monitor.wanopt_webcache_reset.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.monitor.wanopt_webcache_reset.exists(name="old-object"):
            ...     fgt.api.monitor.wanopt_webcache_reset.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update wanopt/webcache/reset object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.monitor.wanopt_webcache_reset.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.monitor.wanopt_webcache_reset.set(payload_dict=obj_data)
