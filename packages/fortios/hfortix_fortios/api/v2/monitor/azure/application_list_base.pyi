...
class ApplicationListResponse(TypedDict):
    """
    Type hints for azure/application_list API response fields.
...
class ApplicationListObject:
    """Typed FortiObject for azure/application_list with IDE autocomplete support.
    ...
    def to_dict(self) -> ApplicationListPayload: ...
    def keys(self) -> Any: ...
