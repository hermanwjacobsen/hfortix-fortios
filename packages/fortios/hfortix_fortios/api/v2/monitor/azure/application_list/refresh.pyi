...
class RefreshPayload(TypedDict, total=False):
    """
    Type hints for azure/application_list/refresh payload fields.
...
class RefreshResponse(TypedDict):
    """
    Type hints for azure/application_list/refresh API response fields.
...
@final
class RefreshObject:
    """Typed FortiObject for azure/application_list/refresh with IDE autocomplete support.
