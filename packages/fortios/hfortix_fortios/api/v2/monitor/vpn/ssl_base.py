...
class Ssl:
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update existing vpn/ssl object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.vpn_ssl.put(
            ...
            ...     "field1": "new-value",
            ... }
            >>> result = fgt.api.monitor.vpn_ssl.put(payload_dict=payload)
        ...
        from ._helpers.ssl import DEPRECATED_FIELDS
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> payload = Ssl.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.monitor.vpn_ssl.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(Ssl.required_fields()) }}
            
            Use Ssl.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.vpn_ssl.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.monitor.vpn_ssl.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.monitor.vpn_ssl.exists(name="old-object"):
            ...     fgt.api.monitor.vpn_ssl.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update vpn/ssl object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.monitor.vpn_ssl.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.monitor.vpn_ssl.set(payload_dict=obj_data)
    ...
    def fields(detailed: bool = False) -> Union[list[str], dict[str, dict]]:
        ...
        Examples:
            ...
            >>> # Detailed info
            >>> fields = Ssl.fields(detailed=True)
            >>> for name, meta in fields.items():
            ...     print(f"{name}: {meta['type']}")
        """
        from ._helpers.ssl import get_all_fields, get_field_metadata
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = Ssl.field_info("name")
            >>> print(f"Type: {info['type']}")
            >>> if 'options' in info:
            ...     print(f"Options: {info['options']}")
        """
        from ._helpers.ssl import get_field_metadata
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = Ssl.validate_field("name", "test")
            >>> if not is_valid:
            ...     print(f"Validation error: {error}")
        """
        from ._helpers.ssl import validate_field_value
    ...
    def required_fields() -> list[str]:
        ...
        Examples:
            >>> required = Ssl.required_fields()
            >>> print(f"Required fields: {', '.join(required)}")
        """
        from ._helpers.ssl import REQUIRED_FIELDS
    ...
    def defaults() -> dict[str, Any]:
        ...
        Examples:
            >>> defaults = Ssl.defaults()
            >>> print(f"Fields with defaults: {len(defaults)}")
            >>> # Use as starting point for payload
            >>> payload = defaults.copy()
            >>> payload['name'] = 'my-custom-name'
        """
        from ._helpers.ssl import FIELDS_WITH_DEFAULTS
    ...
    def schema() -> dict[str, Any]:
        ...
        """
        from ._helpers.ssl import get_schema_info
