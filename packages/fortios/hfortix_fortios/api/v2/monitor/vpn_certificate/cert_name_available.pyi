...
class CertNameAvailablePayload(TypedDict, total=False):
    """
    Type hints for vpn_certificate/cert_name_available payload fields.
    
    Check if the local certificate name is available to use.
    
    **Usage:**
        payload: CertNameAvailablePayload = {
...
class CertNameAvailableResponse(TypedDict):
    """
    Type hints for vpn_certificate/cert_name_available API response fields.
...
@final
class CertNameAvailableObject:
    """Typed FortiObject for vpn_certificate/cert_name_available with IDE autocomplete support.
    ...
    def to_dict(self) -> CertNameAvailablePayload: ...
    def keys(self) -> Any: ...
...
class CertNameAvailable:
    ...
    def get(
        ...
        action: str | None = ...,
        vdom: str | bool | None = ...,
    ) -> CertNameAvailableObject | dict[str, Any]: ...
