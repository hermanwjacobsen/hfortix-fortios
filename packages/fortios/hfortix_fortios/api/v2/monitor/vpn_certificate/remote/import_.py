...
class Import(CRUDEndpoint, MetadataMixin):
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.vpn_certificate_remote_import.get()
            ...
            >>> schema = fgt.api.monitor.vpn_certificate_remote_import.get_schema()
    ...
    def exists(
        ...
        Example:
            ...
            >>> if not fgt.api.monitor.vpn_certificate_remote_import.exists(name="myobj"):
            ...     fgt.api.monitor.vpn_certificate_remote_import.post(payload_dict=data)
        """
