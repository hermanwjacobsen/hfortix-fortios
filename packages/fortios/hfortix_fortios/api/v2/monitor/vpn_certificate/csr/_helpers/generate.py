"""
Validation helpers for vpn_certificate/csr/generate endpoint.
...
def validate_vpn_certificate_csr_generate_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_vpn_certificate_csr_generate_get()
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for vpn_certificate/csr/generate.
...
def validate_vpn_certificate_csr_generate_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ... }
        >>> is_valid, error = validate_vpn_certificate_csr_generate_post(payload)
        >>> assert is_valid == True
...
def validate_vpn_certificate_csr_generate_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_vpn_certificate_csr_generate_put(payload)
    """
