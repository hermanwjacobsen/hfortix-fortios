...
class Generate:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> schema = fgt.api.monitor.vpn_certificate_csr_generate.get(action="schema")
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update existing vpn_certificate/csr/generate object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.vpn_certificate_csr_generate.put(
            ...
            ...     "field1": "new-value",
            ... }
            >>> result = fgt.api.monitor.vpn_certificate_csr_generate.put(payload_dict=payload)
        ...
        endpoint = f"/vpn-certificate/csr/generate/{name_value}"
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete vpn_certificate/csr/generate object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.vpn_certificate_csr_generate.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.monitor.vpn_certificate_csr_generate.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.monitor.vpn_certificate_csr_generate.exists(name="old-object"):
            ...     fgt.api.monitor.vpn_certificate_csr_generate.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update vpn_certificate/csr/generate object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.monitor.vpn_certificate_csr_generate.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.monitor.vpn_certificate_csr_generate.set(payload_dict=obj_data)
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(Generate.help("name"))
        """
        from ._helpers.generate import (
            get_schema_info,
            get_field_metadata,
        )
    ...
    def fields(detailed: bool = False) -> Union[list[str], dict[str, dict]]:
        ...
        Examples:
            ...
            >>> # Detailed info
            >>> fields = Generate.fields(detailed=True)
            >>> for name, meta in fields.items():
            ...     print(f"{name}: {meta['type']}")
        """
        from ._helpers.generate import get_all_fields, get_field_metadata
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = Generate.field_info("name")
            >>> print(f"Type: {info['type']}")
            >>> if 'options' in info:
            ...     print(f"Options: {info['options']}")
        """
        from ._helpers.generate import get_field_metadata
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = Generate.validate_field("name", "test")
            >>> if not is_valid:
            ...     print(f"Validation error: {error}")
        """
        from ._helpers.generate import validate_field_value
    ...
    def required_fields() -> list[str]:
        ...
        Examples:
            >>> required = Generate.required_fields()
            >>> print(f"Required fields: {', '.join(required)}")
        """
        from ._helpers.generate import REQUIRED_FIELDS
    ...
    def defaults() -> dict[str, Any]:
        ...
        """
        from ._helpers.generate import FIELDS_WITH_DEFAULTS
    ...
    def schema() -> dict[str, Any]:
        ...
        """
        from ._helpers.generate import get_schema_info
