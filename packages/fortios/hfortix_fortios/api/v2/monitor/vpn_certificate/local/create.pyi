...
class CreatePayload(TypedDict, total=False):
    """
    Type hints for vpn_certificate/local/create payload fields.
...
class CreateResponse(TypedDict):
    """
    Type hints for vpn_certificate/local/create API response fields.
...
@final
class CreateObject:
    """Typed FortiObject for vpn_certificate/local/create with IDE autocomplete support.
