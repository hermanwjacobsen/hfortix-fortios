...
class CreatePayload(TypedDict, total=False):
    """
    Type hints for web_ui/custom_language/create payload fields.
...
class CreateResponse(TypedDict):
    """
    Type hints for web_ui/custom_language/create API response fields.
...
@final
class CreateObject:
    """Typed FortiObject for web_ui/custom_language/create with IDE autocomplete support.
