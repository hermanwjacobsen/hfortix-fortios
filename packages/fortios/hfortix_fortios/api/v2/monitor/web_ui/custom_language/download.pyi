...
class DownloadPayload(TypedDict, total=False):
    """
    Type hints for web_ui/custom_language/download payload fields.
...
class DownloadResponse(TypedDict):
    """
    Type hints for web_ui/custom_language/download API response fields.
...
class DownloadObject:
    """Typed FortiObject for web_ui/custom_language/download with IDE autocomplete support.
