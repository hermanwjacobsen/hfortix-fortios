...
class CollectedEmail:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        cache_key = f"monitor/user/collected_email"
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update existing user/collected_email object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.user_collected_email.put(
            ...
            ...     "field1": "new-value",
            ... }
            >>> result = fgt.api.monitor.user_collected_email.put(payload_dict=payload)
        ...
        from ._helpers.collected_email import DEPRECATED_FIELDS
        if DEPRECATED_FIELDS:
            from hfortix_core import check_deprecated_fields
            check_deprecated_fields(
                payload=payload_data,
                deprecated_fields=DEPRECATED_FIELDS,
                endpoint="monitor/user/collected_email",
            )
        
        name_value = payload_data.get("name")
        if not name_value:
            raise ValueError("name is required for PUT")
        endpoint = f"/user/collected-email/{name_value}"
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new user/collected_email object.
        ...
        Examples:
            ...
            >>> payload = CollectedEmail.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.monitor.user_collected_email.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(CollectedEmail.required_fields()) }}
            
            Use CollectedEmail.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete user/collected_email object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.user_collected_email.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.monitor.user_collected_email.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.monitor.user_collected_email.exists(name="old-object"):
            ...     fgt.api.monitor.user_collected_email.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update user/collected_email object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.monitor.user_collected_email.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.monitor.user_collected_email.set(payload_dict=obj_data)
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(CollectedEmail.help())
            
            >>> # Get field information
            >>> print(CollectedEmail.help("name"))
        """
        from ._helpers.collected_email import (
            get_schema_info,
            get_field_metadata,
        )
    ...
    def fields(detailed: bool = False) -> Union[list[str], dict[str, dict]]:
        ...
        Examples:
            >>> # Simple list
            >>> fields = CollectedEmail.fields()
            >>> print(f"Available fields: {len(fields)}")
            
            >>> # Detailed info
            >>> fields = CollectedEmail.fields(detailed=True)
            >>> for name, meta in fields.items():
            ...     print(f"{name}: {meta['type']}")
        """
        from ._helpers.collected_email import get_all_fields, get_field_metadata
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = CollectedEmail.field_info("name")
            >>> print(f"Type: {info['type']}")
            >>> if 'options' in info:
            ...     print(f"Options: {info['options']}")
        """
        from ._helpers.collected_email import get_field_metadata
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = CollectedEmail.validate_field("name", "test")
            >>> if not is_valid:
            ...     print(f"Validation error: {error}")
        """
        from ._helpers.collected_email import validate_field_value
    ...
    def required_fields() -> list[str]:
        ...
        Examples:
            >>> required = CollectedEmail.required_fields()
            >>> print(f"Required fields: {', '.join(required)}")
        """
        from ._helpers.collected_email import REQUIRED_FIELDS
    ...
    def defaults() -> dict[str, Any]:
        ...
        Examples:
            >>> defaults = CollectedEmail.defaults()
            >>> print(f"Fields with defaults: {len(defaults)}")
            >>> # Use as starting point for payload
            >>> payload = defaults.copy()
            >>> payload['name'] = 'my-custom-name'
        """
        from ._helpers.collected_email import FIELDS_WITH_DEFAULTS
    ...
    def schema() -> dict[str, Any]:
        ...
        Examples:
            >>> schema = CollectedEmail.schema()
            >>> print(f"Endpoint: {schema['endpoint']}")
            >>> print(f"Total fields: {schema['total_fields']}")
            >>> print(f"Primary key: {schema.get('mkey', 'N/A')}")
        """
        from ._helpers.collected_email import get_schema_info
