...
class SelectPayload(TypedDict, total=False):
    """
    Type hints for user/password_policy_conform/select payload fields.
...
class SelectResponse(TypedDict):
    """
    Type hints for user/password_policy_conform/select API response fields.
...
@final
class SelectObject:
    """Typed FortiObject for user/password_policy_conform/select with IDE autocomplete support.
