"""
Validation helpers for user/device/purdue_level endpoint.
...
def validate_user_device_purdue_level_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_user_device_purdue_level_get()
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for user/device/purdue_level.
...
def validate_user_device_purdue_level_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ... }
        >>> is_valid, error = validate_user_device_purdue_level_post(payload)
        >>> assert is_valid == True
...
def validate_user_device_purdue_level_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_user_device_purdue_level_put(payload)
    """
