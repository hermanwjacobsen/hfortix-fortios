...
class Query:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> schema = fgt.api.monitor.user_device_query.get(action="schema")
        ...
        cache_key = f"monitor/user/device/query"
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update existing user/device/query object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.user_device_query.put(
            ...
            ...     "field1": "new-value",
            ... }
            >>> result = fgt.api.monitor.user_device_query.put(payload_dict=payload)
        ...
        from ._helpers.query import DEPRECATED_FIELDS
        ...
        endpoint = f"/user/device/query/{name_value}"
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new user/device/query object.
        ...
        Examples:
            ...
            >>> payload = Query.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.monitor.user_device_query.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(Query.required_fields()) }}
            
            Use Query.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete user/device/query object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.user_device_query.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.monitor.user_device_query.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.monitor.user_device_query.exists(name="old-object"):
            ...     fgt.api.monitor.user_device_query.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update user/device/query object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.monitor.user_device_query.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.monitor.user_device_query.set(payload_dict=obj_data)
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(Query.help("name"))
        """
        from ._helpers.query import (
            get_schema_info,
            get_field_metadata,
        )
    ...
    def fields(detailed: bool = False) -> Union[list[str], dict[str, dict]]:
        ...
        Examples:
            ...
            >>> # Detailed info
            >>> fields = Query.fields(detailed=True)
            >>> for name, meta in fields.items():
            ...     print(f"{name}: {meta['type']}")
        """
        from ._helpers.query import get_all_fields, get_field_metadata
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = Query.field_info("name")
            >>> print(f"Type: {info['type']}")
            >>> if 'options' in info:
            ...     print(f"Options: {info['options']}")
        """
        from ._helpers.query import get_field_metadata
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = Query.validate_field("name", "test")
            >>> if not is_valid:
            ...     print(f"Validation error: {error}")
        """
        from ._helpers.query import validate_field_value
    ...
    def required_fields() -> list[str]:
        ...
        Examples:
            >>> required = Query.required_fields()
            >>> print(f"Required fields: {', '.join(required)}")
        """
        from ._helpers.query import REQUIRED_FIELDS
    ...
    def defaults() -> dict[str, Any]:
        ...
        """
        from ._helpers.query import FIELDS_WITH_DEFAULTS
    ...
    def schema() -> dict[str, Any]:
        ...
        """
        from ._helpers.query import get_schema_info
