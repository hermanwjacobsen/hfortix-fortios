...
class ThumbnailPayload(TypedDict, total=False):
    """
    Type hints for user/info/thumbnail payload fields.
...
class ThumbnailResponse(TypedDict):
    """
    Type hints for user/info/thumbnail API response fields.
...
class ThumbnailObject:
    """Typed FortiObject for user/info/thumbnail with IDE autocomplete support.
