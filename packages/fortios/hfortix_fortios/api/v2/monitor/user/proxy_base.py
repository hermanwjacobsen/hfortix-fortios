...
class Proxy:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        cache_key = f"monitor/user/proxy"
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update existing user/proxy object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.user_proxy.put(
            ...
            ...     "field1": "new-value",
            ... }
            >>> result = fgt.api.monitor.user_proxy.put(payload_dict=payload)
        ...
        from ._helpers.proxy import DEPRECATED_FIELDS
        ...
        endpoint = f"/user/proxy/{name_value}"
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> payload = Proxy.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.monitor.user_proxy.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(Proxy.required_fields()) }}
            
            Use Proxy.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.user_proxy.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.monitor.user_proxy.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.monitor.user_proxy.exists(name="old-object"):
            ...     fgt.api.monitor.user_proxy.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update user/proxy object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.monitor.user_proxy.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.monitor.user_proxy.set(payload_dict=obj_data)
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(Proxy.help("name"))
        """
        from ._helpers.proxy import (
            get_schema_info,
            get_field_metadata,
        )
    ...
    def fields(detailed: bool = False) -> Union[list[str], dict[str, dict]]:
        ...
        Examples:
            ...
            >>> # Detailed info
            >>> fields = Proxy.fields(detailed=True)
            >>> for name, meta in fields.items():
            ...     print(f"{name}: {meta['type']}")
        """
        from ._helpers.proxy import get_all_fields, get_field_metadata
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = Proxy.field_info("name")
            >>> print(f"Type: {info['type']}")
            >>> if 'options' in info:
            ...     print(f"Options: {info['options']}")
        """
        from ._helpers.proxy import get_field_metadata
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = Proxy.validate_field("name", "test")
            >>> if not is_valid:
            ...     print(f"Validation error: {error}")
        """
        from ._helpers.proxy import validate_field_value
    ...
    def required_fields() -> list[str]:
        ...
        Examples:
            >>> required = Proxy.required_fields()
            >>> print(f"Required fields: {', '.join(required)}")
        """
        from ._helpers.proxy import REQUIRED_FIELDS
    ...
    def defaults() -> dict[str, Any]:
        ...
        """
        from ._helpers.proxy import FIELDS_WITH_DEFAULTS
    ...
    def schema() -> dict[str, Any]:
        ...
        """
        from ._helpers.proxy import get_schema_info
