...
class Reset:
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update existing webfilter/category_quota/reset object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.webfilter_category_quota_reset.put(
            ...
            ...     "field1": "new-value",
            ... }
            >>> result = fgt.api.monitor.webfilter_category_quota_reset.put(payload_dict=payload)
        ...
        endpoint = f"/webfilter/category-quota/reset/{name_value}"
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete webfilter/category_quota/reset object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.webfilter_category_quota_reset.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.monitor.webfilter_category_quota_reset.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.monitor.webfilter_category_quota_reset.exists(name="old-object"):
            ...     fgt.api.monitor.webfilter_category_quota_reset.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update webfilter/category_quota/reset object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.monitor.webfilter_category_quota_reset.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.monitor.webfilter_category_quota_reset.set(payload_dict=obj_data)
