...
class DeletePayload(TypedDict, total=False):
    """
    Type hints for webfilter/override/delete payload fields.
...
class DeleteResponse(TypedDict):
    """
    Type hints for webfilter/override/delete API response fields.
...
@final
class DeleteObject:
    """Typed FortiObject for webfilter/override/delete with IDE autocomplete support.
