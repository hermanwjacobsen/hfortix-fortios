...
class SelectPayload(TypedDict, total=False):
    """
    Type hints for utm/rating_lookup/select payload fields.
...
class SelectResponse(TypedDict):
    """
    Type hints for utm/rating_lookup/select API response fields.
...
@final
class SelectObject:
    """Typed FortiObject for utm/rating_lookup/select with IDE autocomplete support.
