...
class ApplicationCategories:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        cache_key = f"monitor/utm/application_categories"
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update existing utm/application_categories object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.utm_application_categories.put(
            ...
            ...     "field1": "new-value",
            ... }
            >>> result = fgt.api.monitor.utm_application_categories.put(payload_dict=payload)
        ...
        from ._helpers.application_categories import DEPRECATED_FIELDS
        if DEPRECATED_FIELDS:
            from hfortix_core import check_deprecated_fields
            check_deprecated_fields(
                payload=payload_data,
                deprecated_fields=DEPRECATED_FIELDS,
                endpoint="monitor/utm/application_categories",
            )
        
        name_value = payload_data.get("name")
        if not name_value:
            raise ValueError("name is required for PUT")
        endpoint = f"/utm/application-categories/{name_value}"
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new utm/application_categories object.
        ...
        Examples:
            ...
            >>> payload = ApplicationCategories.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.monitor.utm_application_categories.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(ApplicationCategories.required_fields()) }}
            
            Use ApplicationCategories.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete utm/application_categories object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.utm_application_categories.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.monitor.utm_application_categories.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.monitor.utm_application_categories.exists(name="old-object"):
            ...     fgt.api.monitor.utm_application_categories.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update utm/application_categories object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.monitor.utm_application_categories.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.monitor.utm_application_categories.set(payload_dict=obj_data)
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(ApplicationCategories.help())
            
            >>> # Get field information
            >>> print(ApplicationCategories.help("name"))
        """
        from ._helpers.application_categories import (
            get_schema_info,
            get_field_metadata,
        )
    ...
    def fields(detailed: bool = False) -> Union[list[str], dict[str, dict]]:
        ...
        Examples:
            >>> # Simple list
            >>> fields = ApplicationCategories.fields()
            >>> print(f"Available fields: {len(fields)}")
            
            >>> # Detailed info
            >>> fields = ApplicationCategories.fields(detailed=True)
            >>> for name, meta in fields.items():
            ...     print(f"{name}: {meta['type']}")
        """
        from ._helpers.application_categories import get_all_fields, get_field_metadata
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = ApplicationCategories.field_info("name")
            >>> print(f"Type: {info['type']}")
            >>> if 'options' in info:
            ...     print(f"Options: {info['options']}")
        """
        from ._helpers.application_categories import get_field_metadata
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = ApplicationCategories.validate_field("name", "test")
            >>> if not is_valid:
            ...     print(f"Validation error: {error}")
        """
        from ._helpers.application_categories import validate_field_value
    ...
    def required_fields() -> list[str]:
        ...
        Examples:
            >>> required = ApplicationCategories.required_fields()
            >>> print(f"Required fields: {', '.join(required)}")
        """
        from ._helpers.application_categories import REQUIRED_FIELDS
    ...
    def defaults() -> dict[str, Any]:
        ...
        Examples:
            >>> defaults = ApplicationCategories.defaults()
            >>> print(f"Fields with defaults: {len(defaults)}")
            >>> # Use as starting point for payload
            >>> payload = defaults.copy()
            >>> payload['name'] = 'my-custom-name'
        """
        from ._helpers.application_categories import FIELDS_WITH_DEFAULTS
    ...
    def schema() -> dict[str, Any]:
        ...
        Examples:
            >>> schema = ApplicationCategories.schema()
            >>> print(f"Endpoint: {schema['endpoint']}")
            >>> print(f"Total fields: {schema['total_fields']}")
            >>> print(f"Primary key: {schema.get('mkey', 'N/A')}")
        """
        from ._helpers.application_categories import get_schema_info
