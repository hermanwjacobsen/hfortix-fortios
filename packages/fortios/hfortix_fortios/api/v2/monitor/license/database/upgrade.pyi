...
class UpgradePayload(TypedDict, total=False):
    """
    Type hints for license/database/upgrade payload fields.
...
class UpgradeResponse(TypedDict):
    """
    Type hints for license/database/upgrade API response fields.
...
@final
class UpgradeObject:
    """Typed FortiObject for license/database/upgrade with IDE autocomplete support.
