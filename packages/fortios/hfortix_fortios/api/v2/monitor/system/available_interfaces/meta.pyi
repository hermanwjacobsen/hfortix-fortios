...
class MetaPayload(TypedDict, total=False):
    """
    Type hints for system/available_interfaces/meta payload fields.
...
class MetaResponse(TypedDict):
    """
    Type hints for system/available_interfaces/meta API response fields.
...
@final
class MetaObject:
    """Typed FortiObject for system/available_interfaces/meta with IDE autocomplete support.
