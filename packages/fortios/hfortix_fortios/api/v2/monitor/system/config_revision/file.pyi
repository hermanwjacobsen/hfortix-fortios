...
class FilePayload(TypedDict, total=False):
    """
    Type hints for system/config_revision/file payload fields.
...
class FileResponse(TypedDict):
    """
    Type hints for system/config_revision/file API response fields.
...
@final
class FileObject:
    """Typed FortiObject for system/config_revision/file with IDE autocomplete support.
