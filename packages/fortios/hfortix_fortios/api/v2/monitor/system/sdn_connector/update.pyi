...
class UpdatePayload(TypedDict, total=False):
    """
    Type hints for system/sdn_connector/update payload fields.
...
class UpdateResponse(TypedDict):
    """
    Type hints for system/sdn_connector/update API response fields.
...
@final
class UpdateObject:
    """Typed FortiObject for system/sdn_connector/update with IDE autocomplete support.
