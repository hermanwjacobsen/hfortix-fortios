...
class SelectPayload(TypedDict, total=False):
    """
    Type hints for system/disconnect_admins/select payload fields.
...
class SelectResponse(TypedDict):
    """
    Type hints for system/disconnect_admins/select API response fields.
...
@final
class SelectObject:
    """Typed FortiObject for system/disconnect_admins/select with IDE autocomplete support.
