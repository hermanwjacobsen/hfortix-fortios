...
class RefreshPayload(TypedDict, total=False):
    """
    Type hints for system/external_resource/refresh payload fields.
...
class RefreshResponse(TypedDict):
    """
    Type hints for system/external_resource/refresh API response fields.
...
@final
class RefreshObject:
    """Typed FortiObject for system/external_resource/refresh with IDE autocomplete support.
    ...
    def to_dict(self) -> RefreshPayload: ...
    def keys(self) -> Any: ...
