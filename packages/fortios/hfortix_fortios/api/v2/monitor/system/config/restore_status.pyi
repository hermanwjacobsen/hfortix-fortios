...
class RestoreStatusPayload(TypedDict, total=False):
    """
    Type hints for system/config/restore_status payload fields.
...
class RestoreStatusResponse(TypedDict):
    """
    Type hints for system/config/restore_status API response fields.
...
@final
class RestoreStatusObject:
    """Typed FortiObject for system/config/restore_status with IDE autocomplete support.
    ...
    def to_dict(self) -> RestoreStatusPayload: ...
    def keys(self) -> Any: ...
...
class RestoreStatus:
    ...
    def get(
        ...
        action: str | None = ...,
        vdom: str | bool | None = ...,
    ) -> RestoreStatusObject | dict[str, Any]: ...
