...
class GlobalSearchPayload(TypedDict, total=False):
    """
    Type hints for system/global_search payload fields.
...
class GlobalSearchResponse(TypedDict):
    """
    Type hints for system/global_search API response fields.
...
class GlobalSearchObject:
    """Typed FortiObject for system/global_search with IDE autocomplete support.
    ...
    def to_dict(self) -> GlobalSearchPayload: ...
    def keys(self) -> Any: ...
...
class GlobalSearch:
    ...
    def get(
        ...
        action: str | None = ...,
        vdom: str | bool | None = ...,
    ) -> GlobalSearchObject | dict[str, Any]: ...
