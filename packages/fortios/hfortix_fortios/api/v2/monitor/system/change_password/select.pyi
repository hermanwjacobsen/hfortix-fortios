...
class SelectPayload(TypedDict, total=False):
    """
    Type hints for system/change_password/select payload fields.
...
class SelectResponse(TypedDict):
    """
    Type hints for system/change_password/select API response fields.
...
@final
class SelectObject:
    """Typed FortiObject for system/change_password/select with IDE autocomplete support.
