...
class TestPayload(TypedDict, total=False):
    """
    Type hints for system/automation_stitch/test payload fields.
...
class TestResponse(TypedDict):
    """
    Type hints for system/automation_stitch/test API response fields.
...
@final
class TestObject:
    """Typed FortiObject for system/automation_stitch/test with IDE autocomplete support.
