...
class DownloadPayload(TypedDict, total=False):
    """
    Type hints for system/certificate/download payload fields.
...
class DownloadResponse(TypedDict):
    """
    Type hints for system/certificate/download API response fields.
...
class DownloadObject:
    """Typed FortiObject for system/certificate/download with IDE autocomplete support.
