...
class RunPayload(TypedDict, total=False):
    """
    Type hints for system/config_script/run payload fields.
...
class RunResponse(TypedDict):
    """
    Type hints for system/config_script/run API response fields.
...
@final
class RunObject:
    """Typed FortiObject for system/config_script/run with IDE autocomplete support.
