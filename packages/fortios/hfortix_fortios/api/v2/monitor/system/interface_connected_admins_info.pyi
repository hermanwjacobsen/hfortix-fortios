...
class InterfaceConnectedAdminsInfoPayload(TypedDict, total=False):
    """
    Type hints for system/interface_connected_admins_info payload fields.
    
    Return admins info that are connected to current interface.
    
    **Usage:**
        payload: InterfaceConnectedAdminsInfoPayload = {
...
class InterfaceConnectedAdminsInfoResponse(TypedDict):
    """
    Type hints for system/interface_connected_admins_info API response fields.
...
@final
class InterfaceConnectedAdminsInfoObject:
    """Typed FortiObject for system/interface_connected_admins_info with IDE autocomplete support.
    ...
    def to_dict(self) -> InterfaceConnectedAdminsInfoPayload: ...
    def keys(self) -> Any: ...
...
class InterfaceConnectedAdminsInfo:
    ...
    def get(
        ...
        action: str | None = ...,
        vdom: str | bool | None = ...,
    ) -> InterfaceConnectedAdminsInfoObject | dict[str, Any]: ...
