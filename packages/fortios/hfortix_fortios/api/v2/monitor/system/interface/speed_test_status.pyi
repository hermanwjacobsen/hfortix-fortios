...
class SpeedTestStatusPayload(TypedDict, total=False):
    """
    Type hints for system/interface/speed_test_status payload fields.
    
    Retrieve the current status of a speed-test with the results if finished.
    
    **Usage:**
        payload: SpeedTestStatusPayload = {
...
class SpeedTestStatusResponse(TypedDict):
    """
    Type hints for system/interface/speed_test_status API response fields.
...
@final
class SpeedTestStatusObject:
    """Typed FortiObject for system/interface/speed_test_status with IDE autocomplete support.
    ...
    def to_dict(self) -> SpeedTestStatusPayload: ...
    def keys(self) -> Any: ...
...
class SpeedTestStatus:
    ...
    def get(
        ...
        action: str | None = ...,
        vdom: str | bool | None = ...,
    ) -> SpeedTestStatusObject | dict[str, Any]: ...
