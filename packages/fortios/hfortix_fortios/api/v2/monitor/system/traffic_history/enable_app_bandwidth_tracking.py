...
class EnableAppBandwidthTracking:
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update existing system/traffic_history/enable_app_bandwidth_tracking object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.system_traffic_history_enable_app_bandwidth_tracking.put(
            ...
            ...     "field1": "new-value",
            ... }
            >>> result = fgt.api.monitor.system_traffic_history_enable_app_bandwidth_tracking.put(payload_dict=payload)
        ...
        endpoint = f"/system/traffic-history/enable-app-bandwidth-tracking/{name_value}"
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete system/traffic_history/enable_app_bandwidth_tracking object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.system_traffic_history_enable_app_bandwidth_tracking.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.monitor.system_traffic_history_enable_app_bandwidth_tracking.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.monitor.system_traffic_history_enable_app_bandwidth_tracking.exists(name="old-object"):
            ...     fgt.api.monitor.system_traffic_history_enable_app_bandwidth_tracking.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update system/traffic_history/enable_app_bandwidth_tracking object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.monitor.system_traffic_history_enable_app_bandwidth_tracking.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.monitor.system_traffic_history_enable_app_bandwidth_tracking.set(payload_dict=obj_data)
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(EnableAppBandwidthTracking.help())
            
            >>> # Get field information
            >>> print(EnableAppBandwidthTracking.help("name"))
        """
        from ._helpers.enable_app_bandwidth_tracking import (
            get_schema_info,
            get_field_metadata,
        )
    ...
    def fields(detailed: bool = False) -> Union[list[str], dict[str, dict]]:
        ...
        Examples:
            >>> # Simple list
            >>> fields = EnableAppBandwidthTracking.fields()
            >>> print(f"Available fields: {len(fields)}")
            
            >>> # Detailed info
            >>> fields = EnableAppBandwidthTracking.fields(detailed=True)
            >>> for name, meta in fields.items():
            ...     print(f"{name}: {meta['type']}")
        """
        from ._helpers.enable_app_bandwidth_tracking import get_all_fields, get_field_metadata
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = EnableAppBandwidthTracking.field_info("name")
            >>> print(f"Type: {info['type']}")
            >>> if 'options' in info:
            ...     print(f"Options: {info['options']}")
        """
        from ._helpers.enable_app_bandwidth_tracking import get_field_metadata
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = EnableAppBandwidthTracking.validate_field("name", "test")
            >>> if not is_valid:
            ...     print(f"Validation error: {error}")
        """
        from ._helpers.enable_app_bandwidth_tracking import validate_field_value
    ...
    def required_fields() -> list[str]:
        ...
        Examples:
            >>> required = EnableAppBandwidthTracking.required_fields()
            >>> print(f"Required fields: {', '.join(required)}")
        """
        from ._helpers.enable_app_bandwidth_tracking import REQUIRED_FIELDS
    ...
    def defaults() -> dict[str, Any]:
        ...
        Examples:
            >>> defaults = EnableAppBandwidthTracking.defaults()
            >>> print(f"Fields with defaults: {len(defaults)}")
            >>> # Use as starting point for payload
            >>> payload = defaults.copy()
            >>> payload['name'] = 'my-custom-name'
        """
        from ._helpers.enable_app_bandwidth_tracking import FIELDS_WITH_DEFAULTS
    ...
    def schema() -> dict[str, Any]:
        ...
        Examples:
            >>> schema = EnableAppBandwidthTracking.schema()
            >>> print(f"Endpoint: {schema['endpoint']}")
            >>> print(f"Total fields: {schema['total_fields']}")
            >>> print(f"Primary key: {schema.get('mkey', 'N/A')}")
        """
        from ._helpers.enable_app_bandwidth_tracking import get_schema_info
