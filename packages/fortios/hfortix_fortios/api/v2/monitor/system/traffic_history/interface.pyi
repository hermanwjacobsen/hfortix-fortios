...
class InterfacePayload(TypedDict, total=False):
    """
    Type hints for system/traffic_history/interface payload fields.
...
class InterfaceResponse(TypedDict):
    """
    Type hints for system/traffic_history/interface API response fields.
...
class InterfaceObject:
    """Typed FortiObject for system/traffic_history/interface with IDE autocomplete support.
