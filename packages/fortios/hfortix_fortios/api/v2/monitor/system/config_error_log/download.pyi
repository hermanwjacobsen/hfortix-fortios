...
class DownloadResponse(TypedDict):
    """
    Type hints for system/config_error_log/download API response fields.
...
class DownloadObject:
    """Typed FortiObject for system/config_error_log/download with IDE autocomplete support.
