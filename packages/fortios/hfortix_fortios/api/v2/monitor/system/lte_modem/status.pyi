...
class StatusResponse(TypedDict):
    """
    Type hints for system/lte_modem/status API response fields.
...
@final
class StatusObject:
    """Typed FortiObject for system/lte_modem/status with IDE autocomplete support.
