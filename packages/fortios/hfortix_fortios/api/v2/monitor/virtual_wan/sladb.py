...
class Sladb:
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update existing virtual_wan/sladb object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.virtual_wan_sladb.put(
            ...
            ...     "field1": "new-value",
            ... }
            >>> result = fgt.api.monitor.virtual_wan_sladb.put(payload_dict=payload)
        ...
        from ._helpers.sladb import DEPRECATED_FIELDS
        if DEPRECATED_FIELDS:
            from hfortix_core import check_deprecated_fields
            check_deprecated_fields(
                payload=payload_data,
                deprecated_fields=DEPRECATED_FIELDS,
                endpoint="monitor/virtual_wan/sladb",
            )
        
        name_value = payload_data.get("name")
        if not name_value:
            raise ValueError("name is required for PUT")
        endpoint = f"/virtual-wan/sladb/{name_value}"
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new virtual_wan/sladb object.
        ...
        Examples:
            ...
            >>> payload = Sladb.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.monitor.virtual_wan_sladb.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(Sladb.required_fields()) }}
            
            Use Sladb.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete virtual_wan/sladb object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.virtual_wan_sladb.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.monitor.virtual_wan_sladb.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.monitor.virtual_wan_sladb.exists(name="old-object"):
            ...     fgt.api.monitor.virtual_wan_sladb.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update virtual_wan/sladb object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.monitor.virtual_wan_sladb.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.monitor.virtual_wan_sladb.set(payload_dict=obj_data)
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(Sladb.help("name"))
        """
        from ._helpers.sladb import (
            get_schema_info,
            get_field_metadata,
        )
    ...
    def fields(detailed: bool = False) -> Union[list[str], dict[str, dict]]:
        ...
        Examples:
            ...
            >>> # Detailed info
            >>> fields = Sladb.fields(detailed=True)
            >>> for name, meta in fields.items():
            ...     print(f"{name}: {meta['type']}")
        """
        from ._helpers.sladb import get_all_fields, get_field_metadata
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = Sladb.field_info("name")
            >>> print(f"Type: {info['type']}")
            >>> if 'options' in info:
            ...     print(f"Options: {info['options']}")
        """
        from ._helpers.sladb import get_field_metadata
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = Sladb.validate_field("name", "test")
            >>> if not is_valid:
            ...     print(f"Validation error: {error}")
        """
        from ._helpers.sladb import validate_field_value
    ...
    def required_fields() -> list[str]:
        ...
        Examples:
            >>> required = Sladb.required_fields()
            >>> print(f"Required fields: {', '.join(required)}")
        """
        from ._helpers.sladb import REQUIRED_FIELDS
    ...
    def defaults() -> dict[str, Any]:
        ...
        Examples:
            >>> defaults = Sladb.defaults()
            >>> print(f"Fields with defaults: {len(defaults)}")
            >>> # Use as starting point for payload
            >>> payload = defaults.copy()
            >>> payload['name'] = 'my-custom-name'
        """
        from ._helpers.sladb import FIELDS_WITH_DEFAULTS
    ...
    def schema() -> dict[str, Any]:
        ...
        """
        from ._helpers.sladb import get_schema_info
