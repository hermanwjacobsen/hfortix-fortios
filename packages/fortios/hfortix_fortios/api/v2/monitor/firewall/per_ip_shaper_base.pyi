...
class PerIpShaperPayload(TypedDict, total=False):
    """
    Type hints for firewall/per_ip_shaper payload fields.
...
class PerIpShaperResponse(TypedDict):
    """
    Type hints for firewall/per_ip_shaper API response fields.
...
class PerIpShaperObject:
    """Typed FortiObject for firewall/per_ip_shaper with IDE autocomplete support.
...
class PerIpShaper:
    ...
    def get(
        ...
        action: str | None = ...,
        vdom: str | bool | None = ...,
    ) -> PerIpShaperObject | dict[str, Any]: ...
