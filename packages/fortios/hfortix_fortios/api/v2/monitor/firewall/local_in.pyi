...
class LocalInPayload(TypedDict, total=False):
    """
    Type hints for firewall/local_in payload fields.
    
    List implicit and explicit local-in firewall policies.
    
    **Usage:**
        payload: LocalInPayload = {
...
class LocalInResponse(TypedDict):
    """
    Type hints for firewall/local_in API response fields.
...
@final
class LocalInObject:
    """Typed FortiObject for firewall/local_in with IDE autocomplete support.
    ...
    def to_dict(self) -> LocalInPayload: ...
    def keys(self) -> Any: ...
