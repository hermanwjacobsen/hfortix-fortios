...
class CheckAddrgrpExcludeMacMemberPayload(TypedDict, total=False):
    """
    Type hints for firewall/check_addrgrp_exclude_mac_member payload fields.
    
    Check if the IPv4 or IPv6 address group should exclude mac address type member.
    
    **Usage:**
        payload: CheckAddrgrpExcludeMacMemberPayload = {
...
class CheckAddrgrpExcludeMacMemberResponse(TypedDict):
    """
    Type hints for firewall/check_addrgrp_exclude_mac_member API response fields.
...
@final
class CheckAddrgrpExcludeMacMemberObject:
    """Typed FortiObject for firewall/check_addrgrp_exclude_mac_member with IDE autocomplete support.
    ...
    def to_dict(self) -> CheckAddrgrpExcludeMacMemberPayload: ...
    def keys(self) -> Any: ...
...
class CheckAddrgrpExcludeMacMember:
    ...
    def get(
        ...
        action: str | None = ...,
        vdom: str | bool | None = ...,
    ) -> CheckAddrgrpExcludeMacMemberObject | dict[str, Any]: ...
