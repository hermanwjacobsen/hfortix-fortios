...
class DeletePayload(TypedDict, total=False):
    """
    Type hints for firewall/clearpass_address/delete payload fields.
...
class DeleteResponse(TypedDict):
    """
    Type hints for firewall/clearpass_address/delete API response fields.
...
@final
class DeleteObject:
    """Typed FortiObject for firewall/clearpass_address/delete with IDE autocomplete support.
