...
class InternetServiceMatchPayload(TypedDict, total=False):
    """
    Type hints for firewall/internet_service_match payload fields.
    
    List internet services that exist at a given IP or Subnet.
    
    **Usage:**
        payload: InternetServiceMatchPayload = {
...
class InternetServiceMatchResponse(TypedDict):
    """
    Type hints for firewall/internet_service_match API response fields.
...
@final
class InternetServiceMatchObject:
    """Typed FortiObject for firewall/internet_service_match with IDE autocomplete support.
    ...
    def to_dict(self) -> InternetServiceMatchPayload: ...
    def keys(self) -> Any: ...
...
class InternetServiceMatch:
    ...
    def get(
        ...
        action: str | None = ...,
        vdom: str | bool | None = ...,
    ) -> InternetServiceMatchObject | dict[str, Any]: ...
