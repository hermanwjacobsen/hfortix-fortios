...
class Policy:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> schema = fgt.api.monitor.firewall_policy.get(action="schema")
        ...
        cache_key = f"monitor/firewall/policy"
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.firewall_policy.put(
            ...
            ...     "field1": "new-value",
            ... }
            >>> result = fgt.api.monitor.firewall_policy.put(payload_dict=payload)
        ...
        endpoint = f"/firewall/policy/{name_value}"
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.firewall_policy.post(payload_dict=payload)
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.firewall_policy.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.monitor.firewall_policy.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.monitor.firewall_policy.exists(name="old-object"):
            ...     fgt.api.monitor.firewall_policy.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.monitor.firewall_policy.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.monitor.firewall_policy.set(payload_dict=obj_data)
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = Policy.validate_field("name", "test")
            >>> if not is_valid:
