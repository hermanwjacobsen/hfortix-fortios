...
def validate_firewall_policy_lookup_get(
    ...
    **params: Any,
    ...
    Examples:
        >>> # Valid - Get all items
        >>> is_valid, error = validate_firewall_policy_lookup_get()
...
def validate_required_fields(payload: dict) -> tuple[bool, str | None]:
    """
    Validate required fields for firewall/policy_lookup.
...
def validate_firewall_policy_lookup_post(
    ...
    **params: Any,
    ...
    Examples:
        ...
        >>> payload = {
        ... }
        >>> is_valid, error = validate_firewall_policy_lookup_post(payload)
        >>> assert is_valid == True
...
def validate_firewall_policy_lookup_put(
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> is_valid, error = validate_firewall_policy_lookup_put(payload)
    """
