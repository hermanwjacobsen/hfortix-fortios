...
class ProxyPolicy:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> schema = fgt.api.monitor.firewall_proxy_policy.get(action="schema")
        ...
        cache_key = f"monitor/firewall/proxy_policy"
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.firewall_proxy_policy.put(
            ...
            ...     "field1": "new-value",
            ... }
            >>> result = fgt.api.monitor.firewall_proxy_policy.put(payload_dict=payload)
        ...
        if DEPRECATED_FIELDS:
            ...
            check_deprecated_fields(
                ...
                endpoint="monitor/firewall/proxy_policy",
            )
        
        name_value = payload_data.get("name")
        if not name_value:
            raise ValueError("name is required for PUT")
        endpoint = f"/firewall/proxy-policy/{name_value}"
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.firewall_proxy_policy.post(payload_dict=payload)
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.firewall_proxy_policy.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.monitor.firewall_proxy_policy.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.monitor.firewall_proxy_policy.exists(name="old-object"):
            ...     fgt.api.monitor.firewall_proxy_policy.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.monitor.firewall_proxy_policy.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.monitor.firewall_proxy_policy.set(payload_dict=obj_data)
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = ProxyPolicy.field_info("name")
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = ProxyPolicy.validate_field("name", "test")
            >>> if not is_valid:
