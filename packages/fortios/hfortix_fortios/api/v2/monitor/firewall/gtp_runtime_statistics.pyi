...
class GtpRuntimeStatisticsResponse(TypedDict):
    """
    Type hints for firewall/gtp_runtime_statistics API response fields.
...
@final
class GtpRuntimeStatisticsObject:
    """Typed FortiObject for firewall/gtp_runtime_statistics with IDE autocomplete support.
    
    This is a typed wrapper that provides IDE autocomplete for API response fields.
    At runtime, this is actually a FortiObject instance.
    """
    
    # control_packet_forwarded
    control_packet_forwarded: int
    # control_packet_rejected
    control_packet_rejected: int
    # control_packet_dropped
    control_packet_dropped: str
    # data_packet_forwarded
    data_packet_forwarded: int
    # data_packet_dropped
    data_packet_dropped: str
    # billing_packet_forwarded
    billing_packet_forwarded: int
    ...
    def to_dict(self) -> GtpRuntimeStatisticsPayload: ...
    def keys(self) -> Any: ...
