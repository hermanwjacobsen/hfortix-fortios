...
class SelectPayload(TypedDict, total=False):
    """
    Type hints for geoip/geoip_query/select payload fields.
...
class SelectResponse(TypedDict):
    """
    Type hints for geoip/geoip_query/select API response fields.
...
@final
class SelectObject:
    """Typed FortiObject for geoip/geoip_query/select with IDE autocomplete support.
