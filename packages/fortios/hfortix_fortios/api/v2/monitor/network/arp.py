...
class Arp:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        cache_key = f"monitor/network/arp"
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update existing network/arp object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.network_arp.put(
            ...
            ...     "field1": "new-value",
            ... }
            >>> result = fgt.api.monitor.network_arp.put(payload_dict=payload)
        ...
        from ._helpers.arp import DEPRECATED_FIELDS
        ...
        endpoint = f"/network/arp/{name_value}"
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> payload = Arp.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.monitor.network_arp.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(Arp.required_fields()) }}
            
            Use Arp.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.network_arp.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.monitor.network_arp.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.monitor.network_arp.exists(name="old-object"):
            ...     fgt.api.monitor.network_arp.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update network/arp object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.monitor.network_arp.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.monitor.network_arp.set(payload_dict=obj_data)
    ...
    def fields(detailed: bool = False) -> Union[list[str], dict[str, dict]]:
        ...
        Examples:
            ...
            >>> # Detailed info
            >>> fields = Arp.fields(detailed=True)
            >>> for name, meta in fields.items():
            ...     print(f"{name}: {meta['type']}")
        """
        from ._helpers.arp import get_all_fields, get_field_metadata
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = Arp.field_info("name")
            >>> print(f"Type: {info['type']}")
            >>> if 'options' in info:
            ...     print(f"Options: {info['options']}")
        """
        from ._helpers.arp import get_field_metadata
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = Arp.validate_field("name", "test")
            >>> if not is_valid:
            ...     print(f"Validation error: {error}")
        """
        from ._helpers.arp import validate_field_value
    ...
    def required_fields() -> list[str]:
        ...
        Examples:
            >>> required = Arp.required_fields()
            >>> print(f"Required fields: {', '.join(required)}")
        """
        from ._helpers.arp import REQUIRED_FIELDS
    ...
    def defaults() -> dict[str, Any]:
        ...
        Examples:
            >>> defaults = Arp.defaults()
            >>> print(f"Fields with defaults: {len(defaults)}")
            >>> # Use as starting point for payload
            >>> payload = defaults.copy()
            >>> payload['name'] = 'my-custom-name'
        """
        from ._helpers.arp import FIELDS_WITH_DEFAULTS
    ...
    def schema() -> dict[str, Any]:
        ...
        """
        from ._helpers.arp import get_schema_info
