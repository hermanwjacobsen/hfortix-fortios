...
class DownloadPayload(TypedDict, total=False):
    """
    Type hints for wifi/firmware/download payload fields.
...
class DownloadResponse(TypedDict):
    """
    Type hints for wifi/firmware/download API response fields.
...
class DownloadObject:
    """Typed FortiObject for wifi/firmware/download with IDE autocomplete support.
