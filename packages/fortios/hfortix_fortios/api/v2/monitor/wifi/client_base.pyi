...
class ClientPayload(TypedDict, total=False):
    """
    Type hints for wifi/client payload fields.
...
class ClientResponse(TypedDict):
    """
    Type hints for wifi/client API response fields.
...
@final
class ClientObject:
    """Typed FortiObject for wifi/client with IDE autocomplete support.
    ...
    def to_dict(self) -> ClientPayload: ...
    def keys(self) -> Any: ...
