...
class UnassociatedDevices:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        cache_key = f"monitor/wifi/unassociated_devices"
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update existing wifi/unassociated_devices object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.wifi_unassociated_devices.put(
            ...
            ...     "field1": "new-value",
            ... }
            >>> result = fgt.api.monitor.wifi_unassociated_devices.put(payload_dict=payload)
        ...
        from ._helpers.unassociated_devices import DEPRECATED_FIELDS
        if DEPRECATED_FIELDS:
            from hfortix_core import check_deprecated_fields
            check_deprecated_fields(
                payload=payload_data,
                deprecated_fields=DEPRECATED_FIELDS,
                endpoint="monitor/wifi/unassociated_devices",
            )
        
        name_value = payload_data.get("name")
        if not name_value:
            raise ValueError("name is required for PUT")
        endpoint = f"/wifi/unassociated-devices/{name_value}"
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new wifi/unassociated_devices object.
        ...
        Examples:
            ...
            >>> payload = UnassociatedDevices.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.monitor.wifi_unassociated_devices.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(UnassociatedDevices.required_fields()) }}
            
            Use UnassociatedDevices.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete wifi/unassociated_devices object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.wifi_unassociated_devices.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.monitor.wifi_unassociated_devices.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.monitor.wifi_unassociated_devices.exists(name="old-object"):
            ...     fgt.api.monitor.wifi_unassociated_devices.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update wifi/unassociated_devices object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.monitor.wifi_unassociated_devices.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.monitor.wifi_unassociated_devices.set(payload_dict=obj_data)
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(UnassociatedDevices.help())
            
            >>> # Get field information
            >>> print(UnassociatedDevices.help("name"))
        """
        from ._helpers.unassociated_devices import (
            get_schema_info,
            get_field_metadata,
        )
    ...
    def fields(detailed: bool = False) -> Union[list[str], dict[str, dict]]:
        ...
        Examples:
            >>> # Simple list
            >>> fields = UnassociatedDevices.fields()
            >>> print(f"Available fields: {len(fields)}")
            
            >>> # Detailed info
            >>> fields = UnassociatedDevices.fields(detailed=True)
            >>> for name, meta in fields.items():
            ...     print(f"{name}: {meta['type']}")
        """
        from ._helpers.unassociated_devices import get_all_fields, get_field_metadata
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = UnassociatedDevices.field_info("name")
            >>> print(f"Type: {info['type']}")
            >>> if 'options' in info:
            ...     print(f"Options: {info['options']}")
        """
        from ._helpers.unassociated_devices import get_field_metadata
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = UnassociatedDevices.validate_field("name", "test")
            >>> if not is_valid:
            ...     print(f"Validation error: {error}")
        """
        from ._helpers.unassociated_devices import validate_field_value
    ...
    def required_fields() -> list[str]:
        ...
        Examples:
            >>> required = UnassociatedDevices.required_fields()
            >>> print(f"Required fields: {', '.join(required)}")
        """
        from ._helpers.unassociated_devices import REQUIRED_FIELDS
    ...
    def defaults() -> dict[str, Any]:
        ...
        Examples:
            >>> defaults = UnassociatedDevices.defaults()
            >>> print(f"Fields with defaults: {len(defaults)}")
            >>> # Use as starting point for payload
            >>> payload = defaults.copy()
            >>> payload['name'] = 'my-custom-name'
        """
        from ._helpers.unassociated_devices import FIELDS_WITH_DEFAULTS
    ...
    def schema() -> dict[str, Any]:
        ...
        Examples:
            >>> schema = UnassociatedDevices.schema()
            >>> print(f"Endpoint: {schema['endpoint']}")
            >>> print(f"Total fields: {schema['total_fields']}")
            >>> print(f"Primary key: {schema.get('mkey', 'N/A')}")
        """
        from ._helpers.unassociated_devices import get_schema_info
