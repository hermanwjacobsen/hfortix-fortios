...
class UnassociatedDevicesPayload(TypedDict, total=False):
    """
    Type hints for wifi/unassociated_devices payload fields.
    
    Retrieve a list of unassociated and BLE devices
    
    **Usage:**
        payload: UnassociatedDevicesPayload = {
...
class UnassociatedDevicesResponse(TypedDict):
    """
    Type hints for wifi/unassociated_devices API response fields.
...
@final
class UnassociatedDevicesObject:
    """Typed FortiObject for wifi/unassociated_devices with IDE autocomplete support.
    ...
    def to_dict(self) -> UnassociatedDevicesPayload: ...
    def keys(self) -> Any: ...
...
class UnassociatedDevices:
    ...
    def get(
        ...
        action: str | None = ...,
        vdom: str | bool | None = ...,
    ) -> UnassociatedDevicesObject | dict[str, Any]: ...
