...
class SpectrumPayload(TypedDict, total=False):
    """
    Type hints for wifi/spectrum payload fields.
...
class SpectrumResponse(TypedDict):
    """
    Type hints for wifi/spectrum API response fields.
...
class SpectrumObject:
    """Typed FortiObject for wifi/spectrum with IDE autocomplete support.
    ...
    def to_dict(self) -> SpectrumPayload: ...
    def keys(self) -> Any: ...
