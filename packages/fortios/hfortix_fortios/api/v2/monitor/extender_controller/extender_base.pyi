...
class ExtenderPayload(TypedDict, total=False):
    """
    Type hints for extender_controller/extender payload fields.
    ...
    **Usage:**
    ...
    """
    fortiextender_name: str  # fortiextender-name
    type: str  # type
...
class ExtenderResponse(TypedDict):
    """
    Type hints for extender_controller/extender API response fields.
...
class ExtenderObject:
    """Typed FortiObject for extender_controller/extender with IDE autocomplete support.
