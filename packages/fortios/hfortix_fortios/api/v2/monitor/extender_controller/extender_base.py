...
class Extender:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> schema = fgt.api.monitor.extender_controller_extender.get(action="schema")
        ...
        cache_key = f"monitor/extender_controller/extender"
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        """
        Update existing extender_controller/extender object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.extender_controller_extender.put(
            ...
            ...     "field1": "new-value",
            ... }
            >>> result = fgt.api.monitor.extender_controller_extender.put(payload_dict=payload)
        ...
        if DEPRECATED_FIELDS:
            ...
            check_deprecated_fields(
                ...
                endpoint="monitor/extender_controller/extender",
            )
        
        name_value = payload_data.get("name")
        if not name_value:
            raise ValueError("name is required for PUT")
        endpoint = f"/extender-controller/extender/{name_value}"
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new extender_controller/extender object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.extender_controller_extender.post(payload_dict=payload)
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete extender_controller/extender object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.extender_controller_extender.delete(name="object-to-delete")
    ...
    def exists(
        ...
        Examples:
            ...
            >>> if fgt.api.monitor.extender_controller_extender.exists(name="my-object"):
            ...     print("Object exists")
            ... else:
            ...     print("Object not found")
            
            >>> # Conditional delete
            >>> if fgt.api.monitor.extender_controller_extender.exists(name="old-object"):
            ...     fgt.api.monitor.extender_controller_extender.delete(name="old-object")
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update extender_controller/extender object (intelligent operation).
        ...
        Examples:
            ...
            ...     "field2": "value2",
            ... }
            >>> result = fgt.api.monitor.extender_controller_extender.set(payload_dict=payload)
            >>> # Will POST if object doesn't exist, PUT if it does
            
            >>> # Idempotent configuration
            >>> for obj_data in configuration_list:
            ...     fgt.api.monitor.extender_controller_extender.set(payload_dict=obj_data)
