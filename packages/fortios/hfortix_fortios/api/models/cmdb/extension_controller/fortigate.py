...
class FortigateModel(BaseModel):
    ...
    Validation Rules:
        ...
        - authorized: pattern=
        - hostname: max_length=31 pattern=
    ...
    async def validate_profile_references(self, client: Any) -> list[str]:
        ...
        - extension_controller/fortigate_profile
        Args:
...
FortigateModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:36.439233Z
# ============================================================================
