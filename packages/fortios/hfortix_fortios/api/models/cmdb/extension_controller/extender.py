...
class ExtenderModel(BaseModel):
    ...
    wan_extension: list[ExtenderWanExtension] = Field(default_factory=list, description="FortiExtender wan extension configuration.")    
...
# Schema: 1.7.1
# Generated: 2026-01-18T15:06:45.258448Z
# ============================================================================