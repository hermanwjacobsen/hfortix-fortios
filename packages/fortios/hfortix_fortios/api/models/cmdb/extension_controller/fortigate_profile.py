...
class FortigateProfileModel(BaseModel):
    ...
    lan_extension: list[FortigateProfileLanExtension] | None = Field(description="FortiGate connector LAN extension configuration.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
FortigateProfileModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:38.072329Z
# ============================================================================
