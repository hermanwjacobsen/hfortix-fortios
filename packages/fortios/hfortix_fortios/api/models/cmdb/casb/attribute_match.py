...
class AttributeMatchMatch(BaseModel):
    ...
    rule: list[dict[str, Any]] | None = Field(default=None, description="CASB attribute match rule.")
...
class AttributeMatchModel(BaseModel):
    ...
    match: list[AttributeMatchMatch] | None = Field(default=None, description="CASB tenant match rules.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
AttributeMatchModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:34.743249Z
# ============================================================================
