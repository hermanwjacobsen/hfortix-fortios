...
class OtdtModel(BaseModel):
    ...
    parameters: list[OtdtParameters] | None = Field(default=None, description="Application parameters.")
    metadata: list[OtdtMetadata] | None = Field(default=None, description="Meta data.")
...
OtdtModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:40.119084Z
# ============================================================================
