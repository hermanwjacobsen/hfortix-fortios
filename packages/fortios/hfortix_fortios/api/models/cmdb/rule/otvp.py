...
class OtvpModel(BaseModel):
    ...
    metadata: list[OtvpMetadata] | None = Field(default=None, description="Meta data.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
OtvpModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:36.619768Z
# ============================================================================
