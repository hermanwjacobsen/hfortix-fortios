...
class IotdModel(BaseModel):
    ...
    parameters: list[IotdParameters] | None = Field(default=None, description="Application parameters.")
    metadata: list[IotdMetadata] | None = Field(default=None, description="Meta data.")
...
IotdModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:37.655800Z
# ============================================================================
