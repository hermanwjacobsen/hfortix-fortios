...
class QosProfileModel(BaseModel):
    ...
    Validation Rules:
        ...
        - uplink: min=0 max=2097152 pattern=
        - downlink: min=0 max=2097152 pattern=
        - uplink_sta: min=0 max=2097152 pattern=
        - downlink_sta: min=0 max=2097152 pattern=
        - burst: pattern=
        - wmm: pattern=
        - wmm_uapsd: pattern=
        - call_admission_control: pattern=
        - call_capacity: min=0 max=60 pattern=
        - bandwidth_admission_control: pattern=
        - bandwidth_capacity: min=1 max=600000 pattern=
        - dscp_wmm_mapping: pattern=
        - dscp_wmm_vo: pattern=
        - dscp_wmm_vi: pattern=
        - dscp_wmm_be: pattern=
        - dscp_wmm_bk: pattern=
        - wmm_dscp_marking: pattern=
        - wmm_vo_dscp: min=0 max=63 pattern=
        - wmm_vi_dscp: min=0 max=63 pattern=
        - wmm_be_dscp: min=0 max=63 pattern=
        - wmm_bk_dscp: min=0 max=63 pattern=
    """
    ...
    dscp_wmm_vo: list[QosProfileDscpWmmVo] | None = Field(default=None, description="DSCP mapping for voice access (default = 48 56).")
    dscp_wmm_vi: list[QosProfileDscpWmmVi] | None = Field(default=None, description="DSCP mapping for video access (default = 32 40).")
    dscp_wmm_be: list[QosProfileDscpWmmBe] | None = Field(default=None, description="DSCP mapping for best effort access (default = 0 24).")
    dscp_wmm_bk: list[QosProfileDscpWmmBk] | None = Field(default=None, description="DSCP mapping for background access (default = 8 16).")
...
QosProfileModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:39.130207Z
# ============================================================================
