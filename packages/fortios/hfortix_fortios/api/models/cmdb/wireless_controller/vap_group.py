...
class VapGroupModel(BaseModel):
    ...
    vaps: list[VapGroupVaps] | None = Field(default=None, description="List of SSIDs to be included in the VAP group.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
VapGroupModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:37.882095Z
# ============================================================================
