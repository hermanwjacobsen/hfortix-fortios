...
class H2qpOsuProviderModel(BaseModel):
    ...
    Validation Rules:
        ...
        - server_uri: max_length=255 pattern=
        - osu_method: pattern=
        - osu_nai: max_length=255 pattern=
        - service_description: pattern=
        - icon: max_length=35 pattern=
    """
    ...
    friendly_name: list[H2qpOsuProviderFriendlyName] | None = Field(default=None, description="OSU provider friendly name.")
    server_uri: str | None = Field(max_length=255, default="", description="Server URI.")
    osu_method: Literal["oma-dm", "soap-xml-spp", "reserved"] | None = Field(default=None, description="OSU method list.")
    osu_nai: str | None = Field(max_length=255, default="", description="OSU NAI.")
    service_description: list[H2qpOsuProviderServiceDescription] | None = Field(default=None, description="OSU service name.")
...
H2qpOsuProviderModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:37.386234Z
# ============================================================================
