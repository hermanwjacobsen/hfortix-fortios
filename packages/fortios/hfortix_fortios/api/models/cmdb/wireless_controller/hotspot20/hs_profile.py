...
class HsProfileModel(BaseModel):
    ...
    def validate_network_auth(cls, v: Any) -> Any:
        ...
        # Additional datasource validation could be added here
        return v
    @field_validator('x3gpp_plmn')
    @classmethod
    def validate_x3gpp_plmn(cls, v: Any) -> Any:
        """
        Validate x3gpp_plmn field.
    ...
    async def validate_venue_name_references(self, client: Any) -> list[str]:
        ...
        - wireless_controller/hotspot20/anqp_venue_name
        Args:
    ...
    async def validate_venue_url_references(self, client: Any) -> list[str]:
        ...
        Datasource endpoints checked:
        - wireless_controller/hotspot20/anqp_venue_url
        Args:
            client: FortiOS client instance (from fgt._client)
    ...
    async def validate_roaming_consortium_references(self, client: Any) -> list[str]:
        ...
        Datasource endpoints checked:
        - wireless_controller/hotspot20/anqp_roaming_consortium
        Args:
            client: FortiOS client instance (from fgt._client)
    ...
    async def validate_nai_realm_references(self, client: Any) -> list[str]:
        ...
        Datasource endpoints checked:
        - wireless_controller/hotspot20/anqp_nai_realm
        Args:
            client: FortiOS client instance (from fgt._client)
    ...
    async def validate_oper_friendly_name_references(self, client: Any) -> list[str]:
        ...
        Datasource endpoints checked:
        - wireless_controller/hotspot20/h2qp_operator_name
        Args:
            client: FortiOS client instance (from fgt._client)
    ...
    async def validate_oper_icon_references(self, client: Any) -> list[str]:
        ...
        Datasource endpoints checked:
        - wireless_controller/hotspot20/icon
        Args:
            client: FortiOS client instance (from fgt._client)
    ...
    async def validate_advice_of_charge_references(self, client: Any) -> list[str]:
        ...
        Datasource endpoints checked:
        - wireless_controller/hotspot20/h2qp_advice_of_charge
        Args:
            client: FortiOS client instance (from fgt._client)
    ...
    async def validate_osu_provider_nai_references(self, client: Any) -> list[str]:
        ...
        Datasource endpoints checked:
        - wireless_controller/hotspot20/h2qp_osu_provider_nai
        Args:
            client: FortiOS client instance (from fgt._client)
    ...
    async def validate_terms_and_conditions_references(self, client: Any) -> list[str]:
        ...
        Datasource endpoints checked:
        - wireless_controller/hotspot20/h2qp_terms_and_conditions
        Args:
            client: FortiOS client instance (from fgt._client)
    ...
    async def validate_osu_provider_references(self, client: Any) -> list[str]:
        ...
        Datasource endpoints checked:
        - wireless_controller/hotspot20/h2qp_osu_provider
        Args:
            client: FortiOS client instance (from fgt._client)
    ...
    async def validate_wan_metrics_references(self, client: Any) -> list[str]:
        ...
        Datasource endpoints checked:
        - wireless_controller/hotspot20/h2qp_wan_metric
        Args:
            client: FortiOS client instance (from fgt._client)
    ...
    async def validate_network_auth_references(self, client: Any) -> list[str]:
        ...
        Datasource endpoints checked:
        - wireless_controller/hotspot20/anqp_network_auth_type
        Args:
            client: FortiOS client instance (from fgt._client)
        ...
        return errors
    async def validate_x3gpp_plmn_references(self, client: Any) -> list[str]:
        """
        Validate x3gpp_plmn references exist in FortiGate.
        ...
        Datasource endpoints checked:
        - wireless_controller/hotspot20/anqp_3gpp_cellular
        Args:
            client: FortiOS client instance (from fgt._client)
        ...
        Example:
            ...
            >>> fgt = FortiOS(host="192.168.1.1", token="your-token")
            >>> policy = HsProfileModel(
            ...     x3gpp_plmn="invalid-name",
            ... )
            >>>
            >>> # Validate before posting
            >>> errors = await policy.validate_x3gpp_plmn_references(fgt._client)
            >>> if errors:
            ...     print("Validation failed:", errors)
            ... else:
            ...     result = await fgt.api.cmdb.wireless_controller.hotspot20.hs_profile.post(policy.to_fortios_dict())
    ...
    async def validate_conn_cap_references(self, client: Any) -> list[str]:
        ...
        Datasource endpoints checked:
        - wireless_controller/hotspot20/h2qp_conn_capability
        Args:
            client: FortiOS client instance (from fgt._client)
    ...
    async def validate_qos_map_references(self, client: Any) -> list[str]:
        ...
        Datasource endpoints checked:
        - wireless_controller/hotspot20/qos_map
        Args:
            client: FortiOS client instance (from fgt._client)
    ...
    async def validate_ip_addr_type_references(self, client: Any) -> list[str]:
        ...
        Datasource endpoints checked:
        - wireless_controller/hotspot20/anqp_ip_address_type
        Args:
            client: FortiOS client instance (from fgt._client)
...
HsProfileModelDict = dict[str, Any]  # For backward compatibility
