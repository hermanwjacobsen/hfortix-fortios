...
class QosMapModel(BaseModel):
    ...
    dscp_except: list[QosMapDscpExcept] | None = Field(default=None, description="Differentiated Services Code Point (DSCP) exceptions.")
    dscp_range: list[QosMapDscpRange] | None = Field(default=None, description="Differentiated Services Code Point (DSCP) ranges.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
QosMapModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:39.935453Z
# ============================================================================
