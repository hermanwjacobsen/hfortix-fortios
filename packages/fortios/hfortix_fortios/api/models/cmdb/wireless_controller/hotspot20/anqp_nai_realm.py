...
class AnqpNaiRealmNaiList(BaseModel):
    ...
    eap_method: list[dict[str, Any]] | None = Field(default=None, description="EAP Methods.")
...
class AnqpNaiRealmModel(BaseModel):
    ...
    nai_list: list[AnqpNaiRealmNaiList] | None = Field(default=None, description="NAI list.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
AnqpNaiRealmModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:35.402381Z
# ============================================================================
