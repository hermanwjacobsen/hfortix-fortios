...
class TimersModel(BaseModel):
    ...
    Validation Rules:
        - echo_interval: min=1 max=255 pattern=
        - nat_session_keep_alive: min=0 max=255 pattern=
        - discovery_interval: min=2 max=180 pattern=
        - client_idle_timeout: min=20 max=3600 pattern=
        - client_idle_rehome_timeout: min=2 max=3600 pattern=
        - auth_timeout: min=5 max=30 pattern=
        - rogue_ap_log: min=0 max=1440 pattern=
        - fake_ap_log: min=1 max=1440 pattern=
        - sta_offline_cleanup: min=0 max=4294967295 pattern=
        - sta_offline_ip2mac_cleanup: min=0 max=4294967295 pattern=
        ...
        - sta_stats_interval: min=1 max=255 pattern=
        - vap_stats_interval: min=1 max=255 pattern=
        - radio_stats_interval: min=1 max=255 pattern=
        - sta_capability_interval: min=1 max=255 pattern=
        - sta_locate_timer: min=0 max=86400 pattern=
        - ipsec_intf_cleanup: min=30 max=3600 pattern=
        - ble_scan_report_intv: min=10 max=3600 pattern=
        - drma_interval: min=1 max=1440 pattern=
        - ap_reboot_wait_interval1: min=5 max=65535 pattern=
        - ap_reboot_wait_time: max_length=7 pattern=
        - ap_reboot_wait_interval2: min=5 max=65535 pattern=
    """
...
TimersModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:35.891189Z
# ============================================================================
