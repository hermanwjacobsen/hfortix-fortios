...
class BonjourProfilePolicyList(BaseModel):
    ...
    services: str | None = Field(default="all", description="Bonjour services for the VLAN connecting to the Bonjour network.")
...
class BonjourProfileModel(BaseModel):
    ...
    policy_list: list[BonjourProfilePolicyList] | None = Field(default=None, description="Bonjour policy list.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
BonjourProfileModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:36.312040Z
# ============================================================================
