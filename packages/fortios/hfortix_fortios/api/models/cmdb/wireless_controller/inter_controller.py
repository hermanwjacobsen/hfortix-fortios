...
class InterControllerModel(BaseModel):
    ...
    Validation Rules:
        - inter_controller_mode: pattern=
        - l3_roaming: pattern=
        - inter_controller_key: max_length=127 pattern=
        - inter_controller_pri: pattern=
        - fast_failover_max: min=3 max=64 pattern=
        - fast_failover_wait: min=10 max=86400 pattern=
        - inter_controller_peer: pattern=
    """
    ...
    inter_controller_peer: list[InterControllerInterControllerPeer] | None = Field(default=None, description="Fast failover peer wireless controller list.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
InterControllerModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:37.769557Z
# ============================================================================
