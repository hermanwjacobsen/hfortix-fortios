...
class ApcfgProfileCommandList(BaseModel):
    ...
    type_: Literal["non-password", "password"] | None = Field(default="non-password", description="The command type (default = non-password).")
...
class ApcfgProfileModel(BaseModel):
    ...
    Validation Rules:
        ...
        - ac_type: pattern=
        - ac_timer: min=3 max=30 pattern=
        - ac_ip: pattern=
        - ac_port: min=1024 max=49150 pattern=
        - command_list: pattern=
    """
    ...
    command_list: list[ApcfgProfileCommandList] | None = Field(default=None, description="AP local configuration command list.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
ApcfgProfileModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:38.749992Z
# ============================================================================
