...
class GlobalModel(BaseModel):
    ...
    Validation Rules:
        ...
        - acd_process_count: min=0 max=255 pattern=
        - wpad_process_count: min=0 max=255 pattern=
        - image_download: pattern=
        - rolling_wtp_upgrade: pattern=
        - rolling_wtp_upgrade_threshold: max_length=7 pattern=
        - max_retransmit: min=0 max=64 pattern=
        - control_message_offload: pattern=
        - data_ethernet_II: pattern=
        - link_aggregation: pattern=
        - mesh_eth_type: min=0 max=65535 pattern=
        - fiapp_eth_type: min=0 max=65535 pattern=
        - discovery_mc_addr: pattern=
        - discovery_mc_addr6: pattern=
        - max_clients: min=0 max=4294967295 pattern=
        - rogue_scan_mac_adjacency: min=0 max=31 pattern=
        - ipsec_base_ip: pattern=
        - wtp_share: pattern=
        - tunnel_mode: pattern=
        - nac_interval: min=10 max=600 pattern=
        - ap_log_server: pattern=
        - ap_log_server_ip: pattern=
        - ap_log_server_port: min=0 max=65535 pattern=
        - max_sta_offline: min=0 max=4294967295 pattern=
        - max_sta_offline_ip2mac: min=0 max=4294967295 pattern=
        - max_sta_cap: min=0 max=4294967295 pattern=
        - max_sta_cap_wtp: min=1 max=8 pattern=
        - max_rogue_ap: min=0 max=4294967295 pattern=
        - max_rogue_ap_wtp: min=1 max=16 pattern=
        - max_rogue_sta: min=0 max=4294967295 pattern=
    ...
    control_message_offload: str | GlobalControlMessageOffloadEnum | None = Field(default=None, description="Configure CAPWAP control message data channel offload.")
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:37.876520Z
# ============================================================================
