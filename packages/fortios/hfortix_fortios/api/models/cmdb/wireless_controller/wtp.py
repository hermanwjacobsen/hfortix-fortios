...
class WtpModel(BaseModel):
    ...
    lan: list[WtpLan] = Field(default_factory=list, description="WTP LAN port mapping.")    
    ...
    radio_1: list[WtpRadio1] = Field(default_factory=list, description="Configuration options for radio 1.")    
    radio_2: list[WtpRadio2] = Field(default_factory=list, description="Configuration options for radio 2.")    
    radio_3: list[WtpRadio3] = Field(default_factory=list, description="Configuration options for radio 3.")    
    radio_4: list[WtpRadio4] = Field(default_factory=list, description="Configuration options for radio 4.")    
...
# Schema: 1.7.1
# Generated: 2026-01-18T20:31:27.691253Z
# ============================================================================