...
class WtpRadio1(BaseModel):
    ...
    drma_manual_mode: str | None = Field(default="ncf", description="Radio mode to be used for DRMA manual mode (default = ncf).")
...
class WtpModel(BaseModel):
    ...
    Validation Rules:
        ...
        - override_default_mesh_root: pattern=
        - default_mesh_root: pattern=
        - radio_1: pattern=
        - radio_2: pattern=
        - radio_3: pattern=
        - radio_4: pattern=
        - image_download: pattern=
        - mesh_bridge_enable: pattern=
        - purdue_level: pattern=
        - coordinate_latitude: max_length=19 pattern=
        - coordinate_longitude: max_length=19 pattern=
    """
    ...
    split_tunneling_acl: list[WtpSplitTunnelingAcl] | None = Field(default=None, description="Split tunneling ACL filter list.")
    ...
    lan: list[WtpLan] | None = Field(default=None, description="WTP LAN port mapping.")
    ...
    radio_1: list[WtpRadio1] | None = Field(default=None, description="Configuration options for radio 1.")
    radio_2: list[WtpRadio2] | None = Field(default=None, description="Configuration options for radio 2.")
    radio_3: list[WtpRadio3] | None = Field(default=None, description="Configuration options for radio 3.")
    radio_4: list[WtpRadio4] | None = Field(default=None, description="Configuration options for radio 4.")
    ...
    purdue_level: str | WtpPurdueLevelEnum | None = Field(default="3", description="Purdue Level of this WTP.")
    ...
    async def validate_wtp_profile_references(self, client: Any) -> list[str]:
        ...
        Datasource endpoints checked:
        - wireless_controller/wtp_profile
        Args:
            client: FortiOS client instance (from fgt._client)
    ...
    async def validate_apcfg_profile_references(self, client: Any) -> list[str]:
        ...
        Datasource endpoints checked:
        - wireless_controller/apcfg_profile
        Args:
            client: FortiOS client instance (from fgt._client)
    ...
    async def validate_bonjour_profile_references(self, client: Any) -> list[str]:
        ...
        Datasource endpoints checked:
        - wireless_controller/bonjour_profile
        Args:
            client: FortiOS client instance (from fgt._client)
...
WtpModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:36.292732Z
# ============================================================================
