...
class AccessControlListModel(BaseModel):
    ...
    Validation Rules:
        ...
        - layer3_ipv4_rules: pattern=
        - layer3_ipv6_rules: pattern=
    """
    ...
    comment: str | None = Field(max_length=63, default="", description="Description.")
    layer3_ipv4_rules: list[AccessControlListLayer3Ipv4Rules] | None = Field(default=None, description="AP ACL layer3 ipv4 rule list.")
    layer3_ipv6_rules: list[AccessControlListLayer3Ipv6Rules] | None = Field(default=None, description="AP ACL layer3 ipv6 rule list.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
AccessControlListModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:37.186692Z
# ============================================================================
