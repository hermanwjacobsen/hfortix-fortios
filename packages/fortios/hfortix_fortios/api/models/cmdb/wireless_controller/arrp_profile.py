...
class ArrpProfileModel(BaseModel):
    ...
    Validation Rules:
        ...
        - selection_period: min=0 max=65535 pattern=
        - monitor_period: min=0 max=65535 pattern=
        - weight_managed_ap: min=0 max=2000 pattern=
        - weight_rogue_ap: min=0 max=2000 pattern=
        - weight_noise_floor: min=0 max=2000 pattern=
        - weight_channel_load: min=0 max=2000 pattern=
        - weight_spectral_rssi: min=0 max=2000 pattern=
        - weight_weather_channel: min=0 max=2000 pattern=
        - weight_dfs_channel: min=0 max=2000 pattern=
        - threshold_ap: min=0 max=500 pattern=
        - threshold_noise_floor: max_length=7 pattern=
        - threshold_channel_load: min=0 max=100 pattern=
        - threshold_spectral_rssi: max_length=7 pattern=
        - threshold_tx_retries: min=0 max=1000 pattern=
        - threshold_rx_errors: min=0 max=100 pattern=
        - include_weather_channel: pattern=
        - include_dfs_channel: pattern=
        - override_darrp_optimize: pattern=
    ...
    darrp_optimize_schedules: list[ArrpProfileDarrpOptimizeSchedules] | None = Field(default=None, description="Firewall schedules for DARRP running time. DARRP will run periodically based on darrp-optimize within the schedules. Separate multiple schedule names with a space.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
ArrpProfileModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:37.548883Z
# ============================================================================
