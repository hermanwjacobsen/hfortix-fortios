...
class MpskProfileMpskGroup(BaseModel):
    ...
    mpsk_key: list[dict[str, Any]] | None = Field(default=None, description="List of multiple PSK entries.")
...
class MpskProfileModel(BaseModel):
    ...
    Validation Rules:
        ...
        - mpsk_concurrent_clients: min=0 max=65535 pattern=
        - mpsk_external_server_auth: pattern=
        - mpsk_external_server: max_length=35 pattern=
        - mpsk_type: pattern=
        - mpsk_group: pattern=
    """
    ...
    mpsk_group: list[MpskProfileMpskGroup] | None = Field(default=None, description="List of multiple PSK groups.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
MpskProfileModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:38.011805Z
# ============================================================================
