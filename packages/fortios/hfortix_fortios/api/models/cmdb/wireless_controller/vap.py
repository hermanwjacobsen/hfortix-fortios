...
class VapVlanName(BaseModel):
    ...
    vlan_id: int | None = Field(ge=0, le=4094, default=None, description="VLAN IDs (maximum 8 VLAN IDs).")
...
class VapPortalTypeEnum(str, Enum):
    ...
    AUTH = "auth"
    AUTHDISCLAIMER = "auth+disclaimer"
...
class VapRates11AEnum(str, Enum):
    ...
    VALUE_6 = "6"
    VALUE_6_BASIC = "6-basic"
    VALUE_9 = "9"
    VALUE_9_BASIC = "9-basic"
    VALUE_12 = "12"
    VALUE_12_BASIC = "12-basic"
    VALUE_18 = "18"
    VALUE_18_BASIC = "18-basic"
    VALUE_24 = "24"
    VALUE_24_BASIC = "24-basic"
    VALUE_36 = "36"
    VALUE_36_BASIC = "36-basic"
    VALUE_48 = "48"
    VALUE_48_BASIC = "48-basic"
    VALUE_54 = "54"
    VALUE_54_BASIC = "54-basic"


class VapRates11BgEnum(str, Enum):
    """Allowed values for rates_11bg field."""
    VALUE_1 = "1"
    VALUE_1_BASIC = "1-basic"
    VALUE_2 = "2"
    VALUE_2_BASIC = "2-basic"
    VALUE_5_5 = "5.5"
    VALUE_5_5_BASIC = "5.5-basic"
    VALUE_11 = "11"
    VALUE_11_BASIC = "11-basic"
    VALUE_6 = "6"
    VALUE_6_BASIC = "6-basic"
    VALUE_9 = "9"
    VALUE_9_BASIC = "9-basic"
...
class VapModel(BaseModel):
    ...
    Validation Rules:
        ...
        - pre_auth: pattern=
        - external_pre_auth: pattern=
        - mesh_backhaul: pattern=
        - atf_weight: min=0 max=100 pattern=
        ...
        - security: pattern=
        - pmf: pattern=
        - pmf_assoc_comeback_timeout: min=1 max=20 pattern=
        - pmf_sa_query_retry_timeout: min=1 max=5 pattern=
        - beacon_protection: pattern=
        - okc: pattern=
        - mbo: pattern=
        - gas_comeback_delay: min=100 max=10000 pattern=
        - gas_fragmentation_limit: min=512 max=4096 pattern=
        - mbo_cell_data_conn_pref: pattern=
        - x80211k: pattern=
        - x80211v: pattern=
        - neighbor_report_dual_band: pattern=
        - fast_bss_transition: pattern=
        - ft_mobility_domain: min=1 max=65535 pattern=
        - ft_r0_key_lifetime: min=1 max=65535 pattern=
        - ft_over_ds: pattern=
        - sae_groups: pattern=
        - owe_groups: pattern=
        - owe_transition: pattern=
        - owe_transition_ssid: max_length=32 pattern=
        - additional_akms: pattern=
        - eapol_key_retries: pattern=
        - tkip_counter_measure: pattern=
        - external_web: max_length=1023 pattern=
        - external_web_format: pattern=
        - external_logout: max_length=127 pattern=
        ...
        - mac_case: pattern=
        - called_station_id_type: pattern=
        - mac_auth_bypass: pattern=
        - radius_mac_auth: pattern=
        - radius_mac_auth_server: max_length=35 pattern=
        - radius_mac_auth_block_interval: min=30 max=864000 pattern=
        - radius_mac_mpsk_auth: pattern=
        - radius_mac_mpsk_timeout: min=300 max=864000 pattern=
        - radius_mac_auth_usergroups: pattern=
        - auth: pattern=
        - encrypt: pattern=
        - keyindex: min=1 max=4 pattern=
        - key: max_length=128 pattern=
        - passphrase: max_length=128 pattern=
        - sae_password: max_length=128 pattern=
        - sae_h2e_only: pattern=
        - sae_hnp_only: pattern=
        - sae_pk: pattern=
        - sae_private_key: max_length=359 pattern=
        - akm24_only: pattern=
        - radius_server: max_length=35 pattern=
        - nas_filter_rule: pattern=
        - domain_name_stripping: pattern=
        - mlo: pattern=
        - local_standalone: pattern=
        - local_standalone_nat: pattern=
        - ip: pattern=
        - dhcp_lease_time: min=300 max=8640000 pattern=
        - local_standalone_dns: pattern=
        - local_standalone_dns_ip: pattern=
        - local_lan_partition: pattern=
        - local_bridging: pattern=
        - local_lan: pattern=
        - local_authentication: pattern=
        - usergroup: pattern=
        - captive_portal: pattern=
        - captive_network_assistant_bypass: pattern=
        - portal_message_override_group: max_length=35 pattern=
        - portal_message_overrides: pattern=
        - portal_type: pattern=
        - selected_usergroups: pattern=
        ...
        - intra_vap_privacy: pattern=
        - schedule: pattern=
        - ldpc: pattern=
        - high_efficiency: pattern=
        - target_wake_time: pattern=
        - port_macauth: pattern=
        - port_macauth_timeout: min=60 max=65535 pattern=
        - port_macauth_reauth_timeout: min=120 max=65535 pattern=
        - bss_color_partial: pattern=
        - mpsk_profile: max_length=35 pattern=
        - split_tunneling: pattern=
        - nac: pattern=
        - nac_profile: max_length=35 pattern=
        - vlanid: min=0 max=4094 pattern=
        - vlan_auto: pattern=
        - dynamic_vlan: pattern=
        - captive_portal_fw_accounting: pattern=
        - captive_portal_ac_name: max_length=35 pattern=
        - captive_portal_auth_timeout: min=0 max=864000 pattern=
        - multicast_rate: pattern=
        - multicast_enhance: pattern=
        - igmp_snooping: pattern=
        - dhcp_address_enforcement: pattern=
        - broadcast_suppression: pattern=
        - ipv6_rules: pattern=
        - me_disable_thresh: min=2 max=256 pattern=
        - mu_mimo: pattern=
        - probe_resp_suppression: pattern=
        - probe_resp_threshold: max_length=7 pattern=
        - radio_sensitivity: pattern=
        - quarantine: pattern=
        - radio_5g_threshold: max_length=7 pattern=
        - radio_2g_threshold: max_length=7 pattern=
        - vlan_name: pattern=
        - vlan_pooling: pattern=
        - vlan_pool: pattern=
        - dhcp_option43_insertion: pattern=
        - dhcp_option82_insertion: pattern=
        - dhcp_option82_circuit_id_insertion: pattern=
        - dhcp_option82_remote_id_insertion: pattern=
        - ptk_rekey: pattern=
        - ptk_rekey_intv: min=600 max=864000 pattern=
        - gtk_rekey: pattern=
        - gtk_rekey_intv: min=600 max=864000 pattern=
        - eap_reauth: pattern=
        - eap_reauth_intv: min=1800 max=864000 pattern=
        - roaming_acct_interim_update: pattern=
        - qos_profile: max_length=35 pattern=
        - hotspot20_profile: max_length=35 pattern=
        - access_control_list: max_length=35 pattern=
        - primary_wag_profile: max_length=35 pattern=
        - secondary_wag_profile: max_length=35 pattern=
        - tunnel_echo_interval: min=1 max=65535 pattern=
        - tunnel_fallback_interval: min=0 max=65535 pattern=
        - rates_11a: pattern=
        - rates_11bg: pattern=
        - rates_11n_ss12: pattern=
        - rates_11n_ss34: pattern=
        - rates_11ac_mcs_map: max_length=63 pattern=
        - rates_11ax_mcs_map: max_length=63 pattern=
        - rates_11be_mcs_map: max_length=15 pattern=
        - rates_11be_mcs_map_160: max_length=15 pattern=
        - rates_11be_mcs_map_320: max_length=15 pattern=
        - utm_profile: max_length=35 pattern=
        - utm_status: pattern=
        - utm_log: pattern=
        ...
        - address_group: max_length=79 pattern=
        - address_group_policy: pattern=
        - sticky_client_remove: pattern=
        - sticky_client_threshold_5g: max_length=7 pattern=
        - sticky_client_threshold_2g: max_length=7 pattern=
        - sticky_client_threshold_6g: max_length=7 pattern=
        - bstm_rssi_disassoc_timer: min=1 max=2000 pattern=
        - bstm_load_balancing_disassoc_timer: min=1 max=30 pattern=
        - bstm_disassociation_imminent: pattern=
        - beacon_advertising: pattern=
        - osen: pattern=
        - application_detection_engine: pattern=
        - application_dscp_marking: pattern=
        - application_report_intv: min=30 max=864000 pattern=
        - l3_roaming: pattern=
        - l3_roaming_mode: pattern=
    """
    ...
    security: str | VapSecurityEnum | None = Field(default="wpa2-only-personal", description="Security mode for the wireless interface (default = wpa2-only-personal).")
    ...
    x80211k: Literal["disable", "enable"] | None = Field(default="enable", description="Enable/disable 802.11k assisted roaming (default = enable).")
    x80211v: Literal["disable", "enable"] | None = Field(default="enable", description="Enable/disable 802.11v assisted roaming (default = enable).")
    ...
    sae_groups: Literal["19", "20", "21"] | None = Field(default=None, description="SAE-Groups.")
    owe_groups: Literal["19", "20", "21"] | None = Field(default=None, description="OWE-Groups.")
    ...
    additional_akms: Literal["akm6", "akm24"] | None = Field(default=None, description="Additional AKMs.")
    ...
    mac_username_delimiter: str | VapMacUsernameDelimiterEnum | None = Field(default="hyphen", description="MAC authentication username delimiter (default = hyphen).")
    mac_password_delimiter: str | VapMacPasswordDelimiterEnum | None = Field(default="hyphen", description="MAC authentication password delimiter (default = hyphen).")
    mac_calling_station_delimiter: str | VapMacCallingStationDelimiterEnum | None = Field(default="hyphen", description="MAC calling station delimiter (default = hyphen).")
    mac_called_station_delimiter: str | VapMacCalledStationDelimiterEnum | None = Field(default="hyphen", description="MAC called station delimiter (default = hyphen).")
    ...
    radius_mac_auth_usergroups: list[VapRadiusMacAuthUsergroups] | None = Field(default=None, description="Selective user groups that are permitted for RADIUS mac authentication.")
    ...
    local_standalone_dns_ip: str | None = Field(default="", description="IPv4 addresses for the local standalone DNS.")
    ...
    usergroup: list[VapUsergroup] | None = Field(default=None, description="Firewall user group to be used to authenticate WiFi users.")
    ...
    portal_message_overrides: list[VapPortalMessageOverrides] | None = Field(default=None, description="Individual message overrides.")
    portal_type: str | VapPortalTypeEnum | None = Field(default="auth", description="Captive portal functionality. Configure how the captive portal authenticates users and whether it includes a disclaimer.")
    selected_usergroups: list[VapSelectedUsergroups] | None = Field(default=None, description="Selective user groups that are permitted to authenticate.")
    ...
    schedule: list[VapSchedule] | None = Field(default=None, description="Firewall schedules for enabling this VAP on the FortiAP. This VAP will be enabled when at least one of the schedules is valid. Separate multiple schedule names with a space.")
    ldpc: str | VapLdpcEnum | None = Field(default="rxtx", description="VAP low-density parity-check (LDPC) coding configuration.")
    ...
    multicast_rate: str | VapMulticastRateEnum | None = Field(default="0", description="Multicast rate (0, 6000, 12000, or 24000 kbps, default = 0).")
    ...
    broadcast_suppression: str | VapBroadcastSuppressionEnum | None = Field(default=None, description="Optional suppression of broadcast messages. For example, you can keep DHCP messages, ARP broadcasts, and so on off of the wireless network.")
    ipv6_rules: str | VapIpv6RulesEnum | None = Field(default=None, description="Optional rules of IPv6 packets. For example, you can keep RA, RS and so on off of the wireless network.")
    ...
    vlan_name: list[VapVlanName] | None = Field(default=None, description="Table for mapping VLAN name to VLAN ID.")
    vlan_pooling: str | VapVlanPoolingEnum | None = Field(default="disable", description="Enable/disable VLAN pooling, to allow grouping of multiple wireless controller VLANs into VLAN pools (default = disable). When set to wtp-group, VLAN pooling occurs with VLAN assignment by wtp-group.")
    vlan_pool: list[VapVlanPool] | None = Field(default=None, description="VLAN pool.")
    ...
    dhcp_option82_circuit_id_insertion: str | VapDhcpOption82CircuitIdInsertionEnum | None = Field(default="disable", description="Enable/disable DHCP option 82 circuit-id insert (default = disable).")
    ...
    rates_11a: str | VapRates11AEnum | None = Field(default=None, description="Allowed data rates for 802.11a.")
    rates_11bg: str | VapRates11BgEnum | None = Field(default=None, description="Allowed data rates for 802.11b/g.")
    rates_11n_ss12: str | VapRates11NSs12Enum | None = Field(default=None, description="Allowed data rates for 802.11n with 1 or 2 spatial streams.")
    rates_11n_ss34: str | VapRates11NSs34Enum | None = Field(default=None, description="Allowed data rates for 802.11n with 3 or 4 spatial streams.")
    ...
    beacon_advertising: Literal["name", "model", "serial-number"] | None = Field(default=None, description="Fortinet beacon advertising IE data   (default = empty).")
    ...
    async def validate_mpsk_profile_references(self, client: Any) -> list[str]:
        ...
        Datasource endpoints checked:
        - wireless_controller/mpsk_profile
        Args:
            client: FortiOS client instance (from fgt._client)
    ...
    async def validate_nac_profile_references(self, client: Any) -> list[str]:
        ...
        Datasource endpoints checked:
        - wireless_controller/nac_profile
        Args:
            client: FortiOS client instance (from fgt._client)
    ...
    async def validate_qos_profile_references(self, client: Any) -> list[str]:
        ...
        Datasource endpoints checked:
        - wireless_controller/qos_profile
        Args:
            client: FortiOS client instance (from fgt._client)
    ...
    async def validate_hotspot20_profile_references(self, client: Any) -> list[str]:
        ...
        Datasource endpoints checked:
        - wireless_controller/hotspot20/hs_profile
        Args:
            client: FortiOS client instance (from fgt._client)
    ...
    async def validate_access_control_list_references(self, client: Any) -> list[str]:
        ...
        Datasource endpoints checked:
        - wireless_controller/access_control_list
        Args:
            client: FortiOS client instance (from fgt._client)
    ...
    async def validate_primary_wag_profile_references(self, client: Any) -> list[str]:
        ...
        Datasource endpoints checked:
        - wireless_controller/wag_profile
        Args:
            client: FortiOS client instance (from fgt._client)
    ...
    async def validate_utm_profile_references(self, client: Any) -> list[str]:
        ...
        Datasource endpoints checked:
        - wireless_controller/utm_profile
        Args:
            client: FortiOS client instance (from fgt._client)
...
VapModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:34.337647Z
# ============================================================================
