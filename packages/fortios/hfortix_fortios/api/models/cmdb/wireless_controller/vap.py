...
class VapModel(BaseModel):
    ...
    portal_message_overrides: list[VapPortalMessageOverrides] = Field(default_factory=list, description="Individual message overrides.")    
...
# Schema: 1.7.1
# Generated: 2026-01-18T20:31:26.554230Z
# ============================================================================