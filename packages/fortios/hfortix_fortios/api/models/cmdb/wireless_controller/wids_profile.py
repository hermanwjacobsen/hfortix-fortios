...
class WidsProfileModel(BaseModel):
    ...
    Validation Rules:
        ...
        - sensor_mode: pattern=
        - ap_scan: pattern=
        - ap_scan_channel_list_2G_5G: pattern=
        - ap_scan_channel_list_6G: pattern=
        - ap_bgscan_period: min=10 max=3600 pattern=
        - ap_bgscan_intv: min=1 max=600 pattern=
        - ap_bgscan_duration: min=10 max=1000 pattern=
        - ap_bgscan_idle: min=0 max=1000 pattern=
        - ap_bgscan_report_intv: min=15 max=600 pattern=
        - ap_bgscan_disable_schedules: pattern=
        - ap_fgscan_report_intv: min=15 max=600 pattern=
        - ap_scan_passive: pattern=
        - ap_scan_threshold: max_length=7 pattern=
        - ap_auto_suppress: pattern=
        - wireless_bridge: pattern=
        - deauth_broadcast: pattern=
        - null_ssid_probe_resp: pattern=
        - long_duration_attack: pattern=
        - long_duration_thresh: min=1000 max=32767 pattern=
        - invalid_mac_oui: pattern=
        - weak_wep_iv: pattern=
        - auth_frame_flood: pattern=
        - auth_flood_time: min=5 max=120 pattern=
        - auth_flood_thresh: min=1 max=100 pattern=
        - assoc_frame_flood: pattern=
        - assoc_flood_time: min=5 max=120 pattern=
        - assoc_flood_thresh: min=1 max=100 pattern=
        - reassoc_flood: pattern=
        - reassoc_flood_time: min=1 max=120 pattern=
        - reassoc_flood_thresh: min=1 max=65100 pattern=
        - probe_flood: pattern=
        - probe_flood_time: min=1 max=120 pattern=
        - probe_flood_thresh: min=1 max=65100 pattern=
        - bcn_flood: pattern=
        - bcn_flood_time: min=1 max=120 pattern=
        - bcn_flood_thresh: min=1 max=65100 pattern=
        - rts_flood: pattern=
        - rts_flood_time: min=1 max=120 pattern=
        - rts_flood_thresh: min=1 max=65100 pattern=
        - cts_flood: pattern=
        - cts_flood_time: min=1 max=120 pattern=
        - cts_flood_thresh: min=1 max=65100 pattern=
        - client_flood: pattern=
        - client_flood_time: min=1 max=120 pattern=
        - client_flood_thresh: min=1 max=65100 pattern=
        - block_ack_flood: pattern=
        - block_ack_flood_time: min=1 max=120 pattern=
        - block_ack_flood_thresh: min=1 max=65100 pattern=
        - pspoll_flood: pattern=
        - pspoll_flood_time: min=1 max=120 pattern=
        - pspoll_flood_thresh: min=1 max=65100 pattern=
        - netstumbler: pattern=
        - netstumbler_time: min=1 max=120 pattern=
        - netstumbler_thresh: min=1 max=65100 pattern=
        - wellenreiter: pattern=
        - wellenreiter_time: min=1 max=120 pattern=
        - wellenreiter_thresh: min=1 max=65100 pattern=
        - spoofed_deauth: pattern=
        - asleap_attack: pattern=
        - eapol_start_flood: pattern=
        - eapol_start_thresh: min=2 max=100 pattern=
        - eapol_start_intv: min=1 max=3600 pattern=
        - eapol_logoff_flood: pattern=
        - eapol_logoff_thresh: min=2 max=100 pattern=
        - eapol_logoff_intv: min=1 max=3600 pattern=
        - eapol_succ_flood: pattern=
        - eapol_succ_thresh: min=2 max=100 pattern=
        - eapol_succ_intv: min=1 max=3600 pattern=
        - eapol_fail_flood: pattern=
        - eapol_fail_thresh: min=2 max=100 pattern=
        - eapol_fail_intv: min=1 max=3600 pattern=
        - eapol_pre_succ_flood: pattern=
        - eapol_pre_succ_thresh: min=2 max=100 pattern=
        - eapol_pre_succ_intv: min=1 max=3600 pattern=
        - eapol_pre_fail_flood: pattern=
        - eapol_pre_fail_thresh: min=2 max=100 pattern=
        - eapol_pre_fail_intv: min=1 max=3600 pattern=
        - deauth_unknown_src_thresh: min=0 max=65535 pattern=
        - windows_bridge: pattern=
        - disassoc_broadcast: pattern=
        - ap_spoofing: pattern=
        - chan_based_mitm: pattern=
        - adhoc_valid_ssid: pattern=
        - adhoc_network: pattern=
        - eapol_key_overflow: pattern=
        - ap_impersonation: pattern=
        - invalid_addr_combination: pattern=
        - beacon_wrong_channel: pattern=
        - ht_greenfield: pattern=
        - overflow_ie: pattern=
        - malformed_ht_ie: pattern=
        - malformed_auth: pattern=
        - malformed_association: pattern=
        - ht_40mhz_intolerance: pattern=
        - valid_ssid_misuse: pattern=
        - valid_client_misassociation: pattern=
        - hotspotter_attack: pattern=
        - pwsave_dos_attack: pattern=
        - omerta_attack: pattern=
        - disconnect_station: pattern=
        - unencrypted_valid: pattern=
        - fata_jack: pattern=
        - risky_encryption: pattern=
        - fuzzed_beacon: pattern=
        - fuzzed_probe_request: pattern=
        - fuzzed_probe_response: pattern=
        - air_jack: pattern=
        - wpa_ft_attack: pattern=
    """
    ...
    ap_scan_channel_list_2G_5G: list[WidsProfileApScanChannelList2G5G] | None = Field(default=None, description="Selected ap scan channel list for 2.4G and 5G bands.")
    ap_scan_channel_list_6G: list[WidsProfileApScanChannelList6G] | None = Field(default=None, description="Selected ap scan channel list for 6G band.")
    ...
    ap_bgscan_disable_schedules: list[WidsProfileApBgscanDisableSchedules] | None = Field(default=None, description="Firewall schedules for turning off FortiAP radio background scan. Background scan will be disabled when at least one of the schedules is valid. Separate multiple schedule names with a space.")
...
WidsProfileModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:37.303948Z
# ============================================================================
