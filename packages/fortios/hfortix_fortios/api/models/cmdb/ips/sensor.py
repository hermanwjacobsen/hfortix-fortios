...
class SensorEntries(BaseModel):
    ...
    rule: list[dict[str, Any]] | None = Field(default=None, description="Identifies the predefined or custom IPS signatures to add to the sensor.")
    location: str | None = Field(default="all", description="Protect client or server traffic.")
    severity: str | None = Field(default="all", description="Relative severity of the signature, from info to critical. Log messages generated by the signature include the severity.")
    protocol: str | None = Field(default="all", description="Protocols to be examined. Use all for every protocol and other for unlisted protocols.")
    os: str | None = Field(default="all", description="Operating systems to be protected. Use all for every operating system and other for unlisted operating systems.")
    application: str | None = Field(default="all", description="Operating systems to be protected. Use all for every application and other for unlisted application.")
    ...
    cve: list[dict[str, Any]] | None = Field(default=None, description="List of CVE IDs of the signatures to add to the sensor.")
    vuln_type: list[dict[str, Any]] | None = Field(default=None, description="List of signature vulnerability types to filter by.")
    ...
    action: str | None = Field(default="default", description="Action taken with traffic in which signatures are detected.")
    ...
    exempt_ip: list[dict[str, Any]] | None = Field(default=None, description="Traffic from selected source or destination IP addresses is exempt from this signature.")
...
class SensorModel(BaseModel):
    ...
    entries: list[SensorEntries] | None = Field(default=None, description="IPS sensor filter.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:35.503348Z
# ============================================================================
