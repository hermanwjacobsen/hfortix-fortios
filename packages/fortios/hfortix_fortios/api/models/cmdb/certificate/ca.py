...
class CaModel(BaseModel):
    ...
    Validation Rules:
        ...
        - range_: pattern=
        - source: pattern=
        - ssl_inspection_trusted: pattern=
        - scep_url: max_length=255 pattern=
        - est_url: max_length=255 pattern=
        - auto_update_days: min=0 max=4294967295 pattern=
    ...
    range_: Literal["global", "vdom"] | None = Field(default="global", description="Either global or VDOM IP address range for the CA certificate.")
    ...
    details: list[CaDetails] | None = Field(default=None, description="Print CA certificate detailed information.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
CaModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:38.549215Z
# ============================================================================
