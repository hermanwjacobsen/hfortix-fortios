...
class LocalModel(BaseModel):
    ...
    Validation Rules:
        ...
        - scep_password: max_length=128 pattern=
        - ca_identifier: max_length=255 pattern=
        - name_encoding: pattern=
        - source_ip: pattern=
        - ike_localid: max_length=63 pattern=
        - ike_localid_type: pattern=
        - enroll_protocol: pattern=
        - private_key_retain: pattern=
        - cmp_server: max_length=63 pattern=
        - cmp_path: max_length=255 pattern=
        - cmp_server_cert: max_length=79 pattern=
        - cmp_regeneration_method: pattern=
        - acme_ca_url: max_length=255 pattern=
        - acme_domain: max_length=255 pattern=
        - acme_email: max_length=255 pattern=
        - acme_eab_key_id: max_length=255 pattern=
        - acme_eab_key_hmac: max_length=128 pattern=
        - acme_rsa_key_size: min=2048 max=4096 pattern=
        - acme_renew_window: min=1 max=60 pattern=
        - est_server: max_length=255 pattern=
        - est_ca_id: max_length=255 pattern=
        - est_http_username: max_length=63 pattern=
        - est_http_password: max_length=128 pattern=
        - est_client_cert: max_length=79 pattern=
        - est_server_cert: max_length=79 pattern=
        - est_srp_username: max_length=63 pattern=
        - est_srp_password: max_length=128 pattern=
        - est_regeneration_method: pattern=
        - details: pattern=
    """
    ...
    range_: Literal["global", "vdom"] | None = Field(default="global", description="Either a global or VDOM IP address range for the certificate.")
    ...
    enroll_protocol: str | LocalEnrollProtocolEnum | None = Field(default="none", description="Certificate enrollment protocol.")
    ...
    details: list[LocalDetails] | None = Field(default=None, description="Print local certificate detailed information.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
LocalModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:37.522678Z
# ============================================================================
