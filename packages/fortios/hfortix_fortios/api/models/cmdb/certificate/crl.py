...
class CrlModel(BaseModel):
    ...
    range_: Literal["global", "vdom"] | None = Field(default="global", description="Either global or VDOM IP address range for the certificate.")
...
CrlModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:38.771589Z
# ============================================================================
