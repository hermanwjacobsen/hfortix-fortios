...
class ProfileExemption(BaseModel):
    ...
    rule: list[dict[str, Any]] | None = Field(default=None, description="Patch signature rule IDs.")
    device: list[dict[str, Any]] | None = Field(default=None, description="Device MAC addresses.")
...
class ProfileModel(BaseModel):
    ...
    severity: str | ProfileSeverityEnum | None = Field(default=None, description="Relative severity of the signature (low, medium, high, critical).")
    ...
    exemption: list[ProfileExemption] | None = Field(default=None, description="Exempt devices or rules.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:38.245377Z
# ============================================================================
