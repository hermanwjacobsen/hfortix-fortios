...
class ForwardServerModel(BaseModel):
    ...
    Validation Rules:
        ...
        - masquerade: pattern=
        - healthcheck: pattern=
        - monitor: max_length=255 pattern=
        - server_down_option: pattern=
...
ForwardServerModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:35.901614Z
# ============================================================================
