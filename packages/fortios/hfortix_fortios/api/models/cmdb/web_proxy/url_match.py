...
class UrlMatchModel(BaseModel):
    ...
    Validation Rules:
        ...
        - status: pattern=
        - url_pattern: max_length=511 pattern=
        - forward_server: max_length=63 pattern=
        - fast_fallback: max_length=63 pattern=
        - cache_exemption: pattern=
...
UrlMatchModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:35.932282Z
# ============================================================================
