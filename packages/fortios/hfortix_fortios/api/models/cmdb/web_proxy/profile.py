...
class ProfileHeaders(BaseModel):
    ...
    dstaddr: list[dict[str, Any]] | None = Field(default=None, description="Destination address and address group names.")
    dstaddr6: list[dict[str, Any]] | None = Field(default=None, description="Destination address and address group names (IPv6).")
    action: str | None = Field(default="add-to-request", description="Configure adding, removing, or logging of the HTTP header entry in HTTP requests and responses.")
    ...
    add_option: str | None = Field(default="new", description="Configure options to append content to existing HTTP header or add new HTTP header.")
    protocol: Literal["https", "http"] | None = Field(default=None, description="Configure protocol(s) to take add-option action on (HTTP, HTTPS, or both).")
...
class ProfileModel(BaseModel):
    ...
    Validation Rules:
        ...
        - header_client_ip: pattern=
        - header_via_request: pattern=
        - header_via_response: pattern=
        - header_client_cert: pattern=
        - header_x_forwarded_for: pattern=
        - header_x_forwarded_client_cert: pattern=
        - header_front_end_https: pattern=
        - header_x_authenticated_user: pattern=
        - header_x_authenticated_groups: pattern=
        - strip_encoding: pattern=
        - log_header_change: pattern=
        - headers: pattern=
    """
    ...
    headers: list[ProfileHeaders] | None = Field(default=None, description="Configure HTTP forwarded requests headers.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:37.105505Z
# ============================================================================
