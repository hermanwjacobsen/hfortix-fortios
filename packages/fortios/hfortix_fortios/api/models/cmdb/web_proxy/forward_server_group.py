...
class ForwardServerGroupModel(BaseModel):
    ...
    server_list: list[ForwardServerGroupServerList] | None = Field(default=None, description="Add web forward servers to a list to form a server group. Optionally assign weights to each server.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
ForwardServerGroupModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:35.925508Z
# ============================================================================
