...
class SettingsModel(BaseModel):
    ...
    Validation Rules:
        ...
        - vdom_type: pattern=
        - lan_extension_controller_addr: max_length=255 pattern=
        - lan_extension_controller_port: min=1024 max=65535 pattern=
        - opmode: pattern=
        - ngfw_mode: pattern=
        - http_external_dest: pattern=
        ...
        - bfd_dont_enforce_src_port: pattern=
        - utf8_spam_tagging: pattern=
        - wccp_cache_engine: pattern=
        - vpn_stats_log: pattern=
        - vpn_stats_period: min=0 max=4294967295 pattern=
        - v4_ecmp_mode: pattern=
        - mac_ttl: min=300 max=8640000 pattern=
        - fw_session_hairpin: pattern=
        - prp_trailer_action: pattern=
        - snat_hairpin_traffic: pattern=
        - dhcp_proxy: pattern=
        - dhcp_proxy_interface_select_method: pattern=
        - dhcp_proxy_interface: max_length=15 pattern=
        - dhcp_proxy_vrf_select: min=0 max=511 pattern=
        - dhcp_server_ip: pattern=
        - dhcp6_server_ip: pattern=
        - central_nat: pattern=
        - gui_default_policy_columns: pattern=
        - lldp_reception: pattern=
        - lldp_transmission: pattern=
        - link_down_access: pattern=
        - nat46_generate_ipv6_fragment_header: pattern=
        - nat46_force_ipv4_packet_forwarding: pattern=
        - nat64_force_ipv6_packet_forwarding: pattern=
        - detect_unknown_esp: pattern=
        - intree_ses_best_route: pattern=
        - auxiliary_session: pattern=
        - asymroute: pattern=
        - asymroute_icmp: pattern=
        - tcp_session_without_syn: pattern=
        - ses_denied_traffic: pattern=
        - ses_denied_multicast_traffic: pattern=
        - strict_src_check: pattern=
        - allow_linkdown_path: pattern=
        - asymroute6: pattern=
        - asymroute6_icmp: pattern=
        - sctp_session_without_init: pattern=
        - sip_expectation: pattern=
        - sip_nat_trace: pattern=
        - h323_direct_model: pattern=
        - status: pattern=
        - sip_tcp_port: min=1 max=65535 pattern=
        - sip_udp_port: min=1 max=65535 pattern=
        - sip_ssl_port: min=0 max=65535 pattern=
        - sccp_port: min=0 max=65535 pattern=
        - multicast_forward: pattern=
        - multicast_ttl_notchange: pattern=
        - multicast_skip_policy: pattern=
        - allow_subnet_overlap: pattern=
        - deny_tcp_with_icmp: pattern=
        - ecmp_max_paths: min=1 max=255 pattern=
        - discovered_device_timeout: min=1 max=365 pattern=
        - email_portal_check_dns: pattern=
        - default_voip_alg_mode: pattern=
        - gui_icap: pattern=
        - gui_implicit_policy: pattern=
        - gui_dns_database: pattern=
        - gui_load_balance: pattern=
        - gui_multicast_policy: pattern=
        - gui_dos_policy: pattern=
        - gui_object_colors: pattern=
        - gui_route_tag_address_creation: pattern=
        - gui_voip_profile: pattern=
        - gui_ap_profile: pattern=
        - gui_security_profile_group: pattern=
        - gui_local_in_policy: pattern=
        - gui_wanopt_cache: pattern=
        - gui_explicit_proxy: pattern=
        - gui_dynamic_routing: pattern=
        - gui_sslvpn_personal_bookmarks: pattern=
        - gui_sslvpn_realms: pattern=
        - gui_policy_based_ipsec: pattern=
        - gui_threat_weight: pattern=
        - gui_spamfilter: pattern=
        - gui_file_filter: pattern=
        - gui_application_control: pattern=
        - gui_ips: pattern=
        - gui_dhcp_advanced: pattern=
        - gui_vpn: pattern=
        - gui_sslvpn: pattern=
        - gui_wireless_controller: pattern=
        - gui_advanced_wireless_features: pattern=
        - gui_switch_controller: pattern=
        - gui_fortiap_split_tunneling: pattern=
        - gui_webfilter_advanced: pattern=
        - gui_traffic_shaping: pattern=
        - gui_wan_load_balancing: pattern=
        - gui_antivirus: pattern=
        - gui_webfilter: pattern=
        - gui_videofilter: pattern=
        - gui_dnsfilter: pattern=
        - gui_waf_profile: pattern=
        - gui_dlp_profile: pattern=
        - gui_dlp_advanced: pattern=
        - gui_virtual_patch_profile: pattern=
        - gui_casb: pattern=
        - gui_fortiextender_controller: pattern=
        - gui_advanced_policy: pattern=
        - gui_allow_unnamed_policy: pattern=
        - gui_email_collection: pattern=
        - gui_multiple_interface_policy: pattern=
        - gui_policy_disclaimer: pattern=
        - gui_ztna: pattern=
        - gui_ot: pattern=
        - gui_dynamic_device_os_id: pattern=
        - gui_gtp: pattern=
        - location_id: pattern=
        - ike_session_resume: pattern=
        - ike_quick_crash_detect: pattern=
        - ike_dn_format: pattern=
        - ike_port: min=1024 max=65535 pattern=
        - ike_tcp_port: min=1 max=65535 pattern=
        - ike_policy_route: pattern=
        - ike_detailed_event_logs: pattern=
        - block_land_attack: pattern=
        - default_app_port_as_service: pattern=
        - fqdn_session_check: pattern=
        - ext_resource_session_check: pattern=
        - dyn_addr_session_check: pattern=
        - default_policy_expiry_days: min=0 max=365 pattern=
        - gui_enforce_change_summary: pattern=
        - internet_service_database_cache: pattern=
        - internet_service_app_ctrl_size: min=0 max=4294967295 pattern=
    """
    ...
    vpn_stats_log: str | SettingsVpnStatsLogEnum | None = Field(default=None, description="Enable/disable periodic VPN log statistics for one or more types of VPN. Separate names with a space.")
    ...
    v4_ecmp_mode: str | SettingsV4EcmpModeEnum | None = Field(default="source-ip-based", description="IPv4 Equal-cost multi-path (ECMP) routing and load balancing mode.")
    ...
    dhcp_server_ip: str | None = Field(default="", description="DHCP Server IPv4 address.")
    dhcp6_server_ip: str | None = Field(default="", description="DHCPv6 server IPv6 address.")
    central_nat: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable central NAT.")
    gui_default_policy_columns: list[SettingsGuiDefaultPolicyColumns] | None = Field(default=None, description="Default columns to display for policy lists on GUI.")
    ...
    sip_tcp_port: int | None = Field(ge=1, le=65535, default=5060, description="TCP port the SIP proxy monitors for SIP traffic (0 - 65535, default = 5060).")
    sip_udp_port: int | None = Field(ge=1, le=65535, default=5060, description="UDP port the SIP proxy monitors for SIP traffic (0 - 65535, default = 5060).")
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:37.038484Z
# ============================================================================
