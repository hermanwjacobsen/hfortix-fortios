...
class CloudServiceModel(BaseModel):
    ...
    Validation Rules:
        ...
        - vendor: pattern=
        - traffic_vdom: max_length=31 pattern=
        - gck_service_account: max_length=285 pattern=
        - gck_private_key: max_length=8191 pattern=
        - gck_keyid: max_length=127 pattern=
        - gck_access_token_lifetime: min=1 max=3600 pattern=
    """
...
CloudServiceModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:37.846063Z
# ============================================================================
