...
class SshConfigModel(BaseModel):
    ...
    Validation Rules:
        - ssh_kex_algo: pattern=
        - ssh_enc_algo: pattern=
        - ssh_mac_algo: pattern=
        - ssh_hsk_algo: pattern=
        - ssh_hsk_override: pattern=
        - ssh_hsk_password: max_length=128 pattern=
        - ssh_hsk: pattern=
    """
    ...
    # Model Fields
    # ========================================================================
    ssh_kex_algo: str | SshConfigSshKexAlgoEnum | None = Field(default=None, description="Select one or more SSH kex algorithms.")
    ssh_enc_algo: str | SshConfigSshEncAlgoEnum | None = Field(default=None, description="Select one or more SSH ciphers.")
    ssh_mac_algo: str | SshConfigSshMacAlgoEnum | None = Field(default=None, description="Select one or more SSH MAC algorithms.")
    ssh_hsk_algo: str | SshConfigSshHskAlgoEnum | None = Field(default=None, description="Select one or more SSH hostkey algorithms.")
...
SshConfigModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:35.837699Z
# ============================================================================
