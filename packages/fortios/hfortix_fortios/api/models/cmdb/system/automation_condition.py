...
class AutomationConditionModel(BaseModel):
    ...
    Validation Rules:
        ...
        - cpu_usage_percent: min=0 max=100 pattern=
        - mem_usage_percent: min=0 max=100 pattern=
        - vdom: max_length=31 pattern=
        - vpn_tunnel_name: max_length=79 pattern=
        - vpn_tunnel_state: pattern=
    """
...
AutomationConditionModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:38.889274Z
# ============================================================================
