...
class PasswordPolicyGuestAdminModel(BaseModel):
    ...
    apply_to: Literal["guest-admin-password"] | None = Field(default="guest-admin-password", description="Guest administrator to which this password policy applies.")
...
PasswordPolicyGuestAdminModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:39.358799Z
# ============================================================================
