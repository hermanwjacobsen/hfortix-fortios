...
class IpsecAggregateModel(BaseModel):
    ...
    member: list[IpsecAggregateMember] | None = Field(description="Member tunnels of the aggregate.")
    algorithm: str | IpsecAggregateAlgorithmEnum | None = Field(default="round-robin", description="Frame distribution algorithm.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
IpsecAggregateModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:35.051634Z
# ============================================================================
