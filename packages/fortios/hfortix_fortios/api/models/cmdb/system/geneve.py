...
class GeneveModel(BaseModel):
    ...
    Validation Rules:
        ...
        - vni: min=0 max=16777215 pattern=
        - type_: pattern=
        - ip_version: pattern=
        - remote_ip: pattern=
        - remote_ip6: pattern=
    ...
    type_: Literal["ethernet", "ppp"] = Field(default="ethernet", description="GENEVE type.")
...
GeneveModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:36.664231Z
# ============================================================================
