...
class ZoneModel(BaseModel):
    ...
    tagging: list[ZoneTagging] | None = Field(default=None, description="Config object tagging.")
    ...
    interface: list[ZoneInterface] | None = Field(default=None, description="Add interfaces to this zone. Interfaces must not be assigned to another zone or have firewall policies defined.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
ZoneModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:38.299279Z
# ============================================================================
