...
class GlobalModel(BaseModel):
    ...
    Validation Rules:
        - language: pattern=
        - gui_ipv6: pattern=
        - gui_replacement_message_groups: pattern=
        - gui_local_out: pattern=
        - gui_certificates: pattern=
        - gui_custom_language: pattern=
        - gui_wireless_opensecurity: pattern=
        - gui_app_detection_sdwan: pattern=
        - gui_display_hostname: pattern=
        - gui_fortigate_cloud_sandbox: pattern=
        - gui_firmware_upgrade_warning: pattern=
        - gui_forticare_registration_setup_warning: pattern=
        - gui_auto_upgrade_setup_warning: pattern=
        - gui_workflow_management: pattern=
        - gui_cdn_usage: pattern=
        - admin_https_ssl_versions: pattern=
        - admin_https_ssl_ciphersuites: pattern=
        - admin_https_ssl_banned_ciphers: pattern=
        - admintimeout: min=1 max=480 pattern=
        - admin_console_timeout: min=15 max=300 pattern=
        - ssd_trim_freq: pattern=
        - ssd_trim_hour: min=0 max=23 pattern=
        - ssd_trim_min: min=0 max=60 pattern=
        - ssd_trim_weekday: pattern=
        - ssd_trim_date: min=1 max=31 pattern=
        - admin_concurrent: pattern=
        - admin_lockout_threshold: min=1 max=10 pattern=
        - admin_lockout_duration: min=1 max=2147483647 pattern=
        - refresh: min=0 max=4294967295 pattern=
        - interval: min=0 max=4294967295 pattern=
        - failtime: min=0 max=4294967295 pattern=
        - purdue_level: pattern=
        - daily_restart: pattern=
        - restart_time: pattern=
        - wad_restart_mode: pattern=
        - wad_restart_start_time: pattern=
        - wad_restart_end_time: pattern=
        - wad_p2s_max_body_size: min=1 max=32 pattern=
        - radius_port: min=1 max=65535 pattern=
        - speedtestd_server_port: min=1 max=65535 pattern=
        - speedtestd_ctrl_port: min=1 max=65535 pattern=
        - admin_login_max: min=1 max=100 pattern=
        - remoteauthtimeout: min=1 max=300 pattern=
        - ldapconntimeout: min=1 max=300000 pattern=
        - batch_cmdb: pattern=
        - multi_factor_authentication: pattern=
        - ssl_min_proto_version: pattern=
        - autorun_log_fsck: pattern=
        - timezone: max_length=63 pattern=
        - traffic_priority: pattern=
        - traffic_priority_level: pattern=
        - quic_congestion_control_algo: pattern=
        - quic_max_datagram_size: min=1200 max=1500 pattern=
        - quic_udp_payload_size_shaping_per_cid: pattern=
        - quic_ack_thresold: min=2 max=5 pattern=
        - quic_pmtud: pattern=
        - quic_tls_handshake_timeout: min=1 max=60 pattern=
        - anti_replay: pattern=
        - send_pmtu_icmp: pattern=
        - honor_df: pattern=
        - pmtu_discovery: pattern=
        - revision_image_auto_backup: pattern=
        - revision_backup_on_logout: pattern=
        - management_vdom: max_length=31 pattern=
        - hostname: max_length=35 pattern=
        - alias: max_length=35 pattern=
        - strong_crypto: pattern=
        - ssl_static_key_ciphers: pattern=
        - snat_route_change: pattern=
        - ipv6_snat_route_change: pattern=
        - speedtest_server: pattern=
        - cli_audit_log: pattern=
        - dh_params: pattern=
        - fds_statistics: pattern=
        - fds_statistics_period: min=1 max=1440 pattern=
        - tcp_option: pattern=
        - lldp_transmission: pattern=
        - lldp_reception: pattern=
        - proxy_auth_timeout: min=1 max=10000 pattern=
        - proxy_keep_alive_mode: pattern=
        - proxy_re_authentication_time: min=1 max=86400 pattern=
        - proxy_auth_lifetime: pattern=
        - proxy_auth_lifetime_timeout: min=5 max=65535 pattern=
        - proxy_resource_mode: pattern=
        - proxy_cert_use_mgmt_vdom: pattern=
        - sys_perf_log_interval: min=0 max=15 pattern=
        - check_protocol_header: pattern=
        - vip_arp_range: pattern=
        - reset_sessionless_tcp: pattern=
        - allow_traffic_redirect: pattern=
        - ipv6_allow_traffic_redirect: pattern=
        - strict_dirty_session_check: pattern=
        - tcp_halfclose_timer: min=1 max=86400 pattern=
        - tcp_halfopen_timer: min=1 max=86400 pattern=
        - tcp_timewait_timer: min=0 max=300 pattern=
        - tcp_rst_timer: min=5 max=300 pattern=
        - udp_idle_timer: min=1 max=86400 pattern=
        - block_session_timer: min=1 max=300 pattern=
        - ip_src_port_range: pattern=
        - pre_login_banner: pattern=
        - post_login_banner: pattern=
        - tftp: pattern=
        - av_failopen: pattern=
        - av_failopen_session: pattern=
        - memory_use_threshold_extreme: min=70 max=97 pattern=
        - memory_use_threshold_red: min=70 max=97 pattern=
        - memory_use_threshold_green: min=70 max=97 pattern=
        - ip_fragment_mem_thresholds: min=32 max=2047 pattern=
        - ip_fragment_timeout: min=3 max=30 pattern=
        - ipv6_fragment_timeout: min=5 max=60 pattern=
        - cpu_use_threshold: min=50 max=99 pattern=
        - log_single_cpu_high: pattern=
        - check_reset_range: pattern=
        - upgrade_report: pattern=
        - admin_port: min=1 max=65535 pattern=
        - admin_sport: min=1 max=65535 pattern=
        - admin_host: max_length=255 pattern=
        - admin_https_redirect: pattern=
        - admin_hsts_max_age: min=0 max=2147483647 pattern=
        - admin_ssh_password: pattern=
        - admin_restrict_local: pattern=
        - admin_ssh_port: min=1 max=65535 pattern=
        - admin_ssh_grace_time: min=10 max=3600 pattern=
        - admin_ssh_v1: pattern=
        - admin_telnet: pattern=
        - admin_telnet_port: min=1 max=65535 pattern=
        - admin_forticloud_sso_login: pattern=
        - admin_forticloud_sso_default_profile: max_length=35 pattern=
        - default_service_source_port: pattern=
        - admin_server_cert: max_length=35 pattern=
        - admin_https_pki_required: pattern=
        - wifi_certificate: max_length=35 pattern=
        - dhcp_lease_backup_interval: min=10 max=3600 pattern=
        - wifi_ca_certificate: max_length=79 pattern=
        - auth_http_port: min=1 max=65535 pattern=
        - auth_https_port: min=1 max=65535 pattern=
        - auth_ike_saml_port: min=0 max=65535 pattern=
        - auth_keepalive: pattern=
        - policy_auth_concurrent: min=0 max=100 pattern=
        - auth_session_limit: pattern=
        - auth_cert: max_length=35 pattern=
        - clt_cert_req: pattern=
        - fortiservice_port: min=1 max=65535 pattern=
        - cfg_save: pattern=
        - cfg_revert_timeout: min=10 max=4294967295 pattern=
        - reboot_upon_config_restore: pattern=
        - admin_scp: pattern=
        - wireless_controller: pattern=
        - wireless_controller_port: min=1024 max=49150 pattern=
        - fortiextender_data_port: min=1024 max=49150 pattern=
        - fortiextender: pattern=
        - extender_controller_reserved_network: pattern=
        - fortiextender_discovery_lockdown: pattern=
        - fortiextender_vlan_mode: pattern=
        - fortiextender_provision_on_authorization: pattern=
        - switch_controller: pattern=
        - switch_controller_reserved_network: pattern=
        - dnsproxy_worker_count: min=1 max=2 pattern=
        - url_filter_count: min=1 max=1 pattern=
        - httpd_max_worker_count: min=0 max=128 pattern=
        - proxy_worker_count: min=1 max=2 pattern=
        - scanunit_count: min=2 max=2 pattern=
        - fgd_alert_subscription: pattern=
        - ipv6_accept_dad: min=0 max=2 pattern=
        - ipv6_allow_anycast_probe: pattern=
        - ipv6_allow_multicast_probe: pattern=
        - ipv6_allow_local_in_silent_drop: pattern=
        - csr_ca_attribute: pattern=
        - wimax_4g_usb: pattern=
        - cert_chain_max: min=1 max=2147483647 pattern=
        - sslvpn_max_worker_count: min=0 max=1 pattern=
        - sslvpn_affinity: max_length=79 pattern=
        - sslvpn_web_mode: pattern=
        - two_factor_ftk_expiry: min=60 max=600 pattern=
        - two_factor_email_expiry: min=30 max=300 pattern=
        - two_factor_sms_expiry: min=30 max=300 pattern=
        - two_factor_fac_expiry: min=10 max=3600 pattern=
        - two_factor_ftm_expiry: min=1 max=168 pattern=
        - per_user_bal: pattern=
        - wad_worker_count: min=0 max=2 pattern=
        - wad_worker_dev_cache: min=0 max=10240 pattern=
        - wad_csvc_cs_count: min=1 max=1 pattern=
        - wad_csvc_db_count: min=0 max=2 pattern=
        - wad_source_affinity: pattern=
        - wad_memory_change_granularity: min=5 max=25 pattern=
        - login_timestamp: pattern=
        - ip_conflict_detection: pattern=
        - miglogd_children: min=0 max=15 pattern=
        - log_daemon_cpu_threshold: min=0 max=99 pattern=
        - special_file_23_support: pattern=
        - log_uuid_address: pattern=
        - log_ssl_connection: pattern=
        - gui_rest_api_cache: pattern=
        - rest_api_key_url_query: pattern=
        - arp_max_entry: min=131072 max=2147483647 pattern=
        - ha_affinity: max_length=79 pattern=
        - bfd_affinity: max_length=79 pattern=
        - cmdbsvr_affinity: max_length=79 pattern=
        - av_affinity: max_length=79 pattern=
        - wad_affinity: max_length=79 pattern=
        - ips_affinity: max_length=79 pattern=
        - miglog_affinity: max_length=79 pattern=
        - syslog_affinity: max_length=79 pattern=
        - url_filter_affinity: max_length=79 pattern=
        - router_affinity: max_length=79 pattern=
        - ndp_max_entry: min=65536 max=2147483647 pattern=
        - br_fdb_max_entry: min=8192 max=2147483647 pattern=
        - max_route_cache_size: min=0 max=2147483647 pattern=
        - ipsec_qat_offload: pattern=
        - device_idle_timeout: min=30 max=31536000 pattern=
        - user_device_store_max_devices: min=31262 max=89320 pattern=
        - user_device_store_max_device_mem: min=1 max=5 pattern=
        - user_device_store_max_users: min=31262 max=89320 pattern=
        - user_device_store_max_unified_mem: min=62524334 max=625243340 pattern=
        - gui_device_latitude: max_length=19 pattern=
        - gui_device_longitude: max_length=19 pattern=
        - private_data_encryption: pattern=
        - auto_auth_extension_device: pattern=
        - gui_theme: pattern=
        - gui_date_format: pattern=
        - gui_date_time_source: pattern=
        - igmp_state_limit: min=96 max=128000 pattern=
        - cloud_communication: pattern=
        - ipsec_ha_seqjump_rate: min=1 max=10 pattern=
        - fortitoken_cloud: pattern=
        - fortitoken_cloud_push_status: pattern=
        - fortitoken_cloud_region: max_length=63 pattern=
        - fortitoken_cloud_sync_interval: min=0 max=336 pattern=
        - faz_disk_buffer_size: pattern=
        - irq_time_accounting: pattern=
        - management_ip: max_length=255 pattern=
        - management_port: min=1 max=65535 pattern=
        - management_port_use_admin_sport: pattern=
        - forticonverter_integration: pattern=
        - forticonverter_config_upload: pattern=
        - internet_service_database: pattern=
        - internet_service_download_list: pattern=
        - geoip_full_db: pattern=
        - early_tcp_npu_session: pattern=
        - npu_neighbor_update: pattern=
        - delay_tcp_npu_session: pattern=
        - interface_subnet_usage: pattern=
        - sflowd_max_children_num: min=0 max=1 pattern=
        - fortigslb_integration: pattern=
        - user_history_password_threshold: min=3 max=15 pattern=
        - auth_session_auto_backup: pattern=
        - auth_session_auto_backup_interval: pattern=
        - scim_https_port: min=0 max=65535 pattern=
        - scim_http_port: min=0 max=65535 pattern=
        - scim_server_cert: max_length=35 pattern=
        - application_bandwidth_tracking: pattern=
        - tls_session_cache: pattern=
    """
    ...
    # Model Fields
    # ========================================================================
    language: str | GlobalLanguageEnum | None = Field(default="english", description="GUI display language.")
    ...
    admin_https_ssl_versions: Literal["tlsv1-1", "tlsv1-2", "tlsv1-3"] | None = Field(default=None, description="Allowed TLS versions for web administration.")
    admin_https_ssl_ciphersuites: str | GlobalAdminHttpsSslCiphersuitesEnum | None = Field(default=None, description="Select one or more TLS 1.3 ciphersuites to enable. Does not affect ciphers in TLS 1.2 and below. At least one must be enabled. To disable all, remove TLS1.3 from admin-https-ssl-versions.")
    admin_https_ssl_banned_ciphers: str | GlobalAdminHttpsSslBannedCiphersEnum | None = Field(default=None, description="Select one or more cipher technologies that cannot be used in GUI HTTPS negotiations. Only applies to TLS 1.2 and below.")
    ...
    ssd_trim_freq: str | GlobalSsdTrimFreqEnum | None = Field(default="weekly", description="How often to run SSD Trim (default = weekly). SSD Trim prevents SSD drive data loss by finding and isolating errors.")
    ...
    ssd_trim_weekday: str | GlobalSsdTrimWeekdayEnum | None = Field(default="sunday", description="Day of week to run SSD Trim.")
    ...
    purdue_level: str | GlobalPurdueLevelEnum | None = Field(default="3", description="Purdue Level of this FortiGate.")
    ...
    ssl_min_proto_version: str | GlobalSslMinProtoVersionEnum | None = Field(default="TLSv1-2", description="Minimum supported protocol version for SSL/TLS connections (default = TLSv1.2).")
    ...
    quic_congestion_control_algo: str | GlobalQuicCongestionControlAlgoEnum | None = Field(default="cubic", description="QUIC congestion control algorithm (default = cubic).")
    ...
    dh_params: str | GlobalDhParamsEnum | None = Field(default="2048", description="Number of bits to use in the Diffie-Hellman exchange for HTTPS/SSH protocols.")
    ...
    fgd_alert_subscription: str | GlobalFgdAlertSubscriptionEnum | None = Field(default=None, description="Type of alert to retrieve from FortiGuard.")
    ...
    gui_theme: str | GlobalGuiThemeEnum | None = Field(default="jade", description="Color scheme for the administration GUI.")
    gui_date_format: str | GlobalGuiDateFormatEnum | None = Field(default="yyyy/MM/dd", description="Default date format used throughout GUI.")
    ...
    internet_service_database: str | GlobalInternetServiceDatabaseEnum | None = Field(default="full", description="Configure which Internet Service database size to download from FortiGuard and use.")
    internet_service_download_list: list[GlobalInternetServiceDownloadList] | None = Field(default=None, description="Configure which on-demand Internet Service IDs are to be downloaded.")
    ...
    auth_session_auto_backup_interval: str | GlobalAuthSessionAutoBackupIntervalEnum | None = Field(default="15min", description="Configure automatic authentication session backup interval (default = 15min).")
...
GlobalModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:40.232543Z
# ============================================================================
