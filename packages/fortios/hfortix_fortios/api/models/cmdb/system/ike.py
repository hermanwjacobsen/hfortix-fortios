...
class IkeModel(BaseModel):
    ...
    dh_group_1: list[IkeDhGroup1] = Field(default_factory=list, description="Diffie-Hellman group 1 (MODP-768).")    
    dh_group_2: list[IkeDhGroup2] = Field(default_factory=list, description="Diffie-Hellman group 2 (MODP-1024).")    
    dh_group_5: list[IkeDhGroup5] = Field(default_factory=list, description="Diffie-Hellman group 5 (MODP-1536).")    
    dh_group_14: list[IkeDhGroup14] = Field(default_factory=list, description="Diffie-Hellman group 14 (MODP-2048).")    
    dh_group_15: list[IkeDhGroup15] = Field(default_factory=list, description="Diffie-Hellman group 15 (MODP-3072).")    
    dh_group_16: list[IkeDhGroup16] = Field(default_factory=list, description="Diffie-Hellman group 16 (MODP-4096).")    
    dh_group_17: list[IkeDhGroup17] = Field(default_factory=list, description="Diffie-Hellman group 17 (MODP-6144).")    
    dh_group_18: list[IkeDhGroup18] = Field(default_factory=list, description="Diffie-Hellman group 18 (MODP-8192).")    
    dh_group_19: list[IkeDhGroup19] = Field(default_factory=list, description="Diffie-Hellman group 19 (EC-P256).")    
    dh_group_20: list[IkeDhGroup20] = Field(default_factory=list, description="Diffie-Hellman group 20 (EC-P384).")    
    dh_group_21: list[IkeDhGroup21] = Field(default_factory=list, description="Diffie-Hellman group 21 (EC-P521).")    
    dh_group_27: list[IkeDhGroup27] = Field(default_factory=list, description="Diffie-Hellman group 27 (EC-P224BP).")    
    dh_group_28: list[IkeDhGroup28] = Field(default_factory=list, description="Diffie-Hellman group 28 (EC-P256BP).")    
    dh_group_29: list[IkeDhGroup29] = Field(default_factory=list, description="Diffie-Hellman group 29 (EC-P384BP).")    
    dh_group_30: list[IkeDhGroup30] = Field(default_factory=list, description="Diffie-Hellman group 30 (EC-P512BP).")    
    dh_group_31: list[IkeDhGroup31] = Field(default_factory=list, description="Diffie-Hellman group 31 (EC-X25519).")    
    dh_group_32: list[IkeDhGroup32] = Field(default_factory=list, description="Diffie-Hellman group 32 (EC-X448).")    
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.1
# Generated: 2026-01-18T20:31:27.208141Z
# ============================================================================