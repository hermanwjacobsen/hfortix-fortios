...
class DnsServerModel(BaseModel):
    ...
    mode: str | DnsServerModeEnum | None = Field(default="recursive", description="DNS server mode.")
...
DnsServerModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:40.339471Z
# ============================================================================
