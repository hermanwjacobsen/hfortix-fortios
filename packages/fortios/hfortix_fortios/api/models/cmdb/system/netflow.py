...
class NetflowModel(BaseModel):
    ...
    Validation Rules:
        - active_flow_timeout: min=60 max=3600 pattern=
        - inactive_flow_timeout: min=10 max=600 pattern=
        - template_tx_timeout: min=60 max=86400 pattern=
        - template_tx_counter: min=10 max=6000 pattern=
        - session_cache_size: pattern=
        - exclusion_filters: pattern=
        - collectors: pattern=
    """
    ...
    exclusion_filters: list[NetflowExclusionFilters] | None = Field(default=None, description="Exclusion filters")
    collectors: list[NetflowCollectors] | None = Field(default=None, description="Netflow collectors.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
NetflowModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:35.589506Z
# ============================================================================
