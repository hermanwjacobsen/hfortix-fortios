...
class NetworkPolicyModel(BaseModel):
    ...
    Validation Rules:
        ...
        - voice: pattern=
        - voice_signaling: pattern=
        - guest: pattern=
        - guest_voice_signaling: pattern=
        - softphone: pattern=
        - video_conferencing: pattern=
        - streaming_video: pattern=
        - video_signaling: pattern=
    """
    ...
    voice: list[NetworkPolicyVoice] | None = Field(default=None, description="Voice.")
    voice_signaling: list[NetworkPolicyVoiceSignaling] | None = Field(default=None, description="Voice signaling.")
    guest: list[NetworkPolicyGuest] | None = Field(default=None, description="Guest.")
    guest_voice_signaling: list[NetworkPolicyGuestVoiceSignaling] | None = Field(default=None, description="Guest Voice Signaling.")
    softphone: list[NetworkPolicySoftphone] | None = Field(default=None, description="Softphone.")
    video_conferencing: list[NetworkPolicyVideoConferencing] | None = Field(default=None, description="Video Conferencing.")
    streaming_video: list[NetworkPolicyStreamingVideo] | None = Field(default=None, description="Streaming Video.")
    video_signaling: list[NetworkPolicyVideoSignaling] | None = Field(default=None, description="Video Signaling.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
NetworkPolicyModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:39.910071Z
# ============================================================================
