...
class NetworkPolicyModel(BaseModel):
    ...
    voice: list[NetworkPolicyVoice] = Field(default_factory=list, description="Voice.")    
    voice_signaling: list[NetworkPolicyVoiceSignaling] = Field(default_factory=list, description="Voice signaling.")    
    guest: list[NetworkPolicyGuest] = Field(default_factory=list, description="Guest.")    
    guest_voice_signaling: list[NetworkPolicyGuestVoiceSignaling] = Field(default_factory=list, description="Guest Voice Signaling.")    
    softphone: list[NetworkPolicySoftphone] = Field(default_factory=list, description="Softphone.")    
    video_conferencing: list[NetworkPolicyVideoConferencing] = Field(default_factory=list, description="Video Conferencing.")    
    streaming_video: list[NetworkPolicyStreamingVideo] = Field(default_factory=list, description="Streaming Video.")    
    video_signaling: list[NetworkPolicyVideoSignaling] = Field(default_factory=list, description="Video Signaling.")    
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-17T17:56:14.077650Z
# ============================================================================