...
class FortiguardModel(BaseModel):
    ...
    Validation Rules:
        - fortiguard_anycast: pattern=
        - fortiguard_anycast_source: pattern=
        - protocol: pattern=
        - port: pattern=
        - load_balance_servers: min=1 max=266 pattern=
        - auto_join_forticloud: pattern=
        - update_server_location: pattern=
        - sandbox_region: max_length=63 pattern=
        - sandbox_inline_scan: pattern=
        - update_ffdb: pattern=
        - update_uwdb: pattern=
        - update_dldb: pattern=
        - update_extdb: pattern=
        - update_build_proxy: pattern=
        - persistent_connection: pattern=
        - vdom: max_length=31 pattern=
        - auto_firmware_upgrade: pattern=
        - auto_firmware_upgrade_day: pattern=
        - auto_firmware_upgrade_delay: min=0 max=14 pattern=
        - auto_firmware_upgrade_start_hour: min=0 max=23 pattern=
        - auto_firmware_upgrade_end_hour: min=0 max=23 pattern=
        - FDS_license_expiring_days: min=1 max=100 pattern=
        - subscribe_update_notification: pattern=
        - antispam_force_off: pattern=
        - antispam_cache: pattern=
        - antispam_cache_ttl: min=300 max=86400 pattern=
        - antispam_cache_mpermille: min=1 max=150 pattern=
        - antispam_license: min=0 max=4294967295 pattern=
        - antispam_expiration: min=0 max=4294967295 pattern=
        - antispam_timeout: min=1 max=30 pattern=
        - outbreak_prevention_force_off: pattern=
        - outbreak_prevention_cache: pattern=
        - outbreak_prevention_cache_ttl: min=300 max=86400 pattern=
        - outbreak_prevention_cache_mpermille: min=1 max=150 pattern=
        - outbreak_prevention_license: min=0 max=4294967295 pattern=
        - outbreak_prevention_expiration: min=0 max=4294967295 pattern=
        - outbreak_prevention_timeout: min=1 max=30 pattern=
        - webfilter_force_off: pattern=
        - webfilter_cache: pattern=
        - webfilter_cache_ttl: min=300 max=86400 pattern=
        - webfilter_license: min=0 max=4294967295 pattern=
        - webfilter_expiration: min=0 max=4294967295 pattern=
        - webfilter_timeout: min=1 max=30 pattern=
        - sdns_server_ip: pattern=
        - sdns_server_port: min=1 max=65535 pattern=
        - anycast_sdns_server_ip: pattern=
        - anycast_sdns_server_port: min=1 max=65535 pattern=
        - sdns_options: pattern=
        - source_ip: pattern=
        - source_ip6: pattern=
        - proxy_server_ip: max_length=63 pattern=
        - proxy_server_port: min=0 max=65535 pattern=
        - proxy_username: max_length=64 pattern=
        - proxy_password: max_length=128 pattern=
        - ddns_server_ip: pattern=
        - ddns_server_ip6: pattern=
        - ddns_server_port: min=1 max=65535 pattern=
    ...
    port: str | FortiguardPortEnum | None = Field(default="443", description="Port used to communicate with the FortiGuard servers.")
    ...
    auto_firmware_upgrade_day: str | FortiguardAutoFirmwareUpgradeDayEnum | None = Field(default=None, description="Allowed day(s) of the week to install an automatic patch-level firmware upgrade from FortiGuard (default is none). Disallow any day of the week to use auto-firmware-upgrade-delay instead, which waits for designated days before installing an automatic patch-level firmware upgrade.")
    ...
    sdns_server_ip: str | None = Field(default="", description="IP address of the FortiGuard DNS rating server.")
    ...
    sdns_options: Literal["include-question-section"] | None = Field(default=None, description="Customization options for the FortiGuard DNS service.")
...
FortiguardModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:37.245161Z
# ============================================================================
