...
class AdminModel(BaseModel):
    ...
    Validation Rules:
        ...
        - vdom: pattern=
        - remote_auth: pattern=
        - remote_group: max_length=35 pattern=
        - wildcard: pattern=
        ...
        - trusthost9: pattern=
        - trusthost10: pattern=
        - ip6_trusthost1: pattern=
        - ip6_trusthost2: pattern=
        - ip6_trusthost3: pattern=
        - ip6_trusthost4: pattern=
        - ip6_trusthost5: pattern=
        - ip6_trusthost6: pattern=
        - ip6_trusthost7: pattern=
        - ip6_trusthost8: pattern=
        - ip6_trusthost9: pattern=
        - ip6_trusthost10: pattern=
        - accprofile: max_length=35 pattern=
        - allow_remove_admin_session: pattern=
        - comments: max_length=255 pattern=
        - ssh_public_key1: pattern=
        - ssh_public_key2: pattern=
        - ssh_public_key3: pattern=
        - ssh_certificate: max_length=35 pattern=
        - schedule: max_length=35 pattern=
        - accprofile_override: pattern=
        - vdom_override: pattern=
        - password_expire: pattern=
        - force_password_change: pattern=
        - two_factor: pattern=
        ...
        - guest_auth: pattern=
        - guest_usergroups: pattern=
        - guest_lang: max_length=35 pattern=
        - status: pattern=
        - list_: pattern=
    """
    ...
    vdom: list[AdminVdom] | None = Field(default=None, description="Virtual domain(s) that the administrator can access.")
    ...
    two_factor: str | AdminTwoFactorEnum | None = Field(default="disable", description="Enable/disable two-factor authentication.")
    ...
    guest_usergroups: list[AdminGuestUsergroups] | None = Field(default=None, description="Select guest user groups.")
    ...
    list_: Any = Field(default=None, description="print admin list information")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
AdminModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:35.011349Z
# ============================================================================
