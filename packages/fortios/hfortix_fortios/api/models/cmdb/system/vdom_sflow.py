...
class VdomSflowModel(BaseModel):
    ...
    collectors: list[VdomSflowCollectors] | None = Field(default=None, description="sFlow collectors.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
VdomSflowModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:37.110697Z
# ============================================================================
