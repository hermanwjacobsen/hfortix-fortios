...
class AlarmGroups(BaseModel):
    ...
    fw_policy_violations: list[dict[str, Any]] | None = Field(default=None, description="Firewall policy violations.")
...
class AlarmModel(BaseModel):
    ...
    groups: list[AlarmGroups] | None = Field(default=None, description="Alarm groups.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
AlarmModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:38.759556Z
# ============================================================================
