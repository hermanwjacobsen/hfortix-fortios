...
class AcmeModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    interface: list[AcmeInterface] | None = Field(default=None, description="Interface(s) on which the ACME client will listen for challenges.")
    ...
    accounts: list[AcmeAccounts] | None = Field(default=None, description="ACME accounts list.")
...
AcmeModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:38.378784Z
# ============================================================================
