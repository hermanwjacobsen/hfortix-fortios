...
class PasswordPolicyModel(BaseModel):
    ...
    Validation Rules:
        - status: pattern=
        - apply_to: pattern=
        - minimum_length: min=12 max=128 pattern=
        - min_lower_case_letter: min=0 max=128 pattern=
        - min_upper_case_letter: min=0 max=128 pattern=
        - min_non_alphanumeric: min=0 max=128 pattern=
        - min_number: min=0 max=128 pattern=
        - expire_status: pattern=
        - expire_day: min=1 max=999 pattern=
        - reuse_password: pattern=
        - reuse_password_limit: min=0 max=20 pattern=
        - login_lockout_upon_weaker_encryption: pattern=
    """
    ...
    apply_to: Literal["admin-password", "ipsec-preshared-key"] | None = Field(default="admin-password", description="Apply password policy to administrator passwords or IPsec pre-shared keys or both. Separate entries with a space.")
...
PasswordPolicyModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:38.597510Z
# ============================================================================
