...
class SdnVpnModel(BaseModel):
    ...
    Validation Rules:
        ...
        - remote_type: pattern=
        - routing_type: pattern=
        - vgw_id: max_length=63 pattern=
        - tgw_id: max_length=63 pattern=
        - subnet_id: max_length=63 pattern=
        - bgp_as: min=1 max=4294967295 pattern=
        - cgw_gateway: pattern=
        - nat_traversal: pattern=
        - tunnel_interface: max_length=15 pattern=
        - internal_interface: max_length=15 pattern=
        - local_cidr: pattern=
        - remote_cidr: pattern=
        - cgw_name: max_length=35 pattern=
        - psksecret: pattern=
        - type_: min=0 max=65535 pattern=
        - status: min=0 max=255 pattern=
        - code: min=0 max=255 pattern=
    """
    ...
    type_: int | None = Field(ge=0, le=65535, default=0, description="SDN VPN type.")
...
SdnVpnModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:40.313009Z
# ============================================================================
