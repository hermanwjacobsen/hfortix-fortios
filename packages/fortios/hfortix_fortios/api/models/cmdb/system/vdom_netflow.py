...
class VdomNetflowModel(BaseModel):
    ...
    collectors: list[VdomNetflowCollectors] | None = Field(default=None, description="Netflow collectors.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
VdomNetflowModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:35.727529Z
# ============================================================================
