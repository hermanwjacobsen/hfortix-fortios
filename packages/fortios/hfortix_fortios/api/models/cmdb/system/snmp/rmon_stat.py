...
class RmonStatModel(BaseModel):
    ...
    Validation Rules:
        ...
        - source: max_length=15 pattern=
        - owner: max_length=127 pattern=
    """
...
RmonStatModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:36.045199Z
# ============================================================================
