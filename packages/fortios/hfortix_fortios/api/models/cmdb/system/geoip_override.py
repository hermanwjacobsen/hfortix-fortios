...
class GeoipOverrideModel(BaseModel):
    ...
    Validation Rules:
        ...
        - country_id: max_length=2 pattern=
        - ip_range: pattern=
        - ip6_range: pattern=
    """
    ...
    ip_range: list[GeoipOverrideIpRange] | None = Field(default=None, description="Table of IP ranges assigned to country.")
    ip6_range: list[GeoipOverrideIp6Range] | None = Field(default=None, description="Table of IPv6 ranges assigned to country.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
GeoipOverrideModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:39.784136Z
# ============================================================================
