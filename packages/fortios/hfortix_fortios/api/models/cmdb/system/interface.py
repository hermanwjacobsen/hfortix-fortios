...
class InterfaceVrrp(BaseModel):
    ...
    vrdst: str | None = Field(default="", description="Monitor the route to this destination.")
...
class InterfaceSpeedEnum(str, Enum):
    ...
    VALUE_10FULL = "10full"
    VALUE_10HALF = "10half"
    VALUE_100FULL = "100full"
    VALUE_100HALF = "100half"
    VALUE_100AUTO = "100auto"
    VALUE_1000FULL = "1000full"
    VALUE_1000AUTO = "1000auto"
...
class InterfaceModel(BaseModel):
    ...
    async def validate_switch_controller_traffic_policy_references(self, client: Any) -> list[str]:
        ...
        Datasource endpoints checked:
        - switch_controller/traffic_policy
        Args:
            client: FortiOS client instance (from fgt._client)
    ...
    async def validate_switch_controller_nac_references(self, client: Any) -> list[str]:
        ...
        Datasource endpoints checked:
        - switch_controller/fortilink_settings
        Args:
            client: FortiOS client instance (from fgt._client)
...
InterfaceModelDict = dict[str, Any]  # For backward compatibility
