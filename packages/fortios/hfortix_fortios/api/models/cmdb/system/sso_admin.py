...
class SsoAdminModel(BaseModel):
    ...
    vdom: list[SsoAdminVdom] | None = Field(default=None, description="Virtual domain(s) that the administrator can access.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
SsoAdminModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:35.018665Z
# ============================================================================
