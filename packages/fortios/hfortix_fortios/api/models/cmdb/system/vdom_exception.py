...
class VdomExceptionModel(BaseModel):
    ...
    object_: str | VdomExceptionObjectEnum | None = Field(default=None, description="Name of the configuration object that can be configured independently for all VDOMs.")
    ...
    vdom: list[VdomExceptionVdom] | None = Field(default=None, description="Names of the VDOMs.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
VdomExceptionModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:39.044538Z
# ============================================================================
