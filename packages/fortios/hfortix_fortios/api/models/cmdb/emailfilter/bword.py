...
class BwordEntries(BaseModel):
    ...
    language: str = Field(default="western", description="Language for the banned word.")
...
class BwordModel(BaseModel):
    ...
    entries: list[BwordEntries] | None = Field(default=None, description="Spam filter banned word.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
BwordModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:37.537841Z
# ============================================================================
