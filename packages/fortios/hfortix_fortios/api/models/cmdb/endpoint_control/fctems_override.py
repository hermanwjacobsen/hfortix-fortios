...
class FctemsOverrideModel(BaseModel):
    ...
    Validation Rules:
        - ems_id: min=1 max=7 pattern=
        - status: pattern=
        - name: max_length=35 pattern=
        - dirty_reason: pattern=
        - fortinetone_cloud_authentication: pattern=
        - cloud_authentication_access_key: max_length=20 pattern=
        - server: max_length=255 pattern=
        - https_port: min=1 max=65535 pattern=
        - serial_number: max_length=16 pattern=
        - tenant_id: max_length=32 pattern=
        - source_ip: pattern=
        - pull_sysinfo: pattern=
        - pull_vulnerabilities: pattern=
        - pull_tags: pattern=
        - pull_malware_hash: pattern=
        - capabilities: pattern=
        - call_timeout: min=1 max=180 pattern=
        - out_of_sync_threshold: min=10 max=3600 pattern=
        - send_tags_to_all_vdoms: pattern=
        - websocket_override: pattern=
        - interface_select_method: pattern=
        - interface: max_length=15 pattern=
        - trust_ca_cn: pattern=
        - verifying_ca: max_length=79 pattern=
    """
    ...
    capabilities: str | FctemsOverrideCapabilitiesEnum | None = Field(default=None, description="List of EMS capabilities.")
...
FctemsOverrideModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:38.857665Z
# ============================================================================
