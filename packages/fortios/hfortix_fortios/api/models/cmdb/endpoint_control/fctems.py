...
class FctemsModel(BaseModel):
    ...
    capabilities: str | FctemsCapabilitiesEnum | None = Field(default=None, description="List of EMS capabilities.")
...
FctemsModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:36.981959Z
# ============================================================================
