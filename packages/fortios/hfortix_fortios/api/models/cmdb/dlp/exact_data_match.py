...
class ExactDataMatchColumns(BaseModel):
    ...
    type_: str = Field(max_length=35, default="", description="Data-type for this column.")  # datasource: ['dlp.data-type.name']
...
class ExactDataMatchModel(BaseModel):
    ...
    Validation Rules:
        ...
        - optional: min=0 max=32 pattern=
        - data: max_length=35 pattern=
        - columns: pattern=
    """
    ...
    columns: list[ExactDataMatchColumns] | None = Field(description="DLP exact-data-match column types.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
ExactDataMatchModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:38.567093Z
# ============================================================================
