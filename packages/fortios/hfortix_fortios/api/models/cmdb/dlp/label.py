...
class LabelModel(BaseModel):
    ...
    Validation Rules:
        ...
        - type_: pattern=
        - mpip_type: pattern=
        - connector: max_length=35 pattern=
    ...
    type_: Literal["mpip", "fortidata"] | None = Field(default="mpip", description="Label type.")
    ...
    entries: list[LabelEntries] | None = Field(description="DLP label entries.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
LabelModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:36.564591Z
# ============================================================================
