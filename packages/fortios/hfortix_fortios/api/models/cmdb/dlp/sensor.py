...
class SensorModel(BaseModel):
    ...
    entries: list[SensorEntries] | None = Field(description="DLP sensor entries.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
    ...
    async def validate_entries_references(self, client: Any) -> list[str]:
        ...
        - dlp/dictionary        - dlp/exact_data_match
        Args:
        ...
        for item in values:
            ...
            if not found:
                errors.append(
                    ...
                    "dlp/dictionary or dlp/exact_data_match"
                )
        return errors
...
SensorModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:38.714165Z
# ============================================================================
