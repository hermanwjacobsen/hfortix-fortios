...
class SettingsModel(BaseModel):
    ...
    Validation Rules:
        - storage_device: max_length=35 pattern=
        - size: min=16 max=4294967295 pattern=
        - db_mode: pattern=
        - cache_mem_percent: min=1 max=15 pattern=
        - chunk_size: min=100 max=100000 pattern=
        - config_builder_timeout: min=10 max=100000 pattern=
    """
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:35.065128Z
# ============================================================================
