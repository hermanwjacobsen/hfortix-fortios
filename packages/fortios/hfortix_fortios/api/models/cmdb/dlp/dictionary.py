...
class DictionaryEntries(BaseModel):
    ...
    type_: str = Field(max_length=35, default="", description="Pattern type to match.")  # datasource: ['dlp.data-type.name']
...
class DictionaryModel(BaseModel):
    ...
    comment: str | None = Field(max_length=255, default=None, description="Optional comments.")
    entries: list[DictionaryEntries] | None = Field(description="DLP dictionary entries.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
DictionaryModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:37.788770Z
# ============================================================================
