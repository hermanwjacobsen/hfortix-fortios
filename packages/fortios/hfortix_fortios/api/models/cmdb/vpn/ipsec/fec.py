...
class FecModel(BaseModel):
    ...
    mappings: list[FecMappings] | None = Field(description="FEC redundancy mapping table.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
FecModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:37.679786Z
# ============================================================================
