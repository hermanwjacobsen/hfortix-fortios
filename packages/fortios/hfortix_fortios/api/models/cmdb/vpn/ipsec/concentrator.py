...
class ConcentratorModel(BaseModel):
    ...
    member: list[ConcentratorMember] | None = Field(default=None, description="Names of up to 3 VPN tunnels to add to the concentrator.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
ConcentratorModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:37.648982Z
# ============================================================================
