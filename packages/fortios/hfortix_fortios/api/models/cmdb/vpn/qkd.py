...
class QkdModel(BaseModel):
    ...
    certificate: list[QkdCertificate] | None = Field(default=None, description="Names of up to 4 certificates to offer to the KME.")
...
QkdModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:39.498556Z
# ============================================================================
