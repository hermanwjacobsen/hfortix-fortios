...
class SettingModel(BaseModel):
    ...
    Validation Rules:
        - ocsp_status: pattern=
        - ocsp_option: pattern=
        - proxy: max_length=127 pattern=
        - proxy_port: min=1 max=65535 pattern=
        - proxy_username: max_length=63 pattern=
        - proxy_password: max_length=128 pattern=
        - source_ip: max_length=63 pattern=
        - ocsp_default_server: max_length=35 pattern=
        - interface_select_method: pattern=
        - interface: max_length=15 pattern=
        - vrf_select: min=0 max=511 pattern=
        - check_ca_cert: pattern=
        - check_ca_chain: pattern=
        - subject_match: pattern=
        - subject_set: pattern=
        - cn_match: pattern=
        - cn_allow_multi: pattern=
        - crl_verification: pattern=
        - strict_ocsp_check: pattern=
        - ssl_min_proto_version: pattern=
        - cmp_save_extra_certs: pattern=
        - cmp_key_usage_checking: pattern=
        - cert_expire_warning: min=0 max=100 pattern=
        - certname_rsa1024: max_length=35 pattern=
        - certname_rsa2048: max_length=35 pattern=
        - certname_rsa4096: max_length=35 pattern=
        - certname_dsa1024: max_length=35 pattern=
        - certname_dsa2048: max_length=35 pattern=
        - certname_ecdsa256: max_length=35 pattern=
        - certname_ecdsa384: max_length=35 pattern=
        - certname_ecdsa521: max_length=35 pattern=
        - certname_ed25519: max_length=35 pattern=
        - certname_ed448: max_length=35 pattern=
    """
    ...
    crl_verification: list[SettingCrlVerification] | None = Field(default=None, description="CRL verification options.")
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:38.809909Z
# ============================================================================
