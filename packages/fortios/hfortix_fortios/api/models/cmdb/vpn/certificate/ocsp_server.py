...
class OcspServerModel(BaseModel):
    ...
    Validation Rules:
        ...
        - cert: max_length=127 pattern=
        - secondary_url: max_length=127 pattern=
        - secondary_cert: max_length=127 pattern=
        - unavail_action: pattern=
...
OcspServerModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:37.820073Z
# ============================================================================
