...
class CaModel(BaseModel):
    ...
    range_: Literal["global", "vdom"] | None = Field(default="vdom", description="Either global or VDOM IP address range for the CA certificate.")
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:38.868033Z
# ============================================================================
