...
class QosPolicyModel(BaseModel):
    ...
    Validation Rules:
        ...
        - default_cos: min=0 max=7 pattern=
        - trust_dot1p_map: max_length=63 pattern=
        - trust_ip_dscp_map: max_length=63 pattern=
        - queue_policy: max_length=63 pattern=
    """
    ...
    async def validate_trust_dot1p_map_references(self, client: Any) -> list[str]:
        ...
        - switch_controller/qos/dot1p_map
        Args:
    ...
    async def validate_trust_ip_dscp_map_references(self, client: Any) -> list[str]:
        ...
        Datasource endpoints checked:
        - switch_controller/qos/ip_dscp_map
        Args:
            client: FortiOS client instance (from fgt._client)
    ...
    async def validate_queue_policy_references(self, client: Any) -> list[str]:
        ...
        Datasource endpoints checked:
        - switch_controller/qos/queue_policy
        Args:
            client: FortiOS client instance (from fgt._client)
...
QosPolicyModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:39.382234Z
# ============================================================================
