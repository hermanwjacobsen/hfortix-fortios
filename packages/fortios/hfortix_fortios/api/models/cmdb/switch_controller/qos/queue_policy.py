...
class QueuePolicyModel(BaseModel):
    ...
    cos_queue: list[QueuePolicyCosQueue] | None = Field(default=None, description="COS queue configuration.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
QueuePolicyModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:39.877884Z
# ============================================================================
