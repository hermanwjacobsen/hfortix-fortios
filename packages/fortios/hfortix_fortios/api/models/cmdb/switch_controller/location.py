...
class LocationModel(BaseModel):
    ...
    address_civic: list[LocationAddressCivic] = Field(default_factory=list, description="Configure location civic address.")    
    coordinates: list[LocationCoordinates] = Field(default_factory=list, description="Configure location GPS coordinates.")    
    elin_number: list[LocationElinNumber] = Field(default_factory=list, description="Configure location ELIN number.")    
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.1
# Generated: 2026-01-18T15:06:46.792562Z
# ============================================================================