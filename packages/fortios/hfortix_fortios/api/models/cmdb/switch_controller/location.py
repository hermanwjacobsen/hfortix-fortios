...
class LocationAddressCivic(BaseModel):
    ...
    zip_: str | None = Field(max_length=47, default="", description="Postal/zip code.")
...
class LocationModel(BaseModel):
    ...
    address_civic: list[LocationAddressCivic] | None = Field(default=None, description="Configure location civic address.")
    coordinates: list[LocationCoordinates] | None = Field(default=None, description="Configure location GPS coordinates.")
    elin_number: list[LocationElinNumber] | None = Field(default=None, description="Configure location ELIN number.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
LocationModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:40.276770Z
# ============================================================================
