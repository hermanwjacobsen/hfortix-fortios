...
class RemoteLogModel(BaseModel):
    ...
    severity: str | RemoteLogSeverityEnum | None = Field(default="information", description="Severity of logs to be transferred to remote log server.")
    csv: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable comma-separated value (CSV) strings.")
    facility: str | RemoteLogFacilityEnum | None = Field(default="local7", description="Facility to log to remote syslog server.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
RemoteLogModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:38.344224Z
# ============================================================================
