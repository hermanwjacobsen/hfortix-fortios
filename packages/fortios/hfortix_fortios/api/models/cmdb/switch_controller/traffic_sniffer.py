...
class TrafficSnifferTargetPort(BaseModel):
    ...
    in_ports: list[dict[str, Any]] | None = Field(default=None, description="Configure source ingress port interfaces.")
    out_ports: list[dict[str, Any]] | None = Field(default=None, description="Configure source egress port interfaces.")
...
class TrafficSnifferModel(BaseModel):
    ...
    target_mac: list[TrafficSnifferTargetMac] | None = Field(default=None, description="Sniffer MACs to filter.")
    target_ip: list[TrafficSnifferTargetIp] | None = Field(default=None, description="Sniffer IPs to filter.")
    target_port: list[TrafficSnifferTargetPort] | None = Field(default=None, description="Sniffer ports to filter.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
    ...
    async def validate_target_port_references(self, client: Any) -> list[str]:
        ...
        - switch_controller/managed_switch
        Args:
...
TrafficSnifferModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:39.106706Z
# ============================================================================
