...
class SystemModel(BaseModel):
    ...
    Validation Rules:
        - parallel_process_override: pattern=
        - parallel_process: min=1 max=24 pattern=
        - data_sync_interval: min=30 max=1800 pattern=
        - iot_weight_threshold: min=0 max=255 pattern=
        - iot_scan_interval: min=2 max=10080 pattern=
        - iot_holdoff: min=0 max=10080 pattern=
        - iot_mac_idle: min=0 max=10080 pattern=
        - nac_periodic_interval: min=5 max=180 pattern=
        - dynamic_periodic_interval: min=5 max=180 pattern=
        - tunnel_mode: pattern=
        - caputp_echo_interval: min=8 max=600 pattern=
        - caputp_max_retransmit: min=0 max=64 pattern=
    """
...
SystemModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:34.561238Z
# ============================================================================
