...
class StpInstanceModel(BaseModel):
    ...
    vlan_range: list[StpInstanceVlanRange] | None = Field(default=None, description="Configure VLAN range for STP instance.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
StpInstanceModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:34.904421Z
# ============================================================================
