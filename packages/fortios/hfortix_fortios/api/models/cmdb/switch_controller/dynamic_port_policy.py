...
class DynamicPortPolicyPolicy(BaseModel):
    ...
    x802_1x: str | None = Field(max_length=31, default="", description="802.1x security policy to be applied when using this policy.")  # datasource: ['switch-controller.security-policy.802-1X.name', 'switch-controller.security-policy.captive-portal.name']
...
DynamicPortPolicyModelDict = dict[str, Any]  # For backward compatibility
