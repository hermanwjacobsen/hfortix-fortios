...
class IngressModel(BaseModel):
    ...
    action: list[IngressAction] = Field(default_factory=list, description="ACL actions.")    
    classifier: list[IngressClassifier] = Field(default_factory=list, description="ACL classifiers.")    
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.1
# Generated: 2026-01-18T20:31:27.846840Z
# ============================================================================