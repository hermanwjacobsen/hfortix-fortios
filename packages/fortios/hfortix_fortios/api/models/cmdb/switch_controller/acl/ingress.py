...
class IngressModel(BaseModel):
    ...
    action: list[IngressAction] | None = Field(default=None, description="ACL actions.")
    classifier: list[IngressClassifier] | None = Field(default=None, description="ACL classifiers.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
IngressModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:36.550429Z
# ============================================================================
