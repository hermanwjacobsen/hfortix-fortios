...
class SwitchGroupModel(BaseModel):
    ...
    members: list[SwitchGroupMembers] | None = Field(default=None, description="FortiSwitch members belonging to this switch group.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
SwitchGroupModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:35.070241Z
# ============================================================================
