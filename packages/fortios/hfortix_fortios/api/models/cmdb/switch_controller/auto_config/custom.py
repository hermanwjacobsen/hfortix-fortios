...
class CustomModel(BaseModel):
    ...
    switch_binding: list[CustomSwitchBinding] | None = Field(default=None, description="Switch binding list.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
    ...
    async def validate_switch_binding_references(self, client: Any) -> list[str]:
        ...
        - switch_controller/auto_config/policy
        Args:
...
CustomModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:39.465090Z
# ============================================================================
