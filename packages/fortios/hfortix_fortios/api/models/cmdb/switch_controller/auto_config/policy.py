...
class PolicyModel(BaseModel):
    ...
    Validation Rules:
        ...
        - qos_policy: max_length=63 pattern=
        - storm_control_policy: max_length=63 pattern=
        - poe_status: pattern=
        - igmp_flood_report: pattern=
        - igmp_flood_traffic: pattern=
    """
    ...
    async def validate_qos_policy_references(self, client: Any) -> list[str]:
        ...
        - switch_controller/qos/qos_policy
        Args:
    ...
    async def validate_storm_control_policy_references(self, client: Any) -> list[str]:
        ...
        Datasource endpoints checked:
        - switch_controller/storm_control_policy
        Args:
            client: FortiOS client instance (from fgt._client)
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:35.918028Z
# ============================================================================
