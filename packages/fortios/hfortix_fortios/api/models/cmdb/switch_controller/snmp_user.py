...
class SnmpUserModel(BaseModel):
    ...
    Validation Rules:
        ...
        - queries: pattern=
        - query_port: min=0 max=65535 pattern=
    ...
    auth_proto: str | SnmpUserAuthProtoEnum | None = Field(default="sha256", description="Authentication protocol.")
    auth_pwd: Any = Field(max_length=128, description="Password for authentication protocol.")
    priv_proto: str | SnmpUserPrivProtoEnum | None = Field(default="aes128", description="Privacy (encryption) protocol.")
...
SnmpUserModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:37.725587Z
# ============================================================================
