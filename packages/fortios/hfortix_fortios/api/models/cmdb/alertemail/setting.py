...
class SettingModel(BaseModel):
    ...
    Validation Rules:
        ...
        - mailto1: max_length=63 pattern=
        - mailto2: max_length=63 pattern=
        - mailto3: max_length=63 pattern=
        - filter_mode: pattern=
        - email_interval: min=1 max=99999 pattern=
        - IPS_logs: pattern=
        - firewall_authentication_failure_logs: pattern=
        - HA_logs: pattern=
        - IPsec_errors_logs: pattern=
        - FDS_update_logs: pattern=
        - PPP_errors_logs: pattern=
        - sslvpn_authentication_errors_logs: pattern=
        - antivirus_logs: pattern=
        - webfilter_logs: pattern=
        - configuration_changes_logs: pattern=
        - violation_traffic_logs: pattern=
        - admin_login_logs: pattern=
        - FDS_license_expiring_warning: pattern=
        - log_disk_usage_warning: pattern=
        - fortiguard_log_quota_warning: pattern=
        - amc_interface_bypass_mode: pattern=
        - FIPS_CC_errors: pattern=
        - FSSO_disconnect_logs: pattern=
        - ssh_logs: pattern=
        - local_disk_usage: min=1 max=99 pattern=
        - emergency_interval: min=1 max=99999 pattern=
        - alert_interval: min=1 max=99999 pattern=
        - critical_interval: min=1 max=99999 pattern=
        - error_interval: min=1 max=99999 pattern=
        - warning_interval: min=1 max=99999 pattern=
        - notification_interval: min=1 max=99999 pattern=
        - information_interval: min=1 max=99999 pattern=
        - debug_interval: min=1 max=99999 pattern=
        - severity: pattern=
    """
    ...
    severity: str | SettingSeverityEnum | None = Field(default="alert", description="Lowest severity level to log.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
SettingModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:36.964729Z
# ============================================================================
