...
class OverrideSettingModel(BaseModel):
    ...
    facility: str | OverrideSettingFacilityEnum | None = Field(default="local7", description="Remote syslog facility.")
    ...
    format_: str | OverrideSettingFormatEnum | None = Field(default="default", description="Log format.")
    ...
    enc_algorithm: str | OverrideSettingEncAlgorithmEnum | None = Field(default="disable", description="Enable/disable reliable syslogging with TLS encryption.")
    ...
    custom_field_name: list[OverrideSettingCustomFieldName] | None = Field(default=None, description="Custom field name for CEF format logging.")
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:39.965257Z
# ============================================================================
