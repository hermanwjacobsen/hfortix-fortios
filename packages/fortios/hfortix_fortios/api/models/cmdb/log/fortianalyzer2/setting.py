...
class SettingModel(BaseModel):
    ...
    serial: list[SettingSerial] | None = Field(default=None, description="Serial numbers of the FortiAnalyzer.")
    ...
    upload_option: str | SettingUploadOptionEnum | None = Field(default="5-minute", description="Enable/disable logging to hard disk and then uploading to FortiAnalyzer.")
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:35.516216Z
# ============================================================================
