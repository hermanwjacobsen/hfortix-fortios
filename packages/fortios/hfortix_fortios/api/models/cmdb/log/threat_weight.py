...
class ThreatWeightModel(BaseModel):
    ...
    level: list[ThreatWeightLevel] = Field(default_factory=list, description="Score mapping for threat weight levels.")    
    ...
    malware: list[ThreatWeightMalware] = Field(default_factory=list, description="Anti-virus malware threat weight settings.")    
    ips: list[ThreatWeightIps] = Field(default_factory=list, description="IPS threat weight settings.")    
...
# Schema: 1.7.0
# Generated: 2026-01-17T17:56:13.565028Z
# ============================================================================