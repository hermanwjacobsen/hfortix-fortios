...
class DomainControllerModel(BaseModel):
    ...
    Validation Rules:
        ...
        - ad_mode: pattern=
        - hostname: max_length=255 pattern=
        - username: max_length=64 pattern=
        - password: max_length=128 pattern=
        - ip_address: pattern=
        - ip6: pattern=
        - port: min=0 max=65535 pattern=
        - source_ip_address: pattern=
        - source_ip6: pattern=
        - source_port: min=0 max=65535 pattern=
        - interface_select_method: pattern=
        - interface: max_length=15 pattern=
        - extra_server: pattern=
        - domain_name: max_length=255 pattern=
        - replication_port: min=0 max=65535 pattern=
        - ldap_server: pattern=
        - change_detection: pattern=
        - change_detection_period: min=5 max=10080 pattern=
        - dns_srv_lookup: pattern=
        - adlds_dn: max_length=255 pattern=
        - adlds_ip_address: pattern=
        - adlds_ip6: pattern=
        - adlds_port: min=0 max=65535 pattern=
    """
    ...
    extra_server: list[DomainControllerExtraServer] | None = Field(default=None, description="Extra servers.")
    ...
    ldap_server: list[DomainControllerLdapServer] | None = Field(default=None, description="LDAP server name(s).")
...
DomainControllerModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:39.492346Z
# ============================================================================
