...
class KrbKeytabModel(BaseModel):
    ...
    Validation Rules:
        ...
        - pac_data: pattern=
        - principal: max_length=511 pattern=
        - ldap_server: pattern=
        - keytab: max_length=8191 pattern=
    """
    ...
    ldap_server: list[KrbKeytabLdapServer] | None = Field(default=None, description="LDAP server name(s).")
...
KrbKeytabModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:39.778747Z
# ============================================================================
