...
class PasswordPolicyModel(BaseModel):
    ...
    Validation Rules:
        ...
        - expire_days: min=0 max=999 pattern=
        - warn_days: min=0 max=30 pattern=
        - expired_password_renewal: pattern=
        - minimum_length: min=8 max=128 pattern=
        ...
        - min_change_characters: min=0 max=128 pattern=
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:38.466636Z
# ============================================================================
