...
class CertificateModel(BaseModel):
    ...
    Validation Rules:
        ...
        - status: pattern=
        - type_: pattern=
        - common_name: max_length=64 pattern=
        - issuer: max_length=79 pattern=
    """
    ...
    type_: Literal["single-certificate", "trusted-issuer"] = Field(default="single-certificate", description="Type of certificate authentication method.")
...
CertificateModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:39.138406Z
# ============================================================================
