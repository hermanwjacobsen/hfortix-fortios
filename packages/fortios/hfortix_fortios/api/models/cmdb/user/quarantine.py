...
class QuarantineTargets(BaseModel):
    ...
    macs: list[dict[str, Any]] | None = Field(default=None, description="Quarantine MACs.")
...
class QuarantineModel(BaseModel):
    ...
    Validation Rules:
        ...
        - firewall_groups: max_length=79 pattern=
        - targets: pattern=
    """
    ...
    targets: list[QuarantineTargets] | None = Field(default=None, description="Quarantine entry to hold multiple MACs.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:35.179606Z
# ============================================================================
