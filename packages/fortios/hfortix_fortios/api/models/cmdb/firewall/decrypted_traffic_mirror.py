...
class DecryptedTrafficMirrorModel(BaseModel):
    ...
    traffic_type: Literal["ssl", "ssh"] | None = Field(default="ssl", description="Types of decrypted traffic to be mirrored.")
    ...
    interface: list[DecryptedTrafficMirrorInterface] | None = Field(description="Decrypted traffic mirror interface.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
DecryptedTrafficMirrorModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:39.765100Z
# ============================================================================
