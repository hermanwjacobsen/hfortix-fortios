...
class VipgrpModel(BaseModel):
    ...
    member: list[VipgrpMember] | None = Field(description="Member VIP objects of the group (Separate multiple objects with a space).")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
VipgrpModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:37.073227Z
# ============================================================================
