...
class Vipgrp6Model(BaseModel):
    ...
    member: list[Vipgrp6Member] | None = Field(description="Member VIP objects of the group (Separate multiple objects with a space).")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
Vipgrp6ModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:39.168475Z
# ============================================================================
