...
class ProfileProtocolOptionsModel(BaseModel):
    ...
    http: list[ProfileProtocolOptionsHttp] = Field(default_factory=list, description="Configure HTTP protocol options.")    
    ftp: list[ProfileProtocolOptionsFtp] = Field(default_factory=list, description="Configure FTP protocol options.")    
    imap: list[ProfileProtocolOptionsImap] = Field(default_factory=list, description="Configure IMAP protocol options.")    
    mapi: list[ProfileProtocolOptionsMapi] = Field(default_factory=list, description="Configure MAPI protocol options.")    
    pop3: list[ProfileProtocolOptionsPop3] = Field(default_factory=list, description="Configure POP3 protocol options.")    
    smtp: list[ProfileProtocolOptionsSmtp] = Field(default_factory=list, description="Configure SMTP protocol options.")    
    nntp: list[ProfileProtocolOptionsNntp] = Field(default_factory=list, description="Configure NNTP protocol options.")    
    ssh: list[ProfileProtocolOptionsSsh] = Field(default_factory=list, description="Configure SFTP and SCP protocol options.")    
    dns: list[ProfileProtocolOptionsDns] = Field(default_factory=list, description="Configure DNS protocol options.")    
    cifs: list[ProfileProtocolOptionsCifs] = Field(default_factory=list, description="Configure CIFS protocol options.")    
    mail_signature: list[ProfileProtocolOptionsMailSignature] = Field(default_factory=list, description="Configure Mail signature.")    
...
# Schema: 1.7.1
# Generated: 2026-01-18T20:31:27.187855Z
# ============================================================================