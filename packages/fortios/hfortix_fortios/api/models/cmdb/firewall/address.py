...
class AddressModel(BaseModel):
    ...
    Validation Rules:
        ...
        - subnet: pattern=
        - type_: pattern=
        - route_tag: min=1 max=4294967295 pattern=
        - sub_type: pattern=
        - clearpass_spt: pattern=
        - macaddr: pattern=
        - start_ip: pattern=
        - end_ip: pattern=
        - fqdn: max_length=255 pattern=
        - country: max_length=2 pattern=
        - wildcard_fqdn: max_length=255 pattern=
        - cache_ttl: min=0 max=86400 pattern=
        - wildcard: pattern=
        - sdn: max_length=35 pattern=
        - fsso_group: pattern=
        - sso_attribute_value: pattern=
        - interface: max_length=35 pattern=
        - tenant: max_length=35 pattern=
        - organization: max_length=35 pattern=
        - epg_name: max_length=255 pattern=
        - subnet_name: max_length=255 pattern=
        - sdn_tag: max_length=15 pattern=
        - policy_group: max_length=15 pattern=
        - obj_tag: max_length=255 pattern=
        - obj_type: pattern=
        - tag_detection_level: max_length=15 pattern=
        - tag_type: max_length=63 pattern=
        - hw_vendor: max_length=35 pattern=
        - hw_model: max_length=35 pattern=
        - os: max_length=35 pattern=
        - sw_version: max_length=35 pattern=
        - comment: max_length=255 pattern=
        - associated_interface: max_length=35 pattern=
        - color: min=0 max=32 pattern=
        - filter_: max_length=2047 pattern=
        - sdn_addr_type: pattern=
        - node_ip_only: pattern=
        - obj_id: max_length=255 pattern=
        - list_: pattern=
        - tagging: pattern=
        - allow_routing: pattern=
        - passive_fqdn_learning: pattern=
    ...
    type_: str | AddressTypeEnum | None = Field(default="ipmask", description="Type of address.")
    route_tag: int | None = Field(ge=1, le=4294967295, default=0, description="route-tag address.")
    sub_type: str | AddressSubTypeEnum | None = Field(default="sdn", description="Sub-type of address.")
    clearpass_spt: str | AddressClearpassSptEnum | None = Field(default="unknown", description="SPT (System Posture Token) value.")
    macaddr: list[AddressMacaddr] | None = Field(default=None, description="Multiple MAC address ranges.")
    ...
    fsso_group: list[AddressFssoGroup] | None = Field(default=None, description="FSSO group(s).")
    sso_attribute_value: list[AddressSsoAttributeValue] | None = Field(default=None, description="RADIUS attributes value.")
    ...
    filter_: str = Field(max_length=2047, description="Match criteria filter.")
    ...
    list_: list[AddressList] | None = Field(default=None, description="IP address list.")
    tagging: list[AddressTagging] | None = Field(default=None, description="Config object tagging.")
...
AddressModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:38.330114Z
# ============================================================================
