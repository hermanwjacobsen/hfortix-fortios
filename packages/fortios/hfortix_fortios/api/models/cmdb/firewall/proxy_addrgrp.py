...
class ProxyAddrgrpModel(BaseModel):
    ...
    type_: Literal["src", "dst"] | None = Field(default="src", description="Source or destination address group type.")
    uuid: str | None = Field(default="00000000-0000-0000-0000-000000000000", description="Universally Unique Identifier (UUID; automatically assigned but can be manually reset).")
    member: list[ProxyAddrgrpMember] | None = Field(description="Members of address group.")
    ...
    tagging: list[ProxyAddrgrpTagging] | None = Field(default=None, description="Config object tagging.")
    ...
    async def validate_member_references(self, client: Any) -> list[str]:
        ...
        - firewall/proxy_address        - firewall/proxy_addrgrp
        Args:
        ...
        for item in values:
            ...
            if not found:
                errors.append(
                    ...
                    "firewall/proxy_address or firewall/proxy_addrgrp"
                )
        return errors
...
ProxyAddrgrpModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:35.026001Z
# ============================================================================
