...
class PerIpShaperModel(BaseModel):
    ...
    Validation Rules:
        ...
        - max_bandwidth: min=0 max=80000000 pattern=
        - bandwidth_unit: pattern=
        - max_concurrent_session: min=0 max=2097000 pattern=
        - max_concurrent_tcp_session: min=0 max=2097000 pattern=
        - max_concurrent_udp_session: min=0 max=2097000 pattern=
...
PerIpShaperModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:34.544834Z
# ============================================================================
