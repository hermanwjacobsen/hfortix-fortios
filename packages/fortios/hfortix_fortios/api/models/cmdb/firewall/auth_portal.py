...
class AuthPortalModel(BaseModel):
    ...
    Validation Rules:
        - groups: pattern=
        - portal_addr: max_length=63 pattern=
        - portal_addr6: max_length=63 pattern=
    ...
    # Model Fields
    # ========================================================================
    groups: list[AuthPortalGroups] | None = Field(default=None, description="Firewall user groups permitted to authenticate through this portal. Separate group names with spaces.")
...
AuthPortalModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:38.816786Z
# ============================================================================
