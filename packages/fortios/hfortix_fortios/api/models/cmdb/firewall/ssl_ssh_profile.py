...
class SslSshProfileModel(BaseModel):
    ...
    async def validate_ssl_exempt_references(self, client: Any) -> list[str]:
        ...
        - firewall/wildcard_fqdn/custom        - firewall/wildcard_fqdn/group
        Args:
        ...
        for item in values:
            ...
            if not found:
                errors.append(
                    ...
                    "firewall/wildcard_fqdn/custom or firewall/wildcard_fqdn/group"
                )
        return errors
    async def validate_caname_references(self, client: Any) -> list[str]:
        ...
        Datasource endpoints checked:
        - vpn/certificate/local        - vpn/certificate/hsm_local
        Args:
            client: FortiOS client instance (from fgt._client)
        ...
        if not found:
            errors.append(
                ...
                "vpn/certificate/local or vpn/certificate/hsm_local"
            )
        return errors
...
SslSshProfileModelDict = dict[str, Any]  # For backward compatibility
