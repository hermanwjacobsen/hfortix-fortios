...
class OnDemandSnifferModel(BaseModel):
    ...
    Validation Rules:
        ...
        - max_packet_count: min=1 max=20000 pattern=
        - hosts: pattern=
        - ports: pattern=
        - protocols: pattern=
        - non_ip_packet: pattern=
        - advanced_filter: max_length=255 pattern=
    """
    ...
    hosts: list[OnDemandSnifferHosts] | None = Field(default=None, description="IPv4 or IPv6 hosts to filter in this traffic sniffer.")
    ports: list[OnDemandSnifferPorts] | None = Field(default=None, description="Ports to filter for in this traffic sniffer.")
    protocols: list[OnDemandSnifferProtocols] | None = Field(default=None, description="Protocols to filter in this traffic sniffer.")
...
OnDemandSnifferModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:39.813343Z
# ============================================================================
