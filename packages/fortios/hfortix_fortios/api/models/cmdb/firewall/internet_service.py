...
class InternetServiceModel(BaseModel):
    ...
    Validation Rules:
        ...
        - icon_id: min=0 max=4294967295 pattern=
        - direction: pattern=
        - database: pattern=
        - ip_range_number: min=0 max=4294967295 pattern=
        ...
        - singularity: min=0 max=65535 pattern=
        - obsolete: min=0 max=255 pattern=
    """
...
InternetServiceModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:38.293190Z
# ============================================================================
