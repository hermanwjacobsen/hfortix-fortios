...
class InternetServiceAdditionModel(BaseModel):
    ...
    entry: list[InternetServiceAdditionEntry] | None = Field(default=None, description="Entries added to the Internet Service addition database.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
InternetServiceAdditionModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:34.352495Z
# ============================================================================
