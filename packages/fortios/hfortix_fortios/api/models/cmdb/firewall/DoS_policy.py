...
class DosPolicyModel(BaseModel):
    ...
    srcaddr: list[DosPolicySrcaddr] | None = Field(description="Source address name from available addresses.")
    dstaddr: list[DosPolicyDstaddr] | None = Field(description="Destination address name from available addresses.")
    service: list[DosPolicyService] | None = Field(description="Service object from available options.")
    anomaly: list[DosPolicyAnomaly] | None = Field(default=None, description="Anomaly name.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
DosPolicyModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:35.909951Z
# ============================================================================
