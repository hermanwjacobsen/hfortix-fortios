...
class IdentityBasedRouteRule(BaseModel):
    ...
    groups: list[dict[str, Any]] | None = Field(description="Select one or more group(s) from available groups that are allowed to use this route. Separate group names with a space.")
...
class IdentityBasedRouteModel(BaseModel):
    ...
    rule: list[IdentityBasedRouteRule] | None = Field(default=None, description="Rule.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
IdentityBasedRouteModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:34.980346Z
# ============================================================================
