...
class InterfacePolicy6Model(BaseModel):
    ...
    srcaddr6: list[InterfacePolicy6Srcaddr6] | None = Field(description="IPv6 address object to limit traffic monitoring to network traffic sent from the specified address or range.")
    dstaddr6: list[InterfacePolicy6Dstaddr6] | None = Field(description="IPv6 address object to limit traffic monitoring to network traffic sent to the specified address or range.")
    service6: list[InterfacePolicy6Service6] | None = Field(default=None, description="Service name.")
...
InterfacePolicy6ModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:35.716021Z
# ============================================================================
