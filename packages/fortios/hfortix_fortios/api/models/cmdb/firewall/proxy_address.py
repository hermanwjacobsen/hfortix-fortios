...
class ProxyAddressModel(BaseModel):
    ...
    async def validate_host_references(self, client: Any) -> list[str]:
        ...
        - firewall/address        - firewall/addrgrp        - firewall/proxy_address        - firewall/vipgrp        - firewall/vip
        Args:
        ...
        if not found:
            errors.append(
                ...
                "firewall/address or firewall/addrgrp or firewall/proxy_address or firewall/vipgrp or firewall/vip"
            )
        return errors
...
ProxyAddressModelDict = dict[str, Any]  # For backward compatibility
