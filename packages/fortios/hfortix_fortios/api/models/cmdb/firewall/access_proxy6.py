...
class AccessProxy6Model(BaseModel):
    ...
    api_gateway: list[AccessProxy6ApiGateway] | None = Field(default=None, description="Set IPv4 API Gateway.")
    api_gateway6: list[AccessProxy6ApiGateway6] | None = Field(default=None, description="Set IPv6 API Gateway.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
    ...
    async def validate_auth_virtual_host_references(self, client: Any) -> list[str]:
        ...
        Datasource endpoints checked:
        - firewall/access_proxy_virtual_host
        Args:
            client: FortiOS client instance (from fgt._client)
...
AccessProxy6ModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:37.640118Z
# ============================================================================
