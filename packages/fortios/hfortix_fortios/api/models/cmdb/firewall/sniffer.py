...
class SnifferAnomaly(BaseModel):
    ...
    threshold_default: int | None = Field(ge=0, le=4294967295, default=0, description="Number of detected instances (packets per second or concurrent session number) which triggers action (1 - 2147483647, default = 1000). Note that each anomaly has a different threshold value assigned to it.")
...
class SnifferModel(BaseModel):
    ...
    Validation Rules:
        ...
        - host: max_length=63 pattern=
        - port: max_length=63 pattern=
        - protocol: max_length=63 pattern=
        - vlan: max_length=63 pattern=
        ...
        - ip_threatfeed_status: pattern=
        - ip_threatfeed: pattern=
        - file_filter_profile_status: pattern=
        - file_filter_profile: max_length=47 pattern=
        - ips_dos_status: pattern=
        - anomaly: pattern=
    """
    ...
    ip_threatfeed: list[SnifferIpThreatfeed] | None = Field(default=None, description="Name of an existing IP threat feed.")
    ...
    anomaly: list[SnifferAnomaly] | None = Field(default=None, description="Configuration method to edit Denial of Service (DoS) anomaly settings.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
SnifferModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:34.897593Z
# ============================================================================
