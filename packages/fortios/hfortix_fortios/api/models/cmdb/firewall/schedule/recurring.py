...
class RecurringModel(BaseModel):
    ...
    day: str | RecurringDayEnum | None = Field(default="none", description="One or more days of the week on which the schedule is valid. Separate the names of the days with a space.")
    label_day: str | RecurringLabelDayEnum | None = Field(default="none", description="Configure a window during the time of day in which the schedule job is executed.")
...
RecurringModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:34.878628Z
# ============================================================================
