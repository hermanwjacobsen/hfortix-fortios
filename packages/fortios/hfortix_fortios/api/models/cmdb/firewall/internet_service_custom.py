...
class InternetServiceCustomModel(BaseModel):
    ...
    Validation Rules:
        ...
        - reputation: min=0 max=4294967295 pattern=
    ...
    entry: list[InternetServiceCustomEntry] | None = Field(default=None, description="Entries added to the Internet Service database and custom database.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
InternetServiceCustomModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:39.841364Z
# ============================================================================
