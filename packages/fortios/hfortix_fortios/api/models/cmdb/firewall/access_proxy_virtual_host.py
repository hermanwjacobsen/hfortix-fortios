...
class AccessProxyVirtualHostModel(BaseModel):
    ...
    ssl_certificate: list[AccessProxyVirtualHostSslCertificate] | None = Field(description="SSL certificates for this host.")
...
AccessProxyVirtualHostModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:35.950141Z
# ============================================================================
