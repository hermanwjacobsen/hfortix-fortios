...
class InternetServiceFortiguardModel(BaseModel):
    ...
    entry: list[InternetServiceFortiguardEntry] | None = Field(default=None, description="Entries added to the Internet Service FortiGuard database.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
InternetServiceFortiguardModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:37.413035Z
# ============================================================================
