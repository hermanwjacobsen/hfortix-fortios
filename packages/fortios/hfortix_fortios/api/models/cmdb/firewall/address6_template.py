...
class Address6TemplateSubnetSegment(BaseModel):
    ...
    values_: list[dict[str, Any]] | None = Field(default=None, description="Subnet segment values.")
...
class Address6TemplateModel(BaseModel):
    ...
    Validation Rules:
        ...
        - uuid: pattern=
        - ip6: pattern=
        - subnet_segment_count: min=1 max=6 pattern=
    ...
    subnet_segment: list[Address6TemplateSubnetSegment] | None = Field(default=None, description="IPv6 subnet segments.")
...
Address6TemplateModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:34.964011Z
# ============================================================================
