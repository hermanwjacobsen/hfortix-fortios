...
class MulticastAddress6Model(BaseModel):
    ...
    tagging: list[MulticastAddress6Tagging] | None = Field(default=None, description="Config object tagging.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
MulticastAddress6ModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:38.373122Z
# ============================================================================
