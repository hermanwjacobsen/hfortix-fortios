...
class LdbMonitorModel(BaseModel):
    ...
    Validation Rules:
        ...
        - type_: pattern=
        - interval: min=5 max=65535 pattern=
        - timeout: min=1 max=255 pattern=
        - retry: min=1 max=255 pattern=
        - port: min=0 max=65535 pattern=
        - src_ip: pattern=
        - http_get: max_length=255 pattern=
        - http_match: max_length=255 pattern=
        - http_max_redirects: min=0 max=5 pattern=
        - dns_protocol: pattern=
        - dns_request_domain: max_length=255 pattern=
        - dns_match_ip: pattern=
    """
    ...
    type_: str | LdbMonitorTypeEnum | None = Field(default=None, description="Select the Monitor type used by the health check monitor to check the health of the server (PING | TCP | HTTP | HTTPS | DNS).")
...
LdbMonitorModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:38.971043Z
# ============================================================================
