...
class Bfd6Model(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    neighbor: list[Bfd6Neighbor] | None = Field(default=None, description="Configure neighbor of IPv6 BFD.")
    multihop_template: list[Bfd6MultihopTemplate] | None = Field(default=None, description="BFD IPv6 multi-hop template table.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
Bfd6ModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:36.738493Z
# ============================================================================
