...
class BfdModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    neighbor: list[BfdNeighbor] | None = Field(default=None, description="Neighbor.")
    multihop_template: list[BfdMultihopTemplate] | None = Field(default=None, description="BFD multi-hop template table.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
BfdModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:39.995410Z
# ============================================================================
