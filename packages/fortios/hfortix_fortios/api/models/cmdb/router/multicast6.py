...
class Multicast6PimSmGlobal(BaseModel):
    ...
    rp_address: list[dict[str, Any]] | None = Field(default=None, description="Statically configured RP addresses.")
...
class Multicast6Model(BaseModel):
    ...
    interface: list[Multicast6Interface] | None = Field(default=None, description="Protocol Independent Multicast (PIM) interfaces.")
    pim_sm_global: list[Multicast6PimSmGlobal] | None = Field(default=None, description="PIM sparse-mode global settings.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
Multicast6ModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:34.160054Z
# ============================================================================
