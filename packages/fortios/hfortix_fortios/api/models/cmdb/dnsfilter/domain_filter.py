...
class DomainFilterEntries(BaseModel):
    ...
    type_: Literal["simple", "regex", "wildcard"] | None = Field(default="simple", description="DNS domain filter type.")
...
class DomainFilterModel(BaseModel):
    ...
    entries: list[DomainFilterEntries] | None = Field(description="DNS domain filter entries.")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
DomainFilterModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:37.532509Z
# ============================================================================
