...
class NameParameters(BaseModel):
    ...
    default_value: str | None = Field(max_length=199, default="", description="Parameter default value.")
...
class NameStatus(BaseModel):
    ...
    class Config:
        ...
        extra = "allow"  # Allow additional fields from API
        str_strip_whitespace = True
    application_list_name: list[dict[str, Any]] | None = Field(default=None, description="Application list name.")
...
class NameModel(BaseModel):
    ...
    Validation Rules:
        ...
        - popularity: min=0 max=255 pattern=
        - risk: min=0 max=255 pattern=
    ...
    parameters: list[NameParameters] | None = Field(default=None, description="Application parameters.")
    metadata: list[NameMetadata] | None = Field(default=None, description="Meta data.")
    status: list[NameStatus] | None = Field(default=None, description="print all application information")
    # ========================================================================
    # Custom Validators
    # ========================================================================
...
NameModelDict = dict[str, Any]  # For backward compatibility
...
# Schema: 1.7.0
# Generated: 2026-01-14T22:43:37.666916Z
# ============================================================================
