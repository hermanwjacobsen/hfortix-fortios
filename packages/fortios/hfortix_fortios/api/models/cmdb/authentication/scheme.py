...
class SchemeModel(BaseModel):
    ...
    async def validate_user_database_references(self, client: Any) -> list[str]:
        ...
        Datasource endpoints checked:
        - system/datasource        - user/radius        - user/tacacs_plus        - user/ldap        - user/group        - user/scim
        Args:
            client: FortiOS client instance (from fgt._client)
        ...
        for item in values:
            ...
            if not found:
                errors.append(
                    ...
                    "system/datasource or user/radius or user/tacacs_plus or user/ldap or user/group or user/scim"
                )
        return errors
    ...
    async def validate_external_idp_references(self, client: Any) -> list[str]:
        ...
        Datasource endpoints checked:
        - user/external_identity_provider
        Args:
            client: FortiOS client instance (from fgt._client)
...
SchemeModelDict = dict[str, Any]  # For backward compatibility
