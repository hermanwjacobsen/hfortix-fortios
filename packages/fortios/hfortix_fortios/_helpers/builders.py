...
def build_api_payload(
    ...
    **params: Any
    ...
    COMMON_LIST_FIELDS = {
        ...
        "ztna_ems_tag", "ztna_ems_tag_secondary", "ztna_geo_tag",
        "internet_service_name", "internet_service_group", "internet_service_custom",
        "internet_service_custom_group", "network_service_dynamic",
        "internet_service_src_name", "internet_service_src_group",
        "internet_service_src_custom", "internet_service_src_custom_group",
        "network_service_src_dynamic", "internet_service6_name",
        "internet_service6_group", "internet_service6_custom",
        "internet_service6_custom_group", "internet_service6_src_name",
        "internet_service6_src_group", "internet_service6_src_custom",
        "internet_service6_src_custom_group", "src_vendor_mac",
        "rtp_addr", "ntlm_enabled_browsers", "custom_log_fields",
        "pcp_poolname", "sgt", "internet_service_fortiguard",
        "internet_service_src_fortiguard", "internet_service6_fortiguard",
        "internet_service6_src_fortiguard",
        # Group membership
        "member",
        # System/interface fields
        "interface", "allowaccess", "device",
        # Router fields
        "gateway", "nexthop",
        # VPN fields
        "destination", "source",
