...
class NetworkMonitorSettingsObject(FortiObject[NetworkMonitorSettingsPayload]):
    """Typed FortiObject for switch_controller/network_monitor_settings with IDE autocomplete support."""
    
    # Enable/disable passive gathering of information by FortiSwitch units concerning 
