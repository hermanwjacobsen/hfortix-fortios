...
class ManagedSwitchObject(FortiObject[ManagedSwitchPayload]):
    ...
    route_offload_router: list[str]  # Auto-flattened from member_table
    # Configure VLAN assignment priority.
    vlan: list[str]  # Auto-flattened from member_table
    # Indication of switch type, physical or virtual.
    type: Literal["virtual", "physical"]
    # VDOM which owner of port belongs to.
    owner_vdom: str
    # Flow-tracking netflow ipfix switch identity in hex format(00000000-FFFFFFFF defa
    flow_identity: str
    ...
    # IP source guard.
    ip_source_guard: list[str]  # Auto-flattened from member_table
    ...
    stp_instance: list[str]  # Auto-flattened from member_table
    ...
    snmp_community: list[str]  # Auto-flattened from member_table
    ...
    snmp_user: list[str]  # Auto-flattened from member_table
    # Set QoS drop-policy.
    ...
    remote_log: list[str]  # Auto-flattened from member_table
    ...
    mirror: list[str]  # Auto-flattened from member_table
    # Configuration method to edit FortiSwitch Static and Sticky MAC.
    static_mac: list[str]  # Auto-flattened from member_table
    ...
    dhcp_snooping_static_client: list[str]  # Auto-flattened from member_table
    ...
    # Configure VRF.
    router_vrf: list[str]  # Auto-flattened from member_table
    # Configure system interface on FortiSwitch.
    system_interface: list[str]  # Auto-flattened from member_table
    # Configure static routes.
    router_static: list[str]  # Auto-flattened from member_table
    # Configure DHCP servers.
    system_dhcp_server: list[str]  # Auto-flattened from member_table
