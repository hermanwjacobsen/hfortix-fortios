...
class SystemObject(FortiObject[SystemPayload]):
    ...
    # Time interval between collection of switch data (30 - 1800 sec, default = 60, 0 
    data_sync_interval: int
    # MAC entry's confidence value. Value is re-queried when below this value (default
    ...
    iot_holdoff: int
    # MAC entry's idle time. MAC entry is removed after this value (0 - 10080 mins, de
    iot_mac_idle: int
    # Periodic time interval to run NAC engine (5 - 180 sec, default = 60).
    nac_periodic_interval: int
    # Periodic time interval to run Dynamic port policy engine (5 - 180 sec, default =
