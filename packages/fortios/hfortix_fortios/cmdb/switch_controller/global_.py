...
class Global(CRUDEndpoint, MetadataMixin):
    ...
    def put(
        ...
        dhcp_option82_circuit_id: Literal["intfname", "vlan", "hostname", "mode", "description"] | list[str] | list[dict[str, Any]] | None = None,
        dhcp_option82_remote_id: Literal["mac", "hostname", "ip"] | list[str] | list[dict[str, Any]] | None = None,
        ...
        update_user_device: Literal["mac-cache", "lldp", "dhcp-snooping", "l2-db", "l3-db"] | list[str] | list[dict[str, Any]] | None = None,
