...
class AccessControlListObject(FortiObject[AccessControlListPayload]):
    ...
    layer3_ipv4_rules: list[str]  # Auto-flattened from member_table
    # AP ACL layer3 ipv6 rule list.
    layer3_ipv6_rules: list[str]  # Auto-flattened from member_table
