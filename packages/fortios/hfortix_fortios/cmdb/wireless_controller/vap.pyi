...
class VapPayload(TypedDict, total=False):
    ...
    **Usage:**
    ...
    mlo: NotRequired[Literal["disable", "enable"]]  # Enable/disable WiFi7 Multi-Link-Operation (default = disable
...
class VapObject(FortiObject[VapPayload]):
    ...
    # Protected Management Frames (PMF) SA query retry timeout interval (1 - 5 100s of
    ...
    # RADIUS MAC MPSK cache timeout interval (0 or 300 - 864000, default = 86400, 0 to
    radius_mac_mpsk_timeout: int
    # Selective user groups that are permitted for RADIUS mac authentication.
    radius_mac_auth_usergroups: list[str]  # Auto-flattened from member_table
    ...
    local_standalone_dns_ip: list[str]  # Auto-flattened from member_table
    # Enable/disable segregating client traffic to local LAN side (default = disable).
    local_lan_partition: Literal["enable", "disable"]
    # Enable/disable bridging of wireless and Ethernet interfaces on the FortiAP (defa
    ...
    usergroup: list[str]  # Auto-flattened from member_table
    ...
    # Replacement message group for this VAP (only available when security is set to a
    ...
    selected_usergroups: list[str]  # Auto-flattened from member_table
    ...
    # Enable/disable blocking communication between clients on the same SSID (called i
    intra_vap_privacy: Literal["enable", "disable"]
    # Firewall schedules for enabling this VAP on the FortiAP. This VAP will be enable
    schedule: list[str]  # Auto-flattened from member_table
    ...
    # Enable/disable probe response suppression (to ignore weak signals) (default = di
    ...
    # Enable/disable software radio sensitivity (to ignore weak signals) (default = di
    ...
    vlan_name: list[str]  # Auto-flattened from member_table
    ...
    # VLAN pool.
    vlan_pool: list[str]  # Auto-flattened from member_table
    ...
    # The time interval to send echo to both primary and secondary tunnel peers (1 - 6
...
class Vap:
    ...
    def post(
        ...
        sae_groups: Literal["19", "20", "21"] | list[str] | list[dict[str, Any]] | None = ...,
        owe_groups: Literal["19", "20", "21"] | list[str] | list[dict[str, Any]] | None = ...,
        owe_transition: Literal["disable", "enable"] | None = ...,
        owe_transition_ssid: str | None = ...,
        additional_akms: Literal["akm6", "akm24"] | list[str] | list[dict[str, Any]] | None = ...,
        ...
        local_standalone_dns_ip: str | list[str] | list[dict[str, Any]] | None = ...,
        ...
        broadcast_suppression: Literal["dhcp-up", "dhcp-down", "dhcp-starvation", "dhcp-ucast", "arp-known", "arp-unknown", "arp-reply", "arp-poison", "arp-proxy", "netbios-ns", "netbios-ds", "ipv6", "all-other-mc", "all-other-bc"] | list[str] | list[dict[str, Any]] | None = ...,
        ipv6_rules: Literal["drop-icmp6ra", "drop-icmp6rs", "drop-llmnr6", "drop-icmp6mld2", "drop-dhcp6s", "drop-dhcp6c", "ndp-proxy", "drop-ns-dad", "drop-ns-nondad"] | list[str] | list[dict[str, Any]] | None = ...,
        ...
        rates_11a: Literal["6", "6-basic", "9", "9-basic", "12", "12-basic", "18", "18-basic", "24", "24-basic", "36", "36-basic", "48", "48-basic", "54", "54-basic"] | list[str] | list[dict[str, Any]] | None = ...,
        rates_11bg: Literal["1", "1-basic", "2", "2-basic", "5.5", "5.5-basic", "11", "11-basic", "6", "6-basic", "9", "9-basic", "12", "12-basic", "18", "18-basic", "24", "24-basic", "36", "36-basic", "48", "48-basic", "54", "54-basic"] | list[str] | list[dict[str, Any]] | None = ...,
        rates_11n_ss12: Literal["mcs0/1", "mcs1/1", "mcs2/1", "mcs3/1", "mcs4/1", "mcs5/1", "mcs6/1", "mcs7/1", "mcs8/2", "mcs9/2", "mcs10/2", "mcs11/2", "mcs12/2", "mcs13/2", "mcs14/2", "mcs15/2"] | list[str] | list[dict[str, Any]] | None = ...,
        rates_11n_ss34: Literal["mcs16/3", "mcs17/3", "mcs18/3", "mcs19/3", "mcs20/3", "mcs21/3", "mcs22/3", "mcs23/3", "mcs24/4", "mcs25/4", "mcs26/4", "mcs27/4", "mcs28/4", "mcs29/4", "mcs30/4", "mcs31/4"] | list[str] | list[dict[str, Any]] | None = ...,
        ...
        beacon_advertising: Literal["name", "model", "serial-number"] | list[str] | list[dict[str, Any]] | None = ...,
