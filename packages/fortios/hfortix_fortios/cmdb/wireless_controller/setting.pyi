...
class SettingPayload(TypedDict, total=False):
    ...
    **Usage:**
    ...
    device_weight: NotRequired[int]  # Upper limit of confidence of device for identification (0 - 
...
class SettingObject(FortiObject[SettingPayload]):
    ...
    offending_ssid: list[str]  # Auto-flattened from member_table
    # Upper limit of confidence of device for identification (0 - 255, default = 1, 0 
    device_weight: int
    # Lower limit of creation time of device for identification in minutes (0 - 60, de
    device_holdoff: int
    # Upper limit of idle time of device for identification in minutes (0 - 14400, def
    device_idle: int
...
class Setting:
    ...
    def put(
        ...
        fake_ssid_action: Literal["log", "suppress"] | list[str] | list[dict[str, Any]] | None = ...,
