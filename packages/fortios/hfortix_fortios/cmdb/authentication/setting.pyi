...
class SettingObject(FortiObject[SettingPayload]):
    ...
    # Enable/disable persistent cookie on IP based web portal authentication (default 
    ip_auth_cookie: Literal["enable", "disable"]
    # Persistent web portal cookie maximum age in minutes (30 - 10080 (1 week), defaul
    cookie_max_age: int
    ...
    user_cert_ca: list[str]  # Auto-flattened from member_table
    # Address range for the IP based device query.
    dev_range: list[str]  # Auto-flattened from member_table
