...
class AddressObject(FortiObject[AddressPayload]):
    ...
    sdn: str
    # FSSO group(s).
    fsso_group: list[str]  # Auto-flattened from member_table
    # RADIUS attributes value.
    sso_attribute_value: list[str]  # Auto-flattened from member_table
