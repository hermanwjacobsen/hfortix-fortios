...
class InternetServiceExtensionObject(FortiObject[InternetServiceExtensionPayload]):
    ...
    entry: list[str]  # Auto-flattened from member_table
    # Disable entries in the Internet Service database.
    disable_entry: list[str]  # Auto-flattened from member_table
