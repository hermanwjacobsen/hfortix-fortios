...
class VipObject(FortiObject[VipPayload]):
    ...
    extaddr: list[str]  # Auto-flattened from member_table
    ...
    mappedip: list[str]  # Auto-flattened from member_table
    ...
    srcintf_filter: list[str]  # Auto-flattened from member_table
    # Port mapping type.
    ...
    # Maximum number of concurrent requests that a multiplex server can handle (defaul
    ...
    gslb_public_ips: list[str]  # Auto-flattened from member_table
