...
class IppoolObject(FortiObject[IppoolPayload]):
    ...
    # First IPv4 address (inclusive) in the range for the address pool (format xxx.xxx
    startip: str
    # Final IPv4 address (inclusive) in the range for the address pool (format xxx.xxx
    endip: str
    # First port number (inclusive) in the range for the address pool (1024 - 65535, D
    startport: int
    # Final port number (inclusive) in the range for the address pool (1024 - 65535, D
    endport: int
    ...
    pba_timeout: int
    # Port block allocation interim logging interval (600 - 86400 seconds, default = 0
    pba_interim_log: int
    # Enable/disable fullcone NAT. Accept UDP packets from any host.
    permit_any_host: Literal["disable", "enable"]
    # Enable/disable replying to ARP requests when an IP Pool is added to a policy (de
    ...
    # Source IPv6 network to be translated (format = xxxx:xxxx:xxxx:xxxx:xxxx:xxxx:xxx
    source_prefix6: str
    # Subnet length of a single deterministic NAT64 client (1 - 128, default = 64).
    client_prefix_length: int
    # Maximum number of concurrent TCP sessions allowed per client (0 - 2097000, defau
    tcp_session_quota: int
    # Maximum number of concurrent UDP sessions allowed per client (0 - 2097000, defau
    udp_session_quota: int
    # Maximum number of concurrent ICMP sessions allowed per client (0 - 2097000, defa
