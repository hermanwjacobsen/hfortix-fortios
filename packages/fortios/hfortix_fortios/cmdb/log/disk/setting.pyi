...
class SettingObject(FortiObject[SettingPayload]):
    ...
    # Time of day at which log files are uploaded if uploadsched is enabled (hh:mm or 
    uploadtime: str
...
class Setting:
    ...
    def put(
        ...
        roll_day: Literal["sunday", "monday", "tuesday", "wednesday", "thursday", "friday", "saturday"] | list[str] | list[dict[str, Any]] | None = ...,
        roll_time: str | None = ...,
        ...
        uploadpass: str | None = ...,
        uploaddir: str | None = ...,
        uploadtype: Literal["traffic", "event", "virus", "webfilter", "IPS", "emailfilter", "dlp-archive", "anomaly", "voip", "dlp", "app-ctrl", "waf", "gtp", "dns", "ssh", "ssl", "file-filter", "icap", "virtual-patch", "debug"] | list[str] | list[dict[str, Any]] | None = ...,
