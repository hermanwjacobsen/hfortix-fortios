...
class ProfileObject(FortiObject[ProfilePayload]):
    ...
    # WISP servers.
    wisp_servers: list[str]  # Auto-flattened from member_table
...
class Profile:
    ...
    def post(
        ...
        options: Literal["activexfilter", "cookiefilter", "javafilter", "block-invalid-url", "jscript", "js", "vbs", "unknown", "intrinsic", "wf-referer", "wf-cookie", "per-user-bal"] | list[str] | list[dict[str, Any]] | None = ...,
        https_replacemsg: Literal["enable", "disable"] | None = ...,
        web_flow_log_encoding: Literal["utf-8", "punycode"] | None = ...,
        ovrd_perm: Literal["bannedword-override", "urlfilter-override", "fortiguard-wf-override", "contenttype-check-override"] | list[str] | list[dict[str, Any]] | None = ...,
