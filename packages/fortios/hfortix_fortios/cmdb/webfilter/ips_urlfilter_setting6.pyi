...
class IpsUrlfilterSetting6Object(FortiObject[IpsUrlfilterSetting6Payload]):
    ...
    gateway6: str
    # Filter based on geographical location. Route will NOT be installed if the resolv
    geo_filter: str
