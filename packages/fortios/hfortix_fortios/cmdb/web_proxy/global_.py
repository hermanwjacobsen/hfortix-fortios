...
class Global(CRUDEndpoint, MetadataMixin):
    ...
    def put(
        ...
        learn_client_ip_from_header: Literal["true-client-ip", "x-real-ip", "x-forwarded-for"] | list[str] | list[dict[str, Any]] | None = None,
        ...
        src_affinity_exempt_addr: str | list[str] | list[dict[str, Any]] | None = None,
        src_affinity_exempt_addr6: str | list[str] | list[dict[str, Any]] | None = None,
