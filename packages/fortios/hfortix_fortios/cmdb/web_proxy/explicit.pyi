...
class ExplicitObject(FortiObject[ExplicitPayload]):
    ...
    # Accept incoming HTTPS requests on one or more ports (0 - 65535, default = 0, use
    https_incoming_port: str
    # Name of certificates for secure web proxy.
    secure_web_proxy_cert: list[str]  # Auto-flattened from member_table
    ...
    outgoing_ip6: list[str]  # Auto-flattened from member_table
    ...
    # Authentication realm used to identify the explicit web proxy (maximum of 63 char
    realm: str
    ...
    pac_file_data: str
    # PAC policies.
    pac_policy: list[str]  # Auto-flattened from member_table
...
class Explicit:
    ...
    def put(
        ...
        outgoing_ip6: str | list[str] | list[dict[str, Any]] | None = ...,
