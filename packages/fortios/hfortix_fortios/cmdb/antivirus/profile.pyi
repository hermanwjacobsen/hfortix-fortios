...
class ProfileObject(FortiObject[ProfilePayload]):
    ...
    # Do not submit files matching this DLP file-pattern to FortiSandbox (post-transfe
    analytics_ignore_filetype: int
    # Only submit files matching this DLP file-pattern to FortiSandbox (post-transfer 
    ...
    external_blocklist: list[str]  # Auto-flattened from member_table
