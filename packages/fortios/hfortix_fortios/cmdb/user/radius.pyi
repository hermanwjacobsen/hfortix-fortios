...
class RadiusObject(FortiObject[RadiusPayload]):
    ...
    # Switch controller accounting message Framed-IP detection from DHCP snooping (sec
    ...
    # Minimum supported protocol version for TLS connections (default is to follow sys
    ...
    client_cert: str
    # Enable/disable RADIUS server identity check (verify server domain name/IP addres
    ...
    accounting_server: list[str]  # Auto-flattened from member_table
...
class Radius:
    ...
    def post(
        ...
        interface: str | None = ...,
        vrf_select: int | None = ...,
        switch_controller_service_type: Literal["login", "framed", "callback-login", "callback-framed", "outbound", "administrative", "nas-prompt", "authenticate-only", "callback-nas-prompt", "call-check", "callback-administrative"] | list[str] | list[dict[str, Any]] | None = ...,
        ...
        rsso_log_flags: Literal["protocol-error", "profile-missing", "accounting-stop-missed", "accounting-event", "endpoint-block", "radiusd-other", "none"] | list[str] | list[dict[str, Any]] | None = ...,
