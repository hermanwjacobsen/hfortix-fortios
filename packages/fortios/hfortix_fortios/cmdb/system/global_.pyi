...
class GlobalObject(FortiObject[GlobalPayload]):
    ...
    # Number of minutes before an idle administrator session times out (1 - 480 minute
    admintimeout: int
    ...
    # Maximum size of the body of the local out HTTP request (1 - 32 Mbytes, default =
    ...
    # Global timeout for connections with remote LDAP servers in milliseconds (1 - 300
    ldapconntimeout: int
    # Enable/disable batch mode, allowing you to enter a series of CLI commands that w
    batch_cmdb: Literal["enable", "disable"]
    # Enforce all login methods to require an additional authentication factor (defaul
    ...
    # Enable/disable static key ciphers in SSL/TLS connections (e.g. AES128-SHA, AES25
    ...
    # FortiGuard statistics collection period in minutes. (1 - 1440 min (1 min to 24 h
    ...
    # Authentication timeout in minutes for authenticated users (1 - 10000 min, defaul
    ...
    # Threshold at which memory usage forces the FortiGate to enter conserve mode (% o
    memory_use_threshold_red: int
    # Threshold at which memory usage forces the FortiGate to exit conserve mode (% of
    ...
    # Port used for the control channel in wireless controller mode (wireless-mode is 
    ...
    # Email-based two-factor authentication session timeout (30 - 300 seconds (5 minut
    ...
    # FortiAuthenticator token authentication session timeout (10 - 3600 seconds (1 ho
    ...
    ha_affinity: str
    # Affinity setting for BFD daemon (hexadecimal value up to 256 bits in the format 
    bfd_affinity: str
    # Affinity setting for cmdbsvr (hexadecimal value up to 256 bits in the format of 
    cmdbsvr_affinity: str
    # Affinity setting for AV scanning (hexadecimal value up to 256 bits in the format
    av_affinity: str
    # Affinity setting for wad (hexadecimal value up to 256 bits in the format of xxxx
    wad_affinity: str
    # Affinity setting for IPS (hexadecimal value up to 256 bits in the format of xxxx
    ips_affinity: str
    # Affinity setting for logging (hexadecimal value up to 256 bits in the format of 
    miglog_affinity: str
    # Affinity setting for syslog (hexadecimal value up to 256 bits in the format of x
    syslog_affinity: str
    # URL filter CPU affinity.
    url_filter_affinity: str
    # Affinity setting for BFD/VRRP/BGP/OSPF daemons (hexadecimal value up to 256 bits
    router_affinity: str
    # Maximum number of NDP table entries (set to 65,536 or higher; if set to 0, kerne
    ndp_max_entry: int
    ...
    # Interval in which to clean up remote users in FortiToken Cloud (0 - 336 hours (1
    ...
    internet_service_download_list: list[str]  # Auto-flattened from member_table
    ...
    # Enable/disable allowing use of interface-subnet setting in firewall addresses (d
    ...
    # Enable/disable automatic and periodic backup of authentication sessions (default
...
class Global:
    ...
    def put(
        ...
        admin_https_ssl_versions: Literal["tlsv1-1", "tlsv1-2", "tlsv1-3"] | list[str] | list[dict[str, Any]] | None = ...,
        admin_https_ssl_ciphersuites: Literal["TLS-AES-128-GCM-SHA256", "TLS-AES-256-GCM-SHA384", "TLS-CHACHA20-POLY1305-SHA256", "TLS-AES-128-CCM-SHA256", "TLS-AES-128-CCM-8-SHA256"] | list[str] | list[dict[str, Any]] | None = ...,
        admin_https_ssl_banned_ciphers: Literal["RSA", "DHE", "ECDHE", "DSS", "ECDSA", "AES", "AESGCM", "CAMELLIA", "3DES", "SHA1", "SHA256", "SHA384", "STATIC", "CHACHA20", "ARIA", "AESCCM"] | list[str] | list[dict[str, Any]] | None = ...,
        ...
        fgd_alert_subscription: Literal["advisory", "latest-threat", "latest-virus", "latest-attack", "new-antivirus-db", "new-attack-db"] | list[str] | list[dict[str, Any]] | None = ...,
