...
class TosBasedPriorityObject(FortiObject[TosBasedPriorityPayload]):
    """Typed FortiObject for system/tos_based_priority with IDE autocomplete support."""
    
    # Item ID.
    id: int
    # Value of the ToS byte in the IP datagram header (0-15, 8: minimize delay, 4: max
    tos: int
    # ToS based priority level to low, medium or high (these priorities match firewall
