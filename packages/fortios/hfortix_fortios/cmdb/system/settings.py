...
class Settings(CRUDEndpoint, MetadataMixin):
    ...
    def put(
        ...
        vpn_stats_log: Literal["ipsec", "pptp", "l2tp", "ssl"] | list[str] | list[dict[str, Any]] | None = None,
        ...
        dhcp_server_ip: str | list[str] | list[dict[str, Any]] | None = None,
        dhcp6_server_ip: str | list[str] | list[dict[str, Any]] | None = None,
        ...
        sip_tcp_port: int | list[str] | list[dict[str, Any]] | None = None,
        sip_udp_port: int | list[str] | list[dict[str, Any]] | None = None,
