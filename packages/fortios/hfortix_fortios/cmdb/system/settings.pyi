...
class SettingsObject(FortiObject[SettingsPayload]):
    ...
    dhcp_server_ip: list[str]  # Auto-flattened from member_table
    # DHCPv6 server IPv6 address.
    dhcp6_server_ip: list[str]  # Auto-flattened from member_table
    # Enable/disable central NAT.
    central_nat: Literal["enable", "disable"]
    # Default columns to display for policy lists on GUI.
    gui_default_policy_columns: list[str]  # Auto-flattened from member_table
    ...
    sip_udp_port: int
    # TCP port the SIP proxy monitors for SIP SSL/TLS traffic (0 - 65535, default = 50
    sip_ssl_port: int
...
class Settings:
    ...
    def put(
        ...
        vpn_stats_log: Literal["ipsec", "pptp", "l2tp", "ssl"] | list[str] | list[dict[str, Any]] | None = ...,
        ...
        dhcp_server_ip: str | list[str] | list[dict[str, Any]] | None = ...,
        dhcp6_server_ip: str | list[str] | list[dict[str, Any]] | None = ...,
        ...
        sip_tcp_port: int | list[int] | list[dict[str, Any]] | None = ...,
        sip_udp_port: int | list[int] | list[dict[str, Any]] | None = ...,
