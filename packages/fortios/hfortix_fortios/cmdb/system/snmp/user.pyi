...
class UserObject(FortiObject[UserPayload]):
    ...
    notify_hosts: list[str]  # Auto-flattened from member_table
    # IPv6 SNMP managers to send notifications (traps) to.
    notify_hosts6: list[str]  # Auto-flattened from member_table
...
class User:
    ...
    def post(
        ...
        query_port: int | None = ...,
        notify_hosts: str | list[str] | list[dict[str, Any]] | None = ...,
        notify_hosts6: str | list[str] | list[dict[str, Any]] | None = ...,
        source_ip: str | None = ...,
