...
class DeviceUpgradeExemptionsObject(FortiObject[DeviceUpgradeExemptionsPayload]):
    ...
    fortinet_device: str
    # Highest version of Fortinet firmware to exempt (format in Major.minor.patch, suc
    version: str
