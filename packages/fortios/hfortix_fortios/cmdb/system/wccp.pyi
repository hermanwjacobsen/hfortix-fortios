...
class WccpObject(FortiObject[WccpPayload]):
    ...
    router_list: list[str]  # Auto-flattened from member_table
    # Match method.
...
class Wccp:
    ...
    def post(
        ...
        router_list: str | list[str] | list[dict[str, Any]] | None = ...,
        ...
        primary_hash: Literal["src-ip", "dst-ip", "src-port", "dst-port"] | list[str] | list[dict[str, Any]] | None = ...,
        priority: int | None = ...,
        protocol: int | None = ...,
