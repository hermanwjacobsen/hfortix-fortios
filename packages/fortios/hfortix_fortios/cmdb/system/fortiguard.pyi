...
class FortiguardObject(FortiObject[FortiguardPayload]):
    ...
    # Maximum permille of FortiGate memory the antispam cache is allowed to use (1 - 1
    ...
    # Maximum permille of memory FortiGuard Virus Outbreak Prevention cache can use (1
    ...
    sdns_server_ip: list[str]  # Auto-flattened from member_table
...
class Fortiguard:
    ...
    def put(
        ...
        auto_firmware_upgrade_day: Literal["sunday", "monday", "tuesday", "wednesday", "thursday", "friday", "saturday"] | list[str] | list[dict[str, Any]] | None = ...,
        ...
        sdns_server_ip: str | list[str] | list[dict[str, Any]] | None = ...,
        sdns_server_port: int | None = ...,
        anycast_sdns_server_ip: str | None = ...,
        anycast_sdns_server_port: int | None = ...,
        sdns_options: Literal["include-question-section"] | list[str] | list[dict[str, Any]] | None = ...,
        source_ip: str | None = ...,
        source_ip6: str | None = ...,
