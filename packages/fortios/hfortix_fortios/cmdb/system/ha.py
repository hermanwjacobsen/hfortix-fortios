...
class Ha(CRUDEndpoint, MetadataMixin):
    ...
    def put(
        ...
        key: Any | None = None,
        hbdev: str | list[str] | list[dict[str, Any]] | None = None,
        ...
        session_sync_dev: str | list[str] | list[dict[str, Any]] | None = None,
        ...
        pingserver_monitor_interface: str | list[str] | list[dict[str, Any]] | None = None,
        ...
        ipsec_phase2_proposal: Literal["aes128-sha1", "aes128-sha256", "aes128-sha384", "aes128-sha512", "aes192-sha1", "aes192-sha256", "aes192-sha384", "aes192-sha512", "aes256-sha1", "aes256-sha256", "aes256-sha384", "aes256-sha512", "aes128gcm", "aes256gcm", "chacha20poly1305"] | list[str] | list[dict[str, Any]] | None = None,
