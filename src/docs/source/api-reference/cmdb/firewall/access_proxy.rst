...
Configuration endpoint for firewall/access_proxy.
...
.. code-block:: python
   ...
   fgt.api.cmdb.firewall.access_proxy
...
.. code-block:: python
   ...
   item = fgt.api.cmdb.firewall.access_proxy.get(name='item-name')
   ...
   # Delete item
   result = fgt.api.cmdb.firewall.access_proxy.delete(name='item-name')
