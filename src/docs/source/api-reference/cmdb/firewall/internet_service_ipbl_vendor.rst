...
Configuration endpoint for firewall/internet_service_ipbl_vendor.
...
.. code-block:: python
   ...
   fgt.api.cmdb.firewall.internet_service_ipbl_vendor
...
.. code-block:: python
   ...
   # Delete item
   result = fgt.api.cmdb.firewall.internet_service_ipbl_vendor.delete()
