"""
Fortinet API Exceptions
Comprehensive exception classes for all Fortinet products (FortiOS, FortiManager, FortiAnalyzer, etc.)
"""
...
class APIError(FortinetError):
    ...
    Attributes:
        ...
        error_code (int): FortiOS internal error code (-1 to -10002)
    ...
    def __init__(self, message, http_status=None, error_code=None, response=None):
        ...
        Args:
            ...
            error_code (int, optional): FortiOS error code
        ...
        if error_code:
            error_desc = FORTIOS_ERROR_CODES.get(error_code, "Unknown error")
            error_parts.append(f"Error {error_code}: {error_desc}")
...
FORTIOS_ERROR_CODES = {
    ...
    -104: "The gateway 2 is not a valid gateway",
...
# FortiOS-specific aliases for backward compatibility
